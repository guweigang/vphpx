...
fn main() {
	...
	mut var_release_notes_url := rt.call_function('sprintf', [
		...
		rt.call_function('sanitize_title', [
			rt.new_string(var_display_major_version.str()).clone(),
		]),
	])
	...
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_url', [var_release_page_url.clone()]))
	// unsupported statement: Stmt_InlineHTML
	...
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_url', [var_release_notes_url.clone()]))
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('printf', [
	...
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_url', [var_field_guide_url.clone()]))
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('printf', [
	...
	rt.call_function('__', [
		rt.new_string('<strong>Version %s</strong> addressed some security issues.'),
	])
	rt.call_function('_n_noop', [
		rt.new_string('<strong>Version %1$s</strong> addressed %2$s bug.'),
		rt.new_string('<strong>Version %1$s</strong> addressed %2$s bugs.'),
	])
	rt.call_function('_n_noop', [
		rt.new_string('<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.'),
		rt.new_string('<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.'),
	])
	rt.call_function('_n_noop', [
		rt.new_string('<strong>Version %1$s</strong> addressed some security issues and fixed %2$s bug.'),
		rt.new_string('<strong>Version %1$s</strong> addressed some security issues and fixed %2$s bugs.'),
	])
	rt.call_function('__', [
		rt.new_string('For more information, see <a href="%s">the release notes</a>.'),
	])
	rt.call_function('__', [
		rt.new_string('Important! Your version of WordPress (%1$s) is no longer supported, you will not receive any security updates for your website. To keep your site secure, please <a href="%2$s">update to the latest version of WordPress</a>.'),
	])
	rt.call_function('__', [
		rt.new_string('Important! Your version of WordPress (%1$s) will stop receiving security updates in the near future. To keep your site secure, please <a href="%2$s">update to the latest version of WordPress</a>.'),
	])
	rt.call_function('__', [rt.new_string('This is the final release of WordPress %s')])
	rt.call_function('__', [rt.new_string('https://wordpress.org/download/')])
}
