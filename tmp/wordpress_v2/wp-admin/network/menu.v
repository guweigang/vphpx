...
fn main() {
	...
	if rt.is_true(var_update_data.array_get(rt.new_string('counts')).array_get(rt.new_string('total'))) {
	...
	if rt.is_true(rt.call_function('current_user_can', [rt.new_string('update_themes')]))
		&& rt.is_true(var_update_data.array_get(rt.new_string('counts')).array_get(rt.new_string('themes'))) {
	...
	if rt.is_true(rt.call_function('current_user_can', [rt.new_string('update_plugins')]))
		&& rt.is_true(var_update_data.array_get(rt.new_string('counts')).array_get(rt.new_string('plugins'))) {
