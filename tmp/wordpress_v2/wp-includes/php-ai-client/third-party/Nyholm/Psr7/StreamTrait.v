...
fn create_wordpress_aiclientdependencies_nyholm_psr7_reflectionmethod(_args ...rt.PhpVal) &Class_WordPress_AiClientDependencies_Nyholm_Psr7_ReflectionMethod {
...
fn main() {
	...
	if rt.is_true(rt.greater_equal(rt.get_constant('PHP_VERSION_ID'), rt.new_int(70400)))
