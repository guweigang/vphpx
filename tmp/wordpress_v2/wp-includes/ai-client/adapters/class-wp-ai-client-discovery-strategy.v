...
fn Class_WP_AI_Client_Discovery_Strategy.createclient(mut var_psr17_factory Class_WordPress_AiClientDependencies_Nyholm_Psr7_Factory_Psr17Factory) rt.PhpVal {
	return rt.new_object('WP_AI_Client_HTTP_Client', []string{}, create_wp_ai_client_http_client(var_psr17_factory,
		var_psr17_factory))
}
...
fn create_wp_ai_client_http_client(_args ...rt.PhpVal) &Class_WP_AI_Client_HTTP_Client {
