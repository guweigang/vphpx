...
fn render_block_core_accordion(var_attributes rt.PhpVal, var_content_arg rt.PhpVal) rt.PhpVal {
	...
	var_autoclose = if rt.is_true(var_attributes.array_get(rt.new_string('autoclose'))) {
		'true'
	} else {
		'false'
	}
