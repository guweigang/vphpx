...
fn render_block_core_comment_content(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) string {
	...
	mut var_moderation_note := rt.new_null()
	...
	var_comment_text = rt.call_function('get_comment_text', [
	...
	var_moderation_note = rt.new_string('')
...
fn register_block_core_comment_content() {
	rt.call_function('register_block_type_from_metadata', [
		rt.new_string(@DIR + '/comment-content'),
		rt.create_array([
