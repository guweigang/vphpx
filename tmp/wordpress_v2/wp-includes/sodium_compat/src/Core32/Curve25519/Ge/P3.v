...
fn (mut this Class_ParagonIE_Sodium_Core32_Curve25519_Ge_P3) construct(mut var_x Class_ParagonIE_Sodium_Core32_Curve25519_Fe, mut var_y Class_ParagonIE_Sodium_Core32_Curve25519_Fe, mut var_z Class_ParagonIE_Sodium_Core32_Curve25519_Fe, mut var_t Class_ParagonIE_Sodium_Core32_Curve25519_Fe) {
	...
	if rt.is_true(rt.identical(var_x_mutated, rt.new_null())) {
		var_x_mutated = create_paragonie_sodium_core32_curve25519_fe()
	}
	this.X = var_x_mutated
	if rt.is_true(rt.identical(var_y_mutated, rt.new_null())) {
		var_y_mutated = create_paragonie_sodium_core32_curve25519_fe()
	}
	...
	if rt.is_true(rt.identical(var_t_mutated, rt.new_null())) {
		var_t_mutated = create_paragonie_sodium_core32_curve25519_fe()
	}
...
fn create_paragonie_sodium_core32_curve25519_ge_p3(arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal, arg_3 rt.PhpVal) &Class_ParagonIE_Sodium_Core32_Curve25519_Ge_P3 {
...
fn main() {
	...
	if rt.is_true(rt.call_function('class_exists', [
		rt.new_string('ParagonIE_Sodium_Core32_Curve25519_Ge_P3'),
		rt.new_bool(false),
	]))
	{
		return rt.new_null()
