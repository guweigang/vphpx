...
fn (mut this Class_ParagonIE_Sodium_Core32_SecretStream_State) rekey(var_newKeyAndNonce rt.PhpVal) rt.PhpVal {
	...
	mut iife_temp_4 := Class_ParagonIE_Sodium_Core32_Util{}
	mut iife_result_4 := iife_temp_4.substr(var_newKeyAndNonce.clone(), rt.new_int(32))
	mut iife_temp_5 := Class_ParagonIE_Sodium_Core32_Util{}
...
fn Class_ParagonIE_Sodium_Core32_SecretStream_State.fromstring(var_string rt.PhpVal) rt.PhpVal {
	...
	mut var_state := create_paragonie_sodium_core32_secretstream_state(iife_result_9, rt.new_null())
	mut iife_temp_10 := Class_ParagonIE_Sodium_Core32_Util{}
	...
	mut iife_temp_13 := Class_ParagonIE_Sodium_Core32_Util{}
