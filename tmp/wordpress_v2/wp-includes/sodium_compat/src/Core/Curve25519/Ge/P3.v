...
fn (mut this Class_ParagonIE_Sodium_Core_Curve25519_Ge_P3) construct(var_x rt.PhpVal, var_y rt.PhpVal, var_z rt.PhpVal, var_t rt.PhpVal) {
...
fn create_paragonie_sodium_core_curve25519_ge_p3(arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal, arg_3 rt.PhpVal) &Class_ParagonIE_Sodium_Core_Curve25519_Ge_P3 {
...
fn main() {
	...
	if rt.is_true(rt.call_function('class_exists', [
		rt.new_string('ParagonIE_Sodium_Core_Curve25519_Ge_P3'),
		rt.new_bool(false),
	]))
	{
		return rt.new_null()
