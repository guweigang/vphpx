...
fn Class_ParagonIE_Sodium_Core_Poly1305.onetimeauth(var_m rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	mut iife_temp_0 := Class_ParagonIE_Sodium_Core_Poly1305{}
	...
	mut iife_temp_1 := Class_ParagonIE_Sodium_Core_Poly1305{}
	mut iife_result_1 := iife_temp_1.substr(var_key.clone(), rt.new_int(0), rt.new_int(32))
	mut var_state := create_paragonie_sodium_core_poly1305_state(iife_result_1)
...
fn (mut this Class_ParagonIE_Sodium_Core_Poly1305) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'onetimeauth_verify' {
			...
			return Class_ParagonIE_Sodium_Core_Poly1305.onetimeauth_verify(dispatch_arg_0,
...
fn main() {
	...
	if rt.is_true(rt.call_function('class_exists', [
		rt.new_string('ParagonIE_Sodium_Core_Poly1305'),
		rt.new_bool(false),
	]))
	{
		return rt.new_null()
