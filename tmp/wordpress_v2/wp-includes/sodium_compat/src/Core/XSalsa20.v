...
fn Class_ParagonIE_Sodium_Core_XSalsa20.xsalsa20(var_len rt.PhpVal, var_nonce rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	mut iife_temp_0 := Class_ParagonIE_Sodium_Core_XSalsa20{}
	mut iife_result_0 := iife_temp_0.substr(var_nonce.clone(), rt.new_int(16), rt.new_int(8))
	mut iife_temp_1 := Class_ParagonIE_Sodium_Core_XSalsa20{}
	mut iife_result_1 := iife_temp_1.hsalsa20(var_nonce.clone(), var_key.clone())
	mut iife_temp_2 := Class_ParagonIE_Sodium_Core_XSalsa20{}
...
fn Class_ParagonIE_Sodium_Core_XSalsa20.xsalsa20_xor(var_message rt.PhpVal, var_nonce rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	mut iife_temp_3 := Class_ParagonIE_Sodium_Core_XSalsa20{}
	mut iife_result_3 := iife_temp_3.strlen(var_message.clone())
	mut iife_temp_4 := Class_ParagonIE_Sodium_Core_XSalsa20{}
	mut iife_result_4 := iife_temp_4.xorstrings(var_message.clone(), Class_ParagonIE_Sodium_Core_XSalsa20.xsalsa20(iife_result_3,
