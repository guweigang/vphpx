...
fn (mut this Class_ParagonIE_Sodium_Core_ChaCha20_IetfCtx) construct(key string, iv string, counter string) {
	...
	mut iife_temp_0 := Class_ParagonIE_Sodium_Core_ChaCha20_IetfCtx{}
	...
	mut iife_temp_1 := Class_ParagonIE_Sodium_Core_ChaCha20_IetfCtx{}
	mut iife_result_1 := iife_temp_1.substr(rt.new_string(iv), rt.new_int(0), rt.new_int(8))
	this.Class_ParagonIE_Sodium_Core_ChaCha20_Ctx.construct(rt.new_string(key), iife_result_1,
		rt.new_string(counter_mutated))
	mut iife_temp_2 := Class_ParagonIE_Sodium_Core_ChaCha20_IetfCtx{}
	mut iife_result_2 := iife_temp_2.substr(rt.new_string(counter_mutated), rt.new_int(0),
		rt.new_int(4))
	mut iife_temp_3 := Class_ParagonIE_Sodium_Core_ChaCha20_IetfCtx{}
