...
fn Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_decrypt(message string, ad string, nonce string, key string) rt.PhpVal {
	...
	mut iife_result_2 := iife_temp_2.substr(rt.new_string(message), var_clen.clone(),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_abytes()))
	...
	mut var_state := create_paragonie_sodium_core_poly1305_state(var_block0.clone())
...
fn Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_encrypt(message string, ad string, nonce string, key string) string {
	...
	end_label_2:
	mut iife_temp_15 := Class_ParagonIE_Sodium_Core_Util{}
...
fn Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_ietf_decrypt(message string, ad string, nonce string, key string) rt.PhpVal {
	...
	mut iife_temp_28 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_28 := iife_temp_28.store64_le(rt.new_int(1))
	mut iife_temp_29 := Class_ParagonIE_Sodium_Core_ChaCha20{}
...
fn Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_ietf_encrypt(message string, ad string, nonce string, key string) string {
	...
	end_label_4:
	mut iife_temp_34 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_34 := iife_temp_34.store64_le(rt.new_int(1))
	mut iife_temp_35 := Class_ParagonIE_Sodium_Core_ChaCha20{}
...
fn Class_ParagonIE_Sodium_Crypto.aead_xchacha20poly1305_ietf_decrypt(message string, ad string, nonce string, key string) rt.PhpVal {
	mut nonce_mutated := nonce
	mut iife_temp_38 := Class_ParagonIE_Sodium_Core_Util{}
	...
	mut iife_temp_40 := Class_ParagonIE_Sodium_Core_Util{}
	...
	return Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_ietf_decrypt(message, ad,
...
fn Class_ParagonIE_Sodium_Crypto.aead_xchacha20poly1305_ietf_encrypt(message string, ad string, nonce string, key string) rt.PhpVal {
	mut nonce_mutated := nonce
	mut iife_temp_41 := Class_ParagonIE_Sodium_Core_Util{}
	...
	mut iife_temp_43 := Class_ParagonIE_Sodium_Core_Util{}
	...
	return Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_ietf_encrypt(message, ad,
		var_nonceLast.str(), var_subkey.str())
}

fn Class_ParagonIE_Sodium_Crypto.auth(var_message rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	mut iife_temp_44 := Class_ParagonIE_Sodium_Core_Util{}
...
fn Class_ParagonIE_Sodium_Crypto.auth_verify(var_mac rt.PhpVal, var_message rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	...
	mut iife_temp_45 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_45 := iife_temp_45.hashequals(var_mac_mutated.clone(), Class_ParagonIE_Sodium_Crypto.auth(var_message.clone(),
		var_key.clone()))
...
fn Class_ParagonIE_Sodium_Crypto.box(var_plaintext rt.PhpVal, var_nonce rt.PhpVal, var_keypair rt.PhpVal) rt.PhpVal {
	...
	mut var_c := Class_ParagonIE_Sodium_Crypto.secretbox(var_plaintext.clone(),
		var_nonce_mutated.clone(), Class_ParagonIE_Sodium_Crypto.box_beforenm(Class_ParagonIE_Sodium_Crypto.box_secretkey(var_keypair_mutated.clone()),
		Class_ParagonIE_Sodium_Crypto.box_publickey(var_keypair_mutated.clone())))
	return var_c.clone()
}
...
fn Class_ParagonIE_Sodium_Crypto.box_seal(var_message rt.PhpVal, var_publicKey rt.PhpVal) string {
	...
	mut var_ephemeralSK := Class_ParagonIE_Sodium_Crypto.box_secretkey(var_ephemeralKeypair.clone())
	mut var_ephemeralPK := Class_ParagonIE_Sodium_Crypto.box_publickey(var_ephemeralKeypair.clone())
	mut var_nonce := Class_ParagonIE_Sodium_Crypto.generichash(var_ephemeralPK.str() +
		var_publicKey_mutated.str(), '', rt.new_int(24))
	mut var_keypair := Class_ParagonIE_Sodium_Crypto.box_keypair_from_secretkey_and_publickey(var_ephemeralSK.clone(),
		var_publicKey_mutated.clone())
	mut var_ciphertext := Class_ParagonIE_Sodium_Crypto.box(var_message.clone(), var_nonce.clone(),
		var_keypair.clone())
...
fn Class_ParagonIE_Sodium_Crypto.box_seal_open(var_message rt.PhpVal, var_keypair rt.PhpVal) rt.PhpVal {
	mut var_keypair_mutated := var_keypair
	mut iife_temp_49 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_49 := iife_temp_49.substr(var_message.clone(), rt.new_int(0), rt.new_int(32))
	mut var_ephemeralPK := iife_result_49
	mut iife_temp_50 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_50 := iife_temp_50.substr(var_message.clone(), rt.new_int(32))
	mut var_ciphertext := iife_result_50
	mut var_secretKey := Class_ParagonIE_Sodium_Crypto.box_secretkey(var_keypair_mutated.clone())
	mut var_publicKey := Class_ParagonIE_Sodium_Crypto.box_publickey(var_keypair_mutated.clone())
	mut var_nonce := Class_ParagonIE_Sodium_Crypto.generichash(var_ephemeralPK.str() +
		var_publicKey.str(), '', rt.new_int(24))
	var_keypair_mutated = Class_ParagonIE_Sodium_Crypto.box_keypair_from_secretkey_and_publickey(var_secretKey.clone(),
		var_ephemeralPK.clone())
	mut var_m := Class_ParagonIE_Sodium_Crypto.box_open(var_ciphertext.clone(), var_nonce.clone(),
		var_keypair_mutated.clone())
...
fn Class_ParagonIE_Sodium_Crypto.box_beforenm(var_sk rt.PhpVal, var_pk rt.PhpVal) rt.PhpVal {
	mut iife_temp_54 := Class_ParagonIE_Sodium_Core_HSalsa20{}
	mut iife_result_54 := iife_temp_54.hsalsa20(rt.call_function('str_repeat', [
		rt.new_string(''),
		rt.new_int(16),
	]), Class_ParagonIE_Sodium_Crypto.scalarmult(var_sk.clone(), var_pk.clone()))
...
fn Class_ParagonIE_Sodium_Crypto.box_keypair() string {
	...
	mut var_pKey := Class_ParagonIE_Sodium_Crypto.scalarmult_base(var_sKey.clone())
	return var_sKey.str() + var_pKey.str()
}

fn Class_ParagonIE_Sodium_Crypto.box_seed_keypair(var_seed rt.PhpVal) string {
	mut iife_temp_55 := Class_ParagonIE_Sodium_Core_Util{}
...
fn Class_ParagonIE_Sodium_Crypto.box_keypair_from_secretkey_and_publickey(var_sKey rt.PhpVal, var_pKey rt.PhpVal) string {
	...
	mut iife_temp_56 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_56 := iife_temp_56.substr(var_sKey_mutated.clone(), rt.new_int(0),
		rt.new_int(32))
	mut iife_temp_57 := Class_ParagonIE_Sodium_Core_Util{}
...
fn Class_ParagonIE_Sodium_Crypto.box_secretkey(var_keypair rt.PhpVal) rt.PhpVal {
	...
	mut iife_temp_59 := Class_ParagonIE_Sodium_Core_Util{}
...
fn Class_ParagonIE_Sodium_Crypto.box_publickey(var_keypair rt.PhpVal) rt.PhpVal {
	mut var_keypair_mutated := var_keypair
	mut iife_temp_60 := Class_ParagonIE_Sodium_Core_Util{}
	...
	mut iife_temp_61 := Class_ParagonIE_Sodium_Core_Util{}
...
fn Class_ParagonIE_Sodium_Crypto.box_publickey_from_secretkey(var_sKey rt.PhpVal) rt.PhpVal {
	mut var_sKey_mutated := var_sKey
	mut iife_temp_62 := Class_ParagonIE_Sodium_Core_Util{}
	...
	return Class_ParagonIE_Sodium_Crypto.scalarmult_base(var_sKey_mutated.clone())
}
...
fn Class_ParagonIE_Sodium_Crypto.box_open(var_ciphertext rt.PhpVal, var_nonce rt.PhpVal, var_keypair rt.PhpVal) rt.PhpVal {
	...
	mut var_nonce_mutated := var_nonce
	mut var_keypair_mutated := var_keypair
	return Class_ParagonIE_Sodium_Crypto.secretbox_open(var_ciphertext_mutated.clone(),
		var_nonce_mutated.clone(), Class_ParagonIE_Sodium_Crypto.box_beforenm(Class_ParagonIE_Sodium_Crypto.box_secretkey(var_keypair_mutated.clone()),
		Class_ParagonIE_Sodium_Crypto.box_publickey(var_keypair_mutated.clone())))
}

fn Class_ParagonIE_Sodium_Crypto.generichash(var_message rt.PhpVal, key string, outlen i64) rt.PhpVal {
	mut iife_temp_63 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
	mut iife_result_63 := iife_temp_63.pseudoconstructor()
	mut var_k := rt.new_null()
	if !(key == '') {
		mut iife_temp_64 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
	...
	mut iife_temp_68 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
	...
	mut iife_temp_69 := Class_ParagonIE_Sodium_Core_Util{}
...
fn Class_ParagonIE_Sodium_Crypto.generichash_init(key string, outputLength i64) rt.PhpVal {
	mut iife_temp_73 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
	mut iife_result_73 := iife_temp_73.pseudoconstructor()
	mut var_k := rt.new_null()
	if !(key == '') {
		mut iife_temp_74 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
	...
	mut iife_temp_75 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
	mut iife_result_75 := iife_temp_75.init(var_k.clone(), rt.new_int(outputLength))
	mut var_ctx := iife_result_75
	mut iife_temp_76 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
...
fn Class_ParagonIE_Sodium_Crypto.generichash_init_salt_personal(key string, outputLength i64, salt string, personal string) rt.PhpVal {
	mut iife_temp_77 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
	mut iife_result_77 := iife_temp_77.pseudoconstructor()
	mut var_k := rt.new_null()
	if !(key == '') {
		mut iife_temp_78 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
	...
	if !(salt == '') {
		mut iife_temp_79 := Class_ParagonIE_Sodium_Core_BLAKE2b{}
...
fn Class_ParagonIE_Sodium_Crypto.keyexchange(var_my_sk rt.PhpVal, var_their_pk rt.PhpVal, var_client_pk rt.PhpVal, var_server_pk rt.PhpVal) rt.PhpVal {
	...
	mut iife_result_88 := iife_temp_88.crypto_scalarmult(var_my_sk.clone(), var_their_pk.clone())
	mut iife_temp_89 := Class_ParagonIE_Sodium_Compat{}
	mut iife_result_89 := iife_temp_89.crypto_generichash(rt.new_string(iife_result_88.str() +
...
fn Class_ParagonIE_Sodium_Crypto.scalarmult(var_sKey rt.PhpVal, var_pKey rt.PhpVal) rt.PhpVal {
	mut var_sKey_mutated := var_sKey
	mut var_pKey_mutated := var_pKey
	mut iife_temp_90 := Class_ParagonIE_Sodium_Core_X25519{}
	mut iife_result_90 := iife_temp_90.crypto_scalarmult_curve25519_ref10(var_sKey_mutated.clone(),
		var_pKey_mutated.clone())
	mut var_q := iife_result_90
	Class_ParagonIE_Sodium_Crypto.scalarmult_throw_if_zero(var_q.clone())
	return var_q.clone()
}

fn Class_ParagonIE_Sodium_Crypto.scalarmult_base(var_secret rt.PhpVal) rt.PhpVal {
	mut iife_temp_91 := Class_ParagonIE_Sodium_Core_X25519{}
	mut iife_result_91 := iife_temp_91.crypto_scalarmult_curve25519_ref10_base(var_secret.clone())
	mut var_q := iife_result_91
	Class_ParagonIE_Sodium_Crypto.scalarmult_throw_if_zero(var_q.clone())
	return var_q.clone()
}
...
fn Class_ParagonIE_Sodium_Crypto.scalarmult_throw_if_zero(var_q rt.PhpVal) {
	...
	for {
		if !(rt.is_true(rt.less(var_i, Class_ParagonIE_Sodium_Crypto.box_curve25519xsalsa20poly1305_secretkeybytes()))) { break
		 }
		rt.new_null()
		rt.pre_inc(var_i)
	}
...
fn Class_ParagonIE_Sodium_Crypto.secretbox(var_plaintext rt.PhpVal, var_nonce rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	mut var_nonce_mutated := var_nonce
	mut iife_temp_92 := Class_ParagonIE_Sodium_Core_HSalsa20{}
	mut iife_result_92 := iife_temp_92.hsalsa20(var_nonce_mutated.clone(), var_key.clone())
	mut var_subkey := iife_result_92
	mut var_block0 := rt.call_function('str_repeat', [rt.new_string(''),
		rt.new_int(32)])
	mut iife_temp_93 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_93 := iife_temp_93.strlen(var_plaintext.clone())
	mut var_mlen := iife_result_93
	mut var_mlen0 := var_mlen.clone()
	if rt.is_true(rt.greater(var_mlen0,
		64 - Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_zerobytes()))
	{
		var_mlen0 =
			rt.new_int(64 - Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_zerobytes())
	}
	mut iife_temp_94 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_94 := iife_temp_94.substr(var_plaintext.clone(), rt.new_int(0),
		var_mlen0.clone())
	var_block0 = rt.concat(var_block0, iife_result_94)
	mut iife_temp_95 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_95 := iife_temp_95.substr(var_nonce_mutated.clone(), rt.new_int(16),
		rt.new_int(8))
	mut iife_temp_96 := Class_ParagonIE_Sodium_Core_Salsa20{}
	mut iife_result_96 := iife_temp_96.salsa20_xor(var_block0.clone(), iife_result_95,
		var_subkey.clone())
	var_block0 = iife_result_96
	mut iife_temp_97 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_97 := iife_temp_97.substr(var_block0.clone(),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_zerobytes()))
	mut var_c := iife_result_97
	if rt.is_true(rt.greater(var_mlen, var_mlen0)) {
		mut iife_temp_98 := Class_ParagonIE_Sodium_Core_Util{}
		mut iife_result_98 := iife_temp_98.substr(var_plaintext.clone(),
			rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_zerobytes()))
		mut iife_temp_99 := Class_ParagonIE_Sodium_Core_Util{}
		mut iife_result_99 := iife_temp_99.substr(var_nonce_mutated.clone(), rt.new_int(16),
			rt.new_int(8))
		mut iife_temp_100 := Class_ParagonIE_Sodium_Core_Salsa20{}
		mut iife_result_100 := iife_temp_100.salsa20_xor_ic(iife_result_98, iife_result_99,
			rt.new_int(1), var_subkey.clone())
		var_c = rt.concat(var_c, iife_result_100)
	}
	mut iife_temp_101 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_101 := iife_temp_101.substr(var_block0.clone(), rt.new_int(0),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.onetimeauth_poly1305_keybytes()))
	mut var_state := create_paragonie_sodium_core_poly1305_state(iife_result_101)
	mut iife_temp_102 := Class_ParagonIE_Sodium_Compat{}
	mut iife_result_102 := iife_temp_102.memzero(var_block0.clone())
	if rt.has_exception() {
		unsafe {
			goto catch_label_7
		}
	}
	mut iife_temp_103 := Class_ParagonIE_Sodium_Compat{}
	mut iife_result_103 := iife_temp_103.memzero(var_subkey.clone())
	if rt.has_exception() {
		unsafe {
			goto catch_label_7
		}
...
fn Class_ParagonIE_Sodium_Crypto.secretbox_open(var_ciphertext rt.PhpVal, var_nonce rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	mut var_ciphertext_mutated := var_ciphertext
	mut var_nonce_mutated := var_nonce
	mut iife_temp_104 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_104 := iife_temp_104.substr(var_ciphertext_mutated.clone(), rt.new_int(0),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_macbytes()))
	mut var_mac := iife_result_104
	mut iife_temp_105 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_105 := iife_temp_105.substr(var_ciphertext_mutated.clone(),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_macbytes()))
	mut var_c := iife_result_105
	mut iife_temp_106 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_106 := iife_temp_106.strlen(var_c.clone())
	mut var_clen := iife_result_106
	mut iife_temp_107 := Class_ParagonIE_Sodium_Core_HSalsa20{}
	mut iife_result_107 := iife_temp_107.hsalsa20(var_nonce_mutated.clone(), var_key.clone())
	mut var_subkey := iife_result_107
	mut iife_temp_108 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_108 := iife_temp_108.substr(var_nonce_mutated.clone(), rt.new_int(16),
		rt.new_int(8))
	mut iife_temp_109 := Class_ParagonIE_Sodium_Core_Salsa20{}
	mut iife_result_109 := iife_temp_109.salsa20(rt.new_int(64), iife_result_108,
		var_subkey.clone())
	mut var_block0 := iife_result_109
	mut iife_temp_110 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_110 := iife_temp_110.substr(var_block0.clone(), rt.new_int(0), rt.new_int(32))
	mut iife_temp_111 := Class_ParagonIE_Sodium_Core_Poly1305{}
	mut iife_result_111 := iife_temp_111.onetimeauth_verify(var_mac.clone(), var_c.clone(),
		iife_result_110)
	mut var_verified := iife_result_111
	if rt.is_true(rt.new_bool(!(rt.is_true(var_verified)))) {
		mut iife_temp_112 := Class_ParagonIE_Sodium_Compat{}
		mut iife_result_112 := iife_temp_112.memzero(var_subkey.clone())
		if rt.has_exception() {
			unsafe {
				goto catch_label_8
			}
	...
	mut iife_temp_113 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_113 := iife_temp_113.substr(var_block0.clone(),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_zerobytes()))
	mut iife_temp_114 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_114 := iife_temp_114.substr(var_c.clone(), rt.new_int(0),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_zerobytes()))
	mut iife_temp_115 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_115 := iife_temp_115.xorstrings(iife_result_113, iife_result_114)
	mut var_m := iife_result_115
	if rt.is_true(rt.greater(var_clen,
		Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_zerobytes()))
	{
		mut iife_temp_116 := Class_ParagonIE_Sodium_Core_Util{}
		mut iife_result_116 := iife_temp_116.substr(var_c.clone(),
			rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xsalsa20poly1305_zerobytes()))
		mut iife_temp_117 := Class_ParagonIE_Sodium_Core_Util{}
		mut iife_result_117 := iife_temp_117.substr(var_nonce_mutated.clone(), rt.new_int(16),
			rt.new_int(8))
		mut iife_temp_118 := Class_ParagonIE_Sodium_Core_Salsa20{}
		mut iife_result_118 := iife_temp_118.salsa20_xor_ic(iife_result_116, iife_result_117,
			rt.new_int(1), rt.new_string(var_subkey.str()))
		var_m = rt.concat(var_m, iife_result_118)
	}
	return var_m.clone()
}
...
fn Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305(var_plaintext rt.PhpVal, var_nonce rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	mut var_nonce_mutated := var_nonce
	mut iife_temp_119 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_119 := iife_temp_119.substr(var_nonce_mutated.clone(), rt.new_int(0),
		rt.new_int(16))
	mut iife_temp_120 := Class_ParagonIE_Sodium_Core_HChaCha20{}
	mut iife_result_120 := iife_temp_120.hchacha20(iife_result_119, var_key.clone())
	mut var_subkey := iife_result_120
	mut iife_temp_121 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_121 := iife_temp_121.substr(var_nonce_mutated.clone(), rt.new_int(16),
		rt.new_int(8))
	mut var_nonceLast := iife_result_121
	mut var_block0 := rt.call_function('str_repeat', [rt.new_string(''),
		rt.new_int(32)])
	mut iife_temp_122 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_122 := iife_temp_122.strlen(var_plaintext.clone())
	mut var_mlen := iife_result_122
	mut var_mlen0 := var_mlen.clone()
	if rt.is_true(rt.greater(var_mlen0,
		64 - Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_zerobytes()))
	{
		var_mlen0 =
			rt.new_int(64 - Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_zerobytes())
	}
	mut iife_temp_123 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_123 := iife_temp_123.substr(var_plaintext.clone(), rt.new_int(0),
		var_mlen0.clone())
	var_block0 = rt.concat(var_block0, iife_result_123)
	mut iife_temp_124 := Class_ParagonIE_Sodium_Core_ChaCha20{}
	mut iife_result_124 := iife_temp_124.streamxoric(var_block0.clone(), var_nonceLast.clone(),
		var_subkey.clone())
	var_block0 = iife_result_124
	mut iife_temp_125 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_125 := iife_temp_125.substr(var_block0.clone(),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_zerobytes()))
	mut var_c := iife_result_125
	if rt.is_true(rt.greater(var_mlen, var_mlen0)) {
		mut iife_temp_126 := Class_ParagonIE_Sodium_Core_Util{}
		mut iife_result_126 := iife_temp_126.substr(var_plaintext.clone(),
			rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_zerobytes()))
		mut iife_temp_127 := Class_ParagonIE_Sodium_Core_Util{}
		mut iife_result_127 := iife_temp_127.store64_le(rt.new_int(1))
		mut iife_temp_128 := Class_ParagonIE_Sodium_Core_ChaCha20{}
		mut iife_result_128 := iife_temp_128.streamxoric(iife_result_126, var_nonceLast.clone(),
			var_subkey.clone(), iife_result_127)
		var_c = rt.concat(var_c, iife_result_128)
	}
	mut iife_temp_129 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_129 := iife_temp_129.substr(var_block0.clone(), rt.new_int(0),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.onetimeauth_poly1305_keybytes()))
	mut var_state := create_paragonie_sodium_core_poly1305_state(iife_result_129)
	mut iife_temp_130 := Class_ParagonIE_Sodium_Compat{}
	mut iife_result_130 := iife_temp_130.memzero(var_block0.clone())
	if rt.has_exception() {
		unsafe {
			goto catch_label_9
		}
	...
	mut iife_result_131 := iife_temp_131.memzero(var_subkey.clone())
	if rt.has_exception() {
		unsafe {
			goto catch_label_9
		}
...
fn Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_open(var_ciphertext rt.PhpVal, var_nonce rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	mut var_ciphertext_mutated := var_ciphertext
	mut var_nonce_mutated := var_nonce
	mut iife_temp_132 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_132 := iife_temp_132.substr(var_ciphertext_mutated.clone(), rt.new_int(0),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_macbytes()))
	mut var_mac := iife_result_132
	mut iife_temp_133 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_133 := iife_temp_133.substr(var_ciphertext_mutated.clone(),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_macbytes()))
	mut var_c := iife_result_133
	mut iife_temp_134 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_134 := iife_temp_134.strlen(var_c.clone())
	mut var_clen := iife_result_134
	mut iife_temp_135 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_135 := iife_temp_135.substr(var_nonce_mutated.clone(), rt.new_int(0),
		rt.new_int(16))
	mut iife_temp_136 := Class_ParagonIE_Sodium_Core_HChaCha20{}
	mut iife_result_136 := iife_temp_136.hchacha20(iife_result_135, var_key.clone())
	mut var_subkey := iife_result_136
	mut iife_temp_137 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_137 := iife_temp_137.substr(var_nonce_mutated.clone(), rt.new_int(16),
		rt.new_int(8))
	mut iife_temp_138 := Class_ParagonIE_Sodium_Core_ChaCha20{}
	mut iife_result_138 := iife_temp_138.stream(rt.new_int(64), iife_result_137, var_subkey.clone())
	mut var_block0 := iife_result_138
	mut iife_temp_139 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_139 := iife_temp_139.substr(var_block0.clone(), rt.new_int(0), rt.new_int(32))
	mut iife_temp_140 := Class_ParagonIE_Sodium_Core_Poly1305{}
	mut iife_result_140 := iife_temp_140.onetimeauth_verify(var_mac.clone(), var_c.clone(),
		iife_result_139)
	mut var_verified := iife_result_140
	if rt.is_true(rt.new_bool(!(rt.is_true(var_verified)))) {
		mut iife_temp_141 := Class_ParagonIE_Sodium_Compat{}
		mut iife_result_141 := iife_temp_141.memzero(var_subkey.clone())
		if rt.has_exception() {
			unsafe {
				goto catch_label_10
			}
	...
	mut iife_temp_142 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_142 := iife_temp_142.substr(var_block0.clone(),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_zerobytes()))
	mut iife_temp_143 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_143 := iife_temp_143.substr(var_c.clone(), rt.new_int(0),
		rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_zerobytes()))
	mut iife_temp_144 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_144 := iife_temp_144.xorstrings(iife_result_142, iife_result_143)
	mut var_m := iife_result_144
	if rt.is_true(rt.greater(var_clen,
		Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_zerobytes()))
	{
		mut iife_temp_145 := Class_ParagonIE_Sodium_Core_Util{}
		mut iife_result_145 := iife_temp_145.substr(var_c.clone(),
			rt.new_int(Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_zerobytes()))
		mut iife_temp_146 := Class_ParagonIE_Sodium_Core_Util{}
		mut iife_result_146 := iife_temp_146.substr(var_nonce_mutated.clone(), rt.new_int(16),
			rt.new_int(8))
		mut iife_temp_147 := Class_ParagonIE_Sodium_Core_Util{}
		mut iife_result_147 := iife_temp_147.store64_le(rt.new_int(1))
		mut iife_temp_148 := Class_ParagonIE_Sodium_Core_ChaCha20{}
		mut iife_result_148 := iife_temp_148.streamxoric(iife_result_145, iife_result_146,
			rt.new_string(var_subkey.str()), iife_result_147)
		var_m = rt.concat(var_m, iife_result_148)
	}
	return var_m.clone()
}
...
fn Class_ParagonIE_Sodium_Crypto.secretstream_xchacha20poly1305_init_push(var_key rt.PhpVal) rt.PhpVal {
	...
	mut iife_temp_149 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_149 := iife_temp_149.substr(var_out.clone(), rt.new_int(0), rt.new_int(16))
	mut iife_temp_150 := Class_ParagonIE_Sodium_Core_HChaCha20{}
	mut iife_result_150 := iife_temp_150.hchacha20(iife_result_149, var_key.clone())
	mut var_subkey := iife_result_150
	mut iife_temp_151 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_151 := iife_temp_151.substr(var_out.clone(), rt.new_int(16), rt.new_int(8))
	mut var_state := create_paragonie_sodium_core_secretstream_state(var_subkey.clone(),
		iife_result_151.str() +
...
fn Class_ParagonIE_Sodium_Crypto.secretstream_xchacha20poly1305_init_pull(var_key rt.PhpVal, var_header rt.PhpVal) rt.PhpVal {
	mut iife_temp_152 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_152 := iife_temp_152.substr(var_header.clone(), rt.new_int(0), rt.new_int(16))
	mut iife_temp_153 := Class_ParagonIE_Sodium_Core_HChaCha20{}
	mut iife_result_153 := iife_temp_153.hchacha20(iife_result_152, var_key.clone())
	mut var_subkey := iife_result_153
	mut iife_temp_154 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_154 := iife_temp_154.substr(var_header.clone(), rt.new_int(16))
	mut var_state := create_paragonie_sodium_core_secretstream_state(var_subkey.clone(),
		iife_result_154)
	rt.call_method(var_state, 'counterReset', []rt.PhpVal{})
...
fn Class_ParagonIE_Sodium_Crypto.secretstream_xchacha20poly1305_push(var_state rt.PhpVal, var_msg rt.PhpVal, aad string, tag i64) rt.PhpVal {
	...
	mut tag_mutated := tag
	mut iife_temp_155 := Class_ParagonIE_Sodium_Core_SecretStream_State{}
	mut iife_result_155 := iife_temp_155.fromstring(var_state_mutated.clone())
	mut var_st := iife_result_155
	mut iife_temp_156 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_156 := iife_temp_156.strlen(var_msg.clone())
	mut var_msglen := iife_result_156
	mut iife_temp_157 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_157 := iife_temp_157.strlen(rt.new_string(aad))
	mut var_aadlen := iife_result_157
	...
	mut iife_temp_158 := Class_ParagonIE_Sodium_Core_ChaCha20{}
	mut iife_result_158 := iife_temp_158.ietfstream(rt.new_int(32), rt.call_method(var_st,
		'getCombinedNonce', []rt.PhpVal{}), rt.call_method(var_st, 'getKey', []rt.PhpVal{}))
	mut var_auth := create_paragonie_sodium_core_poly1305_state(iife_result_158)
	...
	mut iife_temp_159 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_159 := iife_temp_159.inttochr(rt.new_int(tag_mutated))
	mut iife_temp_160 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_160 := iife_temp_160.store64_le(rt.new_int(1))
	mut iife_temp_161 := Class_ParagonIE_Sodium_Core_ChaCha20{}
	mut iife_result_161 := iife_temp_161.ietfstreamxoric(rt.new_string(iife_result_159.str() +
		(rt.call_function('str_repeat', [rt.new_string(''), rt.new_int(63)])).str()), rt.call_method(var_st,
		'getCombinedNonce', []rt.PhpVal{}), rt.call_method(var_st, 'getKey', []rt.PhpVal{}),
		iife_result_160)
	mut var_block := iife_result_161
	var_auth.update(var_block.clone())
	mut var_out := var_block.array_get(rt.new_int(0))
	mut iife_temp_162 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_162 := iife_temp_162.store64_le(rt.new_int(2))
	mut iife_temp_163 := Class_ParagonIE_Sodium_Core_ChaCha20{}
	mut iife_result_163 := iife_temp_163.ietfstreamxoric(var_msg.clone(), rt.call_method(var_st,
		'getCombinedNonce', []rt.PhpVal{}), rt.call_method(var_st, 'getKey', []rt.PhpVal{}),
		iife_result_162)
	mut var_cipher := iife_result_163
	...
	mut iife_temp_164 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_164 := iife_temp_164.store64_le(var_aadlen.clone())
	mut var_slen := iife_result_164
	var_auth.update(var_slen.clone())
	mut iife_temp_165 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_165 := iife_temp_165.store64_le(rt.add(rt.new_int(64), var_msglen))
	var_slen = iife_result_165
	var_auth.update(var_slen.clone())
	...
	if rt.is_true(var_rekey) || rt.is_true(rt.call_method(var_st, 'needsRekey', []rt.PhpVal{})) {
		Class_ParagonIE_Sodium_Crypto.secretstream_xchacha20poly1305_rekey(var_state_mutated.clone())
	}
...
fn Class_ParagonIE_Sodium_Crypto.secretstream_xchacha20poly1305_pull(var_state rt.PhpVal, var_cipher rt.PhpVal, aad string) rt.PhpVal {
	...
	mut iife_temp_166 := Class_ParagonIE_Sodium_Core_SecretStream_State{}
	mut iife_result_166 := iife_temp_166.fromstring(var_state_mutated.clone())
	mut var_st := iife_result_166
	mut iife_temp_167 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_167 := iife_temp_167.strlen(var_cipher_mutated.clone())
	mut var_cipherlen := iife_result_167
	mut var_msglen := rt.sub(var_cipherlen,
		Class_ParagonIE_Sodium_Compat.crypto_secretstream_xchacha20poly1305_abytes())
	mut iife_temp_168 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_168 := iife_temp_168.strlen(rt.new_string(aad))
	mut var_aadlen := iife_result_168
	if rt.shift_right(rt.add(var_msglen, rt.new_int(63)), rt.new_int(6)) > 4294967294 {
		rt.throw_exception(rt.new_object('SodiumException', []string{},
			create_sodiumexception(rt.new_string('message cannot be larger than SODIUM_CRYPTO_SECRETSTREAM_XCHACHA20POLY1305_MESSAGEBYTES_MAX bytes'))))
	}
	mut iife_temp_169 := Class_ParagonIE_Sodium_Core_ChaCha20{}
	mut iife_result_169 := iife_temp_169.ietfstream(rt.new_int(32), rt.call_method(var_st,
		'getCombinedNonce', []rt.PhpVal{}), rt.call_method(var_st, 'getKey', []rt.PhpVal{}))
	mut var_auth := create_paragonie_sodium_core_poly1305_state(iife_result_169)
	var_auth.update(rt.new_string(aad))
	var_auth.update(rt.call_function('str_repeat', [rt.new_string(''),
		rt.bitwise_and(rt.sub(rt.new_int(16), var_aadlen), rt.new_int(15))]))
	mut iife_temp_170 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_170 := iife_temp_170.store64_le(rt.new_int(1))
	mut iife_temp_171 := Class_ParagonIE_Sodium_Core_ChaCha20{}
	mut iife_result_171 := iife_temp_171.ietfstreamxoric(rt.new_string(
		(var_cipher_mutated.array_get(rt.new_int(0))).str() +
		(rt.call_function('str_repeat', [rt.new_string(''), rt.new_int(63)])).str()), rt.call_method(var_st,
		'getCombinedNonce', []rt.PhpVal{}), rt.call_method(var_st, 'getKey', []rt.PhpVal{}),
		iife_result_170)
	mut var_block := iife_result_171
	mut iife_temp_172 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_172 := iife_temp_172.chrtoint(var_block.array_get(rt.new_int(0)))
	mut var_tag := iife_result_172
	var_block.array_set(0, var_cipher_mutated.array_get(rt.new_int(0)))
	var_auth.update(var_block.clone())
	mut iife_temp_173 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_173 := iife_temp_173.substr(var_cipher_mutated.clone(), rt.new_int(1),
		var_msglen.clone())
	var_auth.update(iife_result_173)
	var_auth.update(rt.call_function('str_repeat', [rt.new_string(''),
		rt.bitwise_and(rt.add(16 - 64, var_msglen), rt.new_int(15))]))
	mut iife_temp_174 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_174 := iife_temp_174.store64_le(var_aadlen.clone())
	mut var_slen := iife_result_174
	var_auth.update(var_slen.clone())
	mut iife_temp_175 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_175 := iife_temp_175.store64_le(rt.add(rt.new_int(64), var_msglen))
	var_slen = iife_result_175
	var_auth.update(var_slen.clone())
	mut var_mac := var_auth.finish()
	mut iife_temp_176 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_176 := iife_temp_176.substr(var_cipher_mutated.clone(), rt.add(var_msglen,
		rt.new_int(1)), rt.new_int(16))
	mut var_stored := iife_result_176
	mut iife_temp_177 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_177 := iife_temp_177.hashequals(var_mac.clone(), var_stored.clone())
	if rt.is_true(rt.new_bool(!(rt.is_true(iife_result_177)))) {
		return rt.new_bool(false)
	}
	mut iife_temp_178 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_178 := iife_temp_178.substr(var_cipher_mutated.clone(), rt.new_int(1),
		var_msglen.clone())
	mut iife_temp_179 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_179 := iife_temp_179.store64_le(rt.new_int(2))
	mut iife_temp_180 := Class_ParagonIE_Sodium_Core_ChaCha20{}
	mut iife_result_180 := iife_temp_180.ietfstreamxoric(iife_result_178, rt.call_method(var_st,
		'getCombinedNonce', []rt.PhpVal{}), rt.call_method(var_st, 'getKey', []rt.PhpVal{}),
		iife_result_179)
	mut var_out := iife_result_180
	rt.call_method(var_st, 'xorNonce', [var_mac.clone()])
	rt.call_method(var_st, 'incrementCounter', []rt.PhpVal{})
	var_state_mutated = rt.call_method(var_st, 'toString', []rt.PhpVal{})
...
fn Class_ParagonIE_Sodium_Crypto.secretstream_xchacha20poly1305_rekey(var_state rt.PhpVal) {
	mut var_state_mutated := var_state
	mut iife_temp_181 := Class_ParagonIE_Sodium_Core_SecretStream_State{}
	mut iife_result_181 := iife_temp_181.fromstring(var_state_mutated.clone())
	mut var_st := iife_result_181
	mut var_new_key_and_inonce := rt.call_method(var_st, 'getKey', []rt.PhpVal{})
	mut iife_temp_182 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_182 := iife_temp_182.substr(rt.call_method(var_st, 'getNonce', []rt.PhpVal{}),
		rt.new_int(0), rt.new_int(8))
	var_new_key_and_inonce = rt.concat(var_new_key_and_inonce, iife_result_182)
	mut iife_temp_183 := Class_ParagonIE_Sodium_Core_Util{}
	mut iife_result_183 := iife_temp_183.store64_le(rt.new_int(0))
	mut iife_temp_184 := Class_ParagonIE_Sodium_Core_ChaCha20{}
	mut iife_result_184 := iife_temp_184.ietfstreamxoric(var_new_key_and_inonce.clone(), rt.call_method(var_st,
		'getCombinedNonce', []rt.PhpVal{}), rt.call_method(var_st, 'getKey', []rt.PhpVal{}),
		iife_result_183)
	rt.call_method(var_st, 'rekey', [iife_result_184])
...
fn Class_ParagonIE_Sodium_Crypto.sign_detached(var_message rt.PhpVal, var_sk rt.PhpVal) rt.PhpVal {
	mut iife_temp_185 := Class_ParagonIE_Sodium_Core_Ed25519{}
	mut iife_result_185 := iife_temp_185.sign_detached(var_message.clone(), var_sk.clone())
	return iife_result_185
}

fn Class_ParagonIE_Sodium_Crypto.sign(var_message rt.PhpVal, var_sk rt.PhpVal) rt.PhpVal {
	mut iife_temp_186 := Class_ParagonIE_Sodium_Core_Ed25519{}
	mut iife_result_186 := iife_temp_186.sign(var_message.clone(), var_sk.clone())
	return iife_result_186
}

fn Class_ParagonIE_Sodium_Crypto.sign_open(var_signedMessage rt.PhpVal, var_pk rt.PhpVal) rt.PhpVal {
	mut iife_temp_187 := Class_ParagonIE_Sodium_Core_Ed25519{}
	mut iife_result_187 := iife_temp_187.sign_open(var_signedMessage.clone(), var_pk.clone())
	return iife_result_187
}
...
fn Class_ParagonIE_Sodium_Crypto.sign_verify_detached(var_signature rt.PhpVal, var_message rt.PhpVal, var_pk rt.PhpVal) rt.PhpVal {
	mut iife_temp_188 := Class_ParagonIE_Sodium_Core_Ed25519{}
	mut iife_result_188 := iife_temp_188.verify_detached(var_signature.clone(),
		var_message.clone(), var_pk.clone())
	return iife_result_188
}
...
fn create_paragonie_sodium_core_blake2b(_args ...rt.PhpVal) &Class_ParagonIE_Sodium_Core_BLAKE2b {
...
fn create_paragonie_sodium_core_poly1305(_args ...rt.PhpVal) &Class_ParagonIE_Sodium_Core_Poly1305 {
...
fn create_paragonie_sodium_core_secretstream_state(_args ...rt.PhpVal) &Class_ParagonIE_Sodium_Core_SecretStream_State {
...
fn (mut this Class_ParagonIE_Sodium_Crypto) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'aead_chacha20poly1305_decrypt' {
			...
			return Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_decrypt(dispatch_arg_0,
		...
		'aead_chacha20poly1305_encrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return rt.new_string(Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_encrypt(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2, dispatch_arg_3))
		}
		'aead_chacha20poly1305_ietf_decrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_ietf_decrypt(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'aead_chacha20poly1305_ietf_encrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return rt.new_string(Class_ParagonIE_Sodium_Crypto.aead_chacha20poly1305_ietf_encrypt(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2, dispatch_arg_3))
		}
		'aead_xchacha20poly1305_ietf_decrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto.aead_xchacha20poly1305_ietf_decrypt(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'aead_xchacha20poly1305_ietf_encrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto.aead_xchacha20poly1305_ietf_encrypt(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'auth' {
		...
		'auth_verify' {
			...
			return Class_ParagonIE_Sodium_Crypto.auth_verify(dispatch_arg_0, dispatch_arg_1,
				dispatch_arg_2)
		}
		'box' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
		...
		'box_seal' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			return rt.new_string(Class_ParagonIE_Sodium_Crypto.box_seal(dispatch_arg_0,
				dispatch_arg_1))
		}
		'box_seal_open' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
		...
		'box_keypair_from_secretkey_and_publickey' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			return rt.new_string(Class_ParagonIE_Sodium_Crypto.box_keypair_from_secretkey_and_publickey(dispatch_arg_0,
				dispatch_arg_1))
		}
		'box_secretkey' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
		...
		'box_open' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto.box_open(dispatch_arg_0, dispatch_arg_1,
				dispatch_arg_2)
		}
		'generichash' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			...
			return Class_ParagonIE_Sodium_Crypto.generichash(dispatch_arg_0, dispatch_arg_1,
				dispatch_arg_2)
		}
		'generichash_final' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
		...
		'generichash_init_salt_personal' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto.generichash_init_salt_personal(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'generichash_update' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
		...
		'keyExchange' {
			...
			return Class_ParagonIE_Sodium_Crypto.keyexchange(dispatch_arg_0, dispatch_arg_1,
		...
		'secretbox' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto.secretbox(dispatch_arg_0, dispatch_arg_1,
				dispatch_arg_2)
		}
		'secretbox_open' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto.secretbox_open(dispatch_arg_0, dispatch_arg_1,
				dispatch_arg_2)
		}
		'secretbox_xchacha20poly1305' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305(dispatch_arg_0,
		...
		'secretbox_xchacha20poly1305_open' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto.secretbox_xchacha20poly1305_open(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2)
		}
		...
		'secretstream_xchacha20poly1305_init_pull' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto.secretstream_xchacha20poly1305_init_pull(dispatch_arg_0,
				dispatch_arg_1)
		}
		'secretstream_xchacha20poly1305_push' {
			...
			return Class_ParagonIE_Sodium_Crypto.secretstream_xchacha20poly1305_push(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'secretstream_xchacha20poly1305_pull' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto.secretstream_xchacha20poly1305_pull(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2)
		}
		...
		'sign_verify_detached' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto.sign_verify_detached(dispatch_arg_0,
				dispatch_arg_1, dispatch_arg_2)
		}
		else {
			return none
...
fn main() {
	...
	if rt.is_true(rt.call_function('class_exists', [
		rt.new_string('ParagonIE_Sodium_Crypto'),
		rt.new_bool(false),
	]))
	{
		return rt.new_null()
