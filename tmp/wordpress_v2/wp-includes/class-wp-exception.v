...
fn (mut this Class_WP_Exception) construct(var_message rt.PhpVal) {
	this.message = var_message.to_string()
}

fn (mut this Class_WP_Exception) getmessage() string {
	return this.message
}
...
fn create_wp_exception(arg_0 rt.PhpVal) &Class_WP_Exception {
