...
const global_const_simplepie_build = rt.call_function('gmdate', [
	rt.new_string('YmdHis'), iife_result_0])
const global_const_simplepie_url = Class_SimplePie_SimplePie.url()
const global_const_simplepie_useragent = iife_result_1
...
fn create_simplepie(_args ...rt.PhpVal) &Class_SimplePie {
	...
	mut iife_result_0 := iife_temp_0.get_build()
