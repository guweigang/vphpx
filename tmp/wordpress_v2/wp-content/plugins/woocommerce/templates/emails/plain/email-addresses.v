...
fn main() {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_ship_to_billing_address_only', []rt.PhpVal{})))))
		...
		mut var_shipping := rt.call_method(var_order, 'get_formatted_shipping_address',
			[]rt.PhpVal{})
