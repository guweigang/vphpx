...
fn main() {
	...
	rt.new_bool(rt.is_true(rt.call_function('defined', [rt.new_string('ABSPATH')]))
		|| rt.is_true(exit(0)))
	print(
		(rt.call_function('esc_html', [rt.call_function('wc_strtoupper', [rt.call_function('esc_html__', [rt.new_string('Downloads'), rt.new_string('woocommerce')])])])).str() +
		'\n\n')
	...
	for {
		...
		for {
			...
			print((rt.call_function('wp_kses_post', [var_column_name.clone()])).str() + ': ')
