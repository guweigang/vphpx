...
fn main() {
	...
	rt.call_function('printf', [
		rt.call_function('esc_html__', [rt.new_string('Howdy %s,'),
			rt.new_string('woocommerce')]),
		rt.call_function('esc_html', [var_username.clone()]),
	])
	// unsupported statement: Stmt_InlineHTML
	...
	rt.call_function('printf', [
		rt.call_function('esc_html__', [
			rt.new_string('The payment gateway "%1$s" was just enabled on this site: %2$s'),
			rt.new_string('woocommerce'),
		]),
	...
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('printf', [
		rt.call_function('esc_html__', [rt.new_string('This email has been sent to %s'),
			rt.new_string('woocommerce')]),
		rt.call_function('esc_html', [var_admin_email.clone()]),
	])
	// unsupported statement: Stmt_InlineHTML
