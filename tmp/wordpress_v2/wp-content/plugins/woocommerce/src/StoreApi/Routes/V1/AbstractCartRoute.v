...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) construct(mut var_schema_controller Class_Automattic_WooCommerce_StoreApi_SchemaController, mut var_schema Class_Automattic_WooCommerce_StoreApi_Schemas_V1_AbstractSchema) {
	this.Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractRoute.construct(rt.new_object('Automattic_WooCommerce_StoreApi_SchemaController',
		...
		[]string{}, var_schema))
	this.cart_schema = rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute', [
		'Automattic_WooCommerce_StoreApi_Routes_V1_AbstractRoute',
	], &this), 'schema_controller'), 'get', [
		Class_Automattic_WooCommerce_StoreApi_Schemas_V1_CartSchema.identifier(),
	])
	this.cart_item_schema = rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute', [
		'Automattic_WooCommerce_StoreApi_Routes_V1_AbstractRoute',
	], &this), 'schema_controller'), 'get', [
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) is_update_request(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) rt.PhpVal {
	return rt.call_function('in_array', [var_request.get_method(),
		rt.create_array([rt.ArrayItem{ key: none, val: 'POST' },
			rt.ArrayItem{ key: none, val: 'PUT' }, rt.ArrayItem{ key: none, val: 'PATCH' },
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) get_response(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) rt.PhpVal {
	...
	mut var_nonce_check := if this.requires_nonce(mut var_request) {
		this.check_nonce(mut var_request)
	} else {
		rt.new_null()
	}
	...
	return this.add_response_headers(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Response](rt.call_function('rest_ensure_response', [
		var_response.clone(),
	])))
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) add_response_headers(mut var_response Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Response) rt.PhpVal {
	...
	rt.call_method(var_response_mutated, 'header', [rt.new_string('Nonce'),
		var_nonce.clone()])
	rt.call_method(var_response_mutated, 'header', [rt.new_string('Nonce-Timestamp'),
		rt.call_function('time', []rt.PhpVal{})])
	rt.call_method(var_response_mutated, 'header', [rt.new_string('User-ID'),
		rt.call_function('get_current_user_id', []rt.PhpVal{})])
	rt.call_method(var_response_mutated, 'header', [rt.new_string('Cart-Token'),
		this.get_cart_token()])
	rt.call_method(var_response_mutated, 'header', [rt.new_string('Cart-Hash'),
		rt.call_method(rt.get_property(rt.call_function('WC', []rt.PhpVal{}), 'cart'),
			'get_cart_hash', []rt.PhpVal{})])
	rt.call_method(var_response_mutated, 'header', [rt.new_string('Cache-Control'),
		rt.new_string('no-store')])
	return rt.new_object('Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Response', []string{},
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) get_cart_token() rt.PhpVal {
	...
	mut iife_result_2 := iife_temp_2.get_cart_token(rt.new_string((rt.call_method(rt.get_property(rt.call_function('wc',
		[]rt.PhpVal{}), 'session'), 'get_customer_id', []rt.PhpVal{})).str()))
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) has_cart_token(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) rt.PhpVal {
	if rt.is_true(rt.new_bool(this.has_cart_token.is_null())) {
		mut iife_temp_3 := Class_Automattic_WooCommerce_StoreApi_Utilities_CartTokenUtils{}
		mut iife_result_3 := iife_temp_3.validate_cart_token(if !(var_request.get_header(rt.new_string('Cart-Token'))).is_null() {
			var_request.get_header(rt.new_string('Cart-Token'))
		} else {
			rt.new_string('')
		})
		this.has_cart_token = iife_result_3
	}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) requires_nonce(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) bool {
	return rt.is_true(this.is_update_request(mut var_request))
		&& rt.is_true(rt.new_bool(!(rt.is_true(this.has_cart_token(mut var_request)))))
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) cart_updated(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) {
	...
	if rt.is_true(var_draft_order) {
		rt.call_method(this.order_controller, 'update_order_from_cart', [
			var_draft_order.clone(), rt.new_bool(false)])
		rt.call_function('wc_do_deprecated_action', [
			rt.new_string('woocommerce_blocks_cart_update_order_from_request'),
			rt.create_array([rt.ArrayItem{ key: none, val: var_draft_order },
				rt.ArrayItem{ key: none, val: var_request }]),
			rt.new_string('7.2.0'),
			rt.new_string('woocommerce_store_api_cart_update_order_from_request'),
			rt.new_string('This action was deprecated in WooCommerce Blocks version 7.2.0. Please use woocommerce_store_api_cart_update_order_from_request instead.'),
		])
		rt.call_function('do_action', [
			rt.new_string('woocommerce_store_api_cart_update_order_from_request'),
			var_draft_order.clone(),
			var_request,
		])
	}
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) check_nonce(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) bool {
	...
	if rt.is_true(rt.identical(rt.new_null(), var_nonce)) {
		return (this.get_route_error_response(rt.new_string('woocommerce_rest_missing_nonce'), rt.call_function('__', [
			rt.new_string('Missing the Nonce header. This endpoint requires a valid nonce.'),
			rt.new_string('woocommerce'),
		]), 401, rt.new_null())).to_bool()
	}
	...
	{
		return (this.get_route_error_response(rt.new_string('woocommerce_rest_invalid_nonce'), rt.call_function('__', [
			rt.new_string('Nonce is invalid.'),
			rt.new_string('woocommerce'),
		]), 403, rt.new_null())).to_bool()
	}
	return true
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) get_route_error_response(var_error_code rt.PhpVal, var_error_message rt.PhpVal, http_status_code i64, var_additional_data rt.PhpVal) rt.PhpVal {
	...
	if 409 == http_status_code {
		var_additional_data_mutated.array_set('cart', rt.call_method(this.cart_schema,
			'get_item_response', [
			rt.call_method(this.cart_controller, 'get_cart_for_response', []rt.PhpVal{}),
		]))
	}
	return rt.new_object('Automattic_WooCommerce_StoreApi_Routes_V1_WP_Error', []string{}, create_automattic_woocommerce_storeapi_routes_v1_wp_error(var_error_code.clone(),
		var_error_message.clone(), var_additional_data_mutated.clone()))
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'add_response_headers' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Response](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
