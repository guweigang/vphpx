	...
	return rt.create_array([
		...
		rt.ArrayItem{ key: none, val: rt.create_array([
			...
			rt.ArrayItem{ key: 'callback', val: rt.create_array([
				rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById', [
		...
		rt.ArrayItem{ key: 'schema', val: rt.create_array([
			rt.ArrayItem{ key: none, val: rt.get_property(rt.new_object('Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById', [
				'Automattic_WooCommerce_StoreApi_Routes_V1_AbstractRoute',
			], &this), 'schema') },
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById) get_route_response(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(var_object))))
		|| rt.is_true(rt.identical(rt.new_int(0), rt.get_property(var_object, 'id'))) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_StoreApi_Exceptions_RouteException',
			[]string{}, create_automattic_woocommerce_storeapi_exceptions_routeexception(rt.new_string('woocommerce_rest_attribute_invalid_id'), rt.call_function('__', [
			rt.new_string('Invalid attribute ID.'),
			rt.new_string('woocommerce'),
		]), rt.new_int(404))))
	}
...
fn create_automattic_woocommerce_storeapi_routes_v1_productattributesbyid(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById {
