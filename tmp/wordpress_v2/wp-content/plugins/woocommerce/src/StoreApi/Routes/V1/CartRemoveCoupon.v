...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_CartRemoveCoupon) get_route_post_response(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) rt.PhpVal {
	...
	mut var_coupon :=
		create_automattic_woocommerce_storeapi_routes_v1_wc_coupon(var_coupon_code.clone())
	mut var_discounts :=
		create_automattic_woocommerce_storeapi_routes_v1_wc_discounts(var_cart.clone())
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_is_same_coupon', [var_coupon.get_code(), var_coupon_code.clone()])))))
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_StoreApi_Routes_V1_CartRemoveCoupon', [
		'Automattic_WooCommerce_StoreApi_Routes_V1_AbstractCartRoute',
	], &this), 'cart_controller'), 'has_coupon', [var_coupon_code.clone()])))))
	{
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_StoreApi_Exceptions_RouteException',
	...
	rt.call_method(var_cart, 'remove_coupon', [var_coupon_code.clone()])
...
fn create_automattic_woocommerce_storeapi_routes_v1_cartremovecoupon(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_StoreApi_Routes_V1_CartRemoveCoupon {
...
fn create_automattic_woocommerce_storeapi_routes_v1_wc_coupon(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_StoreApi_Routes_V1_WC_Coupon {
...
fn create_automattic_woocommerce_storeapi_routes_v1_wc_discounts(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_StoreApi_Routes_V1_WC_Discounts {
