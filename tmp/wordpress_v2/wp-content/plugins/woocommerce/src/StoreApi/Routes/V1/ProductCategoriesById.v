...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductCategoriesById) get_route_response(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(var_object))))
		...
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_StoreApi_Exceptions_RouteException',
			[]string{}, create_automattic_woocommerce_storeapi_exceptions_routeexception(rt.new_string('woocommerce_rest_category_invalid_id'), rt.call_function('__', [
			rt.new_string('Invalid category ID.'),
			rt.new_string('woocommerce'),
		]), rt.new_int(404))))
	}
...
fn create_automattic_woocommerce_storeapi_routes_v1_productcategoriesbyid(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductCategoriesById {
