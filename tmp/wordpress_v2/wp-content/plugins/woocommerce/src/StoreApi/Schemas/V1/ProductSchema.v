...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) construct(mut var_extend Class_Automattic_WooCommerce_StoreApi_Schemas_ExtendSchema, mut var_controller Class_Automattic_WooCommerce_StoreApi_SchemaController) {
	...
	this.image_attachment_schema = rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema', [
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_properties() rt.PhpVal {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'parent', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('ID of the parent product, if applicable.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'integer' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'variation', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product variation attributes, if applicable.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'on_sale', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Is the product on sale?'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'prices', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Price data provided using the smallest unit of the currency.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'price_html', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Price string formatted as HTML.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'average_rating', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
		...
		rt.ArrayItem{ key: 'review_count', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Amount of reviews that the product has.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'integer' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'categories', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('List of categories, if applicable.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'array' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'tags', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('List of tags, if applicable.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'array' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'brands', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('List of brands, if applicable.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'array' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'attributes', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('List of attributes (taxonomy terms) assigned to the product. For variable products, these are mapped to variations (see the `variations` field).'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'array' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'items', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'properties', val: rt.create_array([
					rt.ArrayItem{ key: 'id', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('The attribute ID, or 0 if the attribute is not taxonomy based.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'integer' },
						rt.ArrayItem{ key: 'context', val: rt.create_array([
					...
					rt.ArrayItem{ key: 'name', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('The attribute name.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'string' },
						rt.ArrayItem{ key: 'context', val: rt.create_array([
					...
					rt.ArrayItem{ key: 'taxonomy', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('The attribute taxonomy, or null if the attribute is not taxonomy based.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'string' },
						rt.ArrayItem{ key: 'context', val: rt.create_array([
					...
					rt.ArrayItem{ key: 'has_variations', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('True if this attribute is used by product variations.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'boolean' },
						rt.ArrayItem{ key: 'context', val: rt.create_array([
					...
					rt.ArrayItem{ key: 'terms', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('List of assigned attribute terms.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'array' },
						rt.ArrayItem{ key: 'context', val: rt.create_array([
						...
						rt.ArrayItem{ key: 'items', val: rt.create_array([
							...
							rt.ArrayItem{ key: 'properties', val: rt.create_array([
								rt.ArrayItem{ key: 'id', val: rt.create_array([
									rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
										rt.new_string('The term ID, or 0 if the attribute is not a global attribute.'),
										rt.new_string('woocommerce'),
									]) },
									rt.ArrayItem{ key: 'type', val: 'integer' },
									rt.ArrayItem{ key: 'context', val: rt.create_array([
								...
								rt.ArrayItem{ key: 'default', val: rt.create_array([
									rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
										rt.new_string('If this is a default attribute'),
										rt.new_string('woocommerce'),
									]) },
									rt.ArrayItem{ key: 'type', val: 'boolean' },
									rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'variations', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('List of variation IDs, if applicable.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'array' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'items', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'properties', val: rt.create_array([
					...
					rt.ArrayItem{ key: 'attributes', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('List of variation attributes.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'array' },
						rt.ArrayItem{ key: 'context', val: rt.create_array([
						...
						rt.ArrayItem{ key: 'items', val: rt.create_array([
							...
							rt.ArrayItem{ key: 'properties', val: rt.create_array([
								...
								rt.ArrayItem{ key: 'value', val: rt.create_array([
									rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
										rt.new_string('The assigned attribute.'),
										rt.new_string('woocommerce'),
									]) },
									rt.ArrayItem{ key: 'type', val: 'string' },
									rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'grouped_products', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('List of grouped product IDs, if applicable.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'array' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'items', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('List of grouped product ids.'),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'type', val: 'integer' },
				rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'has_options', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Does the product have additional options before it can be added to the cart?'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'is_purchasable', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Is the product purchasable?'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'is_in_stock', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Is the product in stock?'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'is_on_backorder', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Is the product stock backordered? This will also return false if backorder notifications are turned off.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'stock_availability', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string("Information about the product's availability."),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'object' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'properties', val: rt.create_array([
				rt.ArrayItem{ key: 'text', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('Stock availability text.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{ key: 'context', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'class', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('Stock availability class.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'weight', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('sprintf', [
				rt.call_function('__', [
					rt.new_string('Product weight (%s).'),
					rt.new_string('woocommerce'),
				]),
		...
		rt.ArrayItem{ key: 'formatted_weight', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product weight formatted for display (e.g. "2.5 kg").'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'formatted_dimensions', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product dimensions formatted for display (e.g. "10 × 5 × 3 cm").'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'add_to_cart', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Add to cart button parameters.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'object' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'properties', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'description', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('Button description.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{ key: 'context', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'minimum', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('The minimum quantity that can be added to the cart.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'number' },
					rt.ArrayItem{ key: 'context', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'maximum', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('The maximum quantity that can be added to the cart.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'number' },
					rt.ArrayItem{ key: 'context', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'single_text', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('Button text in the single product page.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'is_password_protected', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Whether the product requires a password to access its content.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{
			key: Class_Automattic_WooCommerce_StoreApi_Schemas_V1_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema.extending_key()
			val: this.get_extended_schema(Class_Automattic_WooCommerce_StoreApi_Schemas_V1_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema.identifier())
		},
	])
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_item_response(var_product rt.PhpVal) rt.PhpVal {
	...
	mut iife_result_0 := iife_temp_0.get_product_availability(var_product.clone())
	mut var_availability := iife_result_0
	mut var_password_required := rt.call_function('post_password_required', [
		rt.call_method(var_product, 'get_id', []rt.PhpVal{}),
	])
	mut var_short_description := if rt.is_true(var_password_required) { rt.new_string('') } else { this.prepare_html_response(rt.call_function('wc_format_content', [
			rt.call_function('wp_kses_post', [
				rt.call_method(var_product, 'get_short_description', []rt.PhpVal{}),
			]),
		])) }
	mut var_description := if rt.is_true(var_password_required) { rt.new_string('') } else { this.prepare_html_response(rt.call_function('wc_format_content', [
			rt.call_function('wp_kses_post', [
	...
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'name', val: this.prepare_html_response(rt.call_method(var_product,
			'get_title', []rt.PhpVal{})) },
		rt.ArrayItem{ key: 'slug', val: rt.call_method(var_product, 'get_slug', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'parent', val: rt.call_method(var_product, 'get_parent_id',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'type', val: rt.call_method(var_product, 'get_type', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'variation', val: this.prepare_html_response(if rt.is_true(rt.call_method(var_product, 'is_type', [
			Class_Automattic_WooCommerce_Enums_ProductType.variation(),
		]))
		{ rt.call_function('wc_get_formatted_variation', [
				var_product.clone(),
				rt.new_bool(true),
				rt.new_bool(true),
				rt.new_bool(false),
			]) } else { rt.new_string('') }) },
		rt.ArrayItem{ key: 'permalink', val: rt.call_method(var_product, 'get_permalink',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'sku', val: this.prepare_html_response(rt.call_method(var_product,
			'get_sku', []rt.PhpVal{})) },
		rt.ArrayItem{ key: 'short_description', val: var_short_description },
		rt.ArrayItem{ key: 'description', val: var_description },
		rt.ArrayItem{ key: 'on_sale', val: rt.call_method(var_product, 'is_on_sale', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'prices', val: rt.array_to_object(this.prepare_product_price_response(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product](var_product),
			'')) },
		rt.ArrayItem{ key: 'price_html', val: this.prepare_html_response(rt.call_method(var_product,
			'get_price_html', []rt.PhpVal{})) },
		rt.ArrayItem{ key: 'average_rating', val: (rt.call_method(var_product,
			'get_average_rating', []rt.PhpVal{})).str() },
		rt.ArrayItem{ key: 'review_count', val: rt.call_method(var_product, 'get_review_count',
			[]rt.PhpVal{}) },
		rt.ArrayItem{
			key: 'images'
			val: this.get_images(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product](var_product))
		},
		rt.ArrayItem{ key: 'categories', val: this.get_term_list(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product](var_product),
			'product_cat') },
		rt.ArrayItem{ key: 'tags', val: this.get_term_list(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product](var_product),
			'product_tag') },
		rt.ArrayItem{ key: 'brands', val: this.get_term_list(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product](var_product),
			'product_brand') },
		rt.ArrayItem{
			key: 'attributes'
			val: this.get_attributes(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product](var_product))
		},
		rt.ArrayItem{
			key: 'variations'
			val: this.get_variations(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product](var_product))
		},
		rt.ArrayItem{
			key: 'grouped_products'
			val: this.get_grouped_products(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product](var_product))
		},
		rt.ArrayItem{ key: 'has_options', val: rt.call_method(var_product, 'has_options',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'is_purchasable', val: rt.call_method(var_product, 'is_purchasable',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'is_in_stock', val: rt.call_method(var_product, 'is_in_stock',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'is_on_backorder', val: rt.identical(Class_Automattic_WooCommerce_Enums_ProductStockStatus.on_backorder(), rt.call_method(var_product,
			'get_stock_status', []rt.PhpVal{})) },
		rt.ArrayItem{
			key: 'low_stock_remaining'
			val: this.get_low_stock_remaining(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product](var_product))
		},
		rt.ArrayItem{ key: 'stock_availability', val: rt.array_to_object(rt.create_array([
			rt.ArrayItem{
				key: 'text'
				val: if !(var_availability.array_get(rt.new_string('availability'))).is_null() {
			...
			rt.ArrayItem{
				key: 'class'
				val: if !(var_availability.array_get(rt.new_string('class'))).is_null() {
		...
		rt.ArrayItem{ key: 'weight', val: rt.call_method(var_product, 'get_weight', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'dimensions', val: rt.array_to_object(rt.create_array([
			rt.ArrayItem{ key: 'length', val: rt.call_method(var_product, 'get_length',
				[]rt.PhpVal{}) },
			rt.ArrayItem{ key: 'width', val: rt.call_method(var_product, 'get_width', []rt.PhpVal{}) },
			rt.ArrayItem{ key: 'height', val: rt.call_method(var_product, 'get_height',
				[]rt.PhpVal{}) },
		])) },
		rt.ArrayItem{ key: 'formatted_weight', val: rt.call_function('wc_format_weight', [
			rt.new_float((rt.call_method(var_product, 'get_weight', []rt.PhpVal{})).to_f64()),
		]) },
		rt.ArrayItem{ key: 'formatted_dimensions', val: rt.call_function('html_entity_decode', [
			rt.call_function('wc_format_dimensions', [
				rt.cast_array(rt.call_method(var_product, 'get_dimensions', [
					rt.new_bool(false),
				])),
			]),
		...
		rt.ArrayItem{ key: 'add_to_cart', val: rt.array_to_object(rt.call_function('array_merge', [
			rt.create_array([
				rt.ArrayItem{ key: 'text', val: this.prepare_html_response(rt.call_method(var_product,
					'add_to_cart_text', []rt.PhpVal{})) },
				rt.ArrayItem{ key: 'description', val: this.prepare_html_response(rt.call_method(var_product,
					'add_to_cart_description', []rt.PhpVal{})) },
				rt.ArrayItem{ key: 'url', val: this.prepare_html_response(rt.call_method(var_product,
					'add_to_cart_url', []rt.PhpVal{})) },
				rt.ArrayItem{ key: 'single_text', val: this.prepare_html_response(rt.call_method(var_product,
					'single_add_to_cart_text', []rt.PhpVal{})) },
			]),
			rt.call_method(create_automattic_woocommerce_storeapi_utilities_quantitylimits(),
				'get_add_to_cart_limits', [
				var_product.clone(),
			]),
		])) },
		rt.ArrayItem{ key: 'is_password_protected', val: rt.new_bool(!rt.is_true(rt.identical(rt.new_string(''), rt.call_method(var_product,
			'get_post_password', []rt.PhpVal{})))) },
		rt.ArrayItem{
			key: Class_Automattic_WooCommerce_StoreApi_Schemas_V1_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema.extending_key()
			val: this.get_extended_data(Class_Automattic_WooCommerce_StoreApi_Schemas_V1_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema.identifier(),
				var_product.clone())
		},
	])
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_images(mut var_product Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product) rt.PhpVal {
	mut var_attachment_ids := rt.call_function('array_filter', [
		rt.call_function('array_merge', [
			rt.create_array([rt.ArrayItem{ key: none, val: var_product.get_image_id() }]),
			var_product.get_gallery_image_ids(),
		]),
	])
	...
	return rt.call_function('array_values', [
		rt.call_function('array_filter', [
			rt.call_function('array_map', [
				rt.create_array([
					rt.ArrayItem{ key: none, val: this.image_attachment_schema },
					rt.ArrayItem{ key: none, val: 'get_item_response' },
				]),
				var_attachment_ids.clone(),
			]),
		]),
	])
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_low_stock_remaining(mut var_product Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product) rt.PhpVal {
	...
	mut var_stock_format := rt.call_function('get_option', [
		rt.new_string('woocommerce_stock_format'),
	])
	if rt.is_true(rt.identical(rt.new_string('no_amount'), var_stock_format)) {
		return rt.new_null()
	}
	if !(var_remaining_stock.clone().is_null())
		&& rt.is_true(rt.less_equal(var_remaining_stock, rt.call_function('wc_get_low_stock_amount', [var_product]))) {
		return rt.call_function('max', [var_remaining_stock.clone(),
			rt.new_int(0)])
	}
	return rt.new_null()
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) filter_valid_attribute(var_attribute rt.PhpVal) rt.PhpVal {
	return rt.call_function('is_a',
		[var_attribute.clone(), rt.new_string('\\WC_Product_Attribute')])
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) filter_variation_attribute(var_attribute rt.PhpVal) bool {
	return rt.is_true(this.filter_valid_attribute(var_attribute.clone()))
		&& rt.is_true(rt.call_method(var_attribute, 'get_variation', []rt.PhpVal{}))
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_variations(mut var_product Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product) rt.PhpVal {
	...
	mut var_variation_ids := if rt.is_true(var_product.is_type(Class_Automattic_WooCommerce_Enums_ProductType.variable())) {
		var_product.get_visible_children()
	} else {
		rt.new_array()
	}
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_int(var_variation_ids.clone().array_count()))))) {
		return rt.new_array()
	}
	mut var_attributes := rt.call_function('array_filter', [var_product.get_attributes(),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema', [
				'Automattic_WooCommerce_StoreApi_Schemas_V1_AbstractSchema',
			], &this) },
			rt.ArrayItem{ key: none, val: 'filter_variation_attribute' },
		])])
	closure_2_fn := fn [var_product] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		mut var_defaults := if args.len > 0 { args[0].clone() } else { rt.new_null() }
		mut var_attribute := if args.len > 1 { args[1].clone() } else { rt.new_null() }
		mut var_meta_key := rt.call_function('wc_variation_attribute_name', [
			rt.call_method(var_attribute, 'get_name', []rt.PhpVal{}),
		])
		var_defaults.array_set(var_meta_key, rt.create_array([
	...
	mut var_default_variation_meta_data := rt.call_function('array_reduce', [
		var_attributes.clone(), rt.new_closure(closure_2_fn),
		rt.new_array()])
	mut var_default_variation_meta_keys :=
		rt.func_array_keys(var_default_variation_meta_data.clone())
	mut var_cache_group := rt.new_string('product_variation_meta_data')
	mut var_cache_value := rt.call_function('wp_cache_get', [
		var_product.get_id(), var_cache_group.clone()])
	mut var_last_modified := rt.call_function('get_the_modified_date', [
		rt.new_string('U'),
		var_product.get_id(),
	])
	if rt.is_true(rt.identical(rt.new_bool(false), var_cache_value))
		|| rt.is_true(rt.new_bool(!rt.is_true(rt.identical(var_last_modified, var_cache_value.array_get(rt.new_string('last_modified')))))) {
		mut var_variation_meta_data := rt.call_method(var_wpdb, 'get_results', [
			rt.new_string((
				rt.concat(rt.concat(rt.new_string('\n\t\t\t\tSELECT post_id as variation_id, meta_key as attribute_key, meta_value as attribute_value\n\t\t\t\tFROM '), rt.get_property(var_wpdb, 'postmeta')), rt.new_string('\n\t\t\t\tWHERE post_id IN (')) + (rt.call_function('implode', [rt.new_string(','), rt.call_function('array_map', [rt.new_string('esc_sql'), var_variation_ids.clone()])])).str() +
				")\n\t\t\t\tAND meta_key IN ('" + (rt.call_function('implode', [rt.new_string("','"), rt.call_function('array_map', [rt.new_string('esc_sql'), var_default_variation_meta_keys.clone()])])).str() +
				"')\n\t\t\t").str()),
		])
		rt.call_function('wp_cache_set', [var_product.get_id(),
			rt.create_array([
				rt.ArrayItem{ key: 'last_modified', val: var_last_modified },
				rt.ArrayItem{ key: 'data', val: var_variation_meta_data },
			]),
			var_cache_group.clone()])
	} else {
		var_variation_meta_data = var_cache_value.array_get(rt.new_string('data'))
	}
	closure_3_fn := fn [var_default_variation_meta_keys] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		...
		if rt.is_true(rt.call_function('in_array', [
			rt.get_property(var_data, 'attribute_key'),
			var_default_variation_meta_keys.clone(),
			rt.new_bool(true),
		]))
		{
			var_values.array_get_mut(rt.get_property(var_data, 'variation_id')).array_set(rt.get_property(var_data,
				'attribute_key'), rt.get_property(var_data, 'attribute_value'))
		}
		return var_values.clone()
	}
	mut var_attributes_by_variation := rt.call_function('array_reduce', [
		var_variation_meta_data.clone(), rt.new_closure(closure_3_fn),
		rt.call_function('array_fill_keys', [var_variation_ids.clone(),
			rt.new_array()])])
	...
	for {
		...
		mut var_attribute_data := var_default_variation_meta_data.clone()
		...
		for {
			...
			if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.new_string(''), var_meta_value)))) {
				var_attribute_data.array_get_mut(var_meta_key).array_set('value',
					var_meta_value.clone())
			}
		}
		var_variations.array_push(rt.array_to_object(rt.create_array([
			rt.ArrayItem{ key: 'id', val: var_variation_id },
			rt.ArrayItem{ key: 'attributes', val: rt.call_function('array_values', [
				var_attribute_data.clone(),
			]) },
		])))
	}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_grouped_products(mut var_product Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product) rt.PhpVal {
	if rt.is_true(var_product.is_type(Class_Automattic_WooCommerce_Enums_ProductType.grouped())) {
		closure_4_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
			mut var_child := if args.len > 0 { args[0].clone() } else { rt.new_null() }
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_attributes(mut var_product Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product) rt.PhpVal {
	mut var_attributes := rt.call_function('array_filter', [var_product.get_attributes(),
		rt.create_array([
			...
			rt.ArrayItem{ key: none, val: 'filter_valid_attribute' },
		])])
	...
	for {
		...
		mut var_attribute_slug := item_3.key
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(var_attribute, 'get_visible', []rt.PhpVal{})))))
			&& rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(var_attribute, 'get_variation', []rt.PhpVal{}))))) {
			continue
		}
		mut var_terms := if rt.is_true(rt.call_method(var_attribute, 'is_taxonomy', []rt.PhpVal{})) { rt.call_function('array_map', [
				rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema', [
						'Automattic_WooCommerce_StoreApi_Schemas_V1_AbstractSchema',
					], &this) },
					rt.ArrayItem{ key: none, val: 'prepare_product_attribute_taxonomy_value' },
				]),
				rt.call_method(var_attribute, 'get_terms', []rt.PhpVal{}),
			]) } else { rt.call_function('array_map', [
				rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema', [
						'Automattic_WooCommerce_StoreApi_Schemas_V1_AbstractSchema',
					], &this) },
					rt.ArrayItem{ key: none, val: 'prepare_product_attribute_value' },
				]),
				rt.call_method(var_attribute, 'get_options', []rt.PhpVal{}),
			]) }
		mut var_sanitized_attribute_name := rt.call_function('sanitize_key', [
			rt.call_method(var_attribute, 'get_name', []rt.PhpVal{}),
		])
		if rt.is_true(rt.new_bool(var_default_attributes.clone().array_isset(var_sanitized_attribute_name.clone()))) {
			mut iter_4 := var_terms.iterator()
			for {
				item_4 := iter_4.next() or { break }
				mut var_term := item_4.val
				rt.set_property(var_term, 'default', rt.identical(rt.get_property(var_term, 'slug'),
					var_default_attributes.array_get(var_sanitized_attribute_name)))
			}
		}
		var_return.array_push(rt.array_to_object(rt.create_array([
			rt.ArrayItem{ key: 'id', val: rt.call_method(var_attribute, 'get_id', []rt.PhpVal{}) },
			rt.ArrayItem{ key: 'name', val: rt.call_function('wc_attribute_label', [
				rt.call_method(var_attribute, 'get_name', []rt.PhpVal{}),
				var_product,
			]) },
			rt.ArrayItem{
				key: 'taxonomy'
				val: if rt.is_true(rt.call_method(var_attribute, 'is_taxonomy', []rt.PhpVal{})) {
					rt.call_method(var_attribute, 'get_name', []rt.PhpVal{})
				} else {
					rt.new_null()
				}
			},
			rt.ArrayItem{ key: 'has_variations', val: rt.identical(rt.new_bool(true), rt.call_method(var_attribute,
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) prepare_product_attribute_taxonomy_value(mut var_term Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WP_Term) rt.PhpVal {
	...
	return rt.new_object('stdClass', []string{}, this.prepare_product_attribute_value(rt.get_property(var_term_mutated,
		'name'), (rt.get_property(var_term_mutated, 'term_id')).to_i64(), (rt.get_property(var_term_mutated,
		'slug')).str()))
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) prepare_product_attribute_value(var_name rt.PhpVal, id i64, slug string) rt.PhpVal {
	return mut rt.array_to_object(rt.create_array([rt.ArrayItem{ key: 'id', val: id },
		rt.ArrayItem{ key: 'name', val: var_name }, rt.ArrayItem{
			key: 'slug'
			val: if var_slug.len > 0 && var_slug != '0' { rt.new_string(slug) } else { var_name }
		}]))
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) prepare_product_price_response(mut var_product Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product, tax_display_mode string) rt.PhpVal {
	...
	mut var_price_function :=
		rt.new_string(this.get_price_function_from_tax_display_mode(rt.new_string(tax_display_mode_mutated)))
	...
	var_prices.array_set('price', this.prepare_money_response(rt.call_callable(var_price_function, [
		var_product,
	]), rt.call_function('wc_get_price_decimals', []rt.PhpVal{})))
	var_prices.array_set('regular_price', this.prepare_money_response(rt.call_callable(var_price_function, [
		var_product,
		rt.create_array([rt.ArrayItem{ key: 'price', val: var_regular_price }]),
	]), rt.call_function('wc_get_price_decimals', []rt.PhpVal{})))
	var_prices.array_set('sale_price', this.prepare_money_response(rt.call_callable(var_price_function, [
		var_product,
		rt.create_array([rt.ArrayItem{ key: 'price', val: var_sale_price }]),
	]), rt.call_function('wc_get_price_decimals', []rt.PhpVal{})))
	var_prices.array_set('price_range', this.get_price_range(mut var_product,
		tax_display_mode_mutated))
	return this.prepare_currency_response(var_prices.clone())
}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_tax_display_mode(tax_display_mode string) rt.PhpVal {
	mut tax_display_mode_mutated := tax_display_mode
	return if rt.is_true(rt.call_function('in_array', [rt.new_string(tax_display_mode_mutated).clone(),
		rt.create_array([rt.ArrayItem{ key: none, val: 'incl' },
			rt.ArrayItem{ key: none, val: 'excl' }]),
		rt.new_bool(true)]))
	{ rt.new_string(tax_display_mode_mutated) } else { rt.call_function('get_option', [
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_price_function_from_tax_display_mode(var_tax_display_mode rt.PhpVal) string {
	...
	return if rt.is_true(rt.identical(rt.new_string('incl'), var_tax_display_mode_mutated)) {
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_price_range(mut var_product Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product, tax_display_mode string) rt.PhpVal {
	...
	if rt.is_true(var_product.is_type(Class_Automattic_WooCommerce_Enums_ProductType.variable())) {
		...
		if !(!rt.is_true(var_prices.array_get(rt.new_string('price'))))
			&& rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.call_function('min', [var_prices.array_get(rt.new_string('price'))]), rt.call_function('max', [var_prices.array_get(rt.new_string('price'))]))))) {
			return rt.new_object('stdClass', []string{}, rt.array_to_object(rt.create_array([
				rt.ArrayItem{ key: 'min_amount', val: this.prepare_money_response(rt.call_function('min', [
					var_prices.array_get(rt.new_string('price')),
				]), rt.call_function('wc_get_price_decimals', []rt.PhpVal{})) },
				rt.ArrayItem{ key: 'max_amount', val: this.prepare_money_response(rt.call_function('max', [
					var_prices.array_get(rt.new_string('price')),
				]), rt.call_function('wc_get_price_decimals', []rt.PhpVal{})) },
			])))
		}
	...
	if rt.is_true(var_product.is_type(Class_Automattic_WooCommerce_Enums_ProductType.grouped())) {
		...
		mut var_price_function := rt.new_string((if rt.is_true(rt.identical(rt.new_string('incl'),
			rt.new_string(tax_display_mode_mutated)))
		{
			'wc_get_price_including_tax'
		} else {
			'wc_get_price_excluding_tax'
		}).str())
		mut iter_5 := var_children.iterator()
		for {
			...
			if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.new_string(''), rt.call_method(var_child,
				'get_price', []rt.PhpVal{})))))
			{
				var_child_prices.array_push(rt.call_callable(var_price_function, [
					var_child.clone(),
				]))
			}
		}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) get_term_list(mut var_product Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WC_Product, taxonomy string) rt.PhpVal {
	...
	mut var_terms := rt.call_function('get_the_terms', [var_product.get_id(),
	...
	mut var_return := rt.new_array()
	mut var_default_category := rt.new_int((rt.call_function('get_option', [
	...
	for {
		...
		mut var_link := rt.call_function('get_term_link', [var_term.clone(),
			rt.new_string(taxonomy)])
		if rt.is_true(rt.call_function('is_wp_error', [var_link.clone()])) {
			continue
		}
		if rt.is_true(rt.identical(rt.get_property(var_term, 'term_id'), var_default_category)) {
			continue
		}
		var_return.array_push(rt.array_to_object(rt.create_array([
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductSchema) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'prepare_product_attribute_taxonomy_value' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_StoreApi_Schemas_V1_WP_Term](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'prepare_product_attribute_value' {
			...
			return this.prepare_product_attribute_value(dispatch_arg_0, dispatch_arg_1,
				dispatch_arg_2)
		}
