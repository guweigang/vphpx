	...
	return rt.create_array([
		rt.ArrayItem{ key: 'price_range', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Min and max prices found in collection of products, provided using the smallest unit of the currency.'),
			...
			rt.ArrayItem{ key: 'properties', val: rt.call_function('array_merge', [
				...
				rt.create_array([
					rt.ArrayItem{ key: 'min_price', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('Min price found in collection of products.'),
							rt.new_string('woocommerce'),
						]) },
					...
					rt.ArrayItem{ key: 'max_price', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('Max price found in collection of products.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'string' },
						rt.ArrayItem{ key: 'context', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'attribute_counts', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Returns number of products within attribute terms.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'rating_counts', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Returns number of products with each average rating.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'array' },
		...
		rt.ArrayItem{ key: 'stock_status_counts', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Returns number of products with each stock status.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'array' },
		...
		rt.ArrayItem{ key: 'taxonomy_counts', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Returns number of products within taxonomy terms.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'array' },
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductCollectionDataSchema) get_item_response(var_data rt.PhpVal) rt.PhpVal {
	return rt.create_array([
		rt.ArrayItem{
			key: 'price_range'
			val: if !(var_data.array_get(rt.new_string('min_price')).is_null()) && !(var_data.array_get(rt.new_string('max_price')).is_null()) { rt.array_to_object(this.prepare_currency_response(rt.create_array([
					rt.ArrayItem{
						key: 'min_price'
						val: this.prepare_money_response(var_data.array_get(rt.new_string('min_price')), rt.call_function('wc_get_price_decimals', []rt.PhpVal{}))
					},
					rt.ArrayItem{
						key: 'max_price'
						val: this.prepare_money_response(var_data.array_get(rt.new_string('max_price')), rt.call_function('wc_get_price_decimals', []rt.PhpVal{}))
					},
				]))) } else { rt.new_null() }
		},
		rt.ArrayItem{
			key: 'attribute_counts'
			val: var_data.array_get(rt.new_string('attribute_counts'))
		},
		rt.ArrayItem{ key: 'rating_counts', val: var_data.array_get(rt.new_string('rating_counts')) },
		rt.ArrayItem{
			key: 'stock_status_counts'
			val: var_data.array_get(rt.new_string('stock_status_counts'))
		},
		rt.ArrayItem{
			key: 'taxonomy_counts'
			val: var_data.array_get(rt.new_string('taxonomy_counts'))
		},
	])
}
...
fn create_automattic_woocommerce_storeapi_schemas_v1_productcollectiondataschema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ProductCollectionDataSchema {
