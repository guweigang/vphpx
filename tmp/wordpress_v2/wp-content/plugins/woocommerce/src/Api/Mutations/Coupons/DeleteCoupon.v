...
fn (mut this Class_Automattic_WooCommerce_Api_Mutations_Coupons_DeleteCoupon) execute(id i64, force bool) rt.PhpVal {
	mut var_wc_coupon :=
		create_automattic_woocommerce_api_mutations_coupons_wc_coupon(rt.new_int(id))
...
fn create_automattic_woocommerce_api_mutations_coupons_deletecoupon(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Api_Mutations_Coupons_DeleteCoupon {
...
fn create_automattic_woocommerce_api_types_coupons_deletecouponresult(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Api_Types_Coupons_DeleteCouponResult {
