...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_TaxRateVersionStringInvalidator) register_hooks() {
	rt.call_function('add_action', [rt.new_string('woocommerce_tax_rate_added'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_TaxRateVersionStringInvalidator',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'handle_woocommerce_tax_rate_added' },
		]),
		rt.new_int(10), rt.new_int(1)])
	rt.call_function('add_action', [rt.new_string('woocommerce_tax_rate_updated'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_TaxRateVersionStringInvalidator',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'handle_woocommerce_tax_rate_updated' },
		]),
		rt.new_int(10), rt.new_int(1)])
	rt.call_function('add_action', [rt.new_string('woocommerce_tax_rate_deleted'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_TaxRateVersionStringInvalidator',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'handle_woocommerce_tax_rate_deleted' },
		]),
		rt.new_int(10), rt.new_int(1)])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_TaxRateVersionStringInvalidator) handle_woocommerce_tax_rate_added(var_tax_rate_id rt.PhpVal) {
	this.invalidate(rt.new_int(var_tax_rate_id.to_i64()))
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_TaxRateVersionStringInvalidator) invalidate_tax_rates_list() {
	...
	]), 'delete_version', [rt.new_string('list_tax_rates')])
}

fn (mut this Class_Automattic_WooCommerce_Internal_Caches_TaxRateVersionStringInvalidator) invalidate(tax_rate_id i64) {
	rt.call_method(rt.call_method(rt.call_function('wc_get_container', []rt.PhpVal{}), 'get', [
		Class_Automattic_WooCommerce_Internal_Caches_VersionStringGenerator.class(),
	]), 'delete_version', [rt.new_string('tax_rate_${var_tax_rate_id.str()}')])
}

fn create_automattic_woocommerce_internal_caches_taxrateversionstringinvalidator(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Caches_TaxRateVersionStringInvalidator {
