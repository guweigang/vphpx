...
fn Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.validate(mut var_data Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_array, mut var_fields Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_?array) bool {
	...
	for {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('method_exists', [Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.class(), var_method.clone()]))))) {
			return (create_wp_error(rt.new_string('woocommerce_invalid_data'), rt.call_function('sprintf', [rt.new_string('Can\'t validate param \'%s\' as a validator does not exist for it.'), var_field.clone()]))).to_bool()
		}
		mut iife_temp_0 := Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator{}
		mut iife_result_0 := iife_temp_0.{"nodetype":"expr_variable","line":112,"name":"method"}(if !(var_data.array_get(var_field)).is_null() { var_data.array_get(var_field) } else { rt.new_null() }, rt.new_object('Automattic_WooCommerce_Internal_PushNotifications_Validators_array', []string{}, var_data))
...
fn Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.validate_origin(var_value rt.PhpVal, mut var_context Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_?array) bool {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('in_array', [var_value_mutated.clone(), Class_Automattic_WooCommerce_Internal_PushNotifications_Entities_PushToken.origins(), rt.new_bool(true)]))))) {
...
fn Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.validate_device_uuid(var_value rt.PhpVal, mut var_context Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_?array) bool {
	mut var_value_mutated := var_value
	mut var_maybe_platform := if !(var_context.array_get(rt.new_string('platform'))).is_null() { var_context.array_get(rt.new_string('platform')) } else { rt.new_null() }
	if rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_PushNotifications_Entities_PushToken.platform_apple(), var_maybe_platform)) || rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_PushNotifications_Entities_PushToken.platform_android(), var_maybe_platform)) {
		if rt.is_true(rt.new_bool(var_value_mutated.clone().is_null())) {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('preg_match', [Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.device_uuid_format(), var_value_mutated.clone()]))))) {
	...
	if var_value_mutated.clone().is_string() && rt.is_true(rt.greater(rt.new_int(var_value_mutated.clone().to_string().len), Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.device_uuid_maximum_length())) {
...
fn Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.validate_device_locale(var_value rt.PhpVal, mut var_context Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_?array) bool {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('preg_match', [Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.device_locale_format(), var_value_mutated.clone()]))))) {
...
fn Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.validate_platform(var_value rt.PhpVal, mut var_context Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_?array) bool {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('in_array', [var_value_mutated.clone(), Class_Automattic_WooCommerce_Internal_PushNotifications_Entities_PushToken.platforms(), rt.new_bool(true)]))))) {
...
fn Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.validate_token(var_value rt.PhpVal, mut var_context Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_?array) bool {
	...
	if rt.is_true(rt.greater(rt.new_int(var_value_mutated.clone().to_string().len), Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.token_maximum_length())) {
	...
	if rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_PushNotifications_Entities_PushToken.platform_apple(), var_context.array_get(rt.new_string('platform')))) && rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('preg_match', [Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.token_format_apple(), var_value_mutated.clone()]))))) {
	...
	if rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_PushNotifications_Entities_PushToken.platform_android(), var_context.array_get(rt.new_string('platform')))) && rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('preg_match', [Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.token_format_android(), var_value_mutated.clone()]))))) {
		return (create_wp_error(Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.error_code(), rt.new_string('Token is an invalid format.'))).to_bool()
	}
	if rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_PushNotifications_Entities_PushToken.platform_browser(), var_context.array_get(rt.new_string('platform')))) {
		mut var_token_object := rt.call_function('json_decode', [var_value_mutated.clone(), rt.new_bool(true)])
		mut var_endpoint := if !(var_token_object.array_get(rt.new_string('endpoint'))).is_null() { var_token_object.array_get(rt.new_string('endpoint')) } else { rt.new_null() }
		if var_token_object.clone().is_null() || rt.is_true(rt.call_function('json_last_error', []rt.PhpVal{})) || !(var_token_object.array_get(rt.new_string('keys')).array_isset(rt.new_string('auth'))) || !(var_token_object.array_get(rt.new_string('keys')).array_isset(rt.new_string('p256dh'))) || rt.is_true(rt.new_bool(!(rt.is_true(var_endpoint)))) || rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wp_http_validate_url', [rt.new_string((var_endpoint).str())]))))) || rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.call_function('wp_parse_url', [rt.new_string((var_endpoint).str()), rt.get_constant('PHP_URL_SCHEME')]), rt.new_string('https'))))) {
			return (create_wp_error(Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.error_code(), rt.new_string('Token is an invalid format.'))).to_bool()
		}
	}
	return true
...
fn Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_PushTokenValidator.validate_metadata(var_value rt.PhpVal, mut var_context Class_Automattic_WooCommerce_Internal_PushNotifications_Validators_?array) bool {
	...
	for {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('is_scalar', [var_item.clone()]))))) {
