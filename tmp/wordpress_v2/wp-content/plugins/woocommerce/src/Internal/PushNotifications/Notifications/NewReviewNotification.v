...
fn (mut this Class_Automattic_WooCommerce_Internal_PushNotifications_Notifications_NewReviewNotification) write_meta(key string) {
	rt.call_method(rt.call_function('WC', []rt.PhpVal{}), 'call_function', [rt.new_string('update_comment_meta'), this.get_resource_id(), rt.new_string(key), rt.new_string((rt.call_function('time', []rt.PhpVal{})).str())])
}
