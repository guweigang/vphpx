...
fn (mut this Class_Automattic_WooCommerce_Internal_CLI_Migrator_Commands_ResetCommand) magic_invoke(mut var_args Class_Automattic_WooCommerce_Internal_CLI_Migrator_Commands_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_CLI_Migrator_Commands_array) {
		...
		'has_credentials', [var_platform.clone()])))))
	{
		...
		mut iife_result_0 :=
			iife_temp_0.warning(rt.new_string("No credentials found for '${var_platform_display_name.to_string()}' to reset."))
		return
	}
	...
	mut iife_result_1 :=
		iife_temp_1.success(rt.new_string("Credentials for the '${var_platform_display_name.to_string()}' platform have been cleared."))
}
...
fn create_automattic_woocommerce_internal_cli_migrator_commands_resetcommand(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_CLI_Migrator_Commands_ResetCommand {
