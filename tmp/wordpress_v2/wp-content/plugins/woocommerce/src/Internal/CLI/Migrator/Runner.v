...
fn Class_Automattic_WooCommerce_Internal_CLI_Migrator_Runner.register_commands() {
	...
	mut iife_result_0 := iife_temp_0.add_command(rt.new_string('wc migrate products'), rt.call_method(var_container,
		'get', [
	...
	mut iife_result_1 := iife_temp_1.add_command(rt.new_string('wc migrate reset'), rt.call_method(var_container,
		'get', [
	...
	mut iife_result_2 := iife_temp_2.add_command(rt.new_string('wc migrate setup'), rt.call_method(var_container,
		'get', [
	...
	mut iife_result_3 := iife_temp_3.add_command(rt.new_string('wc migrate list'), rt.call_method(var_container,
		'get', [
...
fn create_automattic_woocommerce_internal_cli_migrator_runner(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_CLI_Migrator_Runner {
