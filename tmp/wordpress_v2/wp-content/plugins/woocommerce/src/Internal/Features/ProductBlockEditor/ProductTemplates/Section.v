...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Section) construct(mut var_config Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_array, mut var_root_template Class_Automattic_WooCommerce_Admin_BlockTemplates_BlockTemplateInterface, mut var_parent Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_?ContainerInterface) {
	if !(!rt.is_true(var_config.array_get(rt.new_string('blockName')))) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_InvalidArgumentException', []string{}, create_automattic_woocommerce_internal_features_productblockeditor_producttemplates_invalidargumentexception(rt.new_string('Unexpected key "blockName", this defaults to "woocommerce/product-section".'))))
	}
	this.Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductBlock.construct(rt.call_function('array_merge', [rt.create_array([rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-section' }]), var_config]), rt.new_object('Automattic_WooCommerce_Admin_BlockTemplates_BlockTemplateInterface', []string{}, var_root_template), rt.new_object('Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_?ContainerInterface', []string{}, var_parent))
}

fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Section) add_subsection(mut var_block_config Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_array) rt.PhpVal {
	mut var_block := create_automattic_woocommerce_internal_features_productblockeditor_producttemplates_subsection(var_block_config, this.get_root_template(), rt.new_object('Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Section', ['Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductBlock', 'SectionInterface'], &this))
	return this.add_inner_block(rt.new_object('Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Subsection', []string{}, var_block))
}

fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Section) add_section(mut var_block_config Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_array) rt.PhpVal {
	rt.call_function('wc_deprecated_function', [rt.new_string('add_section'), rt.new_string('8.6.0'), rt.new_string('add_subsection')])
	return this.add_subsection(mut var_block_config)
}
...
fn create_automattic_woocommerce_internal_features_productblockeditor_producttemplates_section(arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Section {
...
fn create_automattic_woocommerce_internal_features_productblockeditor_producttemplates_invalidargumentexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_InvalidArgumentException {
...
fn create_automattic_woocommerce_internal_features_productblockeditor_producttemplates_subsection(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Subsection {
...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Section) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'add_subsection' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_array](if args.len > 0 { args[0] } else { rt.new_null() })
			return this.add_subsection(mut dispatch_arg_0)
		}
		'add_section' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_array](if args.len > 0 { args[0] } else { rt.new_null() })
