...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Group) construct(mut var_config Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_array, mut var_root_template Class_Automattic_WooCommerce_Admin_BlockTemplates_BlockTemplateInterface, mut var_parent Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_?ContainerInterface) {
	...
	if !(!rt.is_true(var_config_mutated.array_get(rt.new_string('blockName')))) {
	...
	if rt.is_true(var_config_mutated.array_get(rt.new_string('id'))) && !rt.is_true(var_config_mutated.array_get(rt.new_string('attributes'))) || !rt.is_true(var_config_mutated.array_get(rt.new_string('attributes')).array_get(rt.new_string('id'))) {
		var_config_mutated.array_set('attributes', if !rt.is_true(var_config_mutated.array_get(rt.new_string('attributes'))) { rt.new_array() } else { var_config_mutated.array_get(rt.new_string('attributes')) })
		var_config_mutated.array_get_mut('attributes').array_set('id', var_config_mutated.array_get(rt.new_string('id')))
	}
	this.Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductBlock.construct(rt.call_function('array_merge', [rt.create_array([rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-tab' }]), var_config_mutated]), rt.new_object('Automattic_WooCommerce_Admin_BlockTemplates_BlockTemplateInterface', []string{}, var_root_template), rt.new_object('Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_?ContainerInterface', []string{}, var_parent))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Group) add_section(mut var_block_config Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_array) rt.PhpVal {
	mut var_block := create_automattic_woocommerce_internal_features_productblockeditor_producttemplates_section(var_block_config, this.get_root_template(), rt.new_object('Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Group', ['Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductBlock', 'GroupInterface'], &this))
...
fn create_automattic_woocommerce_internal_features_productblockeditor_producttemplates_section(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Section {
