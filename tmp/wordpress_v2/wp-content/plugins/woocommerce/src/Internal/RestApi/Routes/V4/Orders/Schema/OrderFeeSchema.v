...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema) get_item_schema_properties() rt.PhpVal {
	mut var_schema := rt.create_array([
		rt.ArrayItem{ key: 'id', val: rt.create_array([
			...
			rt.ArrayItem{
				key: 'context'
				val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema.view_edit_embed_context()
			},
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema) get_item_response(var_order_item rt.PhpVal, mut var_request Class_WP_REST_Request, mut var_include_fields Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_array) rt.PhpVal {
	...
	mut var_data := rt.create_array([
		...
		rt.ArrayItem{ key: 'tax_class', val: rt.call_method(var_order_item, 'get_tax_class',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'tax_status', val: rt.call_method(var_order_item, 'get_tax_status',
			[]rt.PhpVal{}) },
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_orders_schema_orderfeeschema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema {
