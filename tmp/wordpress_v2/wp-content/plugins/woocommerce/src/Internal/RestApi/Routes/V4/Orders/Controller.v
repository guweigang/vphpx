...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) init(mut var_item_schema Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderSchema, mut var_query_utils Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_CollectionQuery, mut var_update_utils Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_UpdateUtils, mut var_action_controller Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_ActionController) {
	...
	this.action_controller = var_action_controller
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) get_query_schema() rt.PhpVal {
	return rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller', [
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) register_routes() {
	rt.call_function('register_rest_route', [
		rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller', [
			'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
		], &this), 'namespace'),
		rt.new_string('/' + (this.rest_base).str()),
		rt.create_array([
			rt.ArrayItem{ key: 'schema', val: rt.create_array([
				rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller', [
					'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
				], &this) },
		...
		rt.create_array([
			...
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'args', val: rt.call_function('array_merge', [
					...
					rt.call_method(this.action_controller, 'get_endpoint_args_for_actions',
						[]rt.PhpVal{}),
				]) },
			]) },
			rt.ArrayItem{ key: none, val: rt.create_array([
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) prepare_links(var_item rt.PhpVal, mut var_request Class_WP_REST_Request, mut var_response Class_WP_REST_Response) rt.PhpVal {
	...
	mut var_links := rt.create_array([
			...
			rt.ArrayItem{ key: 'targetHints', val: rt.create_array([
				rt.ArrayItem{
					...
					{ rt.create_array([rt.ArrayItem{ key: none, val: 'GET' },
							...
							rt.ArrayItem{ key: none, val: 'DELETE' }]) } else { rt.create_array([
		...
		rt.ArrayItem{ key: 'email-templates', val: rt.create_array([
			rt.ArrayItem{ key: 'href', val: rt.call_function('rest_url', [
				rt.call_function('sprintf', [rt.new_string('/wc/v3/%s/%d/actions/email_templates'),
					this.rest_base, rt.call_method(var_item, 'get_id', []rt.PhpVal{})]),
			]) },
			rt.ArrayItem{ key: 'embeddable', val: true },
		]) },
		rt.ArrayItem{ key: 'order-notes', val: rt.create_array([
			rt.ArrayItem{ key: 'href', val: rt.call_function('add_query_arg', [
				rt.create_array([
					rt.ArrayItem{ key: 'order_id', val: rt.new_int((rt.call_method(var_item,
						'get_id', []rt.PhpVal{})).to_i64()) },
				]),
				rt.call_function('rest_url', [
					rt.call_function('sprintf', [
						rt.new_string('/%s/order-notes'),
						rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller', [
							'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
						], &this), 'namespace'),
					]),
	...
	if rt.is_true(rt.call_method(var_item, 'get_payment_method', []rt.PhpVal{})) {
		var_links.array_set('payment_gateway', rt.create_array([
			rt.ArrayItem{ key: 'href', val: rt.call_function('rest_url', [
				rt.call_function('sprintf', [
					rt.new_string('/%s/settings/payment-gateways/%s'),
					rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller', [
						'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
					], &this), 'namespace'),
					rt.call_function('rawurlencode', [
						rt.call_method(var_item, 'get_payment_method', []rt.PhpVal{}),
					]),
				]),
			]) },
			rt.ArrayItem{ key: 'embeddable', val: true },
	...
	if rt.is_true(rt.call_method(var_item, 'get_customer_id', []rt.PhpVal{})) {
		var_links.array_set('customer', rt.create_array([
			rt.ArrayItem{ key: 'href', val: rt.call_function('rest_url', [
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) get_item_response(var_order rt.PhpVal, mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	return rt.call_method(this.item_schema, 'get_item_response', [
		var_order_mutated.clone(), var_request,
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) get_item(var_request rt.PhpVal) rt.PhpVal {
	...
	if !(this.is_valid_order_for_request(var_order.clone())) {
	...
	return this.prepare_item_for_response(var_order.clone(), var_request.clone())
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) get_items(var_request rt.PhpVal) rt.PhpVal {
	mut var_query_args := rt.cast_array(rt.call_function('apply_filters', [
		rt.new_string((this.get_hook_prefix()).str() + 'collection_query_args'),
		rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller', [
			'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
		], &this), 'collection_query'), 'get_query_args', [
			var_request.clone(),
		]),
		var_request.clone(),
		rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller', [
			'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
		], &this),
	]))
	var_query_args = rt.call_function('wp_parse_args', [var_query_args.clone(),
		rt.create_array([rt.ArrayItem{ key: 'post_type', val: this.post_type }])])
	mut var_results := rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller', [
		'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) create_item(var_request rt.PhpVal) rt.PhpVal {
	...
	rt.call_method(var_order, 'set_created_via', [if !(!rt.is_true(var_request.array_get(rt.new_string('created_via')))) { rt.call_function('sanitize_text_field', [
			rt.call_function('wp_unslash', [var_request.array_get(rt.new_string('created_via'))]),
	...
	rt.call_method(this.update_utils, 'update_order_from_request', [
		var_order.clone(), var_request.clone()])
	if rt.has_exception() {
		unsafe {
			goto catch_label_1
		}
	}
	this.update_additional_fields_for_object(var_order.clone(), var_request.clone())
	if rt.has_exception() {
		unsafe {
			goto catch_label_1
		}
	...
	mut var_response := this.prepare_item_for_response(var_order.clone(), var_request.clone())
	if rt.has_exception() {
		unsafe {
			goto catch_label_1
		}
	...
	if rt.instance_of(var_e_1,
		'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_WC_Data_Exception')
	{
		...
		if rt.is_true(var_order) && rt.is_true(rt.new_bool(rt.instance_of(var_order, 'WC_Order')))
			...
			if rt.instance_of(var_e_2,
				'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Exception')
			{
			...
			end_label_2:
			var_data.array_set('new_draft_order_id', rt.call_method(var_order, 'get_id',
				[]rt.PhpVal{}))
		}
		...
		'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_WC_REST_Exception')
	{
		var_e = var_e_1.clone()
		if rt.is_true(var_order) && rt.is_true(rt.new_bool(rt.instance_of(var_order, 'WC_Order')))
			&& rt.is_true(rt.call_method(var_order, 'get_id', []rt.PhpVal{})) {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) update_item(var_request rt.PhpVal) rt.PhpVal {
	...
	rt.call_method(this.action_controller, 'run_actions', [var_order.clone(),
		var_request.clone()])
	if rt.has_exception() {
		unsafe {
			goto catch_label_3
	...
	} else if rt.instance_of(var_e_3,
		'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_WC_REST_Exception')
	{
		var_e = var_e_3.clone()
		return rt.new_object('WP_Error', []string{}, create_wp_error(rt.call_method(var_e,
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) delete_item(var_request rt.PhpVal) rt.PhpVal {
	...
	if rt.is_true(var_force) {
		mut var_result := rt.call_method(var_order, 'delete', [
			rt.new_bool(true)])
		mut var_response := create_wp_rest_response(rt.new_null(), rt.new_int(204))
	} else {
		var_response = this.prepare_item_for_response(var_order.clone(), var_request.clone())
		mut var_supports_trash := rt.call_function('apply_filters', [
			rt.new_string((this.get_hook_prefix()).str() + 'object_trashable'),
		...
		if rt.is_true(rt.identical(rt.new_string('trash'), rt.call_method(var_order, 'get_status',
			[]rt.PhpVal{})))
		{
		...
		var_result = rt.identical(rt.new_string('trash'), rt.call_method(var_order, 'get_status',
			[]rt.PhpVal{}))
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) is_valid_order_for_request(var_order rt.PhpVal) bool {
	mut var_order_mutated := var_order
	return rt.is_true(rt.new_bool(rt.instance_of(var_order_mutated, 'WC_Order')))
		&& rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.call_method(var_order_mutated, 'get_id', []rt.PhpVal{}), rt.new_int(0)))))
		&& rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.new_string('shop_order_refund'), rt.call_method(var_order_mutated, 'get_type', []rt.PhpVal{})))))
}
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_orders_controller(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Controller) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'init' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_CollectionQuery](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
			mut dispatch_arg_2 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_UpdateUtils](if args.len > 2 {
				args[2]
			} else {
				rt.new_null()
			})
			mut dispatch_arg_3 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_ActionController](if args.len > 3 {
				args[3]
			} else {
				rt.new_null()
			})
