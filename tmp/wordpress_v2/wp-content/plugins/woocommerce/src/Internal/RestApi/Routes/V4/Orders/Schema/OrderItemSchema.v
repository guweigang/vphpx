...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderItemSchema) get_item_schema_properties() rt.PhpVal {
	mut var_schema := rt.create_array([
		rt.ArrayItem{ key: 'id', val: rt.create_array([
			...
			rt.ArrayItem{
				key: 'context'
				val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderItemSchema.view_edit_embed_context()
			},
			rt.ArrayItem{ key: 'readonly', val: true },
		]) },
		rt.ArrayItem{ key: 'name', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Item name.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'image', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Line item image, if available.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'product_id', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product or variation ID.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: rt.create_array([
		...
		rt.ArrayItem{ key: 'product_data', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product data this item is linked to.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'properties', val: this.get_product_data_schema() },
		]) },
		...
		rt.ArrayItem{ key: 'price', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Item price. Calculated as total / quantity.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'tax_class', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
		...
		rt.ArrayItem{ key: 'subtotal_tax', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
		...
		rt.ArrayItem{ key: 'currency', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Currency the order item was created with, in ISO format.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderItemSchema) get_item_response(var_order_item rt.PhpVal, mut var_request Class_WP_REST_Request, mut var_include_fields Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_array) rt.PhpVal {
	...
	mut var_quantity_amount := rt.new_float((rt.call_method(var_order_item, 'get_quantity',
		[]rt.PhpVal{})).to_f64())
	mut var_data := rt.create_array([
		...
		rt.ArrayItem{
			key: 'image'
			val: this.get_image(mut rt.cast_object_ptr[Class_WC_Order_Item_Product](var_order_item))
		},
		rt.ArrayItem{
			key: 'product_id'
			val: if rt.is_true(rt.call_method(var_order_item, 'get_variation_id', []rt.PhpVal{})) {
				rt.call_method(var_order_item, 'get_variation_id', []rt.PhpVal{})
			} else {
				rt.call_method(var_order_item, 'get_product_id', []rt.PhpVal{})
			}
		},
		rt.ArrayItem{
			key: 'product_data'
			val: this.get_product_data(mut rt.cast_object_ptr[Class_WC_Order_Item_Product](var_order_item))
		},
		rt.ArrayItem{ key: 'quantity', val: rt.call_method(var_order_item, 'get_quantity',
			[]rt.PhpVal{}) },
		rt.ArrayItem{
			key: 'price'
			val: if rt.is_true(var_quantity_amount) {
				rt.div(rt.call_method(var_order_item, 'get_total', []rt.PhpVal{}),
					var_quantity_amount)
			} else {
				rt.new_int(0)
			}
		},
		rt.ArrayItem{ key: 'tax_class', val: rt.call_method(var_order_item, 'get_tax_class',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'subtotal', val: rt.call_function('wc_format_decimal', [
			rt.call_method(var_order_item, 'get_subtotal', []rt.PhpVal{}),
			var_dp.clone(),
		]) },
		rt.ArrayItem{ key: 'subtotal_tax', val: rt.call_function('wc_format_decimal', [
		...
		rt.ArrayItem{ key: 'currency', val: rt.call_method(rt.call_method(var_order_item,
			'get_order', []rt.PhpVal{}), 'get_currency', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'currency_symbol', val: rt.call_function('html_entity_decode', [
			rt.call_function('get_woocommerce_currency_symbol', [
				rt.call_method(rt.call_method(var_order_item, 'get_order', []rt.PhpVal{}),
	...
	mut iife_temp_0 :=
		Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderItemSchema{}
	mut iife_result_0 := iife_temp_0.cogs_is_enabled()
	if rt.is_true(iife_result_0) {
		var_data.array_get_mut('cost_of_goods_sold').array_set('total_value', if var_data.array_isset(rt.new_string('cogs_value')) {
			var_data.array_get(rt.new_string('cogs_value'))
		} else {
			rt.new_int(0)
		})
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderItemSchema) get_product_data_schema() rt.PhpVal {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'permalink', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product permalink.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{
		...
		rt.ArrayItem{ key: 'global_unique_id', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product global unique ID.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{
		...
		rt.ArrayItem{ key: 'is_virtual', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product is virtual.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'is_downloadable', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product is downloadable.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{
		...
		rt.ArrayItem{ key: 'needs_shipping', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product needs shipping.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderItemSchema) get_product_data(mut var_order_item Class_WC_Order_Item_Product) rt.PhpVal {
	...
	return rt.create_array([
		rt.ArrayItem{ key: 'name', val: rt.call_method(var_product, 'get_name', []rt.PhpVal{}) },
		...
		rt.ArrayItem{ key: 'global_unique_id', val: rt.call_method(var_product,
			'get_global_unique_id', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'type', val: rt.call_method(var_product, 'get_type', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'is_virtual', val: rt.call_method(var_product, 'is_virtual',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'is_downloadable', val: rt.call_method(var_product, 'is_downloadable',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'needs_shipping', val: rt.call_method(var_product, 'needs_shipping',
			[]rt.PhpVal{}) },
	])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderItemSchema) get_image(mut var_order_item Class_WC_Order_Item_Product) string {
	...
	mut var_image_id := if rt.is_true(rt.call_method(var_product, 'get_image_id', []rt.PhpVal{})) {
		rt.call_method(var_product, 'get_image_id', []rt.PhpVal{})
	} else {
		rt.new_int(0)
	}
	return (if rt.is_true(var_image_id) {
		rt.call_function('wp_get_attachment_image_url', [var_image_id.clone(),
			rt.new_string('full')])
	} else {
		rt.new_string('')
	}).str()
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_orders_schema_orderitemschema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderItemSchema {
