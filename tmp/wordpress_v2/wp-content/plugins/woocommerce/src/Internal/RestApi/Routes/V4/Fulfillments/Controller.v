...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) init(mut var_item_schema Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Schema_FulfillmentSchema, mut var_order_fulfillments_controller Class_Automattic_WooCommerce_Admin_Features_Fulfillments_OrderFulfillmentsRestController) {
	...
	this.order_fulfillments_controller = var_order_fulfillments_controller
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) register_routes() {
	rt.call_function('register_rest_route', [
		rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller', [
		...
		rt.create_array([
			...
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'get_fulfillments' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller', [
						'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
					], &this) },
					rt.ArrayItem{ key: none, val: 'check_permission_for_fulfillments' },
				]) },
			...
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'create_fulfillment' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller', [
						'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
		...
		rt.create_array([
			...
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'get_fulfillment' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller', [
						'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
			...
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'update_fulfillment' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller', [
						'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
			...
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'delete_fulfillment' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller', [
						'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'get_providers' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller', [
						'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
					], &this) },
					rt.ArrayItem{ key: none, val: 'check_permission_for_providers' },
				]) },
				rt.ArrayItem{ key: 'schema', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller', [
						'Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController',
					], &this) },
					rt.ArrayItem{ key: none, val: 'get_schema_for_providers' },
				]) },
			]) },
		]),
	])
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) get_fulfillments(mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(var_order_id)))) {
		return this.prepare_error_response(rt.new_string('woocommerce_rest_order_id_required'), rt.call_function('__', [
			rt.new_string('The order ID is required.'),
			rt.new_string('woocommerce'),
		]), rt.create_array([
	...
	var_request.set_param(rt.new_string('order_id'), var_order_id.clone())
	return rt.call_method(this.order_fulfillments_controller, 'get_fulfillments', [
		var_request,
	])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) create_fulfillment(mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	mut var_entity_id := if !(var_params.array_get(rt.new_string('entity_id'))).is_null() {
		var_params.array_get(rt.new_string('entity_id'))
	} else {
		rt.new_null()
	}
	if rt.is_true(rt.new_bool(!(rt.is_true(var_entity_id)))) {
		return this.prepare_error_response(rt.new_string('woocommerce_rest_entity_id_required'), rt.call_function('__', [
			rt.new_string('The entity ID is required.'),
			rt.new_string('woocommerce'),
		]), rt.create_array([
			rt.ArrayItem{ key: 'status', val: rt.call_function('esc_attr', [
				Class_WP_Http.bad_request(),
	...
	mut var_order := rt.call_function('wc_get_order', [
		rt.new_int(var_entity_id.to_i64()),
	])
	if rt.is_true(rt.new_bool(!(rt.is_true(var_order)))) {
		return this.prepare_error_response(rt.new_string('woocommerce_rest_order_invalid_id'), rt.call_function('__', [
			rt.new_string('Invalid order ID.'),
	...
	var_request.set_param(rt.new_string('order_id'), var_entity_id.clone())
	return rt.call_method(this.order_fulfillments_controller, 'create_fulfillment', [
		var_request,
	])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) get_fulfillment(mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(var_fulfillment.get_id())))) {
		return this.prepare_error_response(rt.new_string('woocommerce_rest_fulfillment_invalid_id'), rt.call_function('__', [
	...
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(var_fulfillment.get_entity_type(),
		Class_WC_Order.class()))))
	{
		return this.prepare_error_response(rt.new_string('woocommerce_rest_invalid_entity_type'), rt.call_function('__', [
			rt.new_string('The entity type must be "order".'),
			rt.new_string('woocommerce'),
		]), rt.create_array([
			rt.ArrayItem{ key: 'status', val: rt.call_function('esc_attr', [
				Class_WP_Http.bad_request(),
	...
	mut var_order_id := rt.new_int((var_fulfillment.get_entity_id()).to_i64())
	var_request.set_param(rt.new_string('order_id'), var_order_id.clone())
	return rt.call_method(this.order_fulfillments_controller, 'get_fulfillment', [
		var_request,
	])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) update_fulfillment(mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	mut var_order_id := rt.new_int((var_fulfillment.get_entity_id()).to_i64())
	var_request.set_param(rt.new_string('order_id'), var_order_id.clone())
	return rt.call_method(this.order_fulfillments_controller, 'update_fulfillment', [
		var_request,
	])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) delete_fulfillment(mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	mut var_order_id := rt.new_int((var_fulfillment.get_entity_id()).to_i64())
	var_request.set_param(rt.new_string('order_id'), var_order_id.clone())
	return rt.call_method(this.order_fulfillments_controller, 'delete_fulfillment', [
		var_request,
	])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) check_permission_for_fulfillments(mut var_request Class_WP_REST_Request) bool {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(var_order))))
		&& rt.is_true(var_request.has_param(rt.new_string('fulfillment_id'))) {
		mut var_fulfillment_id :=
			rt.new_int((var_request.get_param(rt.new_string('fulfillment_id'))).to_i64())
		if rt.is_true(var_fulfillment_id) {
			...
			var_order_id = rt.new_int((var_fulfillment.get_entity_id()).to_i64())
			if rt.has_exception() {
				unsafe {
					goto catch_label_1
				}
				...
				'Automattic_WooCommerce_Internal_Admin_Settings_Exceptions_ApiException')
			{
				...
				return (create_wp_error(rt.call_method(var_ex, 'getErrorCode', []rt.PhpVal{}), rt.call_method(var_ex,
				...
				'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Throwable')
			{
				mut var_e := var_e_1.clone()
				return (create_wp_error(rt.new_string('woocommerce_rest_fulfillment_invalid_id'), rt.call_method(var_e,
					'getMessage', []rt.PhpVal{}), rt.create_array([
					rt.ArrayItem{ key: 'status', val: rt.call_function('esc_attr', [
						Class_WP_Http.bad_request(),
					]) },
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(var_order))))
		&& var_body_params.array_isset(rt.new_string('entity_id'))
		&& var_body_params.array_isset(rt.new_string('entity_type')) {
		if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(Class_WC_Order.class(),
			var_body_params.array_get(rt.new_string('entity_type'))))))
		{
			return (create_wp_error(rt.new_string('woocommerce_rest_invalid_entity_type'), rt.call_function('esc_html__', [
				rt.new_string('The entity type must be "order".'),
				rt.new_string('woocommerce'),
			]), rt.create_array([
				rt.ArrayItem{ key: 'status', val: rt.call_function('esc_attr', [
		...
		var_order_id = rt.new_int((var_body_params.array_get(rt.new_string('entity_id'))).to_i64())
		var_order = rt.call_function('wc_get_order', [var_order_id.clone()])
	}
	if rt.is_true(rt.new_bool(!(rt.is_true(var_order)))) {
		return (create_wp_error(rt.new_string('woocommerce_rest_order_id_required'), rt.call_function('esc_html__', [
			rt.new_string('The order ID is required.'),
			rt.new_string('woocommerce'),
		]), rt.create_array([
			rt.ArrayItem{ key: 'status', val: rt.call_function('esc_attr', [
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) prepare_error_response(var_code rt.PhpVal, var_message rt.PhpVal, var_data rt.PhpVal) rt.PhpVal {
	...
	]), if !(var_data.array_get(rt.new_string('status'))).is_null() {
		var_data.array_get(rt.new_string('status'))
	} else {
		Class_WP_Http.bad_request()
	}))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) get_providers(mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	mut iife_temp_0 :=
		Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Automattic_WooCommerce_Admin_Features_Fulfillments_FulfillmentUtils{}
	mut iife_result_0 := iife_temp_0.get_shipping_providers()
	mut iter_1 := iife_result_0.iterator()
	for {
		item_1 := iter_1.next() or { break }
		mut var_provider := item_1.val
		var_providers.array_set(rt.call_method(var_provider, 'get_key', []rt.PhpVal{}), rt.create_array([
	...
	var_providers = rt.call_function('apply_filters', [
		rt.new_string('woocommerce_rest_prepare_fulfillments_providers'),
		var_providers.clone(),
		var_request,
	])
	if !(var_providers.clone().is_array()) {
		rt.call_function('_doing_it_wrong', [
			rt.new_string('woocommerce_rest_prepare_fulfillments_providers'),
			rt.call_function('esc_html__', [
				rt.new_string('The filter must return an array of providers.'),
				rt.new_string('woocommerce'),
			]),
		...
		var_providers =
			this.validate_providers_structure(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_array](var_providers))
	}
	return rt.new_object('WP_REST_Response', []string{}, create_wp_rest_response(var_providers.clone(),
		Class_WP_Http.ok()))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) validate_providers_structure(mut var_providers Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_array) rt.PhpVal {
	...
	mut var_required_keys := rt.create_array([rt.ArrayItem{ key: none, val: 'label' },
		rt.ArrayItem{ key: none, val: 'icon' }, rt.ArrayItem{ key: none, val: 'value' },
		rt.ArrayItem{ key: none, val: 'url' }])
	mut var_valid_providers := rt.new_array()
	mut var_has_invalid := rt.new_bool(false)
	mut iter_2 := var_providers_mutated.iterator()
	for {
		item_2 := iter_2.next() or { break }
		mut var_provider := item_2.val
		mut var_key := item_2.key
		if !(var_provider.clone().is_array()) {
			var_has_invalid = rt.new_bool(true)
			continue
		}
		mut var_missing_keys := rt.call_function('array_diff', [
			var_required_keys.clone(), rt.func_array_keys(var_provider.clone())])
		if !(!rt.is_true(var_missing_keys)) {
			var_has_invalid = rt.new_bool(true)
			continue
		}
		var_valid_providers.array_set(var_key, var_provider.clone())
	}
	if rt.is_true(var_has_invalid) {
		rt.call_function('_doing_it_wrong', [
			rt.new_string('woocommerce_rest_prepare_fulfillments_providers'),
			rt.call_function('esc_html__', [
				rt.new_string('Some providers were removed because they are missing required keys (label, icon, value, url).'),
				rt.new_string('woocommerce'),
			]),
			rt.new_string('10.5.0'),
		])
	}
	return var_valid_providers.clone()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) check_permission_for_providers(mut var_request Class_WP_REST_Request) bool {
	...
	{
		return (this.get_authentication_error_by_method(var_request.get_method())).to_bool()
	}
	return true
}
		...
		rt.ArrayItem{ key: 'additionalProperties', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'properties', val: rt.create_array([
				rt.ArrayItem{ key: 'label', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('The display name of the shipping provider.'),
						rt.new_string('woocommerce'),
					]) },
				...
				rt.ArrayItem{ key: 'icon', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('The icon URL for the shipping provider.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{ key: 'context', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'value', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('The unique key for the shipping provider.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{ key: 'context', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'url', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('The tracking URL template for the shipping provider.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{ key: 'context', val: rt.create_array([
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_fulfillments_controller(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller {
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_fulfillments_automattic_woocommerce_admin_features_fulfillments_fulfillmentutils(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Automattic_WooCommerce_Admin_Features_Fulfillments_FulfillmentUtils {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'init' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Schema_FulfillmentSchema](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Admin_Features_Fulfillments_OrderFulfillmentsRestController](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
		...
		'validate_providers_structure' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_array](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Fulfillments_Controller) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		...
		'order_fulfillments_controller' {
			this.order_fulfillments_controller = val
			return true
		}
		else {
