...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_RefundSchema) get_item_schema_properties() rt.PhpVal {
	mut var_schema := rt.create_array([
		rt.ArrayItem{ key: 'id', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Unique identifier for the refund.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'integer' },
			rt.ArrayItem{
				key: 'context'
				val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_RefundSchema.view_edit_embed_context()
			},
			rt.ArrayItem{ key: 'readonly', val: true },
		]) },
		rt.ArrayItem{ key: 'order_id', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('The ID of the order that was refunded.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'integer' },
			rt.ArrayItem{
		...
		rt.ArrayItem{ key: 'amount', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Amount that was refunded. This is calculated from the line items if not provided.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'reason', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Reason for the refund.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'currency', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Currency the refund was created with, in ISO format.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
		...
		rt.ArrayItem{ key: 'date_created', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string("The date the refund was created, in the site's timezone."),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
		...
		rt.ArrayItem{ key: 'date_created_gmt', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('The date the refund was created, as GMT.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{ key: 'format', val: 'date-time' },
		...
		rt.ArrayItem{ key: 'refunded_by', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('User who created the refund.'),
				rt.new_string('woocommerce'),
			]) },
			...
			rt.ArrayItem{ key: 'properties', val: rt.create_array([
				rt.ArrayItem{ key: 'id', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('User ID of user who created the refund.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'integer' },
					rt.ArrayItem{
				...
				rt.ArrayItem{ key: 'display_name', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('Display name of the user who created the refund.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{
				...
				rt.ArrayItem{ key: 'avatar_url', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('Avatar URL of the user who created the refund.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{
		...
		rt.ArrayItem{ key: 'refunded_payment', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('If the payment was refunded via the API.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'line_items', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Refunded line items. This can include products, fees, and shipping lines, combined into a single array.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'array' },
			rt.ArrayItem{
			...
			rt.ArrayItem{ key: 'items', val: rt.create_array([
				...
				rt.ArrayItem{ key: 'properties', val: rt.create_array([
					rt.ArrayItem{ key: 'id', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('ID of the refund line item. This is not the ID of the original line item.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'integer' },
						rt.ArrayItem{
					...
					rt.ArrayItem{ key: 'line_item_id', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('ID of the original line item.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'integer' },
						rt.ArrayItem{
					...
					rt.ArrayItem{ key: 'quantity', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('Quantity refunded.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'integer' },
						rt.ArrayItem{
					...
					rt.ArrayItem{ key: 'refund_total', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('Total refunded for this item.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'number' },
						rt.ArrayItem{
					...
					rt.ArrayItem{ key: 'refund_tax', val: rt.create_array([
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string("Optional: Taxes refunded for this item. If not provided, tax will be automatically extracted from refund_total using the order's tax rates."),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'type', val: 'array' },
						rt.ArrayItem{
							...
							rt.ArrayItem{ key: 'properties', val: rt.create_array([
								rt.ArrayItem{ key: 'id', val: rt.create_array([
									...
									rt.ArrayItem{
										...
										val: 'rest_validate_request_arg'
									},
								]) },
								rt.ArrayItem{ key: 'refund_total', val: rt.create_array([
									rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
										rt.new_string('Amount refunded for this tax.'),
										rt.new_string('woocommerce'),
									]) },
									rt.ArrayItem{ key: 'type', val: 'number' },
									rt.ArrayItem{
	...
	if rt.is_true(this.cogs_is_enabled()) {
		var_schema =
			this.add_cogs_related_schema(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_array](var_schema))
	}
...
fn Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_RefundSchema.add_cogs_related_schema(mut var_schema Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_array) rt.PhpVal {
	...
	var_schema_mutated.array_set('cost_of_goods_sold', rt.create_array([
		...
		rt.ArrayItem{ key: 'properties', val: rt.create_array([
			rt.ArrayItem{ key: 'total_value', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('Total value of the Cost of Goods Sold for the refund.'),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'type', val: 'number' },
				rt.ArrayItem{ key: 'readonly', val: true },
	...
	return rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_array',
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_RefundSchema) get_item_response(var_refund rt.PhpVal, mut var_request Class_WP_REST_Request, mut var_include_fields Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_array) rt.PhpVal {
	...
	mut var_data := rt.create_array([
		...
		rt.ArrayItem{ key: 'order_id', val: rt.call_method(var_refund, 'get_parent_id',
			[]rt.PhpVal{}) },
		...
		rt.ArrayItem{ key: 'currency_symbol', val: rt.call_function('html_entity_decode', [
			rt.call_function('get_woocommerce_currency_symbol', [
				rt.call_method(var_refund, 'get_currency', []rt.PhpVal{}),
			]),
		...
		rt.ArrayItem{ key: 'refunded_payment', val: rt.call_method(var_refund,
			'get_refunded_payment', []rt.PhpVal{}) },
	])
	if rt.is_true(rt.call_function('in_array', [rt.new_string('refunded_by'), var_include_fields,
		rt.new_bool(true)]))
	{
		mut var_refunded_user := create_automattic_woocommerce_internal_restapi_routes_v4_refunds_schema_wp_user(rt.call_method(var_refund,
			'get_refunded_by', []rt.PhpVal{}))
		if rt.is_true(var_refunded_user.exists()) {
			var_data.array_set('refunded_by', rt.create_array([
				rt.ArrayItem{ key: 'id', val: rt.get_property(var_refunded_user, 'ID') },
				rt.ArrayItem{ key: 'display_name', val: rt.get_property(var_refunded_user,
					'display_name') },
				rt.ArrayItem{ key: 'avatar_url', val: rt.call_function('get_avatar_url', [
					var_refunded_user,
				]) },
			]))
		} else {
	...
	if rt.is_true(rt.call_function('in_array', [rt.new_string('line_items'), var_include_fields,
		rt.new_bool(true)]))
	{
		var_data.array_set('line_items', rt.call_function('array_merge', [
			this.get_line_items_response(rt.call_method(var_refund, 'get_items', [
	...
	if rt.is_true(rt.call_function('in_array', [rt.new_string('meta_data'), var_include_fields,
		rt.new_bool(true)]))
	{
		mut var_filtered_meta_data := this.filter_internal_meta_keys(rt.call_method(var_refund,
	...
	if rt.is_true(this.cogs_is_enabled())
		...
		var_data.array_get_mut('cost_of_goods_sold').array_set('total_value', rt.call_method(var_refund,
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_RefundSchema) get_line_items_response(var_line_items rt.PhpVal, mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	for {
		...
		var_line_items_response.array_push(this.prepare_line_item(var_line_item.clone(), mut
			var_request))
	}
	return var_line_items_response.clone()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_RefundSchema) prepare_line_item(var_line_item rt.PhpVal, mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	mut iter_3 := if !(var_taxes.array_get(rt.new_string('total'))).is_null() {
		var_taxes.array_get(rt.new_string('total'))
	} else {
		rt.new_array()
	}.iterator()
	for {
		...
		var_tax_response.array_push(rt.create_array([
			rt.ArrayItem{ key: 'id', val: rt.call_function('absint', [
				var_tax_rate_id.clone()]) },
			rt.ArrayItem{ key: 'refund_total', val: rt.call_function('wc_format_decimal', [
				rt.call_function('abs', [rt.new_float(var_tax.to_f64())]),
				var_dp.clone()]) },
		]))
	}
	return rt.create_array([
		rt.ArrayItem{ key: 'id', val: rt.call_function('absint', [
			rt.call_method(var_line_item, 'get_id', []rt.PhpVal{}),
		]) },
		rt.ArrayItem{ key: 'line_item_id', val: rt.call_function('absint', [
			rt.call_method(var_line_item, 'get_meta', [
				rt.new_string('_refunded_item_id'),
			]),
		]) },
		rt.ArrayItem{ key: 'quantity', val: rt.call_function('wc_stock_amount', [
			rt.call_function('abs', [
				rt.new_float((rt.call_method(var_line_item, 'get_quantity', []rt.PhpVal{})).to_f64()),
			]),
		]) },
		rt.ArrayItem{ key: 'refund_total', val: rt.call_function('wc_format_decimal', [
			rt.call_function('abs', [
				rt.new_float((rt.call_method(var_line_item, 'get_total', []rt.PhpVal{})).to_f64()),
			]),
			var_dp.clone(),
		]) },
		rt.ArrayItem{ key: 'refund_tax', val: var_tax_response },
	])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_RefundSchema) filter_internal_meta_keys(var_meta_data rt.PhpVal) rt.PhpVal {
	...
	mut var_cpt_hidden_keys := rt.call_method(create_automattic_woocommerce_internal_restapi_routes_v4_refunds_schema_wc_order_data_store_cpt(),
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_refunds_schema_refundschema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_RefundSchema {
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_refunds_schema_wp_user(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_WP_User {
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_refunds_schema_wc_order_data_store_cpt(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_WC_Order_Data_Store_CPT {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_RefundSchema) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'init' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
			mut dispatch_arg_2 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderTaxSchema](if args.len > 2 {
				args[2]
			} else {
				rt.new_null()
			})
			mut dispatch_arg_3 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderShippingSchema](if args.len > 3 {
				args[3]
			} else {
				rt.new_null()
			})
		...
		'add_cogs_related_schema' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_array](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'get_item_response' {
			...
			mut dispatch_arg_2 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Refunds_Schema_array](if args.len > 2 {
				args[2]
			} else {
				rt.new_null()
			})
