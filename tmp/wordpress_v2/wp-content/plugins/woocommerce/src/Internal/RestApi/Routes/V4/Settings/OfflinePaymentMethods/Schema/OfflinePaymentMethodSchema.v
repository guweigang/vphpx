...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_OfflinePaymentMethods_Schema_OfflinePaymentMethodSchema) get_item_schema_properties() rt.PhpVal {
	return rt.create_array([
		rt.ArrayItem{ key: 'id', val: rt.create_array([
			...
			rt.ArrayItem{
				key: 'context'
				val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_OfflinePaymentMethods_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_OfflinePaymentMethods_Schema_OfflinePaymentMethodSchema.view_edit_context()
			},
			rt.ArrayItem{ key: 'readonly', val: true },
		]) },
		rt.ArrayItem{ key: 'title', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Title of the settings group.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{
		...
		rt.ArrayItem{ key: 'description', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Description of the settings group.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{
		...
		rt.ArrayItem{ key: 'values', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Current enabled state for all payment methods.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'groups', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Grouped settings for offline payment methods.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'type', val: 'object' },
			rt.ArrayItem{
			...
			rt.ArrayItem{ key: 'properties', val: rt.create_array([
				rt.ArrayItem{ key: 'payment_methods', val: rt.create_array([
					rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
						rt.new_string('Available offline payment methods.'),
						rt.new_string('woocommerce'),
					]) },
					rt.ArrayItem{ key: 'type', val: 'object' },
					rt.ArrayItem{
					...
					rt.ArrayItem{ key: 'additionalProperties', val: rt.create_array([
						...
						rt.ArrayItem{ key: 'properties', val: rt.create_array([
							rt.ArrayItem{ key: 'id', val: rt.create_array([
								rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
									rt.new_string('Unique identifier for the payment method.'),
									rt.new_string('woocommerce'),
								]) },
								rt.ArrayItem{ key: 'type', val: 'string' },
								rt.ArrayItem{
							...
							rt.ArrayItem{ key: '_order', val: rt.create_array([
								rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
									rt.new_string('Sort order for the payment method.'),
									rt.new_string('woocommerce'),
								]) },
							...
							rt.ArrayItem{ key: 'title', val: rt.create_array([
								rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
									rt.new_string('Title of the payment method.'),
									rt.new_string('woocommerce'),
								]) },
								rt.ArrayItem{ key: 'type', val: 'string' },
								rt.ArrayItem{
							...
							rt.ArrayItem{ key: 'description', val: rt.create_array([
								rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
									rt.new_string('Description of the payment method.'),
									rt.new_string('woocommerce'),
								]) },
								rt.ArrayItem{ key: 'type', val: 'string' },
								rt.ArrayItem{
							...
							rt.ArrayItem{ key: 'icon', val: rt.create_array([
								rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
									rt.new_string('Icon URL for the payment method.'),
									rt.new_string('woocommerce'),
								]) },
								rt.ArrayItem{ key: 'type', val: 'string' },
							...
							rt.ArrayItem{ key: 'state', val: rt.create_array([
								rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
									rt.new_string('Current state configuration of the payment method.'),
									rt.new_string('woocommerce'),
								]) },
								rt.ArrayItem{ key: 'type', val: 'object' },
								rt.ArrayItem{
							...
							rt.ArrayItem{ key: 'management', val: rt.create_array([
								rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
									rt.new_string('Management options for the payment method.'),
									rt.new_string('woocommerce'),
								]) },
								rt.ArrayItem{ key: 'type', val: 'object' },
								rt.ArrayItem{
								...
								rt.ArrayItem{ key: 'properties', val: rt.create_array([
									rt.ArrayItem{ key: '_links', val: rt.create_array([
										rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
											rt.new_string('Management links for the payment method.'),
											rt.new_string('woocommerce'),
										]) },
										rt.ArrayItem{ key: 'type', val: 'object' },
										rt.ArrayItem{
										...
										rt.ArrayItem{ key: 'additionalProperties', val: rt.create_array([
											...
											rt.ArrayItem{ key: 'properties', val: rt.create_array([
												rt.ArrayItem{ key: 'href', val: rt.create_array([
													rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
														rt.new_string('URL for the management link.'),
														rt.new_string('woocommerce'),
													]) },
													rt.ArrayItem{ key: 'type', val: 'string' },
													rt.ArrayItem{ key: 'format', val: 'uri' },
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_settings_offlinepaymentmethods_schema_offlinepaymentmethodschema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_OfflinePaymentMethods_Schema_OfflinePaymentMethodSchema {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_OfflinePaymentMethods_Schema_OfflinePaymentMethodSchema) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'get_item_response' {
			...
			mut dispatch_arg_2 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_OfflinePaymentMethods_Schema_array](if args.len > 2 {
				args[2]
			} else {
				rt.new_null()
			})
