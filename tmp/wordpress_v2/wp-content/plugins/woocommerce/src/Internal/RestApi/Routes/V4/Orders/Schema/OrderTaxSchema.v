...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderTaxSchema) get_item_schema_properties() rt.PhpVal {
	mut var_schema := rt.create_array([
		rt.ArrayItem{ key: 'id', val: rt.create_array([
			...
			rt.ArrayItem{
				key: 'context'
				val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderTaxSchema.view_edit_embed_context()
			},
			rt.ArrayItem{ key: 'readonly', val: true },
		]) },
		rt.ArrayItem{ key: 'rate_code', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
		...
		rt.ArrayItem{ key: 'compound', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
		...
		rt.ArrayItem{ key: 'tax_total', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
		...
		rt.ArrayItem{ key: 'shipping_tax_total', val: rt.create_array([
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderTaxSchema) get_item_response(var_order_item rt.PhpVal, mut var_request Class_WP_REST_Request, mut var_include_fields Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_array) rt.PhpVal {
	...
	mut var_data := rt.create_array([
		...
		rt.ArrayItem{ key: 'rate_code', val: rt.call_method(var_order_item, 'get_rate_code',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'rate_id', val: rt.call_method(var_order_item, 'get_rate_id',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'label', val: rt.call_method(var_order_item, 'get_label', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'compound', val: rt.call_method(var_order_item, 'get_compound',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'tax_total', val: rt.call_function('wc_format_decimal', [
			rt.call_method(var_order_item, 'get_tax_total', []rt.PhpVal{}),
			var_dp.clone(),
		]) },
		rt.ArrayItem{ key: 'shipping_tax_total', val: rt.call_function('wc_format_decimal', [
			rt.call_method(var_order_item, 'get_shipping_tax_total', []rt.PhpVal{}),
			var_dp.clone(),
		]) },
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_orders_schema_ordertaxschema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderTaxSchema {
