...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) enable(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) rt.PhpVal {
	return rt.new_int(this.invoke('enable_core', mut var_args, mut var_assoc_args))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) enable_core(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_assoc_args.array_isset(rt.new_string('force'))))))) {
		mut var_must_confirm := rt.new_bool(true)
		...
		} else if rt.is_true(rt.identical(rt.new_int(0), this.get_lookup_table_info().array_get(rt.new_string('total_rows')))) {
			this.warning("The %W${var_table_name.to_string()}%n table is empty.")
		} else {
		var_must_confirm = rt.new_bool(false)
		}
		if rt.is_true(var_must_confirm) {
		mut iife_temp_0 := Class_WP_CLI{}
		mut iife_result_0 := iife_temp_0.confirm(rt.new_string('Are you sure that you want to enable the table usage?'))
		}
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) disable(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) rt.PhpVal {
	return rt.new_int(this.invoke('disable_core', mut var_args, mut var_assoc_args))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) disable_core(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) {
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.new_string('yes'), rt.call_function('get_option', [rt.new_string('woocommerce_attribute_lookup_enabled')]))))) {
		mut var_table_name := rt.call_method(this.lookup_data_store, 'get_lookup_table_name', []rt.PhpVal{})
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) regenerate_for_product(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) rt.PhpVal {
	return rt.new_int(this.invoke('regenerate_for_product_core', mut var_args, mut var_assoc_args))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) regenerate_for_product_core(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) {
	...
	rt.call_method(this.data_regenerator, 'check_can_do_lookup_table_regeneration', [var_product_id.clone()])
	mut var_use_db_optimization := rt.new_bool(!(rt.is_true(rt.new_bool(var_assoc_args.array_isset(rt.new_string('disable-db-optimization'))))))
	...
	rt.call_method(this.lookup_data_store, 'create_data_for_product', [var_product_id.clone(), var_use_db_optimization.clone()])
	...
	mut iife_result_1 := iife_temp_1.success(rt.call_function('sprintf', [rt.new_string('Attributes lookup data for product %d regenerated in %f seconds.'), var_product_id.clone(), var_total_time.clone()]))
	}
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) check_can_use_db_optimization(use_db_optimization bool) {
	...
	if rt.is_true(rt.new_bool(use_db_optimization_mutated)) && rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(this.lookup_data_store, 'can_use_optimized_db_access', []rt.PhpVal{}))))) {
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) info(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) rt.PhpVal {
	return rt.new_int(this.invoke('info_core', mut var_args, mut var_assoc_args))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) info_core(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) {
	...
	this.log(rt.concat(rt.concat(rt.concat(rt.concat(rt.new_string('The table contains %C'), var_info.array_get(rt.new_string('total_rows'))), rt.new_string('%n rows corresponding to %G')), var_info.array_get(rt.new_string('products_count'))), rt.new_string('%n products.')))
	if rt.is_true(rt.greater(var_info.array_get(rt.new_string('total_rows')), rt.new_int(0))) {
		mut var_highest_product_id_in_table := rt.call_method(var_wpdb, 'get_var', [rt.new_string('select max(product_or_parent_id) from ' + (var_table_name).str())])
	...
	if rt.is_true(rt.call_method(this.lookup_data_store, 'regeneration_is_in_progress', []rt.PhpVal{})) {
		...
		mut iife_result_3 := iife_temp_3.log(rt.new_string(''))
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) abort_regeneration(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) rt.PhpVal {
	return rt.new_int(this.invoke('abort_regeneration_core', mut var_args, mut var_assoc_args))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) resume_regeneration(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) rt.PhpVal {
	return rt.new_int(this.invoke('resume_regeneration_core', mut var_args, mut var_assoc_args))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) cleanup_regeneration_progress(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) rt.PhpVal {
	return rt.new_int(this.invoke('cleanup_regeneration_progress_core', mut var_args, mut var_assoc_args))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) initiate_regeneration(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) rt.PhpVal {
	return rt.new_int(this.invoke('initiate_regeneration_core', mut var_args, mut var_assoc_args))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) initiate_regeneration_core(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) {
	...
	mut var_info := this.get_lookup_table_info()
	if rt.is_true(rt.greater(var_info.array_get(rt.new_string('total_rows')), rt.new_int(0))) && rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_assoc_args.array_isset(rt.new_string('force'))))))) {
		mut var_table_name := rt.call_method(this.lookup_data_store, 'get_lookup_table_name', []rt.PhpVal{})
		this.warning(rt.concat(rt.concat(rt.concat(rt.concat(rt.concat(rt.concat(rt.new_string('The %W'), var_table_name), rt.new_string('%n table contains %C')), var_info.array_get(rt.new_string('total_rows'))), rt.new_string('%n rows corresponding to %G')), var_info.array_get(rt.new_string('products_count'))), rt.new_string('%n products.')))
	mut iife_temp_4 := Class_WP_CLI{}
	mut iife_result_4 := iife_temp_4.confirm(rt.new_string('Initiating the regeneration will first delete the data. Are you sure?'))
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) regenerate(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) rt.PhpVal {
	return rt.new_int(this.invoke('regenerate_core', mut var_args, mut var_assoc_args))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) regenerate_core(mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) i64 {
	mut var_wpdb := rt.new_null()
	mut var_table_name := rt.call_method(this.lookup_data_store, 'get_lookup_table_name', []rt.PhpVal{})
	mut var_batch_size := if !(var_assoc_args.array_get(rt.new_string('batch-size'))).is_null() { var_assoc_args.array_get(rt.new_string('batch-size')) } else { Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_DataRegenerator.products_per_generation_step() }
	if !(var_batch_size.clone().is_long() || var_batch_size.clone().is_double()) || rt.is_true(rt.less(var_batch_size, rt.new_int(1))) {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(this.lookup_data_store, 'regeneration_is_in_progress', []rt.PhpVal{}))))) || rt.is_true(rt.new_bool(var_assoc_args.array_isset(rt.new_string('from-scratch')))) {
		mut var_info := this.get_lookup_table_info()
		if rt.is_true(rt.greater(var_info.array_get(rt.new_string('total_rows')), rt.new_int(0))) && rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_assoc_args.array_isset(rt.new_string('force'))))))) {
			this.warning(rt.concat(rt.concat(rt.concat(rt.concat(rt.concat(rt.concat(rt.new_string('The %W'), var_table_name), rt.new_string('%n table contains %C')), var_info.array_get(rt.new_string('total_rows'))), rt.new_string('%n rows corresponding to %G')), var_info.array_get(rt.new_string('products_count'))), rt.new_string('%n products.')))
		mut iife_temp_5 := Class_WP_CLI{}
		mut iife_result_5 := iife_temp_5.confirm(rt.new_string('Triggering the regeneration will first delete the data. Are you sure?'))
		}
		rt.call_method(this.data_regenerator, 'finalize_regeneration', [rt.new_bool(false)])
		...
		if rt.is_true(rt.identical(rt.new_int(0), var_last_product_id)) {
			rt.call_method(this.data_regenerator, 'finalize_regeneration', [var_was_enabled.clone()])
			mut iife_temp_6 := Class_WP_CLI{}
			mut iife_result_6 := iife_temp_6.log(rt.new_string('No products exist in the database, the table is left empty.'))
			return 0
		}
	mut var_processed_count := rt.new_int(0)
	} else {
		var_last_product_id = rt.call_function('get_option', [rt.new_string('woocommerce_attribute_lookup_last_product_id_to_process')])
		if rt.is_true(rt.identical(rt.new_bool(false), var_last_product_id)) {
			mut iife_temp_7 := Class_WP_CLI{}
			mut iife_result_7 := iife_temp_7.error(rt.new_string('Regeneration seems to be already in progress, but the woocommerce_attribute_lookup_last_product_id_to_process option isn\'t there. Try %9wp cli palt cleanup_regeneration_progress%n first." );'))
			return 1
		}
		var_processed_count = rt.call_function('get_option', [rt.new_string('woocommerce_attribute_lookup_processed_count'), rt.new_int(0)])
		this.log("Resuming regeneration, %C${var_processed_count.to_string()}%n products have been processed already")
		rt.call_method(this.lookup_data_store, 'set_regeneration_in_progress_flag', []rt.PhpVal{})
	}
	rt.call_method(this.data_regenerator, 'cancel_regeneration_scheduled_action', []rt.PhpVal{})
	mut var_use_db_optimization := rt.new_bool(!(rt.is_true(rt.new_bool(var_assoc_args.array_isset(rt.new_string('disable-db-optimization'))))))
	this.check_can_use_db_optimization((var_use_db_optimization).to_bool())
	mut var_progress := rt.call_function('WP_CLI\Utils\make_progress_bar', [rt.new_string(''), var_products_count.clone()])
	this.log("Regenerating %W${var_table_name.to_string()}%n...")
	rt.call_method(var_progress, 'tick', [var_processed_count.clone()])
	mut var_regeneration_step_failed := rt.new_bool(false)
	for rt.is_true(rt.call_method(this.data_regenerator, 'do_regeneration_step', [var_batch_size.clone(), var_use_db_optimization.clone()])) {
		rt.call_method(var_progress, 'tick', [var_batch_size.clone()])
	var_regeneration_step_failed = rt.new_bool(rt.is_true(var_regeneration_step_failed) || rt.is_true(rt.call_method(this.data_regenerator, 'get_last_regeneration_step_failed', []rt.PhpVal{})))
	}
	rt.call_method(this.data_regenerator, 'finalize_regeneration', [var_was_enabled.clone()])
	mut var_time := rt.call_method(var_progress, 'formatTime', [rt.call_method(var_progress, 'elapsed', []rt.PhpVal{})])
	rt.call_method(var_progress, 'finish', []rt.PhpVal{})
	if rt.is_true(var_regeneration_step_failed) {
		this.warning('Lookup data regeneration failed for at least one product.\nSee the WooCommerce logs (source is %9palt-updates%n) for details.\n')
		this.log("Table %W${var_table_name.to_string()}%n regenerated in ${var_time.to_string()}.")
	} else {
		this.log("%GSuccess:%n Table %W${var_table_name.to_string()}%n regenerated in ${var_time.to_string()}.")
	}
	var_info = this.get_lookup_table_info()
	this.log(rt.concat(rt.concat(rt.concat(rt.concat(rt.new_string('The table contains now %C'), var_info.array_get(rt.new_string('total_rows'))), rt.new_string('%n rows corresponding to %G')), var_info.array_get(rt.new_string('products_count'))), rt.new_string('%n products.')))
	return i64(0)
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) get_lookup_table_info() rt.PhpVal {
	mut var_wpdb := rt.new_null()
	mut var_table_name := rt.call_method(this.lookup_data_store, 'get_lookup_table_name', []rt.PhpVal{})
	mut var_info := rt.call_method(var_wpdb, 'get_row', [rt.new_string('select count(1), count(distinct(product_or_parent_id)) from ' + (var_table_name).str()), rt.get_constant('ARRAY_N')])
	return rt.create_array([rt.ArrayItem{ key: 'total_rows', val: rt.call_function('absint', [var_info.array_get(rt.new_int(0))]) }, rt.ArrayItem{ key: 'products_count', val: rt.call_function('absint', [var_info.array_get(rt.new_int(1))]) }])
}

fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) invoke(method_name string, mut var_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array, mut var_assoc_args Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_array) i64 {
	return (rt.call_function('call_user_func', [rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner', []string{}, &this) }, rt.ArrayItem{ key: none, val: method_name }]), var_args, var_assoc_args])).to_i64()
...
catch_label_1:
	...
	if rt.instance_of(var_e_1, 'Automattic_WooCommerce_Internal_ProductAttributesLookup_Exception') {
		...
		mut iife_result_8 := iife_temp_8.error(rt.call_method(var_e, 'getMessage', []rt.PhpVal{}))
		return 1
		unsafe { goto end_label_1 }
	}
	else {
...
mut iife_result_9 := iife_temp_9.colorize(rt.new_string(text))
mut iife_temp_10 := Class_WP_CLI{}
mut iife_result_10 := iife_temp_10.log(iife_result_9)
}
...
mut iife_result_11 := iife_temp_11.colorize(rt.new_string(text))
mut iife_temp_12 := Class_WP_CLI{}
mut iife_result_12 := iife_temp_12.warning(iife_result_11)
}
...
mut iife_result_13 := iife_temp_13.colorize(rt.new_string(text))
mut iife_temp_14 := Class_WP_CLI{}
mut iife_result_14 := iife_temp_14.success(iife_result_13)
}
...
mut iife_result_15 := iife_temp_15.colorize(rt.new_string(text))
mut iife_temp_16 := Class_WP_CLI{}
mut iife_result_16 := iife_temp_16.error(iife_result_15)
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductAttributesLookup_CLIRunner) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'invoke' {
			...
			return rt.new_int(this.invoke(dispatch_arg_0, mut dispatch_arg_1, mut dispatch_arg_2))
		}
		'log' {
			dispatch_arg_0 := (if args.len > 0 { args[0] } else { rt.new_null() }).str()
