...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_PersonalizationTagManager) construct() {
	this.customer_tags_provider =
		create_automattic_woocommerce_internal_emaileditor_personalizationtags_customertagsprovider()
	this.order_tags_provider =
		create_automattic_woocommerce_internal_emaileditor_personalizationtags_ordertagsprovider()
	this.site_tags_provider =
		create_automattic_woocommerce_internal_emaileditor_personalizationtags_sitetagsprovider()
	this.store_tags_provider =
		create_automattic_woocommerce_internal_emaileditor_personalizationtags_storetagsprovider()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_PersonalizationTagManager) init() {
	rt.call_function('add_filter', [
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_PersonalizationTagManager',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'register_personalization_tags' },
		]),
	])
}
...
fn create_automattic_woocommerce_internal_emaileditor_personalizationtags_storetagsprovider(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_EmailEditor_PersonalizationTags_StoreTagsProvider {
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_PersonalizationTagManager) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'customer_tags_provider' {
			this.customer_tags_provider = val
			return true
		}
		'order_tags_provider' {
			this.order_tags_provider = val
			return true
		}
		'site_tags_provider' {
			this.site_tags_provider = val
			return true
		}
		'store_tags_provider' {
			this.store_tags_provider = val
			return true
		}
		else {
