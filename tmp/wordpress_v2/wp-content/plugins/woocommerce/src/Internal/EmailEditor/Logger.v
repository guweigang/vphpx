...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Logger) should_handle(level string) bool {
	...
	mut iife_result_0 := iife_temp_0.get_level_severity(var_logging_threshold.clone())
	mut iife_temp_1 := Class_WC_Log_Levels{}
	mut iife_result_1 := iife_temp_1.get_level_severity(rt.new_string(level))
	return (rt.less_equal(iife_result_0, iife_result_1)).to_bool()
}
