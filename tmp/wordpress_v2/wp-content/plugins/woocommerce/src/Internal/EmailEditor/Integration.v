...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) construct() {
	...
	this.dependency_check = rt.call_method(var_editor_container, 'get', [
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) init() {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(this.dependency_check,
		'are_dependencies_met', []rt.PhpVal{})))))
	{
		return
	}
	rt.call_function('add_action', [rt.new_string('woocommerce_init'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
	...
	rt.call_function('add_action', [rt.new_string('before_delete_post'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'delete_email_template_associated_with_email_editor_post' },
		]),
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) init_logger() {
	mut iife_temp_1 := Class_Automattic_WooCommerce_EmailEditor_Email_Editor_Container{}
	mut iife_result_1 := iife_temp_1.container()
	mut var_editor_container := iife_result_1
	mut var_logger := rt.call_method(var_editor_container, 'get', [
		Class_Automattic_WooCommerce_EmailEditor_Engine_Logger_Email_Editor_Logger.class(),
	])
	rt.call_method(var_logger, 'set_logger', [
		create_automattic_woocommerce_internal_emaileditor_logger(rt.call_function('wc_get_logger',
			[]rt.PhpVal{})),
	])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) init_hooks() {
	...
	rt.call_method(var_container, 'get', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_EmailPatterns_PatternsController.class(),
	])
	rt.call_method(var_container, 'get', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_EmailTemplates_TemplatesController.class(),
	])
	rt.call_method(var_container, 'get', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_PersonalizationTagManager.class(),
	])
	rt.call_method(var_container, 'get', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_BlockEmailRenderer.class(),
	])
	rt.call_method(var_container, 'get', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_WCTransactionalEmails_WCTransactionalEmails.class(),
	])
	this.editor_page_renderer = rt.call_method(var_container, 'get', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_PageRenderer.class(),
	])
	this.template_api_controller = rt.call_method(var_container, 'get', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_EmailTemplates_TemplateApiController.class(),
	])
	this.email_api_controller = rt.call_method(var_container, 'get', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_EmailApiController.class(),
	])
	mut iife_temp_2 := Class_Automattic_WooCommerce_Internal_EmailEditor_WC_Emails{}
	mut iife_result_2 := iife_temp_2.instance()
	mut var_registered_emails := rt.call_method(iife_result_2, 'get_emails', []rt.PhpVal{})
	if var_registered_emails.array_isset(rt.new_string('WC_Email_New_Order')) {
		this.wc_email_instance =
			var_registered_emails.array_get(rt.new_string('WC_Email_New_Order'))
	} else {
		mut var_first_email_key := rt.call_function('array_key_first', [
			var_registered_emails.clone()])
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) register_hooks() {
	rt.call_function('add_filter', [rt.new_string('woocommerce_email_editor_post_types'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'add_email_post_type' },
		])])
	rt.call_function('add_filter', [rt.new_string('woocommerce_is_email_editor_page'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'is_editor_page' },
		]),
		rt.new_int(10), rt.new_int(1)])
	rt.call_function('add_filter', [rt.new_string('replace_editor'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'replace_editor' },
		]),
		rt.new_int(10), rt.new_int(2)])
	rt.call_function('add_filter', [
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'update_send_preview_email_rendered_data' },
		]),
		rt.new_int(10),
		rt.new_int(2),
	])
	rt.call_function('add_filter', [
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'update_send_preview_email_personalizer_context' },
		]),
	])
	rt.call_function('add_filter', [
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'update_preview_post_template_html_data' },
		]),
		rt.new_int(100),
		rt.new_int(1),
	])
	rt.call_function('add_action', [
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'send_preview_email_before_wp_mail' },
		]),
		rt.new_int(10),
	])
	rt.call_function('add_action', [
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'send_preview_email_after_wp_mail' },
		]),
		rt.new_int(10),
	])
	rt.call_function('add_filter', [
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_Integration',
				[]string{}, &this) },
			rt.ArrayItem{ key: none, val: 'update_email_subject_for_send_preview_email' },
		]),
		rt.new_int(10),
		rt.new_int(2),
	])
	rt.call_function('add_action', [rt.new_string('rest_api_init'),
		rt.create_array([rt.ArrayItem{ key: none, val: this.email_api_controller },
			rt.ArrayItem{ key: none, val: 'register_routes' }])])
	rt.call_function('add_action', [rt.new_string('woocommerce_updated'),
		rt.create_array([
			rt.ArrayItem{
				key: none
				val: Class_Automattic_WooCommerce_Internal_EmailEditor_WCTransactionalEmails_WCEmailTemplateDivergenceDetector.class()
			},
			rt.ArrayItem{ key: none, val: 'run_sweep' },
		]),
		rt.new_int(20)])
	rt.call_function('add_action', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_WCTransactionalEmails_WCEmailTemplateSyncBackfill.backfill_complete_action(),
		rt.create_array([
			rt.ArrayItem{
				key: none
				val: Class_Automattic_WooCommerce_Internal_EmailEditor_WCTransactionalEmails_WCEmailTemplateDivergenceDetector.class()
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) add_email_post_type(mut var_post_types Class_Automattic_WooCommerce_Internal_EmailEditor_array) rt.PhpVal {
	...
	var_post_types_mutated.array_push(rt.create_array([
		rt.ArrayItem{
			key: 'name'
			val: Class_Automattic_WooCommerce_Internal_EmailEditor_Automattic_WooCommerce_Internal_EmailEditor_Integration.email_post_type()
		},
		rt.ArrayItem{ key: 'args', val: rt.create_array([
			rt.ArrayItem{ key: 'labels', val: rt.create_array([
				rt.ArrayItem{ key: 'name', val: rt.call_function('__', [
					rt.new_string('Emails'),
			...
			rt.ArrayItem{ key: 'capabilities', val: rt.create_array([
				rt.ArrayItem{ key: 'edit_post', val: 'manage_woocommerce' },
				rt.ArrayItem{ key: 'read_post', val: 'manage_woocommerce' },
				rt.ArrayItem{ key: 'delete_post', val: 'manage_woocommerce' },
				rt.ArrayItem{ key: 'edit_posts', val: 'manage_woocommerce' },
				rt.ArrayItem{ key: 'edit_others_posts', val: 'manage_woocommerce' },
				rt.ArrayItem{ key: 'delete_posts', val: 'manage_woocommerce' },
				rt.ArrayItem{ key: 'publish_posts', val: 'manage_woocommerce' },
				rt.ArrayItem{ key: 'read_private_posts', val: 'manage_woocommerce' },
				rt.ArrayItem{ key: 'create_posts', val: 'manage_woocommerce' },
			]) },
			rt.ArrayItem{ key: 'map_meta_cap', val: false },
		]) },
	]))
	return rt.new_object('Automattic_WooCommerce_Internal_EmailEditor_array', []string{},
		var_post_types_mutated)
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) is_editor_page(is_editor_page bool) bool {
	...
	if rt.is_true(rt.call_function('is_admin', []rt.PhpVal{}))
		&& rt.get_superglobal('_GET').array_isset(rt.new_string('post'))
		...
		return rt.is_true(var_post)
			&& rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_EmailEditor_Automattic_WooCommerce_Internal_EmailEditor_Integration.email_post_type(), rt.get_property(var_post, 'post_type')))
	}
	return false
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) replace_editor(var_replace rt.PhpVal, var_post rt.PhpVal) bool {
	...
	if rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_EmailEditor_Automattic_WooCommerce_Internal_EmailEditor_Integration.email_post_type(), rt.get_property(var_post_mutated, 'post_type')))
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) delete_email_template_associated_with_email_editor_post(var_post_id rt.PhpVal, var_post rt.PhpVal) {
	...
	mut var_post_mutated := var_post
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_EmailEditor_Automattic_WooCommerce_Internal_EmailEditor_Integration.email_post_type(), rt.get_property(var_post_mutated,
		'post_type')))))
	{
		return
	}
	...
	mut var_post_manager := iife_result_3
	mut var_email_type := rt.call_method(var_post_manager, 'get_email_type_from_post_id', [
	...
	rt.call_method(var_post_manager, 'delete_email_template', [
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) extend_template_post_api() {
	rt.call_function('register_rest_field', [rt.new_string('wp_template'),
		rt.new_string('woocommerce_data'),
		rt.create_array([
			...
			rt.ArrayItem{ key: 'update_callback', val: rt.create_array([
				rt.ArrayItem{ key: none, val: this.template_api_controller },
				rt.ArrayItem{ key: none, val: 'save_template_data' },
			]) },
			rt.ArrayItem{ key: 'schema', val: rt.call_method(this.template_api_controller,
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) update_email_preview_data(var_data rt.PhpVal, email_type string, post_id i64) rt.PhpVal {
	...
	if !(post_id_mutated == 0) {
		...
		var_type_param = rt.call_method(iife_result_4, 'get_email_type_class_name_from_post_id', [
			rt.new_int(post_id_mutated).clone(),
		])
	} else if !(email_type_mutated == '') {
		mut iife_temp_5 :=
			Class_Automattic_WooCommerce_Internal_EmailEditor_WCTransactionalEmails_WCTransactionalEmailPostsManager{}
		mut iife_result_5 := iife_temp_5.get_instance()
		var_type_param = rt.call_method(iife_result_5, 'get_email_type_class_name_from_email_id', [
			rt.new_string(email_type_mutated).clone(),
		])
	}
	...
	mut var_message := rt.call_method(var_email_preview, 'generate_placeholder_content', [
	...
	if rt.instance_of(var_e_1,
		'Automattic_WooCommerce_Internal_EmailEditor_InvalidArgumentException')
	{
		mut var_e := var_e_1.clone()
		var_message = rt.call_method(var_email_preview, 'generate_placeholder_content', [
			Class_Automattic_WooCommerce_Internal_Admin_EmailPreview_EmailPreview.default_email_type(),
		])
		if rt.has_exception() {
			unsafe {
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) update_send_preview_email_rendered_data(var_data rt.PhpVal, var_post rt.PhpVal) rt.PhpVal {
	mut var_post_mutated := var_post
	mut var_email_type := rt.new_string('')
	mut var_post_body := rt.call_function('file_get_contents', [
		rt.new_string('php://input'),
	])
	if rt.is_true(var_post_body) {
		mut var_decoded_body := rt.call_function('json_decode', [
			var_post_body.clone()])
		if rt.is_true(rt.identical(rt.call_function('json_last_error', []rt.PhpVal{}), rt.get_constant('JSON_ERROR_NONE')))
			&& !(rt.get_property(var_decoded_body, 'postId')).is_null() {
			mut var_post_id := rt.call_function('absint', [
				rt.get_property(var_decoded_body, 'postId'),
			])
			mut iife_temp_6 :=
				Class_Automattic_WooCommerce_Internal_EmailEditor_WCTransactionalEmails_WCTransactionalEmailPostsManager{}
			mut iife_result_6 := iife_temp_6.get_instance()
			var_email_type = rt.call_method(iife_result_6, 'get_email_type_from_post_id', [
				var_post_id.clone(),
			])
			if !(!rt.is_true(var_email_type)) {
				return this.update_email_preview_data(var_data.clone(), var_email_type.str(), 0)
			}
		}
	} else if !(!rt.is_true(var_post_mutated))
		&& rt.is_true(rt.new_bool(rt.instance_of(var_post_mutated, 'WP_Post'))) {
		mut iife_temp_7 :=
			Class_Automattic_WooCommerce_Internal_EmailEditor_WCTransactionalEmails_WCTransactionalEmailPostsManager{}
		mut iife_result_7 := iife_temp_7.get_instance()
		var_email_type = rt.call_method(iife_result_7, 'get_email_type_from_post_id', [
			rt.get_property(var_post_mutated, 'ID'),
		])
		if !(!rt.is_true(var_email_type)) {
			return this.update_email_preview_data(var_data.clone(), var_email_type.str(), (rt.get_property(var_post_mutated,
				'ID')).to_i64())
		}
	}
	return var_data.clone()
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) update_send_preview_email_personalizer_context(var_context rt.PhpVal) rt.PhpVal {
	...
	mut var_post_manager := iife_result_8
	mut var_email_id := rt.call_method(var_post_manager, 'get_email_type_from_post_id', [
		rt.call_function('get_the_ID', []rt.PhpVal{}),
	])
	mut var_email_type := if rt.is_true(var_email_id) {
		rt.call_method(var_post_manager, 'get_email_type_class_name_from_email_id', [
			var_email_id.clone(),
		])
	} else {
		Class_Automattic_WooCommerce_Internal_Admin_EmailPreview_EmailPreview.default_email_type()
	...
	rt.call_method(var_email_preview, 'set_email_type', [var_email_type.clone()])
	if rt.has_exception() {
		unsafe {
			goto catch_label_3
		}
	...
	end_label_3:
	mut var_email := rt.call_method(var_email_preview, 'get_email', []rt.PhpVal{})
	rt.set_property(var_email, 'recipient', if !(var_context.array_get(rt.new_string('recipient_email'))).is_null() {
		var_context.array_get(rt.new_string('recipient_email'))
	} else {
		rt.new_string('')
	})
	mut var_personalizer := rt.call_method(rt.call_function('wc_get_container', []rt.PhpVal{}),
		'get', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_TransactionalEmailPersonalizer.class(),
	])
	return rt.call_method(var_personalizer, 'prepare_context_data', [
		var_context.clone(), var_email.clone()])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) update_preview_post_template_html_data(var_data rt.PhpVal) rt.PhpVal {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('str_contains', [
		rt.new_string(var_data.str()),
		Class_Automattic_WooCommerce_Internal_EmailEditor_BlockEmailRenderer.woo_email_content_placeholder(),
	])))))
	{
		return var_data.clone()
	}
	mut var_type_param := if rt.get_superglobal('_GET').array_isset(rt.new_string('woo_email')) { rt.call_function('sanitize_text_field', [
			rt.call_function('wp_unslash', [rt.get_superglobal('_GET').array_get(rt.new_string('woo_email'))]),
		]) } else { rt.new_string('') }
	mut var_post_id := if rt.get_superglobal('_REQUEST').array_isset(rt.new_string('preview_id')) { rt.call_function('sanitize_text_field', [
			rt.call_function('wp_unslash', [rt.get_superglobal('_REQUEST').array_get(rt.new_string('preview_id'))]),
		]) } else { rt.new_string('') }
	return this.update_email_preview_data(var_data.clone(), var_type_param.str(),
		var_post_id.to_i64())
}

fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) extend_post_api() {
	rt.call_function('register_rest_field', [
		Class_Automattic_WooCommerce_Internal_EmailEditor_Automattic_WooCommerce_Internal_EmailEditor_Integration.email_post_type(),
		rt.new_string('woocommerce_data'),
		rt.create_array([
			rt.ArrayItem{ key: 'get_callback', val: rt.create_array([
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) send_preview_email_before_wp_mail() {
	rt.call_function('add_filter', [rt.new_string('wp_mail_from'),
		rt.create_array([rt.ArrayItem{ key: none, val: this.wc_email_instance },
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) update_email_subject_for_send_preview_email(var_subject rt.PhpVal, var_post rt.PhpVal) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_post_mutated, 'WP_Post'))))))
		|| rt.is_true(rt.new_bool(!rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_EmailEditor_Automattic_WooCommerce_Internal_EmailEditor_Integration.email_post_type(), rt.get_property(var_post_mutated, 'post_type'))))) {
		return var_subject.clone()
	}
	mut iife_temp_9 :=
		Class_Automattic_WooCommerce_Internal_EmailEditor_WCTransactionalEmails_WCTransactionalEmailPostsManager{}
	mut iife_result_9 := iife_temp_9.get_instance()
	mut var_post_manager := iife_result_9
	mut var_email_type_class_name := rt.call_method(var_post_manager,
		'get_email_type_class_name_from_post_id', [
		rt.get_property(var_post_mutated, 'ID'),
	])
	if !rt.is_true(var_email_type_class_name) {
		return var_subject.clone()
	}
	mut var_email_preview := rt.call_method(rt.call_function('wc_get_container', []rt.PhpVal{}),
		'get', [
	...
	rt.call_method(var_email_preview, 'set_email_type', [var_email_type_class_name.clone()])
	if rt.has_exception() {
		unsafe {
			goto catch_label_4
		}
	}
	return rt.call_method(var_email_preview, 'get_subject', []rt.PhpVal{})
	unsafe {
		goto end_label_4
	}
	catch_label_4:
	...
	} else if rt.instance_of(var_e_4, 'Automattic_WooCommerce_Internal_EmailEditor_Throwable') {
		var_e = var_e_4.clone()
		return var_subject.clone()
		unsafe {
			goto end_label_4
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'delete_email_template_associated_with_email_editor_post' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			this.delete_email_template_associated_with_email_editor_post(dispatch_arg_0,
				dispatch_arg_1)
			return rt.new_null()
		}
...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_Integration) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'editor_page_renderer' {
			this.editor_page_renderer = val
			return true
		}
		'dependency_check' {
			this.dependency_check = val
			return true
		}
		'template_api_controller' {
			this.template_api_controller = val
			return true
		}
