...
fn Class_Automattic_WooCommerce_Internal_Abilities_AbilitiesCategories.init() {
	rt.call_function('add_action', [rt.new_string('abilities_api_categories_init'),
...
fn Class_Automattic_WooCommerce_Internal_Abilities_AbilitiesCategories.register_categories() {
	...
	rt.call_function('wp_register_ability_category', [rt.new_string('woocommerce-rest'),
		rt.create_array([
			rt.ArrayItem{ key: 'label', val: rt.call_function('__', [
				rt.new_string('WooCommerce REST API'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('REST API operations for WooCommerce resources including products, orders, and other store data.'),
				rt.new_string('woocommerce'),
			]) },
		])])
}
