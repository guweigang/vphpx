...
fn Class_Automattic_WooCommerce_Internal_Api_Utils.complexity_from_pagination(child_complexity i64, mut var_args Class_Automattic_WooCommerce_Internal_Api_array) i64 {
	...
	mut var_requested := if !(var_args.array_get(rt.new_string('first'))).is_null() {
		var_args.array_get(rt.new_string('first'))
	} else {
		if !(var_args.array_get(rt.new_string('last'))).is_null() {
			var_args.array_get(rt.new_string('last'))
		} else {
			iife_result_0
		}
	}
	mut var_page_size := if var_requested.clone().is_long()
...
fn Class_Automattic_WooCommerce_Internal_Api_Utils.create_pagination_params(mut var_args Class_Automattic_WooCommerce_Internal_Api_array) rt.PhpVal {
	closure_2_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		return create_automattic_woocommerce_internal_api_automattic_woocommerce_api_pagination_paginationparams(if !(var_args.array_get(rt.new_string('first'))).is_null() {
			var_args.array_get(rt.new_string('first'))
		} else {
			rt.new_null()
		}, if !(var_args.array_get(rt.new_string('last'))).is_null() {
			...
			rt.new_null()
		}, if !(var_args.array_get(rt.new_string('after'))).is_null() {
			var_args.array_get(rt.new_string('after'))
		} else {
			rt.new_null()
		}, if !(var_args.array_get(rt.new_string('before'))).is_null() {
			var_args.array_get(rt.new_string('before'))
		} else {
			rt.new_null()
		})
	}
	return Class_Automattic_WooCommerce_Internal_Api_Utils.create_input(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_Api_callable](rt.new_closure(closure_2_fn)))
}
...
fn Class_Automattic_WooCommerce_Internal_Api_Utils.execute_command(mut var_command Class_Automattic_WooCommerce_Internal_Api_object, mut var_execute_args Class_Automattic_WooCommerce_Internal_Api_array) rt.PhpVal {
	closure_3_fn := fn [var_command, var_execute_args] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		return var_command.execute(rt.new_object('Automattic_WooCommerce_Internal_Api_array',
			[]string{}, var_execute_args))
	}
	return Class_Automattic_WooCommerce_Internal_Api_Utils.translate_exceptions(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_Api_callable](rt.new_closure(closure_3_fn)))
}
...
fn Class_Automattic_WooCommerce_Internal_Api_Utils.authorize_command(mut var_command Class_Automattic_WooCommerce_Internal_Api_object, mut var_authorize_args Class_Automattic_WooCommerce_Internal_Api_array) bool {
	closure_4_fn := fn [var_command, var_authorize_args] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		return var_command.authorize(rt.new_object('Automattic_WooCommerce_Internal_Api_array',
			[]string{}, var_authorize_args))
	}
	return (Class_Automattic_WooCommerce_Internal_Api_Utils.translate_exceptions(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_Api_callable](rt.new_closure(closure_4_fn)))).to_bool()
}
...
fn create_automattic_woocommerce_internal_api_automattic_woocommerce_vendor_graphql_error_error(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Api_Automattic_WooCommerce_Vendor_GraphQL_Error_Error {
...
fn create_automattic_woocommerce_internal_api_automattic_woocommerce_api_pagination_paginationparams(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Api_Automattic_WooCommerce_Api_Pagination_PaginationParams {
