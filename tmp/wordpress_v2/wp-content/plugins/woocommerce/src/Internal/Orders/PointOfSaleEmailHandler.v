...
fn (mut this Class_Automattic_WooCommerce_Internal_Orders_PointOfSaleEmailHandler) register() {
	...
	for {
		...
		rt.call_function('add_filter', [
			rt.new_string('woocommerce_email_enabled_' + var_email_id.str()),
			rt.create_array([
...
fn create_automattic_woocommerce_internal_orders_pointofsaleemailhandler(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Orders_PointOfSaleEmailHandler {
