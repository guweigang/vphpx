...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_PayUIndia) is_account_connected(mut var_payment_gateway Class_WC_Payment_Gateway) bool {
	return !(!rt.is_true(var_payment_gateway.get_option(rt.new_string('currency1_payu_key'))))
		&& !(!rt.is_true(var_payment_gateway.get_option(rt.new_string('currency1_payu_salt'))))
	unsafe {
		goto end_label_1
	}
	catch_label_1:
...
fn create_automattic_woocommerce_internal_admin_settings_paymentsproviders_payuindia(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_PayUIndia {
