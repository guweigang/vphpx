...
fn Class_Automattic_WooCommerce_Internal_Admin_Notes_PerformanceOnMobile.get_note() rt.PhpVal {
	...
	mut iife_temp_0 := Class_Automattic_WooCommerce_Internal_Admin_Notes_PerformanceOnMobile{}
	mut iife_result_0 := iife_temp_0.wc_admin_active_for(var_nine_months_in_seconds.clone())
	...
	var_note.set_title(rt.call_function('__', [
		rt.new_string('Track your store performance on mobile'),
		rt.new_string('woocommerce'),
	]))
	var_note.set_content(rt.call_function('__', [
		rt.new_string('Monitor your sales and high performing products with the Woo app.'),
		rt.new_string('woocommerce'),
	]))
