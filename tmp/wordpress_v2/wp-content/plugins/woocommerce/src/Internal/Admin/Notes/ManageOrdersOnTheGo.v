...
pub fn Class_Automattic_WooCommerce_Internal_Admin_Notes_ManageOrdersOnTheGo.note_name() string {
	return 'wc-admin-manage-orders-on-the-go'
}
...
fn Class_Automattic_WooCommerce_Internal_Admin_Notes_ManageOrdersOnTheGo.get_note() rt.PhpVal {
	mut iife_temp_0 := Class_Automattic_WooCommerce_Internal_Admin_Notes_ManageOrdersOnTheGo{}
	mut iife_result_0 := iife_temp_0.is_wc_admin_active_in_date_range(rt.new_string('month-6+'))
	...
	var_note.set_title(rt.call_function('__', [
		rt.new_string('Manage your orders on the go'),
		rt.new_string('woocommerce'),
	]))
	var_note.set_content(rt.call_function('__', [
		rt.new_string('Look for orders, customer info, and process refunds in one click with the Woo app.'),
		rt.new_string('woocommerce'),
	]))
	...
	var_note.set_name(Class_Automattic_WooCommerce_Internal_Admin_Notes_Automattic_WooCommerce_Internal_Admin_Notes_ManageOrdersOnTheGo.note_name())
...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_Notes_ManageOrdersOnTheGo) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'get_note' {
			return Class_Automattic_WooCommerce_Internal_Admin_Notes_ManageOrdersOnTheGo.get_note()
		}
		else {
			return none
		}
