...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock) construct(mut var_config Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_array, mut var_root_template Class_Automattic_WooCommerce_Admin_BlockTemplates_BlockTemplateInterface, mut var_parent Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_?ContainerInterface) {
	...
	this.root_template = var_root_template
	this.parent = if var_parent.is_null() { var_root_template } else { var_parent }
	...
	if !(var_config.array_isset(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.id_key())) {
		this.id = rt.call_method(this.root_template, 'generate_block_id', [rt.new_string(this.get_name())])
	} else {
	...
	if var_config.array_isset(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.hide_conditions_key()) {
		...
		for {
			...
			this.add_hide_condition((var_hide_condition.array_get(rt.new_string('expression'))).str())
		}
	}
	if var_config.array_isset(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.disable_conditions_key()) {
		mut iter_2 := var_config.array_get(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.disable_conditions_key()).iterator()
		for {
			item_2 := iter_2.next() or { break }
			mut var_disable_condition := item_2.val
			this.add_disable_condition((var_disable_condition.array_get(rt.new_string('expression'))).str())
		}
	}
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock) validate(mut var_config Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_array, mut var_root_template Class_Automattic_WooCommerce_Admin_BlockTemplates_BlockTemplateInterface, mut var_parent Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_?ContainerInterface) {
	if !(var_parent).is_null() && rt.is_true(rt.new_bool(!rt.is_true(rt.identical(var_parent.get_root_template(), var_root_template)))) {
	...
	if !(var_config.array_isset(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.name_key())) || !(var_config.array_get(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.name_key()).is_string()) {
	...
	if var_config.array_isset(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.order_key()) && !(var_config.array_get(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.order_key()).is_long()) {
	...
	if var_config.array_isset(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.attributes_key()) && !(var_config.array_get(Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock.attributes_key()).is_array()) {
...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock) set_attributes(mut var_attributes Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_array) {
	this.attributes = var_attributes
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock) set_attribute(key string, var_value rt.PhpVal) {
	mut key_mutated := key
	this.attributes.array_set(key_mutated, var_value.clone())
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_AbstractBlock) is_detached() bool {
	...
	return !(rt.is_true(var_is_in_parent) && rt.is_true(var_is_in_root_template))
}
...
fn create_automattic_woocommerce_internal_admin_blocktemplates_valueerror(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Admin_BlockTemplates_ValueError {
