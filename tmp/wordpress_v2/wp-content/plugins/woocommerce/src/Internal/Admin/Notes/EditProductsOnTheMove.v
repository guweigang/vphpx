...
pub fn Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove.note_name() string {
	return 'wc-admin-edit-products-on-the-move'
}

struct Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove {
	rt.PhpObjectBase
}

fn Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove.get_note() rt.PhpVal {
	mut var_year_in_seconds := rt.mul(rt.new_int(365), rt.get_constant('DAY_IN_SECONDS'))
	mut iife_temp_0 := Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove{}
	mut iife_result_0 := iife_temp_0.wc_admin_active_for(var_year_in_seconds.clone())
	...
	mut iife_temp_2 := Class_Automattic_WooCommerce_Internal_Admin_Notes_RealTimeOrderAlerts{}
	mut iife_result_2 := iife_temp_2.has_note_been_actioned()
	if rt.is_true(iife_result_2) {
		return rt.new_null()
	}
	mut iife_temp_3 := Class_Automattic_WooCommerce_Internal_Admin_Notes_ManageOrdersOnTheGo{}
	mut iife_result_3 := iife_temp_3.has_note_been_actioned()
	if rt.is_true(iife_result_3) {
		return rt.new_null()
	}
	mut iife_temp_4 := Class_Automattic_WooCommerce_Internal_Admin_Notes_PerformanceOnMobile{}
	mut iife_result_4 := iife_temp_4.has_note_been_actioned()
	...
	var_note.set_title(rt.call_function('__', [
		rt.new_string('Edit products on the move'),
		rt.new_string('woocommerce'),
	]))
	var_note.set_content(rt.call_function('__', [
		rt.new_string('Edit and create new products from your mobile devices with the Woo app'),
		rt.new_string('woocommerce'),
	]))
	...
	var_note.set_name(Class_Automattic_WooCommerce_Internal_Admin_Notes_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove.note_name())
...
fn create_automattic_woocommerce_internal_admin_notes_editproductsonthemove(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove {
	mut obj := &Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove{
...
fn create_automattic_woocommerce_internal_admin_notes_manageordersonthego(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Admin_Notes_ManageOrdersOnTheGo {
...
fn create_automattic_woocommerce_internal_admin_notes_performanceonmobile(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Admin_Notes_PerformanceOnMobile {
...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'get_note' {
			return Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove.get_note()
		}
		else {
			return none
		}
...
fn (this &Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_Internal_Admin_Notes_EditProductsOnTheMove) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
