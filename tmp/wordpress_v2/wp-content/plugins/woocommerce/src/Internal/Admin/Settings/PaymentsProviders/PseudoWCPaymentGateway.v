...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_PseudoWCPaymentGateway) get_settings_url() string {
	...
	return (rt.call_function('admin_url', [
		rt.new_string('admin.php?page=wc-settings&tab=checkout&section=' + this.id.to_lower()),
	])).str()
}
...
fn create_automattic_woocommerce_internal_admin_settings_paymentsproviders_wc_payment_gateway(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_WC_Payment_Gateway {
