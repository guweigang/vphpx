...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductFilters_FilterDataProvider) with(mut var_query_clauses_generator Class_Automattic_WooCommerce_Internal_ProductFilters_Interfaces_QueryClausesGenerator) rt.PhpVal {
	...
	if !(this.providers.array_isset(var_class_name)) {
		this.providers.array_set(var_class_name, create_automattic_woocommerce_internal_productfilters_filterdata(var_query_clauses_generator,
			this.taxonomy_hierarchy_data))
	}
...
fn create_automattic_woocommerce_internal_productfilters_filterdataprovider(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_ProductFilters_FilterDataProvider {
...
fn create_automattic_woocommerce_internal_productfilters_filterdata(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Internal_ProductFilters_FilterData {
