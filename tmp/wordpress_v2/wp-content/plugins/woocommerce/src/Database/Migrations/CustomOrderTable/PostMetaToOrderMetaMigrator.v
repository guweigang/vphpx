...
fn (mut this Class_Automattic_WooCommerce_Database_Migrations_CustomOrderTable_PostMetaToOrderMetaMigrator) construct(var_excluded_columns rt.PhpVal) {
	this.excluded_columns = var_excluded_columns.clone()
...
fn create_automattic_woocommerce_database_migrations_metatometatablemigrator(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Database_Migrations_MetaToMetaTableMigrator {
