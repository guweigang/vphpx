...
fn (mut this Class_Automattic_WooCommerce_Database_Migrations_TableMigrator) db_query(query string) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.new_string(''), rt.get_property(var_wpdb, 'last_error'))))) {
...
fn create_automattic_woocommerce_database_migrations_exception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Database_Migrations_Exception {
