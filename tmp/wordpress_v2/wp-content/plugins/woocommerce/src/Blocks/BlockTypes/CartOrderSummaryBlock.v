...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CartOrderSummaryBlock) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	...
	mut var_regex_for_cart_order_summary_totals :=
		rt.new_string('/<div data-block-name="woocommerce\\/cart-order-summary-totals-block"(.+?)>/')
	mut var_order_summary_totals_content :=
		rt.new_string('<div data-block-name="woocommerce/cart-order-summary-totals-block" class="wp-block-woocommerce-cart-order-summary-totals-block">')
	...
	if rt.is_true(rt.call_function('preg_match', [var_regex_for_cart_order_summary_totals.clone(),
		var_content_mutated.clone()]))
	{
...
fn create_automattic_woocommerce_blocks_blocktypes_cartordersummaryblock(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_BlockTypes_CartOrderSummaryBlock {
