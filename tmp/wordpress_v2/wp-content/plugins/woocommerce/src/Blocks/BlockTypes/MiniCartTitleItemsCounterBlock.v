	...
	rt.call_function('wp_interactivity_state', [this.get_full_block_name(),
		rt.create_array([
			rt.ArrayItem{ key: 'itemsInCartText', val: rt.call_function('sprintf', [
				var_cart_item_text.clone(),
				var_cart_item_count.clone(),
			]) },
		])])
...
fn create_automattic_woocommerce_blocks_blocktypes_minicarttitleitemscounterblock(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartTitleItemsCounterBlock {
