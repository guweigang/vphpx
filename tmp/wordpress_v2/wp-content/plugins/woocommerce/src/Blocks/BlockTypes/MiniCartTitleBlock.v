...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartTitleBlock) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	...
	if rt.is_true(iife_result_0) {
		return this.render_experimental_iapi_title_block(var_attributes.clone(),
...
fn create_automattic_woocommerce_blocks_blocktypes_minicarttitleblock(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartTitleBlock {
