...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_AddToCartWithOptions_GroupedProductItemLabel) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) string {
	...
	mut iife_result_0 := iife_temp_0.get_product_from_context(var_block.clone(),
		var_GLOBALS.array_get(rt.new_string('product')))
	mut var_product := iife_result_0
...
fn create_automattic_woocommerce_blocks_blocktypes_addtocartwithoptions_groupedproductitemlabel(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_BlockTypes_AddToCartWithOptions_GroupedProductItemLabel {
