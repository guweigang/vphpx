...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	...
	if rt.is_true(var_product) {
		...
		closure_3_fn := fn [var_product_rating, var_product_reviews_count] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
...
fn create_automattic_woocommerce_blocks_blocktypes_productratingstars(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars {
