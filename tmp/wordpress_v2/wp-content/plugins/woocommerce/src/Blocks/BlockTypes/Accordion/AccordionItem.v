...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_Accordion_AccordionItem) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	...
	closure_1_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		...
		return var_context.array_get(rt.new_string('openByDefault'))
	}
	...
	])))
	{
		mut var_interactivity_context := rt.create_array([
			...
			rt.ArrayItem{
				key: 'openByDefault'
				val: var_attributes.array_get(rt.new_string('openByDefault'))
			},
		])
...
fn create_automattic_woocommerce_blocks_blocktypes_accordion_accordionitem(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_BlockTypes_Accordion_AccordionItem {
