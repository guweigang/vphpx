...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_Reviews_ProductReviewsPagination) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) string {
	...
	mut var_p :=
		create_automattic_woocommerce_blocks_blocktypes_reviews_wp_html_tag_processor(var_content.clone())
	...
	return (rt.call_function('sprintf', [rt.new_string('<div %1$s>%2$s</div>'),
		var_wrapper_attributes.clone(), var_p.get_updated_html()])).str()
}
...
fn create_automattic_woocommerce_blocks_blocktypes_reviews_productreviewspagination(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_BlockTypes_Reviews_ProductReviewsPagination {
