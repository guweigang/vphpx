...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTemplatesRegistry) init() {
	...
	mut iife_result_0 := iife_temp_0.supports_block_templates(rt.new_string('wp_template'))
	...
	mut iife_result_1 := iife_temp_1.is_enabled(rt.new_string('launch-your-store'))
	...
	mut iife_result_2 := iife_temp_2.supports_block_templates(rt.new_string('wp_template_part'))
	if rt.is_true(iife_result_2) {
		...
		if rt.is_true(rt.call_function('wp_is_block_theme', []rt.PhpVal{})) {
			...
			if var_product_types.clone().array_count() > 0 {
				...
				if rt.is_true(rt.new_bool(var_product_types.clone().array_isset(Class_Automattic_WooCommerce_Enums_ProductType.simple()))) {
				...
				if rt.is_true(rt.new_bool(var_product_types.clone().array_isset(Class_Automattic_WooCommerce_Enums_ProductType.external()))) {
				...
				if rt.is_true(rt.new_bool(var_product_types.clone().array_isset(Class_Automattic_WooCommerce_Enums_ProductType.variable()))) {
				...
				if rt.is_true(rt.new_bool(var_product_types.clone().array_isset(Class_Automattic_WooCommerce_Enums_ProductType.grouped()))) {
	...
	for {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.get_property(var_template, 'is_taxonomy_template'))))) {
			mut iife_temp_3 := Class_Automattic_WooCommerce_Blocks_Utils_BlockTemplateUtils{}
			mut iife_result_3 := iife_temp_3.get_templates_directory(rt.new_string('wp_template'))
			mut var_directory := iife_result_3
			...
			rt.call_function('register_block_template', [
				rt.new_string('woocommerce//' + (Class_Automattic_WooCommerce_Blocks_{
					nodeType: 'Expr_Variable'
					line:     102
					name:     'template'
				}.slug()).str()),
				rt.create_array([
					...
					rt.ArrayItem{ key: 'content', val: rt.call_function('file_get_contents', [
						var_template_file_path.clone(),
					]) },
				]),
			])
		}
	}
	mut iter_2 := var_template_parts.iterator()
	for {
		item_2 := iter_2.next() or { break }
		mut var_template_part := item_2.val
		rt.call_method(var_template_part, 'init', []rt.PhpVal{})
	}
	this.templates = rt.call_function('array_merge', [var_templates.clone(),
		var_template_parts.clone()])
}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTemplatesRegistry) get_template(var_template_slug rt.PhpVal) rt.PhpVal {
	if rt.is_true(rt.new_bool(this.templates.array_isset(var_template_slug.clone()))) {
		mut var_registered_template := this.templates.array_get(var_template_slug)
		return var_registered_template.clone()
	}
	return rt.new_null()
}
...
fn create_automattic_woocommerce_blocks_templates_productcatalogtemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_ProductCatalogTemplate {
...
fn create_automattic_woocommerce_blocks_templates_producttagtemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_ProductTagTemplate {
...
fn create_automattic_woocommerce_blocks_templates_productattributetemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_ProductAttributeTemplate {
...
fn create_automattic_woocommerce_blocks_templates_productbrandtemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_ProductBrandTemplate {
...
fn create_automattic_woocommerce_blocks_templates_carttemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_CartTemplate {
...
fn create_automattic_woocommerce_blocks_templates_orderconfirmationtemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_OrderConfirmationTemplate {
...
fn create_automattic_woocommerce_blocks_templates_checkoutheadertemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_CheckoutHeaderTemplate {
...
fn create_automattic_woocommerce_blocks_templates_simpleproductaddtocartwithoptionstemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_SimpleProductAddToCartWithOptionsTemplate {
...
fn create_automattic_woocommerce_blocks_templates_externalproductaddtocartwithoptionstemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_ExternalProductAddToCartWithOptionsTemplate {
...
fn create_automattic_woocommerce_blocks_templates_variableproductaddtocartwithoptionstemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_VariableProductAddToCartWithOptionsTemplate {
...
fn create_automattic_woocommerce_blocks_templates_groupedproductaddtocartwithoptionstemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_GroupedProductAddToCartWithOptionsTemplate {
