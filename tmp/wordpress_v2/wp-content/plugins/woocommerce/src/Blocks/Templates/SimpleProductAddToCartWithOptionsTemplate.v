...
pub fn Class_Automattic_WooCommerce_Blocks_Templates_SimpleProductAddToCartWithOptionsTemplate.slug() string {
	return 'simple-product-add-to-cart-with-options'
}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_SimpleProductAddToCartWithOptionsTemplate) init() {
}

fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_SimpleProductAddToCartWithOptionsTemplate) get_template_title() rt.PhpVal {
	return rt.call_function('_x', [rt.new_string('Simple Product Add to Cart + Options'),
		rt.new_string('Template name'), rt.new_string('woocommerce')])
}

fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_SimpleProductAddToCartWithOptionsTemplate) get_template_description() rt.PhpVal {
	return rt.call_function('__', [
		rt.new_string('Template used to display the Add to Cart + Options form for Simple Products.'),
