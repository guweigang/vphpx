...
pub fn Class_Automattic_WooCommerce_Blocks_Templates_ProductTagTemplate.slug() string {
...
fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_ProductTagTemplate) get_template_title() rt.PhpVal {
	return rt.call_function('_x', [rt.new_string('Products by Tag'),
		rt.new_string('Template name'), rt.new_string('woocommerce')])
}

fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_ProductTagTemplate) get_template_description() rt.PhpVal {
	return rt.call_function('__', [rt.new_string('Displays products filtered by a tag.'),
		rt.new_string('woocommerce')])
}

fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_ProductTagTemplate) render_block_template() {
		...
		mut var_templates := rt.call_function('get_block_templates', [
			rt.create_array([
				rt.ArrayItem{ key: 'slug__in', val: rt.create_array([
					rt.ArrayItem{
						key: none
						val: Class_Automattic_WooCommerce_Blocks_Templates_Automattic_WooCommerce_Blocks_Templates_ProductTagTemplate.slug()
					},
				]) },
			]),
		])
