...
pub fn Class_Automattic_WooCommerce_Blocks_Templates_CheckoutHeaderTemplate.slug() string {
	return 'checkout-header'
}

struct Class_Automattic_WooCommerce_Blocks_Templates_CheckoutHeaderTemplate {
	rt.PhpObjectBase
pub mut:
	template_area rt.PhpVal = rt.new_string('header')
}

fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_CheckoutHeaderTemplate) init() {
}

fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_CheckoutHeaderTemplate) get_template_title() rt.PhpVal {
	return rt.call_function('_x', [rt.new_string('Checkout Header'),
		rt.new_string('Template name'), rt.new_string('woocommerce')])
}

fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_CheckoutHeaderTemplate) get_template_description() rt.PhpVal {
	return rt.call_function('__', [
		rt.new_string('Template used to display the simplified Checkout header.'),
...
fn create_automattic_woocommerce_blocks_templates_checkoutheadertemplate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Templates_CheckoutHeaderTemplate {
	mut obj := &Class_Automattic_WooCommerce_Blocks_Templates_CheckoutHeaderTemplate{
		...
		template_area: rt.new_string('header')
	}
	return obj
}
