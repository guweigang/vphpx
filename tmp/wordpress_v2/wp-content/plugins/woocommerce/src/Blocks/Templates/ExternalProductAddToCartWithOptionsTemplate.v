...
pub fn Class_Automattic_WooCommerce_Blocks_Templates_ExternalProductAddToCartWithOptionsTemplate.slug() string {
	return 'external-product-add-to-cart-with-options'
}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_ExternalProductAddToCartWithOptionsTemplate) init() {
}

fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_ExternalProductAddToCartWithOptionsTemplate) get_template_title() rt.PhpVal {
	return rt.call_function('_x', [
		rt.new_string('External Product Add to Cart + Options'),
		rt.new_string('Template name'),
		rt.new_string('woocommerce'),
	])
}

fn (mut this Class_Automattic_WooCommerce_Blocks_Templates_ExternalProductAddToCartWithOptionsTemplate) get_template_description() rt.PhpVal {
	return rt.call_function('__', [
		rt.new_string('Template used to display the Add to Cart + Options form for External Products.'),
		rt.new_string('woocommerce'),
	])
}
