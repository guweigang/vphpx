...
fn (mut this Class_Automattic_WooCommerce_Blocks_Registry_Container) factory(mut var_instantiation_callback Class_Closure) rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_Blocks_Registry_FactoryType', []string{},
		create_automattic_woocommerce_blocks_registry_factorytype(var_instantiation_callback))
}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_Registry_Container) register(var_id rt.PhpVal, var_value rt.PhpVal) {
	...
	if !rt.is_true(this.registry.array_get(var_id)) {
		...
		{
			var_value_mutated =
				create_automattic_woocommerce_blocks_registry_sharedtype(var_value_mutated.clone())
		}
		this.registry.array_set(var_id, var_value_mutated.clone())
	}
}
...
fn create_automattic_woocommerce_blocks_registry_factorytype(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Blocks_Registry_FactoryType {
