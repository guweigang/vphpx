	...
	return rt.create_array([
		rt.ArrayItem{ key: 'GB', val: rt.create_array([
			rt.ArrayItem{ key: 'patterns', val: rt.create_array([
				...
				rt.ArrayItem{ key: none, val: '/^[A-Z]{2}\\d{7}GB$/' },
				rt.ArrayItem{ key: none, val: '/^[A-Z]{1}\\d{9}[A-Z]{1}$/' },
				rt.ArrayItem{ key: none, val: '/^[A-Z]{2}\\d{8}[A-Z]{2}$/' },
				rt.ArrayItem{ key: none, val: '/^[A-Z]{2}\\d{6}[A-Z]{2}$/' },
				rt.ArrayItem{ key: none, val: '/^[A-Z]{4}\\d{10}$/' },
				rt.ArrayItem{ key: none, val: '/^SD\\d{8,12}$/' },
				rt.ArrayItem{ key: none, val: '/^SF\\d{8,12}$/' },
				rt.ArrayItem{ key: none, val: '/^RM\\d{8,12}$/' },
				rt.ArrayItem{ key: none, val: '/^\\d{16}$/' },
				rt.ArrayItem{ key: none, val: '/^\\d{14}$/' },
				rt.ArrayItem{ key: none, val: '/^\\d{13}$/' },
				rt.ArrayItem{ key: none, val: '/^\\d{12}$/' },
				rt.ArrayItem{ key: none, val: '/^\\d{11}$/' },
				rt.ArrayItem{ key: none, val: '/^\\d{10}$/' },
				rt.ArrayItem{ key: none, val: '/^\\d{9}$/' },
				rt.ArrayItem{ key: none, val: '/^PF\\d{8,12}$/' },
				rt.ArrayItem{ key: none, val: '/^[A-Z]{2}\\d{8}PF$/' },
				rt.ArrayItem{ key: none, val: '/^\\d{13}$/' },
				rt.ArrayItem{ key: none, val: '/^IT\\d{9}GB$/' },
				rt.ArrayItem{ key: none, val: '/^IE\\d{9}GB$/' },
				rt.ArrayItem{ key: none, val: '/^IS\\d{9}GB$/' },
				rt.ArrayItem{ key: none, val: '/^BF\\d{8,12}$/' },
				rt.ArrayItem{ key: none, val: '/^[A-Z]{3}\\d{8,12}$/' },
				rt.ArrayItem{ key: none, val: '/^[A-Z]{1}\\d{8}[A-Z]{2}$/' },
				rt.ArrayItem{ key: none, val: '/^[0-9]{9}[A-Z]{3}$/' },
			]) },
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_RoyalMailShippingProvider) get_shipping_to_countries() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: none, val: 'AD' },
		...
		rt.ArrayItem{ key: none, val: 'AO' }, rt.ArrayItem{ key: none, val: 'AQ' },
		rt.ArrayItem{ key: none, val: 'AR' }, rt.ArrayItem{ key: none, val: 'AS' },
		rt.ArrayItem{ key: none, val: 'AT' }, rt.ArrayItem{ key: none, val: 'AU' },
		rt.ArrayItem{ key: none, val: 'AW' }, rt.ArrayItem{ key: none, val: 'AX' },
		...
		rt.ArrayItem{ key: none, val: 'BL' }, rt.ArrayItem{ key: none, val: 'BM' },
		rt.ArrayItem{ key: none, val: 'BN' }, rt.ArrayItem{ key: none, val: 'BO' },
		rt.ArrayItem{ key: none, val: 'BQ' }, rt.ArrayItem{ key: none, val: 'BR' },
		rt.ArrayItem{ key: none, val: 'BS' }, rt.ArrayItem{ key: none, val: 'BT' },
		rt.ArrayItem{ key: none, val: 'BV' }, rt.ArrayItem{ key: none, val: 'BW' },
		rt.ArrayItem{ key: none, val: 'BY' }, rt.ArrayItem{ key: none, val: 'BZ' },
		rt.ArrayItem{ key: none, val: 'CA' }, rt.ArrayItem{ key: none, val: 'CC' },
		rt.ArrayItem{ key: none, val: 'CD' }, rt.ArrayItem{ key: none, val: 'CF' },
		rt.ArrayItem{ key: none, val: 'CG' }, rt.ArrayItem{ key: none, val: 'CH' },
		rt.ArrayItem{ key: none, val: 'CI' }, rt.ArrayItem{ key: none, val: 'CK' },
		rt.ArrayItem{ key: none, val: 'CL' }, rt.ArrayItem{ key: none, val: 'CM' },
		rt.ArrayItem{ key: none, val: 'CN' }, rt.ArrayItem{ key: none, val: 'CO' },
		rt.ArrayItem{ key: none, val: 'CR' }, rt.ArrayItem{ key: none, val: 'CU' },
		rt.ArrayItem{ key: none, val: 'CV' }, rt.ArrayItem{ key: none, val: 'CW' },
		rt.ArrayItem{ key: none, val: 'CX' }, rt.ArrayItem{ key: none, val: 'CY' },
		...
		rt.ArrayItem{ key: none, val: 'EH' }, rt.ArrayItem{ key: none, val: 'ER' },
		rt.ArrayItem{ key: none, val: 'ES' }, rt.ArrayItem{ key: none, val: 'ET' },
		rt.ArrayItem{ key: none, val: 'FI' }, rt.ArrayItem{ key: none, val: 'FJ' },
		rt.ArrayItem{ key: none, val: 'FK' }, rt.ArrayItem{ key: none, val: 'FM' },
		rt.ArrayItem{ key: none, val: 'FO' }, rt.ArrayItem{ key: none, val: 'FR' },
		rt.ArrayItem{ key: none, val: 'GA' }, rt.ArrayItem{ key: none, val: 'GB' },
		rt.ArrayItem{ key: none, val: 'GD' }, rt.ArrayItem{ key: none, val: 'GE' },
		rt.ArrayItem{ key: none, val: 'GF' }, rt.ArrayItem{ key: none, val: 'GG' },
		rt.ArrayItem{ key: none, val: 'GH' }, rt.ArrayItem{ key: none, val: 'GI' },
		rt.ArrayItem{ key: none, val: 'GL' }, rt.ArrayItem{ key: none, val: 'GM' },
		rt.ArrayItem{ key: none, val: 'GN' }, rt.ArrayItem{ key: none, val: 'GP' },
		rt.ArrayItem{ key: none, val: 'GQ' }, rt.ArrayItem{ key: none, val: 'GR' },
		rt.ArrayItem{ key: none, val: 'GS' }, rt.ArrayItem{ key: none, val: 'GT' },
		rt.ArrayItem{ key: none, val: 'GU' }, rt.ArrayItem{ key: none, val: 'GW' },
		rt.ArrayItem{ key: none, val: 'GY' }, rt.ArrayItem{ key: none, val: 'HK' },
		rt.ArrayItem{ key: none, val: 'HM' }, rt.ArrayItem{ key: none, val: 'HN' },
		...
		rt.ArrayItem{ key: none, val: 'KI' }, rt.ArrayItem{ key: none, val: 'KM' },
		rt.ArrayItem{ key: none, val: 'KN' }, rt.ArrayItem{ key: none, val: 'KP' },
		...
		rt.ArrayItem{ key: none, val: 'SI' }, rt.ArrayItem{ key: none, val: 'SJ' },
		rt.ArrayItem{ key: none, val: 'SK' }, rt.ArrayItem{ key: none, val: 'SL' },
		rt.ArrayItem{ key: none, val: 'SM' }, rt.ArrayItem{ key: none, val: 'SN' },
		rt.ArrayItem{ key: none, val: 'SO' }, rt.ArrayItem{ key: none, val: 'SR' },
		rt.ArrayItem{ key: none, val: 'SS' }, rt.ArrayItem{ key: none, val: 'ST' },
		rt.ArrayItem{ key: none, val: 'SV' }, rt.ArrayItem{ key: none, val: 'SX' },
		rt.ArrayItem{ key: none, val: 'SY' }, rt.ArrayItem{ key: none, val: 'SZ' },
		rt.ArrayItem{ key: none, val: 'TC' }, rt.ArrayItem{ key: none, val: 'TD' },
		rt.ArrayItem{ key: none, val: 'TF' }, rt.ArrayItem{ key: none, val: 'TG' },
		rt.ArrayItem{ key: none, val: 'TH' }, rt.ArrayItem{ key: none, val: 'TJ' },
		rt.ArrayItem{ key: none, val: 'TK' }, rt.ArrayItem{ key: none, val: 'TL' },
		rt.ArrayItem{ key: none, val: 'TM' }, rt.ArrayItem{ key: none, val: 'TN' },
		rt.ArrayItem{ key: none, val: 'TO' }, rt.ArrayItem{ key: none, val: 'TR' },
		rt.ArrayItem{ key: none, val: 'TT' }, rt.ArrayItem{ key: none, val: 'TV' },
		rt.ArrayItem{ key: none, val: 'TW' }, rt.ArrayItem{ key: none, val: 'TZ' },
		rt.ArrayItem{ key: none, val: 'UA' }, rt.ArrayItem{ key: none, val: 'UG' },
		rt.ArrayItem{ key: none, val: 'UM' }, rt.ArrayItem{ key: none, val: 'US' },
		rt.ArrayItem{ key: none, val: 'UY' }, rt.ArrayItem{ key: none, val: 'UZ' },
		rt.ArrayItem{ key: none, val: 'VA' }, rt.ArrayItem{ key: none, val: 'VC' },
		rt.ArrayItem{ key: none, val: 'VE' }, rt.ArrayItem{ key: none, val: 'VG' },
		rt.ArrayItem{ key: none, val: 'VI' }, rt.ArrayItem{ key: none, val: 'VN' },
		rt.ArrayItem{ key: none, val: 'VU' }, rt.ArrayItem{ key: none, val: 'WF' },
		rt.ArrayItem{ key: none, val: 'WS' }, rt.ArrayItem{ key: none, val: 'YE' },
		rt.ArrayItem{ key: none, val: 'YT' }, rt.ArrayItem{ key: none, val: 'ZA' },
		rt.ArrayItem{ key: none, val: 'ZM' }, rt.ArrayItem{ key: none, val: 'ZW' }])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_RoyalMailShippingProvider) validate_country_pattern(tracking_number string, country_code string) bool {
	...
	mut iter_1 :=
		Class_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_RoyalMailShippingProvider.tracking_patterns().array_get(rt.new_string(country_code)).array_get(rt.new_string('patterns')).iterator()
	for {
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_RoyalMailShippingProvider) try_parse_tracking_number(tracking_number string, shipping_from string, shipping_to string) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool('GB' != shipping_from_mutated)) {
		return rt.new_null()
	}
	if this.validate_country_pattern(var_normalized.str(), shipping_from_mutated) {
		mut var_confidence :=
			Class_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_RoyalMailShippingProvider.tracking_patterns().array_get(rt.new_string(shipping_from_mutated)).array_get(rt.new_string('confidence'))
		if rt.is_true(rt.call_function('preg_match', [
			rt.new_string('/^[A-Z]{2}\\d{7,9}GB$/'),
			var_normalized.clone(),
		]))
		{
			mut iife_temp_0 :=
				Class_Automattic_WooCommerce_Admin_Features_Fulfillments_FulfillmentUtils{}
			mut iife_result_0 := iife_temp_0.check_s10_upu_format(var_normalized.clone())
			if rt.is_true(iife_result_0) {
				var_confidence = rt.call_function('min', [rt.new_int(98),
					rt.add(var_confidence, rt.new_int(8))])
			}
		}
		if rt.is_true(rt.call_function('preg_match', [rt.new_string('/^\\d{11,16}$/'),
			var_normalized.clone()]))
		{
			mut iife_temp_1 :=
				Class_Automattic_WooCommerce_Admin_Features_Fulfillments_FulfillmentUtils{}
			mut iife_result_1 := iife_temp_1.validate_mod10_check_digit(var_normalized.clone())
			if rt.is_true(iife_result_1) {
				var_confidence = rt.call_function('min', [rt.new_int(95),
					rt.add(var_confidence, rt.new_int(5))])
			}
		}
		if rt.is_true(rt.call_function('preg_match', [rt.new_string('/^(SD|SF)\\d+/'),
			var_normalized.clone()]))
		{
			var_confidence = rt.call_function('min', [rt.new_int(96),
				rt.add(var_confidence, rt.new_int(6))])
		} else if rt.is_true(rt.call_function('preg_match', [
			rt.new_string('/^PF\\d+/'), var_normalized.clone()]))
		{
			var_confidence = rt.call_function('min', [rt.new_int(94),
				rt.add(var_confidence, rt.new_int(4))])
		} else if rt.is_true(rt.call_function('preg_match', [
			rt.new_string('/^(IT|IE|IS)\\d+GB$/'),
			var_normalized.clone(),
		]))
		{
			var_confidence = rt.call_function('min', [rt.new_int(95),
			...
			rt.new_string('/^(RM|BF)\\d+/'),
			var_normalized.clone(),
		]))
		{
			var_confidence = rt.call_function('min', [rt.new_int(92),
		...
		mut var_european_destinations := rt.create_array([
		...
		if rt.is_true(rt.call_function('in_array', [rt.new_string(shipping_to_mutated).clone(),
			var_european_destinations.clone(), rt.new_bool(true)]))
		{
			var_confidence = rt.call_function('min', [rt.new_int(95),
				rt.add(var_confidence, rt.new_int(3))])
		}
...
fn create_automattic_woocommerce_admin_features_fulfillments_providers_royalmailshippingprovider(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_RoyalMailShippingProvider {
