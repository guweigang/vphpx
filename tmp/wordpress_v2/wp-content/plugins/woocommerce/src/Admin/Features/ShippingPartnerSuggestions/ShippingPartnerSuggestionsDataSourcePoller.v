...
fn init_static_automattic_woocommerce_admin_features_shippingpartnersuggestions_shippingpartnersuggestionsdatasourcepoller() {
	rt.init_static_prop('Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_ShippingPartnerSuggestionsDataSourcePoller',
...
fn Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_ShippingPartnerSuggestionsDataSourcePoller.get_instance() rt.PhpVal {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.get_static_prop('Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_ShippingPartnerSuggestionsDataSourcePoller',
		'instance')))))
	{
		rt.set_static_prop('Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_ShippingPartnerSuggestionsDataSourcePoller',
			'instance', rt.new_object('Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_self',
			[]string{}, create_automattic_woocommerce_admin_features_shippingpartnersuggestions_self(Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_ShippingPartnerSuggestionsDataSourcePoller.id(),
			Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_ShippingPartnerSuggestionsDataSourcePoller.get_data_sources())))
	}
	return rt.get_static_prop('Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_ShippingPartnerSuggestionsDataSourcePoller',
		'instance')
}
...
fn Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_ShippingPartnerSuggestionsDataSourcePoller.get_data_sources() rt.PhpVal {
	...
	return rt.create_array([
		rt.ArrayItem{ key: none, val: iife_result_0.str() +
			'wp-json/wccom/shipping-partner-suggestions/2.0/suggestions.json' },
	])
}
...
struct Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_self {
	rt.PhpObjectBase
}
...
fn create_automattic_woocommerce_admin_features_shippingpartnersuggestions_self(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_self {
	mut obj := &Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_self{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_self) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_self) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_Admin_Features_ShippingPartnerSuggestions_self) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}
