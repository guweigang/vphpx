...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Tasks_GetMobileApp) can_view() bool {
	mut var_jetpack_can_be_installed := rt.new_bool(
...
fn Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Tasks_GetMobileApp.is_jetpack_connected() bool {
	if rt.is_true(rt.call_function('class_exists', [rt.new_string('\\Automattic\\Jetpack\\Connection\\Manager')]))
...
fn create_automattic_woocommerce_admin_features_onboardingtasks_tasks_getmobileapp(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Tasks_GetMobileApp {
