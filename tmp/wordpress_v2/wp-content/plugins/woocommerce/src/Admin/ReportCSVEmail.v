...
fn (mut this Class_Automattic_WooCommerce_Admin_ReportCSVEmail) trigger(var_user_id rt.PhpVal, var_report_type rt.PhpVal, var_download_url rt.PhpVal) {
	mut var_user := create_automattic_woocommerce_admin_wp_user(var_user_id.clone())
...
fn create_automattic_woocommerce_admin_wc_email(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_WC_Email {
...
fn create_automattic_woocommerce_admin_wp_user(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_WP_User {
