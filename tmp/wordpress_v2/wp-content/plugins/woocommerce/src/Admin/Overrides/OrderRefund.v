...
fn (mut this Class_Automattic_WooCommerce_Admin_Overrides_OrderRefund) get_report_customer_id() rt.PhpVal {
	if rt.is_true(rt.new_bool(this.customer_id.is_null())) {
		...
		mut iife_result_0 := iife_temp_0.get_or_create_customer_from_order(var_parent_order.clone())
...
fn create_automattic_woocommerce_admin_overrides_orderrefund(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_Overrides_OrderRefund {
...
fn create_automattic_woocommerce_admin_overrides_wc_order_refund(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_Overrides_WC_Order_Refund {
...
fn (mut this Class_Automattic_WooCommerce_Admin_Overrides_OrderRefund) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'order_class_name' {
			...
			return rt.new_string(Class_Automattic_WooCommerce_Admin_Overrides_OrderRefund.order_class_name(dispatch_arg_0,
