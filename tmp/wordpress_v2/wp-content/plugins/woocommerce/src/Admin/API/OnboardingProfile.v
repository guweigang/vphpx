...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) register_routes() {
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_OnboardingProfile', [
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'update_items' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_OnboardingProfile', [
						'Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller',
	...
	rt.call_function('register_rest_route', [this.namespace,
		rt.new_string('/' + (this.rest_base).str() + '/experimental_get_email_prefill'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				rt.ArrayItem{
					key: 'methods'
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'get_email_prefill' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_OnboardingProfile', [
						'Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller',
	...
	rt.call_function('register_rest_route', [this.namespace,
		rt.new_string('/' + (this.rest_base).str() + '/progress'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				rt.ArrayItem{
					key: 'methods'
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'get_profile_progress' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_OnboardingProfile', [
						'Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller',
	...
	rt.call_function('register_rest_route', [this.namespace,
		rt.new_string('/' + (this.rest_base).str() + '/progress/core-profiler/complete'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				rt.ArrayItem{
					key: 'methods'
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'core_profiler_step_complete' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_OnboardingProfile', [
						'Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller',
				...
				rt.ArrayItem{ key: 'args', val: rt.create_array([
					rt.ArrayItem{ key: 'step', val: rt.create_array([
						...
						rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
							rt.new_string('The Core Profiler step to mark as complete.'),
							rt.new_string('woocommerce'),
						]) },
						rt.ArrayItem{ key: 'enum', val: rt.create_array([
							rt.ArrayItem{ key: none, val: 'intro-opt-in' },
							rt.ArrayItem{ key: none, val: 'skip-guided-setup' },
							rt.ArrayItem{ key: none, val: 'user-profile' },
							rt.ArrayItem{ key: none, val: 'business-info' },
							rt.ArrayItem{ key: none, val: 'plugins' },
							rt.ArrayItem{ key: none, val: 'intro-builder' },
							rt.ArrayItem{ key: none, val: 'skip-guided-setup' },
						]) },
					]) },
				]) },
	...
	rt.call_function('register_rest_route', [this.namespace,
		rt.new_string('/' + (this.rest_base).str() + '/update-store-currency-and-measurement-units'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'update_store_currency_and_measurement_units' },
				]) },
				rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_OnboardingProfile', [
						'Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller',
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) get_items(var_request rt.PhpVal) rt.PhpVal {
	...
	var_onboarding_data.array_set('industry', if var_onboarding_data.array_isset(rt.new_string('industry')) {
		this.filter_industries(var_onboarding_data.array_get(rt.new_string('industry')))
	} else {
		rt.new_null()
	})
	mut var_item_schema := this.get_item_schema()
	mut var_items := rt.new_array()
	mut iter_1 := var_item_schema.array_get(rt.new_string('properties')).iterator()
	for {
		item_1 := iter_1.next() or { break }
		mut var_property_schema := item_1.val
		mut var_key := item_1.key
		var_items.array_set(var_key, if var_onboarding_data.array_isset(var_key) {
			var_onboarding_data.array_get(var_key)
		} else {
			rt.new_null()
		})
	}
	mut iife_temp_0 := Class_Automattic_WooCommerce_Admin_API_WC_Helper_Options{}
	mut iife_result_0 := iife_temp_0.get(rt.new_string('auth'))
	mut var_wccom_auth := iife_result_0
	var_items.array_set('wccom_connected', if !rt.is_true(var_wccom_auth.array_get(rt.new_string('access_token'))) {
		false
	} else {
		true
	})
	mut var_item := this.prepare_item_for_response(var_items.clone(), var_request.clone())
	mut var_data := this.prepare_response_for_collection(var_item.clone())
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) update_items(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_query_args := this.prepare_objects_query(var_params.clone())
	mut var_onboarding_data := rt.cast_array(rt.call_function('get_option', [
		Class_Automattic_WooCommerce_Internal_Admin_Onboarding_OnboardingProfile.data_option(),
		rt.new_array(),
	]))
	mut var_profile_data := rt.call_function('array_merge', [
		var_onboarding_data.clone(), var_query_args.clone()])
	rt.call_function('update_option', [
		Class_Automattic_WooCommerce_Internal_Admin_Onboarding_OnboardingProfile.data_option(),
		var_profile_data.clone(),
	])
	rt.call_function('do_action', [
		rt.new_string('woocommerce_onboarding_profile_data_updated'),
		var_onboarding_data.clone(),
	...
	mut var_result := rt.create_array([rt.ArrayItem{ key: 'status', val: 'success' },
		rt.ArrayItem{ key: 'message', val: rt.call_function('__', [
			rt.new_string('Onboarding profile data has been updated.'),
			rt.new_string('woocommerce'),
		]) }])
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) get_email_prefill(var_request rt.PhpVal) rt.PhpVal {
	...
	]))
	{
		...
		if rt.is_true(var_jetpack_connection_manager.is_active()) {
			...
			var_result.array_set('email', var_jetpack_user.array_get(rt.new_string('email')))
		}
	}
	if !rt.is_true(var_result.array_get(rt.new_string('email'))) {
		var_result.array_set('email', rt.call_function('get_option', [
			rt.new_string('admin_email'),
		]))
	}
	return rt.call_function('rest_ensure_response', [var_result.clone()])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) core_profiler_step_complete(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_step := var_json.array_get(rt.new_string('step'))
	mut var_onboarding_progress := rt.cast_array(rt.call_function('get_option', [
		Class_Automattic_WooCommerce_Internal_Admin_Onboarding_OnboardingProfile.progress_option(),
		rt.new_array(),
	]))
	...
	var_onboarding_progress.array_get_mut('core_profiler_completed_steps').array_set(var_step, rt.create_array([
		rt.ArrayItem{ key: 'completed_at', val: rt.call_function('gmdate', [
			rt.new_string('Y-m-d\\TH:i:s\\Z'),
		]) },
	]))
	rt.call_function('update_option', [
		Class_Automattic_WooCommerce_Internal_Admin_Onboarding_OnboardingProfile.progress_option(),
		var_onboarding_progress.clone(),
	])
	rt.call_function('do_action', [
		rt.new_string('woocommerce_core_profiler_step_complete'),
		var_step.clone(),
	])
	mut var_response_data := rt.create_array([
		rt.ArrayItem{ key: 'results', val: var_onboarding_progress },
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) get_profile_progress(var_request rt.PhpVal) rt.PhpVal {
	...
	return rt.call_function('rest_ensure_response', [var_onboarding_progress.clone()])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) update_store_currency_and_measurement_units(mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	if !rt.is_true(var_country_code) || !(var_locale_info.array_isset(var_country_code)) {
		return rt.new_object('WP_Error', []string{}, create_wp_error(rt.new_string('woocommerce_rest_invalid_country_code'), rt.call_function('__', [
			rt.new_string('Invalid country code.'),
			rt.new_string('woocommerce'),
	...
	mut var_currency_settings := rt.create_array([
		rt.ArrayItem{
			...
			val: var_country_info.array_get(rt.new_string('currency_code'))
		},
		rt.ArrayItem{
			key: 'woocommerce_currency_pos'
			val: var_country_info.array_get(rt.new_string('currency_pos'))
		},
		rt.ArrayItem{
			key: 'woocommerce_price_thousand_sep'
			val: var_country_info.array_get(rt.new_string('thousand_sep'))
		},
		rt.ArrayItem{
			key: 'woocommerce_price_decimal_sep'
			val: var_country_info.array_get(rt.new_string('decimal_sep'))
		},
		rt.ArrayItem{
			key: 'woocommerce_price_num_decimals'
			val: var_country_info.array_get(rt.new_string('num_decimals'))
		},
		rt.ArrayItem{
			key: 'woocommerce_weight_unit'
			val: var_country_info.array_get(rt.new_string('weight_unit'))
		},
		rt.ArrayItem{
			key: 'woocommerce_dimension_unit'
			val: var_country_info.array_get(rt.new_string('dimension_unit'))
		},
	])
	mut iter_2 := var_currency_settings.iterator()
	for {
		item_2 := iter_2.next() or { break }
		mut var_value := item_2.val
		mut var_key := item_2.key
		rt.call_function('update_option', [var_key.clone(), var_value.clone()])
	}
	return rt.new_object('WP_REST_Response', []string{}, create_wp_rest_response(rt.new_array(),
		rt.new_int(204)))
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) prepare_objects_query(var_params rt.PhpVal) rt.PhpVal {
	...
	mut var_properties :=
		Class_Automattic_WooCommerce_Admin_API_OnboardingProfile.get_profile_properties()
	...
	var_args = rt.call_function('apply_filters', [
		rt.new_string('woocommerce_rest_onboarding_profile_object_query'),
		var_args.clone(),
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) prepare_item_for_response(var_item rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_data := this.add_additional_fields_to_object(var_item_mutated.clone(),
		var_request.clone())
	var_data = this.filter_response_by_context(var_data.clone(), rt.new_string('view'))
	mut var_response := rt.call_function('rest_ensure_response', [
		var_data.clone()])
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_rest_onboarding_prepare_profile'),
		var_response.clone(),
...
fn Class_Automattic_WooCommerce_Admin_API_OnboardingProfile.get_profile_properties() rt.PhpVal {
	mut var_properties := rt.create_array([
		rt.ArrayItem{ key: 'completed', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Whether or not the profile was completed.'),
				rt.new_string('woocommerce'),
			]) },
		...
		rt.ArrayItem{ key: 'skipped', val: rt.create_array([
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Whether or not the profile was skipped.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'view' },
		...
		rt.ArrayItem{ key: 'industry', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'readonly', val: true },
			rt.ArrayItem{ key: 'nullable', val: true },
			rt.ArrayItem{ key: 'validate_callback', val: 'rest_validate_request_arg' },
			rt.ArrayItem{ key: 'items', val: rt.create_array([
				rt.ArrayItem{ key: 'type', val: 'string' },
			]) },
		]) },
		rt.ArrayItem{ key: 'business_extensions', val: rt.create_array([
			rt.ArrayItem{ key: 'type', val: 'array' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Extra business extensions to install.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'view' },
		...
		rt.ArrayItem{ key: 'is_agree_marketing', val: rt.create_array([
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Whether or not this store agreed to receiving marketing contents from WooCommerce.com.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'view' },
		...
		rt.ArrayItem{ key: 'store_email', val: rt.create_array([
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Store email address.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'view' },
			...
			rt.ArrayItem{ key: 'validate_callback', val: rt.create_array([
				...
				rt.ArrayItem{ key: none, val: 'rest_validate_marketing_email' },
			]) },
		]) },
		rt.ArrayItem{ key: 'is_store_country_set', val: rt.create_array([
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Whether or not this store country is set via onboarding profiler.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'view' },
		...
		rt.ArrayItem{ key: 'is_plugins_page_skipped', val: rt.create_array([
			rt.ArrayItem{ key: 'type', val: 'boolean' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Whether or not plugins step in core profiler was skipped.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'view' },
		...
		rt.ArrayItem{ key: 'selling_online_answer', val: rt.create_array([
			rt.ArrayItem{ key: 'type', val: 'string' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Selling online answer.'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'context', val: rt.create_array([
				rt.ArrayItem{ key: none, val: 'view' },
	...
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_rest_onboarding_profile_properties'),
...
fn Class_Automattic_WooCommerce_Admin_API_OnboardingProfile.rest_validate_marketing_email(var_value rt.PhpVal, var_request rt.PhpVal, var_param rt.PhpVal) bool {
	mut var_is_agree_marketing := rt.call_method(var_request, 'get_param', [
		rt.new_string('is_agree_marketing'),
	])
	if rt.is_true(var_is_agree_marketing) || !(!rt.is_true(var_value))
		&& rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('is_email', [var_value.clone()]))))) {
		return (create_wp_error(rt.new_string('rest_invalid_email'), rt.call_function('__', [
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) get_item_schema() rt.PhpVal {
	...
	mut var_schema := rt.create_array([
		...
		rt.ArrayItem{ key: 'title', val: 'onboarding_profile' },
		rt.ArrayItem{ key: 'type', val: 'object' },
		rt.ArrayItem{ key: 'properties', val: var_properties },
	])
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) get_collection_params() rt.PhpVal {
	mut var_params :=
		Class_Automattic_WooCommerce_Admin_API_OnboardingProfile.get_profile_properties()
	mut iter_5 := var_params.iterator()
	for {
		item_5 := iter_5.next() or { break }
		mut var_param := item_5.val
	...
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_rest_onboarding_profile_collection_params'),
		var_params.clone(),
	])
}
...
fn create_automattic_woocommerce_admin_api_onboardingprofile(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_OnboardingProfile {
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProfile) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'rest_validate_marketing_email' {
			...
			return rt.new_bool(Class_Automattic_WooCommerce_Admin_API_OnboardingProfile.rest_validate_marketing_email(dispatch_arg_0,
