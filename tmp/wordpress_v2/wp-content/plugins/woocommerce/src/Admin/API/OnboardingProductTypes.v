		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					...
					rt.ArrayItem{ key: none, val: 'get_product_types' },
				]) },
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_OnboardingProductTypes) get_product_types(var_request rt.PhpVal) rt.PhpVal {
	mut iife_temp_0 := Class_Automattic_WooCommerce_Internal_Admin_Onboarding_OnboardingProducts{}
	mut iife_result_0 := iife_temp_0.get_product_types_with_data()
...
fn create_automattic_woocommerce_admin_api_onboardingproducttypes(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_OnboardingProductTypes {
