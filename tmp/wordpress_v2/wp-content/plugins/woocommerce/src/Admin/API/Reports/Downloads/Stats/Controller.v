...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Stats_Controller) prepare_reports_query(var_request rt.PhpVal) rt.PhpVal {
	...
	var_args.array_set('customer_includes',
		rt.cast_array(var_request.array_get(rt.new_string('customer_includes'))))
	var_args.array_set('customer_excludes',
		rt.cast_array(var_request.array_get(rt.new_string('customer_excludes'))))
	var_args.array_set('order_includes',
		rt.cast_array(var_request.array_get(rt.new_string('order_includes'))))
	var_args.array_set('order_excludes',
		rt.cast_array(var_request.array_get(rt.new_string('order_excludes'))))
	var_args.array_set('ip_address_includes',
		rt.cast_array(var_request.array_get(rt.new_string('ip_address_includes'))))
	var_args.array_set('ip_address_excludes',
		rt.cast_array(var_request.array_get(rt.new_string('ip_address_excludes'))))
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Stats_Controller) prepare_item_for_response(var_report rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_rest_prepare_report_downloads_stats'),
		var_response.clone(),
		var_report.clone(),
		var_request.clone(),
	])
	...
	return rt.create_array([
		rt.ArrayItem{ key: 'download_count', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Number of downloads.'),
				rt.new_string('woocommerce'),
			]) },
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Stats_Controller) get_item_schema() rt.PhpVal {
	...
	mut var_schema := rt.create_array([
		...
		rt.ArrayItem{ key: 'title', val: 'report_orders_stats' },
		...
		rt.ArrayItem{ key: 'properties', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'intervals', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('Reports data grouped by intervals.'),
					rt.new_string('woocommerce'),
				]) },
				...
				rt.ArrayItem{ key: 'items', val: rt.create_array([
					...
					rt.ArrayItem{ key: 'properties', val: rt.create_array([
						rt.ArrayItem{ key: 'interval', val: rt.create_array([
							rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
								rt.new_string('Type of interval.'),
								rt.new_string('woocommerce'),
							]) },
						...
						rt.ArrayItem{ key: 'date_start', val: rt.create_array([
							rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
								rt.new_string("The date the report start, in the site's timezone."),
								rt.new_string('woocommerce'),
							]) },
						...
						rt.ArrayItem{ key: 'date_start_gmt', val: rt.create_array([
							rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
								rt.new_string('The date the report start, as GMT.'),
								rt.new_string('woocommerce'),
							]) },
							rt.ArrayItem{ key: 'type', val: 'date-time' },
							rt.ArrayItem{ key: 'context', val: rt.create_array([
						...
						rt.ArrayItem{ key: 'date_end', val: rt.create_array([
							rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
								rt.new_string("The date the report end, in the site's timezone."),
								rt.new_string('woocommerce'),
							]) },
							rt.ArrayItem{ key: 'type', val: 'date-time' },
							rt.ArrayItem{ key: 'context', val: rt.create_array([
						...
						rt.ArrayItem{ key: 'date_end_gmt', val: rt.create_array([
							rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
								rt.new_string('The date the report end, as GMT.'),
								rt.new_string('woocommerce'),
							]) },
							rt.ArrayItem{ key: 'type', val: 'date-time' },
							rt.ArrayItem{ key: 'context', val: rt.create_array([
						...
						rt.ArrayItem{ key: 'subtotals', val: rt.create_array([
							rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
								rt.new_string('Interval subtotals.'),
								rt.new_string('woocommerce'),
							]) },
							rt.ArrayItem{ key: 'type', val: 'object' },
							rt.ArrayItem{ key: 'context', val: rt.create_array([
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Stats_Controller) get_collection_params() rt.PhpVal {
	...
	var_params.array_get_mut('orderby').array_set('enum', this.apply_custom_orderby_filters(rt.create_array([
		...
		rt.ArrayItem{ key: none, val: 'download_count' },
	])))
	...
	var_params.array_set('customer_includes', rt.create_array([
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Limit response to objects that have the specified customer ids.'),
			rt.new_string('woocommerce'),
		]) },
		rt.ArrayItem{ key: 'type', val: 'array' },
		rt.ArrayItem{ key: 'sanitize_callback', val: 'wp_parse_id_list' },
	...
	var_params.array_set('customer_excludes', rt.create_array([
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string("Limit response to objects that don't have the specified customer ids."),
			rt.new_string('woocommerce'),
		]) },
		rt.ArrayItem{ key: 'type', val: 'array' },
		rt.ArrayItem{ key: 'sanitize_callback', val: 'wp_parse_id_list' },
...
fn create_automattic_woocommerce_admin_api_reports_downloads_stats_controller(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Stats_Controller {
