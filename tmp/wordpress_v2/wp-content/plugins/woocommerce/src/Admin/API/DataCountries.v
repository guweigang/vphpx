...
fn (mut this Class_Automattic_WooCommerce_Admin_API_DataCountries) register_routes() {
	rt.call_function('register_rest_route', [this.namespace,
		rt.new_string('/' +
			(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_DataCountries', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Countries_Controller'], &this), 'rest_base')).str() +
			'/locales'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_DataCountries', [
						'Automattic_WooCommerce_Admin_API_WC_REST_Data_Countries_Controller',
					], &this) },
					rt.ArrayItem{ key: none, val: 'get_locales' },
				]) },
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_DataCountries) get_locales() rt.PhpVal {
	mut var_locales := rt.call_method(rt.get_property(rt.call_function('WC', []rt.PhpVal{}),
		'countries'), 'get_country_locale', []rt.PhpVal{})
	return rt.call_function('rest_ensure_response', [var_locales.clone()])
}
...
fn create_automattic_woocommerce_admin_api_datacountries(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_DataCountries {
...
fn create_automattic_woocommerce_admin_api_wc_rest_data_countries_controller(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_WC_REST_Data_Countries_Controller {
