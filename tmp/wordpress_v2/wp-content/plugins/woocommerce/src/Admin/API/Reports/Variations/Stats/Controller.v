...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_Controller) construct() {
	rt.call_function('add_filter', [
		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_Controller', [
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_Controller) get_datastore_data(var_query_args rt.PhpVal) rt.PhpVal {
	...
	mut var_query := create_automattic_woocommerce_admin_api_reports_genericquery(var_query_args_mutated.clone(),
		rt.new_string('variations-stats'))
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_Controller) prepare_reports_query(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_collection_params := rt.call_function('apply_filters', [
		rt.new_string('experimental_woocommerce_analytics_variations_stats_collection_params'),
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_Controller) prepare_item_for_response(var_report rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_rest_prepare_report_variations_stats'),
		var_response.clone(),
		var_report.clone(),
		var_request.clone(),
	])
	...
	return rt.create_array([
		rt.ArrayItem{ key: 'items_sold', val: rt.create_array([
			rt.ArrayItem{ key: 'title', val: rt.call_function('__', [
				rt.new_string('Variations Sold'),
				rt.new_string('woocommerce'),
			]) },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Number of variation items sold.'),
				rt.new_string('woocommerce'),
			]) },
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_Controller) set_default_report_data(var_results rt.PhpVal) rt.PhpVal {
	...
	if !rt.is_true(var_results_mutated) {
		var_results_mutated =
			create_automattic_woocommerce_admin_api_reports_variations_stats_stdclass()
...
fn create_automattic_woocommerce_admin_api_reports_variations_stats_stdclass(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_stdClass {
