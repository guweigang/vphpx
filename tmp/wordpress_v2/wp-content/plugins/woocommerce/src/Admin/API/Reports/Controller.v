...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Controller) get_items(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_reports := rt.create_array([
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'performance-indicators' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Batch endpoint for getting specific performance indicators from `stats` endpoints.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'revenue/stats' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Stats about revenue.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'orders/stats' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Stats about orders.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'products' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Products detailed reports.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'products/stats' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Stats about products.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'variations' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Variations detailed reports.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			...
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Stats about variations.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'categories' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product categories detailed reports.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'categories/stats' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Stats about product categories.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'coupons' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Coupons detailed reports.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'coupons/stats' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Stats about coupons.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'taxes' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Taxes detailed reports.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'taxes/stats' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Stats about taxes.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'downloads' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product downloads detailed reports.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'downloads/files' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Product download files detailed reports.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'downloads/stats' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Stats about product downloads.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'customers' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Customers detailed reports.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
		rt.ArrayItem{ key: none, val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: 'customers/stats' },
			rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
				rt.new_string('Stats about groups of customers.'),
				rt.new_string('woocommerce'),
			]) },
		]) },
	])
	...
	for {
		...
		if !rt.is_true(var_report.array_get(rt.new_string('slug'))) {
			continue
		}
		if !rt.is_true(var_report.array_get(rt.new_string('path'))) {
			var_report.array_set('path', '/' +
				(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Controller', ['Automattic_WooCommerce_Admin_API_Reports_GenericController'], &this), 'namespace')).str() +
				'/reports/' + (var_report.array_get(rt.new_string('slug'))).str())
		}
		if !(var_report.array_isset(rt.new_string('url'))) {
			if rt.is_true(rt.identical(rt.new_string('/stats'), rt.call_function('substr', [
				var_report.array_get(rt.new_string('slug')),
				rt.new_int(-6),
			])))
			{
				mut var_url_slug := rt.call_function('substr', [
					var_report.array_get(rt.new_string('slug')),
					rt.new_int(0),
					rt.new_int(-6),
				])
			} else {
				var_url_slug = var_report.array_get(rt.new_string('slug'))
			}
		...
		mut var_item := this.prepare_item_for_response(rt.new_object('stdClass', []string{},
			rt.array_to_object(var_report)), var_request.clone())
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Controller) prepare_item_for_response(var_report rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_data := rt.create_array([
		rt.ArrayItem{ key: 'slug', val: rt.get_property(var_report_mutated, 'slug') },
		rt.ArrayItem{ key: 'description', val: rt.get_property(var_report_mutated, 'description') },
		rt.ArrayItem{ key: 'path', val: rt.get_property(var_report_mutated, 'path') },
	])
		...
		rt.create_array([
			rt.ArrayItem{ key: 'self', val: rt.create_array([
				rt.ArrayItem{ key: 'href', val: rt.call_function('rest_url', [
					rt.get_property(var_report_mutated, 'path'),
				]) },
			]) },
			rt.ArrayItem{ key: 'report', val: rt.create_array([
				rt.ArrayItem{ key: 'href', val: rt.get_property(var_report_mutated, 'url') },
			]) },
			rt.ArrayItem{ key: 'collection', val: rt.create_array([
				rt.ArrayItem{ key: 'href', val: rt.call_function('rest_url', [
					rt.call_function('sprintf', [rt.new_string('%s/%s'),
						rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Controller', [
	...
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_rest_prepare_report'),
		var_response.clone(),
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Controller) get_item_schema() rt.PhpVal {
	mut var_schema := rt.create_array([
		...
		rt.ArrayItem{ key: 'title', val: 'report' },
		...
		rt.ArrayItem{ key: 'properties', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'description', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('A human-readable description of the resource.'),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'type', val: 'string' },
				rt.ArrayItem{ key: 'context', val: rt.create_array([
