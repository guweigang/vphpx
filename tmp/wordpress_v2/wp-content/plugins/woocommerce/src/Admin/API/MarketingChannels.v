...
fn (mut this Class_Automattic_WooCommerce_Admin_API_MarketingChannels) get_items(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_channels := rt.call_method(var_marketing_channels_service, 'get_registered_channels',
		[]rt.PhpVal{})
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_MarketingChannels) prepare_item_for_response(var_item rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	mut var_data := rt.create_array([
		rt.ArrayItem{ key: 'slug', val: rt.call_method(var_item, 'get_slug', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'is_setup_completed', val: rt.call_method(var_item,
			'is_setup_completed', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'settings_url', val: rt.call_method(var_item, 'get_setup_url',
			[]rt.PhpVal{}) },
		...
		rt.ArrayItem{ key: 'description', val: rt.call_method(var_item, 'get_description',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'product_listings_status', val: rt.call_method(var_item,
			'get_product_listings_status', []rt.PhpVal{}) },
		rt.ArrayItem{ key: 'errors_count', val: rt.call_method(var_item, 'get_errors_count',
			[]rt.PhpVal{}) },
		rt.ArrayItem{ key: 'icon', val: rt.call_method(var_item, 'get_icon_url', []rt.PhpVal{}) },
	])
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_MarketingChannels) get_item_schema() rt.PhpVal {
	mut var_schema := rt.create_array([
		...
		rt.ArrayItem{ key: 'title', val: 'marketing_channel' },
		rt.ArrayItem{ key: 'type', val: 'object' },
		rt.ArrayItem{ key: 'properties', val: rt.create_array([
			rt.ArrayItem{ key: 'slug', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('Unique identifier string for the marketing channel extension, also known as the plugin slug.'),
					rt.new_string('woocommerce'),
				]) },
			...
			rt.ArrayItem{ key: 'name', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('Name of the marketing channel.'),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'type', val: 'string' },
				rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'description', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('Description of the marketing channel.'),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'type', val: 'string' },
				rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'icon', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('Path to the channel icon.'),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'type', val: 'string' },
				rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'is_setup_completed', val: rt.create_array([
				rt.ArrayItem{ key: 'type', val: 'boolean' },
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('Whether or not the marketing channel is set up.'),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'context', val: rt.create_array([
					rt.ArrayItem{ key: none, val: 'view' },
			...
			rt.ArrayItem{ key: 'settings_url', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('URL to the settings page, or the link to complete the setup/onboarding if the channel has not been set up yet.'),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'type', val: 'string' },
				rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'product_listings_status', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string("Status of the marketing channel's product listings."),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'type', val: 'string' },
				rt.ArrayItem{ key: 'context', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'errors_count', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('Number of channel issues/errors (e.g. account-related errors, product synchronization issues, etc.).'),
					rt.new_string('woocommerce'),
				]) },
				rt.ArrayItem{ key: 'type', val: 'string' },
				rt.ArrayItem{ key: 'context', val: rt.create_array([
...
fn create_automattic_woocommerce_admin_api_marketingchannels(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_MarketingChannels {
