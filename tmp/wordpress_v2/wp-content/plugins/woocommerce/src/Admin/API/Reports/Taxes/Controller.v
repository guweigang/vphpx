...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller) prepare_reports_query(var_request rt.PhpVal) rt.PhpVal {
	...
	var_args.array_set('taxes', var_request.array_get(rt.new_string('taxes')))
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller) prepare_item_for_response(var_report rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_rest_prepare_report_taxes'),
		var_response.clone(),
	...
	mut var_links := rt.create_array([
		rt.ArrayItem{ key: 'tax', val: rt.create_array([
			rt.ArrayItem{ key: 'href', val: rt.call_function('rest_url', [
				rt.call_function('sprintf', [rt.new_string('/%s/taxes/%d'),
					rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller', [
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller) get_item_schema() rt.PhpVal {
	mut var_schema := rt.create_array([
		...
		rt.ArrayItem{ key: 'title', val: 'report_taxes' },
		...
		rt.ArrayItem{ key: 'properties', val: rt.create_array([
			...
			rt.ArrayItem{ key: 'tax_rate', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
					rt.new_string('Tax rate.'),
					rt.new_string('woocommerce'),
				]) },
			...
			rt.ArrayItem{ key: 'priority', val: rt.create_array([
				rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller) get_collection_params() rt.PhpVal {
	...
	var_params.array_get_mut('orderby').array_set('enum', this.apply_custom_orderby_filters(rt.create_array([
		...
		rt.ArrayItem{ key: none, val: 'tax_code' },
		rt.ArrayItem{ key: none, val: 'rate' },
		rt.ArrayItem{ key: none, val: 'order_tax' },
	...
	var_params.array_set('taxes', rt.create_array([
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Limit result set to items assigned one or more tax rates.'),
			rt.new_string('woocommerce'),
		]) },
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller) get_export_columns() rt.PhpVal {
	mut var_export_columns := rt.create_array([
		rt.ArrayItem{ key: 'tax_code', val: rt.call_function('__', [
			rt.new_string('Tax code'),
			rt.new_string('woocommerce'),
		]) },
		rt.ArrayItem{ key: 'rate', val: rt.call_function('__', [
			rt.new_string('Rate'),
			rt.new_string('woocommerce'),
		]) },
		rt.ArrayItem{ key: 'total_tax', val: rt.call_function('__', [
			rt.new_string('Total tax'),
			rt.new_string('woocommerce'),
		]) },
		rt.ArrayItem{ key: 'order_tax', val: rt.call_function('__', [
			rt.new_string('Order tax'),
			rt.new_string('woocommerce'),
		]) },
		rt.ArrayItem{ key: 'shipping_tax', val: rt.call_function('__', [
			rt.new_string('Shipping tax'),
			rt.new_string('woocommerce'),
		]) },
	...
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_report_taxes_export_columns'),
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller) prepare_item_for_export(var_item rt.PhpVal) rt.PhpVal {
	mut iife_temp_0 := Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_WC_Tax{}
	mut iife_result_0 := iife_temp_0.get_rate_code(rt.new_object('stdClass', []string{}, rt.array_to_object(rt.create_array([
		rt.ArrayItem{ key: 'tax_rate_id', val: var_item.array_get(rt.new_string('tax_rate_id')) },
		rt.ArrayItem{ key: 'tax_rate_country', val: var_item.array_get(rt.new_string('country')) },
		rt.ArrayItem{ key: 'tax_rate_state', val: var_item.array_get(rt.new_string('state')) },
		rt.ArrayItem{ key: 'tax_rate_name', val: var_item.array_get(rt.new_string('name')) },
		rt.ArrayItem{ key: 'tax_rate_priority', val: var_item.array_get(rt.new_string('priority')) },
	]))))
	mut iife_temp_1 := Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller{}
	mut iife_result_1 :=
		iife_temp_1.csv_number_format(var_item.array_get(rt.new_string('total_tax')))
	mut iife_temp_2 := Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller{}
	mut iife_result_2 :=
		iife_temp_2.csv_number_format(var_item.array_get(rt.new_string('order_tax')))
	mut iife_temp_3 := Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller{}
	mut iife_result_3 :=
		iife_temp_3.csv_number_format(var_item.array_get(rt.new_string('shipping_tax')))
	mut var_export_item := rt.create_array([
		rt.ArrayItem{ key: 'tax_code', val: iife_result_0 },
		rt.ArrayItem{ key: 'rate', val: var_item.array_get(rt.new_string('tax_rate')) },
		rt.ArrayItem{ key: 'total_tax', val: iife_result_1 },
		rt.ArrayItem{ key: 'order_tax', val: iife_result_2 },
		rt.ArrayItem{ key: 'shipping_tax', val: iife_result_3 },
		rt.ArrayItem{ key: 'orders_count', val: var_item.array_get(rt.new_string('orders_count')) },
	])
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_report_taxes_prepare_export_item'),
...
fn create_automattic_woocommerce_admin_api_reports_taxes_controller(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_Controller {
...
fn create_automattic_woocommerce_admin_api_reports_taxes_wc_tax(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Reports_Taxes_WC_Tax {
