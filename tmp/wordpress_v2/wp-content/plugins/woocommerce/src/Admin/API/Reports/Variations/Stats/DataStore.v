...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore) assign_report_columns() {
	mut iife_temp_0 := Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore{}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore) update_sql_query_params(var_query_args rt.PhpVal) {
	...
	mut iife_temp_1 := Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore{}
	...
	if rt.is_true(var_attribute_order_items_subquery) {
		...
		var_products_where_clause = rt.concat(var_products_where_clause,
			var_attribute_order_items_subquery)
	}
	if 0 < var_where_subquery.clone().array_count() {
		mut var_operator := this.get_match_operator(var_query_args.clone())
		var_products_where_clause = rt.concat(var_products_where_clause, rt.new_string(
	...
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore', [
		'Automattic_WooCommerce_Admin_API_Reports_Variations_DataStore',
		'DataStoreInterface',
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore) should_exclude_simple_products(mut var_query_args Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_array) rt.PhpVal {
	return rt.call_function('apply_filters', [
		rt.new_string('experimental_woocommerce_analytics_variations_stats_should_exclude_simple_products'),
		rt.new_bool(true),
		var_query_args,
	])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore) get_default_query_vars() rt.PhpVal {
	mut var_defaults :=
		this.Class_Automattic_WooCommerce_Admin_API_Reports_Variations_DataStore.get_default_query_vars()
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore) get_noncached_stats_data(var_query_args rt.PhpVal, var_params rt.PhpVal, var_data rt.PhpVal, var_expected_interval_count rt.PhpVal) rt.PhpVal {
	...
	mut iife_temp_2 := Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore{}
	...
	mut var_totals_query := rt.create_array([
		rt.ArrayItem{ key: 'from_clause', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore', [
			'Automattic_WooCommerce_Admin_API_Reports_Variations_DataStore',
			'DataStoreInterface',
		], &this), 'total_query'), 'get_sql_clause', [
			rt.new_string('join'),
		]) },
		rt.ArrayItem{ key: 'where_time_clause', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore', [
			'Automattic_WooCommerce_Admin_API_Reports_Variations_DataStore',
			'DataStoreInterface',
		], &this), 'total_query'), 'get_sql_clause', [
			rt.new_string('where_time'),
		]) },
		rt.ArrayItem{ key: 'where_clause', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore', [
			'Automattic_WooCommerce_Admin_API_Reports_Variations_DataStore',
			'DataStoreInterface',
		], &this), 'total_query'), 'get_sql_clause', [
			rt.new_string('where'),
	...
	mut var_segmenter := create_automattic_woocommerce_admin_api_reports_variations_stats_segmenter(var_query_args.clone(), rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore', [
		'Automattic_WooCommerce_Admin_API_Reports_Variations_DataStore',
		'DataStoreInterface',
	], &this), 'report_columns'))
	...
	if rt.is_true(rt.identical(rt.new_null(), var_totals)) {
		return rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_WP_Error',
			[]string{}, create_automattic_woocommerce_admin_api_reports_variations_stats_wp_error(rt.new_string('woocommerce_analytics_variations_stats_result_failed'), rt.call_function('__', [
...
fn create_automattic_woocommerce_admin_api_reports_variations_stats_datastore(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore {
...
fn create_automattic_woocommerce_admin_api_reports_variations_stats_segmenter(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_Segmenter {
...
fn create_automattic_woocommerce_admin_api_reports_variations_stats_wp_error(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_WP_Error {
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_DataStore) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'should_exclude_simple_products' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Admin_API_Reports_Variations_Stats_array](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
