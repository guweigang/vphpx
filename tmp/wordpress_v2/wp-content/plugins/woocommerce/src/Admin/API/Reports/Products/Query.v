...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Query) get_data() rt.PhpVal {
	...
	mut iife_temp_0 := Class_Automattic_WooCommerce_Admin_API_Reports_Products_WC_Data_Store{}
	mut iife_result_0 := iife_temp_0.load(rt.new_string('report-products'))
	mut var_data_store := iife_result_0
	mut var_results := rt.call_method(var_data_store, 'get_data', [
		var_args.clone()])
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_analytics_products_select_query'),
		var_results.clone(),
		var_args.clone(),
	])
}
...
fn create_automattic_woocommerce_admin_api_reports_products_query(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Reports_Products_Query {
...
fn create_automattic_woocommerce_admin_api_reports_products_wc_data_store(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Reports_Products_WC_Data_Store {
