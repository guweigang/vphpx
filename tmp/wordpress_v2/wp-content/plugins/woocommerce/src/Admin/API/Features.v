		...
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.create_array([
				...
				rt.ArrayItem{ key: 'callback', val: rt.create_array([
					rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Features', [
						'Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller',
					], &this) },
					rt.ArrayItem{ key: none, val: 'get_features' },
				]) },
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Features) get_features(var_request rt.PhpVal) rt.PhpVal {
	...
	mut iife_result_0 := iife_temp_0.get_available_features()
...
fn create_automattic_woocommerce_admin_api_features(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Admin_API_Features {
