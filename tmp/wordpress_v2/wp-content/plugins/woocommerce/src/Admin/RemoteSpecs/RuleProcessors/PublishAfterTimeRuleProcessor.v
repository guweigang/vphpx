...
fn (mut this Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_PublishAfterTimeRuleProcessor) process(var_rule rt.PhpVal, var_stored_state rt.PhpVal) rt.PhpVal {
	return rt.greater_equal(rt.call_method(this.date_time_provider, 'get_now', []rt.PhpVal{}), create_automattic_woocommerce_admin_remotespecs_ruleprocessors_datetime(rt.get_property(var_rule,
		'publish_after')))
}
