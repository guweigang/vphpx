		...
		'Automattic_WooCommerce_Caches_WC_Abstract_Order'))))))
	{
		return rt.create_array([
			rt.ArrayItem{ key: none, val:
				...
				(rt.call_function('gettype', [var_object.clone()])).str() },
		])
	}
	return rt.new_null()
}
...
fn create_automattic_woocommerce_caches_ordercache(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Caches_OrderCache {
