...
fn main() {
	...
	rt.echo_val(rt.call_function('esc_attr', [var_body_font_family.clone()]))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_attr', [var_body_font_family.clone()]))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_attr', [var_body_font_family.clone()]))
	...
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_url', [var_left_image.clone()]))
	// unsupported statement: Stmt_InlineHTML
	print(if rt.is_true(var_paragraph_font_family) {
		' has-' + (rt.call_function('esc_attr', [var_paragraph_font_family.clone()])).str() +
			'-font-family'
	} else {
		''
	})
	...
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_url', [var_right_image.clone()]))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_url', [var_right_image.clone()]))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_attr', [var_heading_font_family.clone()]))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_attr', [var_heading_font_family.clone()]))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_html_x', [
