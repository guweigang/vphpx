...
fn (mut this Class_Action_Scheduler_WP_CLI_Action_Command) cancel(mut var_args Class_Action_Scheduler_WP_CLI_array, mut var_assoc_args Class_Action_Scheduler_WP_CLI_array) {
	...
	mut var_command := create_action_scheduler_wp_cli_action_cancel_command(var_args,
		var_assoc_args)
...
fn (mut this Class_Action_Scheduler_WP_CLI_Action_Command) create(mut var_args Class_Action_Scheduler_WP_CLI_array, mut var_assoc_args Class_Action_Scheduler_WP_CLI_array) {
	...
	mut var_command := create_action_scheduler_wp_cli_action_create_command(var_args,
		var_assoc_args)
	rt.call_method(var_command, 'execute', []rt.PhpVal{})
}
...
fn (mut this Class_Action_Scheduler_WP_CLI_Action_Command) delete(mut var_args Class_Action_Scheduler_WP_CLI_array, mut var_assoc_args Class_Action_Scheduler_WP_CLI_array) {
	...
	mut var_command := create_action_scheduler_wp_cli_action_delete_command(var_args,
		var_assoc_args)
	rt.call_method(var_command, 'execute', []rt.PhpVal{})
}
...
fn (mut this Class_Action_Scheduler_WP_CLI_Action_Command) generate(mut var_args Class_Action_Scheduler_WP_CLI_array, mut var_assoc_args Class_Action_Scheduler_WP_CLI_array) {
	...
	mut var_command := create_action_scheduler_wp_cli_action_generate_command(var_args,
		var_assoc_args)
	rt.call_method(var_command, 'execute', []rt.PhpVal{})
}
...
fn (mut this Class_Action_Scheduler_WP_CLI_Action_Command) get(mut var_args Class_Action_Scheduler_WP_CLI_array, mut var_assoc_args Class_Action_Scheduler_WP_CLI_array) {
	...
	mut var_command := create_action_scheduler_wp_cli_action_get_command(var_args, var_assoc_args)
	rt.call_method(var_command, 'execute', []rt.PhpVal{})
}
...
fn (mut this Class_Action_Scheduler_WP_CLI_Action_Command) subcommand_list(mut var_args Class_Action_Scheduler_WP_CLI_array, mut var_assoc_args Class_Action_Scheduler_WP_CLI_array) {
	...
	mut var_command := create_action_scheduler_wp_cli_action_list_command(var_args, var_assoc_args)
	rt.call_method(var_command, 'execute', []rt.PhpVal{})
}
...
fn (mut this Class_Action_Scheduler_WP_CLI_Action_Command) logs(mut var_args Class_Action_Scheduler_WP_CLI_array) {
	...
	mut iife_temp_0 := Class_Action_Scheduler_WP_CLI_WP_CLI{}
	mut iife_result_0 := iife_temp_0.runcommand(var_command.clone())
}
...
fn (mut this Class_Action_Scheduler_WP_CLI_Action_Command) next(mut var_args Class_Action_Scheduler_WP_CLI_array, mut var_assoc_args Class_Action_Scheduler_WP_CLI_array) {
	...
	mut var_command := create_action_scheduler_wp_cli_action_next_command(var_args, var_assoc_args)
	rt.call_method(var_command, 'execute', []rt.PhpVal{})
}
...
fn (mut this Class_Action_Scheduler_WP_CLI_Action_Command) run(mut var_args Class_Action_Scheduler_WP_CLI_array, mut var_assoc_args Class_Action_Scheduler_WP_CLI_array) {
	...
	mut var_command := create_action_scheduler_wp_cli_action_run_command(var_args, var_assoc_args)
	rt.call_method(var_command, 'execute', []rt.PhpVal{})
}
...
fn create_action_scheduler_wp_cli_action_command(_args ...rt.PhpVal) &Class_Action_Scheduler_WP_CLI_Action_Command {
...
fn create_action_scheduler_wp_cli_wp_cli_command(_args ...rt.PhpVal) &Class_Action_Scheduler_WP_CLI_WP_CLI_Command {
...
fn create_action_scheduler_wp_cli_action_cancel_command(_args ...rt.PhpVal) &Class_Action_Scheduler_WP_CLI_Action_Cancel_Command {
...
fn create_action_scheduler_wp_cli_action_create_command(_args ...rt.PhpVal) &Class_Action_Scheduler_WP_CLI_Action_Create_Command {
...
fn create_action_scheduler_wp_cli_action_delete_command(_args ...rt.PhpVal) &Class_Action_Scheduler_WP_CLI_Action_Delete_Command {
...
fn create_action_scheduler_wp_cli_action_list_command(_args ...rt.PhpVal) &Class_Action_Scheduler_WP_CLI_Action_List_Command {
...
fn create_action_scheduler_wp_cli_wp_cli(_args ...rt.PhpVal) &Class_Action_Scheduler_WP_CLI_WP_CLI {
...
fn create_action_scheduler_wp_cli_action_run_command(_args ...rt.PhpVal) &Class_Action_Scheduler_WP_CLI_Action_Run_Command {
