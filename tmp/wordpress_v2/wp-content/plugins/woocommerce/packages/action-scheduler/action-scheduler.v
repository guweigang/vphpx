...
fn action_scheduler_initialize_3_dot_9_dot_3() {
	...
	])))))
	{
		...
		mut iife_result_1 := iife_temp_1.init(rt.new_string(@FILE))
	}
}
...
fn main() {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('function_exists', [rt.new_string('action_scheduler_register_3_dot_9_dot_3')])))))
		...
		if rt.is_true(rt.call_function('did_action', [rt.new_string('plugins_loaded')]))
			...
			mut iife_result_2 := iife_temp_2.initialize_latest_version()
		}
	}
}
