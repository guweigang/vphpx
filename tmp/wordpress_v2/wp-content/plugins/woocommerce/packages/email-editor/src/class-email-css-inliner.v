...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Email_Css_Inliner) from_html(unprocessed_html string) rt.PhpVal {
	...
	mut iife_temp_0 := Class_Automattic_WooCommerce_EmailEditor_{"nodeType":"Expr_Variable","line":40,"name":"inliner_class"}{}
	mut iife_result_0 := iife_temp_0.fromhtml(rt.new_string(unprocessed_html))
	rt.set_property(var_that, 'inliner', iife_result_0)
	return mut var_that
}
...
fn create_automattic_woocommerce_emaileditor_self(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditor_self {
...
fn create_automattic_woocommerce_emaileditor_{"nodetype":"expr_variable","line":40,"name":"inliner_class"}(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditor_{"nodeType":"Expr_Variable","line":40,"name":"inliner_class"} {
...
fn create_automattic_woocommerce_emaileditor_logicexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditor_LogicException {
