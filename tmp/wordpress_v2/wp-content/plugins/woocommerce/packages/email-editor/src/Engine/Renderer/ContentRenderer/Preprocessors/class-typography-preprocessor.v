...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Typography_Preprocessor) preprocess(mut var_parsed_blocks Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array, mut var_layout Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array, mut var_styles Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array) rt.PhpVal {
	...
	for {
		...
		var_block.array_set('innerBlocks', this.copy_typography_from_parent(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array](var_block.array_get(rt.new_string('innerBlocks'))), mut
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Typography_Preprocessor) copy_typography_from_parent(mut var_children Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array, mut var_parent_block Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array) rt.PhpVal {
	...
	mut iter_2 := var_children_mutated.iterator()
	for {
		...
		var_child.array_set('email_attrs', rt.call_function('array_merge', [
			this.filterstyles(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array](var_parent_block.array_get(rt.new_string('email_attrs')))),
			var_child.array_get(rt.new_string('email_attrs')),
		]))
		var_child.array_set('innerBlocks', this.copy_typography_from_parent(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array](if !(var_child.array_get(rt.new_string('innerBlocks'))).is_null() {
			var_child.array_get(rt.new_string('innerBlocks'))
		} else {
			rt.new_array()
		}), mut
		...
		var_children_mutated.array_set(var_key, var_child.clone())
	}
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array',
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Typography_Preprocessor) preprocess_parent(mut var_block Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array) rt.PhpVal {
	...
	if var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_get(rt.new_string('color')).array_isset(rt.new_string('text')) {
		var_email_attrs.array_set('color',
			var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_get(rt.new_string('color')).array_get(rt.new_string('text')))
	}
	if var_block_mutated.array_get(rt.new_string('attrs')).array_isset(rt.new_string('textColor'))
		&& var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('textColor')).is_string()
		...
		var_email_attrs.array_set('color', rt.call_method(this.settings_controller,
			...
			[var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('textColor'))]))
	}
	if var_block_mutated.array_get(rt.new_string('attrs')).array_isset(rt.new_string('fontSize'))
		&& var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('fontSize')).is_string() {
		var_block_mutated.array_get_mut('attrs').array_get_mut('style').array_get_mut('typography').array_set('fontSize', rt.call_method(this.settings_controller,
			...
			[var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('fontSize'))]))
	}
	if var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_get(rt.new_string('typography')).array_isset(rt.new_string('fontSize')) {
		var_email_attrs.array_set('font-size',
			var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_get(rt.new_string('typography')).array_get(rt.new_string('fontSize')))
	}
	if var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_get(rt.new_string('typography')).array_isset(rt.new_string('textDecoration')) {
		var_email_attrs.array_set('text-decoration',
			var_block_mutated.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_get(rt.new_string('typography')).array_get(rt.new_string('textDecoration')))
	}
	var_block_mutated.array_set('email_attrs', rt.call_function('array_merge', [
		var_email_attrs.clone(),
		if !(var_block_mutated.array_get(rt.new_string('email_attrs'))).is_null() {
			var_block_mutated.array_get(rt.new_string('email_attrs'))
		} else {
			rt.new_array()
		},
	]))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Typography_Preprocessor) set_defaults_from_theme(mut var_block Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(if !(var_block_mutated.array_get(rt.new_string('email_attrs')).array_get(rt.new_string('color'))).is_null() {
		var_block_mutated.array_get(rt.new_string('email_attrs')).array_get(rt.new_string('color'))
	} else {
		rt.new_string('')
	}))))
	{
		var_block_mutated.array_get_mut('email_attrs').array_set('color', if !(var_theme_data.array_get(rt.new_string('styles')).array_get(rt.new_string('color')).array_get(rt.new_string('text'))).is_null() {
			var_theme_data.array_get(rt.new_string('styles')).array_get(rt.new_string('color')).array_get(rt.new_string('text'))
		} else {
			rt.new_null()
		})
	}
	if rt.is_true(rt.new_bool(!(rt.is_true(if !(var_block_mutated.array_get(rt.new_string('email_attrs')).array_get(rt.new_string('font-size'))).is_null() {
		var_block_mutated.array_get(rt.new_string('email_attrs')).array_get(rt.new_string('font-size'))
	} else {
		rt.new_string('')
	}))))
	{
