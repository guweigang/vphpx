...
fn Class_Automattic_WooCommerce_EmailEditor_Validator_Builder.string() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Validator_Schema_String_Schema', []string{}, create_automattic_woocommerce_emaileditor_validator_schema_string_schema())
}

fn Class_Automattic_WooCommerce_EmailEditor_Validator_Builder.number() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Validator_Schema_Number_Schema', []string{}, create_automattic_woocommerce_emaileditor_validator_schema_number_schema())
}

fn Class_Automattic_WooCommerce_EmailEditor_Validator_Builder.integer() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Validator_Schema_Integer_Schema', []string{}, create_automattic_woocommerce_emaileditor_validator_schema_integer_schema())
}

fn Class_Automattic_WooCommerce_EmailEditor_Validator_Builder.boolean() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Validator_Schema_Boolean_Schema', []string{}, create_automattic_woocommerce_emaileditor_validator_schema_boolean_schema())
}

fn Class_Automattic_WooCommerce_EmailEditor_Validator_Builder.null() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Validator_Schema_Null_Schema', []string{}, create_automattic_woocommerce_emaileditor_validator_schema_null_schema())
}
...
fn Class_Automattic_WooCommerce_EmailEditor_Validator_Builder.one_of(mut var_schemas Class_Automattic_WooCommerce_EmailEditor_Validator_array) rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Validator_Schema_One_Of_Schema', []string{}, create_automattic_woocommerce_emaileditor_validator_schema_one_of_schema(var_schemas))
}
...
fn Class_Automattic_WooCommerce_EmailEditor_Validator_Builder.any_of(mut var_schemas Class_Automattic_WooCommerce_EmailEditor_Validator_array) rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Validator_Schema_Any_Of_Schema', []string{}, create_automattic_woocommerce_emaileditor_validator_schema_any_of_schema(var_schemas))
}
...
fn create_automattic_woocommerce_emaileditor_validator_schema_integer_schema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditor_Validator_Schema_Integer_Schema {
...
fn create_automattic_woocommerce_emaileditor_validator_schema_boolean_schema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditor_Validator_Schema_Boolean_Schema {
...
fn create_automattic_woocommerce_emaileditor_validator_schema_object_schema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditor_Validator_Schema_Object_Schema {
...
fn create_automattic_woocommerce_emaileditor_validator_schema_one_of_schema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditor_Validator_Schema_One_Of_Schema {
...
fn create_automattic_woocommerce_emaileditor_validator_schema_any_of_schema(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditor_Validator_Schema_Any_Of_Schema {
