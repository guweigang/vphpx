...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Quote_Preprocessor) process_blocks(mut var_blocks Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array, mut var_styles Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array) rt.PhpVal {
	...
	for {
		...
		if rt.is_true(rt.identical(rt.new_string('core/quote'), var_block.array_get(rt.new_string('blockName')))) {
			mut var_quote_align := if !(var_block.array_get(rt.new_string('attrs')).array_get(rt.new_string('textAlign'))).is_null() { var_block.array_get(rt.new_string('attrs')).array_get(rt.new_string('textAlign')) } else { rt.new_null() }
			mut var_quote_typography := if !(var_block.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_get(rt.new_string('typography'))).is_null() { var_block.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_get(rt.new_string('typography')) } else { rt.new_array() }
			var_block.array_set('innerBlocks', this.apply_alignment_to_children(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array](var_block.array_get(rt.new_string('innerBlocks'))), mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_?string](var_quote_align)))
			var_block.array_set('innerBlocks', this.apply_typography_to_children(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array](var_block.array_get(rt.new_string('innerBlocks'))), mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array](var_quote_typography), mut var_styles))
		}
		var_block.array_set('innerBlocks', this.process_blocks(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array](var_block.array_get(rt.new_string('innerBlocks'))), mut var_styles))
	}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Quote_Preprocessor) apply_alignment_to_children(mut var_blocks Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array, mut var_text_align Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_?string) rt.PhpVal {
	...
	for {
		...
		if !(var_block.array_get(rt.new_string('attrs')).array_isset(rt.new_string('textAlign'))) && !(var_block.array_get(rt.new_string('attrs')).array_isset(rt.new_string('align'))) {
			if !(var_block.array_isset(rt.new_string('attrs'))) {
				var_block.array_set('attrs', rt.new_array())
			}
			var_block.array_get_mut('attrs').array_set('textAlign', var_text_align)
		}
		if var_block.array_isset(rt.new_string('innerBlocks')) {
			var_block.array_set('innerBlocks', this.apply_alignment_to_children(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array](var_block.array_get(rt.new_string('innerBlocks'))), mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_?string](if !(var_block.array_get(rt.new_string('attrs')).array_get(rt.new_string('textAlign'))).is_null() { var_block.array_get(rt.new_string('attrs')).array_get(rt.new_string('textAlign')) } else { var_block.array_get(rt.new_string('attrs')).array_get(rt.new_string('align')) })))
		}
	}
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array', []string{}, var_blocks)
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Quote_Preprocessor) apply_typography_to_children(mut var_blocks Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array, mut var_quote_typography Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array, mut var_styles Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array) rt.PhpVal {
	...
	mut var_default_typography := if !(var_styles.array_get(rt.new_string('blocks')).array_get(rt.new_string('core/quote')).array_get(rt.new_string('typography'))).is_null() { var_styles.array_get(rt.new_string('blocks')).array_get(rt.new_string('core/quote')).array_get(rt.new_string('typography')) } else { rt.new_array() }
	mut var_merged_typography := rt.call_function('array_merge', [var_default_typography.clone(), var_quote_typography_mutated])
	if !rt.is_true(var_merged_typography) {
		return rt.new_object('Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array', []string{}, var_blocks)
	}
	mut iter_3 := var_blocks.iterator()
	for {
		item_3 := iter_3.next() or { break }
		mut var_block := item_3.val
		if rt.is_true(rt.identical(rt.new_string('core/paragraph'), var_block.array_get(rt.new_string('blockName')))) {
			if !(var_block.array_isset(rt.new_string('attrs'))) {
				var_block.array_set('attrs', rt.new_array())
			}
			if !(var_block.array_get(rt.new_string('attrs')).array_isset(rt.new_string('style'))) {
				var_block.array_get_mut('attrs').array_set('style', rt.new_array())
			}
			if !(var_block.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_isset(rt.new_string('typography'))) {
				var_block.array_get_mut('attrs').array_get_mut('style').array_set('typography', rt.new_array())
			}
			var_block.array_get_mut('attrs').array_get_mut('style').array_set('typography', rt.call_function('array_merge', [var_merged_typography.clone(), var_block.array_get(rt.new_string('attrs')).array_get(rt.new_string('style')).array_get(rt.new_string('typography'))]))
		}
	}
	return rt.new_object('Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_array', []string{}, var_blocks)
}
