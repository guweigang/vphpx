...
fn Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName.parse(mut var_oParserState Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	...
	var_oParserState.consume(rt.new_string(']'))
	return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName', [
		'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_ValueList',
	], create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_linename(var_aNames.clone(),
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName) render(var_oOutputFormat rt.PhpVal) string {
	mut iife_temp_0 := Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_OutputFormat{}
	mut iife_result_0 := iife_temp_0.createcompact()
	return '[' +
		(this.Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_ValueList.render(iife_result_0)).str() + ']'
}
