...
fn Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_CSSString.parse(mut var_oParserState Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
		...
		for rt.is_true(rt.new_bool(!(rt.is_true(var_oParserState.comes(var_sQuote.clone()))))) {
			...
			if rt.is_true(rt.identical(var_sContent, rt.new_null())) {
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_SourceException',
					[]string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_sourceexception(rt.concat(rt.new_string('Non-well-formed quoted string '),
	...
	return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_CSSString', [
		'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_PrimitiveValue',
	], create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_cssstring(var_sResult,
