...
fn Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_URL.parse(mut var_oParserState Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	...
	mut iife_result_0 := iife_temp_0.parse(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState',
		[]string{}, var_oParserState))
	mut var_oResult := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_url(iife_result_0,
