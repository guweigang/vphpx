...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) anchor() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_Anchor',
		[]string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_anchor(this.iCurrentPosition, rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState',
		[]string{}, &this)))
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) parseidentifier(bIgnoreCase bool) rt.PhpVal {
	if rt.is_true(this.isend()) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException',
			[]string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedeofexception(rt.new_string(''),
	...
	if rt.is_true(rt.identical(var_sResult, rt.new_null())) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedTokenException',
			[]string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedtokenexception(var_sResult.clone(), this.peek(5,
	...
	for {
		...
		if rt.is_true(rt.get_property(this.oParserSettings, 'bLenientParsing')) {
			...
			if rt.instance_of(var_e_1,
				'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException')
			{
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) consume(mValue i64) rt.PhpVal {
	if rt.is_true(rt.new_bool(rt.new_int(mValue).is_string())) {
		...
		{
			rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedTokenException',
				[]string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedtokenexception(rt.new_int(mValue), this.peek((rt.call_function('max', [
				var_iLength.clone(),
				rt.new_int(5),
		...
		if rt.is_true(rt.greater(rt.add(this.iCurrentPosition, rt.new_int(mValue)), this.iLength)) {
			rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException',
				[]string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedeofexception(rt.new_int(mValue), this.peek(5,
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) consumeexpression(var_mExpression rt.PhpVal, var_iMaxLength rt.PhpVal) rt.PhpVal {
	...
	rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedTokenException',
		[]string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedtokenexception(var_mExpression.clone(), this.peek(5,
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) consumecomment() rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(var_mComment, rt.new_bool(false))))) {
		return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Comment_Comment',
			[]string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_comment_comment(rt.call_function('substr', [
			var_mComment.clone(),
			rt.new_int(1),
		]), var_iLineNo.clone()))
	}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) consumeuntil(var_aEnd rt.PhpVal, bIncludeEnd bool, consumeEnd bool, mut var_comments Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_array) rt.PhpVal {
	...
	if rt.is_true(rt.call_function('in_array', [
		Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState.eof(),
		var_aEnd_mutated.clone(),
	]))
	{
		return var_out.clone()
	...
	rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException',
		[]string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedeofexception(
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_anchor(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_Anchor {
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedeofexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException {
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_comment_comment(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Comment_Comment {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Settings](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
		...
		'consumeUntil' {
			...
			mut dispatch_arg_3 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_array](if args.len > 3 {
				args[3]
			} else {
				rt.new_null()
			})
