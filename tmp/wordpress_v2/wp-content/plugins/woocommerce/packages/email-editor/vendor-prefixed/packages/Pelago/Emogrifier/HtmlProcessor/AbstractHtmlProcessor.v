...
fn Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.fromhtml(unprocessedHtml string) rt.PhpVal {
	if rt.is_true(rt.identical(rt.new_string(unprocessedHtml), rt.new_string(''))) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_InvalidArgumentException',
			[]string{}, create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_invalidargumentexception(rt.new_string('The provided HTML must not be empty.'),
			rt.new_int(1515763647))))
	}
	mut var_instance :=
		create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_static()
...
fn Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.fromdomdocument(mut var_document Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMDocument) rt.PhpVal {
	mut var_instance :=
		create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_static()
	var_instance.setdomdocument(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMDocument',
		[]string{}, var_document))
	return mut var_instance
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) getdomdocument() rt.PhpVal {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(this.domDocument,
		'Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMDocument'))))))
	{
		mut var_message := rt.new_string(
			(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.class()).str() + '::setDomDocument() has not yet been called on ' +(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_static.class()).str())
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_UnexpectedValueException',
			[]string{}, create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_unexpectedvalueexception(var_message.clone(),
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) setdomdocument(mut var_domDocument Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMDocument) {
	...
	this.xPath =
		create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_domxpath(this.domDocument)
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) getxpath() rt.PhpVal {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(this.xPath,
		'Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMXPath'))))))
	{
		mut var_message := rt.new_string(
			(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.class()).str() + '::setDomDocument() has not yet been called on ' +(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_static.class()).str())
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_UnexpectedValueException',
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) renderbodycontent() string {
	...
	return (rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) removeselfclosingtagsclosingtags(html string) string {
	return (rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
		'replace', [
		rt.new_string('%</' +
			(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.php_unrecognized_void_tagname_matcher()).str() + '>%'),
		rt.new_string(''),
		rt.new_string(html),
	])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) gethtmlelement() rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_htmlElement,
		'Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMElement'))))))
	{
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_UnexpectedValueException',
			[]string{}, create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_unexpectedvalueexception(rt.new_string('There is no HTML element although there should be one.'),
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) getbodyelement() rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_node,
		'Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMElement'))))))
	{
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_RuntimeException',
			[]string{}, create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_runtimeexception(rt.new_string('There is no body element.'),
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) createrawdomdocument(html string) {
	mut var_domDocument :=
		create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_domdocument()
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) ensuredocumenttype(html string) string {
	...
	return
		(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.default_document_type()).str() + html
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) addcontenttypemetatag(html string) string {
	...
	mut var_hasHeadTag := rt.new_bool(!rt.is_true(rt.identical(rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
	...
	if rt.is_true(var_hasHeadTag) {
		mut var_reworkedHtml := rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
			'replace', [rt.new_string('/<head(?=[\\s>])([^>]*+)>/i'),
			rt.new_string('<head$1>' +(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.content_type_meta_tag()).str()),
			rt.new_string(html)])
	} else if rt.is_true(var_hasHtmlTag) {
		var_reworkedHtml = rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
			'replace', [rt.new_string('/<html(.*?)>/is'),
			rt.new_string('<html$1><head>' +
				(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.content_type_meta_tag()).str() + '</head>'),
			rt.new_string(html)])
	} else {
		var_reworkedHtml = rt.new_string(
			(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.content_type_meta_tag()).str() + html)
	}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) hascontenttypemetataginhead(html string) bool {
	...
	rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
		'match', [
	...
	if var_matches.array_isset(rt.new_int(0)) {
		...
		if rt.instance_of(var_e_1,
			'Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_RuntimeException')
		{
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) hasendofheadelement(html string) bool {
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
		'match', [
		rt.new_string('%<(?!' +
			(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.tagname_allowed_before_body_matcher()).str() + '[\\s/>])\\w|</head>%i'),
		rt.new_string(html),
	]), rt.new_int(0)))))
	{
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) removehtmlcomments(html string) string {
	return (rt.call_method(rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
		...
		Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.html_comment_pattern(),
		rt.new_string(''),
		rt.new_string(html),
	])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) removehtmltemplateelements(html string) string {
	return (rt.call_method(rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
		'throwExceptions', [rt.new_bool(true)]), 'replace', [
		Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.html_template_element_pattern(),
		rt.new_string(''),
		rt.new_string(html),
	])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) ensurephpunrecognizedselfclosingtagsarexml(html string) string {
	return (rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(),
		'replace', [
		rt.new_string('%<' +
			(Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor.php_unrecognized_void_tagname_matcher()).str() + '\\b[^>]*+(?<!/)(?=>)%'),
		rt.new_string('$0/'),
		rt.new_string(html),
	])).str()
}
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_invalidargumentexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_InvalidArgumentException {
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_static(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_static {
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_unexpectedvalueexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_UnexpectedValueException {
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_domxpath(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMXPath {
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_runtimeexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_RuntimeException {
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_domdocument(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMDocument {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_AbstractHtmlProcessor) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'fromDomDocument' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMDocument](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
