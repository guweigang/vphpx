...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_Preg) logorthrowpreglasterror() {
	...
	if rt.is_true(this.throwExceptions) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_RuntimeException', []string{}, create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_runtimeexception(var_message.clone(), rt.new_int(1592870147))))
	}
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_runtimeexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_RuntimeException {
