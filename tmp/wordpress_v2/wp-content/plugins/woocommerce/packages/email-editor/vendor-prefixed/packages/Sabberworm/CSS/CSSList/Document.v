...
fn Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_Document.parse(mut var_oParserState Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	...
	mut iife_temp_0 :=
		Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSList{}
	mut iife_result_0 := iife_temp_0.parselist(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState',
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_csslist_cssblocklist(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList {
