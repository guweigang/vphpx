...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser) construct(mut var_tokenizer Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_?Tokenizer) {
	this.tokenizer = if !(var_tokenizer).is_null() { var_tokenizer } else { create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_tokenizer_tokenizer() }
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser) parse(source string) rt.PhpVal {
	mut var_reader := create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_reader(rt.new_string(source))
	mut var_stream := rt.call_method(this.tokenizer, 'tokenize', [var_reader])
	return this.parseselectorlist(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_TokenStream](var_stream))
}

fn Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser.parseseries(mut var_tokens Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_array) rt.PhpVal {
	mut iter_1 := var_tokens.iterator()
	for {
		item_1 := iter_1.next() or { break }
		mut var_token := item_1.val
		if rt.is_true(rt.call_method(var_token, 'isString', []rt.PhpVal{})) {
			mut iife_temp_0 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
	...
	closure_7_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		...
		if !(var_string.clone().is_long() || var_string.clone().is_double()) {
			mut iife_temp_6 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser) parseselectorlist(mut var_stream Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_TokenStream) rt.PhpVal {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser) parserselectornode(mut var_stream Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_TokenStream) rt.PhpVal {
	...
	for true {
		...
		if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.new_null(), var_pseudoElement)))) {
			mut iife_temp_7 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
	...
	var_result = create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_combinedselectornode(var_result.clone(), var_combinator.clone(), var_nextSelector.clone())
	}
	return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_SelectorNode', []string{}, create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_selectornode(var_result.clone(), var_pseudoElement.clone()))
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser) parsesimpleselector(mut var_stream Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_TokenStream, insideNegation bool) rt.PhpVal {
	...
	for true {
		...
		if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.new_null(), var_pseudoElement)))) {
			mut iife_temp_8 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
		...
		var_result = create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_hashnode(var_result.clone(), rt.call_method(rt.call_method(var_stream_mutated, 'getNext', []rt.PhpVal{}), 'getValue', []rt.PhpVal{}))
		} else if rt.is_true(rt.call_method(var_peek, 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: '.' }])])) {
			rt.call_method(var_stream_mutated, 'getNext', []rt.PhpVal{})
		var_result = create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_classnode(var_result.clone(), rt.call_method(var_stream_mutated, 'getNextIdentifier', []rt.PhpVal{}))
		} else if rt.is_true(rt.call_method(var_peek, 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: '[' }])])) {
			rt.call_method(var_stream_mutated, 'getNext', []rt.PhpVal{})
		var_result = this.parseattributenode(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_NodeInterface](var_result), mut var_stream_mutated)
		} else if rt.is_true(rt.call_method(var_peek, 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: ':' }])])) {
			rt.call_method(var_stream_mutated, 'getNext', []rt.PhpVal{})
			if rt.is_true(rt.call_method(rt.call_method(var_stream_mutated, 'getPeek', []rt.PhpVal{}), 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: ':' }])])) {
				rt.call_method(var_stream_mutated, 'getNext', []rt.PhpVal{})
			...
			if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(rt.call_method(var_stream_mutated, 'getPeek', []rt.PhpVal{}), 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: '(' }])]))))) {
				var_result = create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_pseudonode(var_result.clone(), var_identifier.clone())
				continue
			}
			rt.call_method(var_stream_mutated, 'getNext', []rt.PhpVal{})
			rt.call_method(var_stream_mutated, 'skipWhitespace', []rt.PhpVal{})
			if rt.is_true(rt.identical(rt.new_string('not'), rt.new_string(var_identifier.clone().to_string().to_lower()))) {
				if var_insideNegation {
					mut iife_temp_9 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
				...
				if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.new_null(), var_argumentPseudoElement)))) {
					mut iife_temp_10 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
				...
				if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(var_next, 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: ')' }])]))))) {
					mut iife_temp_11 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
					mut iife_result_11 := iife_temp_11.unexpectedtoken(rt.new_string('")"'), var_next.clone())
					rt.throw_exception(iife_result_11)
				}
			var_result = create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_negationnode(var_result.clone(), var_argument.clone())
			} else {
				...
				for true {
					...
					if rt.is_true(rt.call_method(var_next, 'isIdentifier', []rt.PhpVal{})) || rt.is_true(rt.call_method(var_next, 'isString', []rt.PhpVal{})) || rt.is_true(rt.call_method(var_next, 'isNumber', []rt.PhpVal{})) || rt.is_true(rt.call_method(var_next, 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: '+' }, rt.ArrayItem{ key: none, val: '-' }])])) {
						...
						mut iife_temp_12 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
				...
				if !rt.is_true(var_arguments) {
					mut iife_temp_13 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
			...
			var_result = create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_functionnode(var_result.clone(), var_identifier.clone(), var_arguments.clone())
			}
		} else {
			mut iife_temp_14 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
	...
	if rt.is_true(rt.identical(rt.new_int(rt.call_method(var_stream_mutated, 'getUsed', []rt.PhpVal{}).array_count()), var_selectorStart)) {
		mut iife_temp_15 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser) parseelementnode(mut var_stream Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_TokenStream) rt.PhpVal {
	mut var_stream_mutated := var_stream
	mut var_peek := rt.call_method(var_stream_mutated, 'getPeek', []rt.PhpVal{})
	...
	return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_ElementNode', []string{}, create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_elementnode(var_namespace.clone(), var_element.clone()))
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser) parseattributenode(mut var_selector Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_NodeInterface, mut var_stream Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_TokenStream) rt.PhpVal {
	mut var_stream_mutated := var_stream
	rt.call_method(var_stream_mutated, 'skipWhitespace', []rt.PhpVal{})
	...
	if rt.is_true(rt.identical(rt.new_null(), var_attribute)) && rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(rt.call_method(var_stream_mutated, 'getPeek', []rt.PhpVal{}), 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: '|' }])]))))) {
		mut iife_temp_16 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
	...
	if rt.is_true(rt.identical(rt.new_null(), var_operator)) {
		...
		if rt.is_true(rt.call_method(var_next, 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: ']' }])])) {
			return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode', []string{}, create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_attributenode(var_selector, var_namespace.clone(), var_attribute.clone(), rt.new_string('exists'), rt.new_null()))
		} else if rt.is_true(rt.call_method(var_next, 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: '=' }])])) {
		var_operator = rt.new_string('=')
			...
			mut iife_temp_17 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
	...
	var_value = create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_token(Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Token.type_string(), (rt.call_method(var_value, 'getValue', []rt.PhpVal{})).str(), rt.call_method(var_value, 'getPosition', []rt.PhpVal{}))
	}
	if !(rt.is_true(rt.call_method(var_value, 'isIdentifier', []rt.PhpVal{})) || rt.is_true(rt.call_method(var_value, 'isString', []rt.PhpVal{}))) {
		mut iife_temp_18 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
	...
	var_next = rt.call_method(var_stream_mutated, 'getNext', []rt.PhpVal{})
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(var_next, 'isDelimiter', [rt.create_array([rt.ArrayItem{ key: none, val: ']' }])]))))) {
		mut iife_temp_19 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{}
		mut iife_result_19 := iife_temp_19.unexpectedtoken(rt.new_string('"]"'), var_next.clone())
		rt.throw_exception(iife_result_19)
	}
	return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode', []string{}, create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_attributenode(var_selector, var_namespace.clone(), var_attribute.clone(), var_operator.clone(), rt.call_method(var_value, 'getValue', []rt.PhpVal{})))
}
...
struct Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Reader {
	rt.PhpObjectBase
}

struct Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException {
	rt.PhpObjectBase
}

struct Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_CombinedSelectorNode {
	rt.PhpObjectBase
}
...
struct Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_PseudoNode {
	rt.PhpObjectBase
}
...
struct Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode {
	rt.PhpObjectBase
}
...
struct Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode {
	rt.PhpObjectBase
}
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_parser(arg_0 rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_tokenizer_tokenizer(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_Tokenizer {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_reader(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Reader {
	mut obj := &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Reader{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}

fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_exception_syntaxerrorexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException {
	mut obj := &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}

fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_combinedselectornode(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_CombinedSelectorNode {
	mut obj := &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_CombinedSelectorNode{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_hashnode(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_HashNode {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_pseudonode(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_PseudoNode {
	mut obj := &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_PseudoNode{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}

fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_negationnode(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_NegationNode {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_functionnode(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode {
	mut obj := &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_attributenode(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode {
	mut obj := &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_?Tokenizer](if args.len > 0 { args[0] } else { rt.new_null() })
		...
		'parseSeries' {
			...
			return Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Parser.parseseries(mut dispatch_arg_0)
		}
		'parseSelectorList' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_TokenStream](if args.len > 0 { args[0] } else { rt.new_null() })
		...
		'parseAttributeNode' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_TokenStream](if args.len > 1 { args[1] } else { rt.new_null() })
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Reader) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Reader) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Reader) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}


fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}


fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_CombinedSelectorNode) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_CombinedSelectorNode) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_CombinedSelectorNode) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_PseudoNode) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_PseudoNode) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_PseudoNode) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}
