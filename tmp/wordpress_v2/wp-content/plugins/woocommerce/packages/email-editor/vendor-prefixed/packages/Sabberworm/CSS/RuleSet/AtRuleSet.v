...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_AtRuleSet) construct(var_sType rt.PhpVal, sArgs string, iLineNo i64) {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_AtRuleSet) atrulename() rt.PhpVal {
	return this.sType
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_AtRuleSet) atruleargs() rt.PhpVal {
	return this.sArgs
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_AtRuleSet) magic_tostring() rt.PhpVal {
	return this.render(create_automattic_woocommerce_emaileditorvendor_sabberworm_css_outputformat())
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_AtRuleSet) render(var_oOutputFormat rt.PhpVal) rt.PhpVal {
	mut var_sResult := rt.call_method(var_oOutputFormat, 'comments', [
		rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_AtRuleSet', [
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_ruleset_atruleset(sArgs string, iLineNo i64, arg_2 rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_AtRuleSet {
