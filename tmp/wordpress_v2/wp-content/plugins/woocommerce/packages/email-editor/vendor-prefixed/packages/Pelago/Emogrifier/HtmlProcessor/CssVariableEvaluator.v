...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_CssVariableEvaluator) replacevariablesinpropertyvalue(propertyValue string) string {
	mut iife_temp_1 := Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Closure{}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_CssVariableEvaluator) evaluatevariablesinelementanddescendants(mut var_element Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_DOMElement, mut var_ancestorVariableDefinitions Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_array) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_preg(), 'match', [rt.new_string('/(?<![\\w\\-])--[\\w\\-]/'), var_style.clone()]), rt.new_int(0))))) {
		mut var_declarations := rt.call_method(create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_declarationblockparser(), 'parse', [var_style.clone()])
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_cssvariableevaluator(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_CssVariableEvaluator {
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_htmlprocessor_closure(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_HtmlProcessor_Closure {
