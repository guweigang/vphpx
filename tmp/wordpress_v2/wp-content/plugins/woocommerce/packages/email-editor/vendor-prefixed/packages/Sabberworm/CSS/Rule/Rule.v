...
fn Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule.parse(mut var_oParserState Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState, var_commentsBeforeRule rt.PhpVal) rt.PhpVal {
	...
	mut var_oRule := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_rule_rule(var_oParserState.parseidentifier(rt.new_bool(!(rt.is_true(var_oParserState.comes(rt.new_string('--')))))),
	...
	mut iife_temp_0 := Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_Value{}
	mut iife_result_0 := iife_temp_0.parsevalue(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState',
		[]string{}, var_oParserState),
		Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule.listdelimiterforrule(var_oRule.getrule()))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule) setvalues(mut var_aSpaceSeparatedValues Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_array) rt.PhpVal {
	...
	if var_aSpaceSeparatedValues.array_count() > 1 {
		var_oSpaceSeparatedList = create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_rulevaluelist(rt.new_string(' '), rt.get_property(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule', [
			'Commentable',
			'CSSElement',
			'Positionable',
		], &this), 'iLineNo'))
	...
	for {
		...
		if var_aCommaSeparatedValues.clone().array_count() > 1 {
			var_oCommaSeparatedList = create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_rulevaluelist(rt.new_string(','), rt.get_property(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule', [
				'Commentable',
				'CSSElement',
				'Positionable',
			], &this), 'iLineNo'))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule) getvalues() rt.PhpVal {
	...
	for {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_mValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_RuleValueList'))))))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule) addvalue(var_mValue rt.PhpVal, sType string) {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(this.mValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_RuleValueList'))))))
		...
		this.mValue = create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_rulevaluelist(rt.new_string(sType),
			this.getlinenumber())
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule) render(var_oOutputFormat rt.PhpVal) rt.PhpVal {
	mut var_sResult := rt.new_string((rt.concat(rt.concat(rt.concat(rt.call_method(var_oOutputFormat,
		'comments', [
		rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule', [
			'Commentable',
			'CSSElement',
			'Positionable',
		], &this),
	...
	if rt.is_true(rt.new_bool(rt.instance_of(this.mValue,
		'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_Value')))
	{
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'parse' {
			...
			return Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule.parse(mut dispatch_arg_0,
				dispatch_arg_1)
		}
		...
		'setValues' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_array](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
