...
fn fdiv(num1 f64, num2 f64) f64 {
	mut var_num1 := num1
	mut var_num2 := num2
	mut iife_temp_0 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Polyfill_Php80_Php80{}
...
fn preg_last_error_msg() string {
	mut iife_temp_1 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Polyfill_Php80_Php80{}
...
fn str_contains(var_haystack rt.PhpVal, var_needle rt.PhpVal) bool {
	mut iife_temp_2 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Polyfill_Php80_Php80{}
...
fn str_starts_with(var_haystack rt.PhpVal, var_needle rt.PhpVal) bool {
	mut iife_temp_3 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Polyfill_Php80_Php80{}
...
fn str_ends_with(var_haystack rt.PhpVal, var_needle rt.PhpVal) bool {
	mut iife_temp_4 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Polyfill_Php80_Php80{}
...
fn get_debug_type(var_value rt.PhpVal) string {
	mut iife_temp_5 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Polyfill_Php80_Php80{}
...
fn get_resource_id(var_resource rt.PhpVal) i64 {
	mut iife_temp_6 := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Polyfill_Php80_Php80{}
