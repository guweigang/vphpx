...
fn init_static_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_declarationblockparser() {
	rt.init_static_prop('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_DeclarationBlockParser',
		'cache', rt.new_array())
}

fn Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_DeclarationBlockParser.clearcache() {
	rt.set_static_prop('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_DeclarationBlockParser',
		'cache', rt.new_array())
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_DeclarationBlockParser) parse(declarationBlock string) rt.PhpVal {
	if rt.get_static_prop('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_DeclarationBlockParser',
		'cache').array_isset(rt.new_string(declarationBlock))
	{
		return rt.get_static_prop('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_DeclarationBlockParser',
	...
	for {
		...
		if rt.is_true(rt.identical(var_propertyName, rt.new_string(''))) {
			rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_UnexpectedValueException',
				[]string{}, create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_unexpectedvalueexception(rt.new_string('An empty property name was encountered.'),
	...
	rt.get_static_prop('Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_DeclarationBlockParser',
...
fn create_automattic_woocommerce_emaileditorvendor_pelago_emogrifier_utilities_unexpectedvalueexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Pelago_Emogrifier_Utilities_UnexpectedValueException {
