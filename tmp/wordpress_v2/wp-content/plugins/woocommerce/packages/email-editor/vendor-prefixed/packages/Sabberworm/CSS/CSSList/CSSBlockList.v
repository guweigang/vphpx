...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList) alldeclarationblocks(mut var_aResult Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_array) {
	...
	mut iter_1 := rt.get_property(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList', [
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList) allrulesets(mut var_aResult Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_array) {
	mut var_aResult_mutated := var_aResult
	mut iter_2 := rt.get_property(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList', [
		'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSList',
	], &this), 'aContents').iterator()
	for {
		...
		if rt.is_true(rt.new_bool(rt.instance_of(var_mContent,
			'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_RuleSet')))
		{
			var_aResult_mutated.array_push(var_mContent.clone())
		} else if rt.is_true(rt.new_bool(rt.instance_of(var_mContent,
			'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList')))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList) getallvalues(var_element rt.PhpVal, var_ruleSearchPatternOrSearchInFunctionArguments rt.PhpVal, searchInFunctionArguments bool) rt.PhpVal {
	...
	if rt.is_true(rt.identical(var_element_mutated, rt.new_null())) {
		var_element_mutated = rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList', [
			'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSList',
		], &this)
	...
	this.allvalues(var_element_mutated.clone(), mut
		rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_array](var_result),
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList) allvalues(var_oElement rt.PhpVal, mut var_aResult Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_array, var_sSearchString rt.PhpVal, bSearchInFunctionArguments bool) {
		...
		'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_RuleSet')))
	{
		...
		'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule')))
	{
		...
		'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_ValueList')))
	{
		if var_bSearchInFunctionArguments
			|| rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_oElement, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_CSSFunction')))))) {
			mut iter_5 :=
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_CSSBlockList) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'allValues' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_array](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
