...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) setflag(flag i64, on bool) rt.PhpVal {
	...
	return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension',
		[]string{}, this)
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) getnodetranslators() rt.PhpVal {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'EmailEditorVendor_Attribute', val: rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension', [
				'Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_AbstractExtension',
			], &this) },
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) translatefunction(mut var_node Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode, mut var_translator Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator) rt.PhpVal {
	mut var_xpath := var_translator.nodetoxpath(var_node.getselector())
	return var_translator.addfunction(var_xpath.clone(), rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode',
		[]string{}, var_node))
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) translateelement(mut var_node Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_ElementNode) rt.PhpVal {
	...
	if rt.is_true(var_element)
		&& this.hasflag((Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension.element_name_in_lower_case()).to_i64()) {
	...
	mut var_xpath := create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_xpath_xpathexpr(rt.new_string(''),
		var_element.clone())
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_xpath_xpathexpr(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_XPathExpr {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'translateSelector' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_SelectorNode](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
		...
		'translateCombinedSelector' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_CombinedSelectorNode](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'translateNegation' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_NegationNode](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'translateFunction' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'translatePseudo' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_PseudoNode](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'translateAttribute' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'translateClass' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_ClassNode](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'translateHash' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_HashNode](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'translateElement' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_ElementNode](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
