...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) construct(mut var_selector Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_NodeInterface, name string, mut var_arguments Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_array) {
	mut var_arguments_mutated := var_arguments
	this.selector = var_selector
	this.name = name.to_lower()
	this.arguments = var_arguments_mutated
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) getselector() rt.PhpVal {
	return this.selector
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) getname() string {
	return this.name
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) getarguments() rt.PhpVal {
	return this.arguments
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) getspecificity() rt.PhpVal {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) magic_tostring() string {
	...
	return (rt.call_function('sprintf', [rt.new_string('%s[%s:%s(%s)]'),
		this.getnodename(), this.selector, rt.new_string(this.name),
		rt.new_string((if rt.is_true(var_arguments) { '[' + var_arguments.str() + ']' } else { '' }).str())])).str()
}
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_functionnode(arg_0 rt.PhpVal, name string, arg_2 rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_FunctionNode) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			...
			mut dispatch_arg_2 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_array](if args.len > 2 {
				args[2]
			} else {
				rt.new_null()
			})
