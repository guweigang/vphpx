...
fn init_static_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_cssselectorconverter() {
	rt.init_static_prop('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_CssSelectorConverter',
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_CssSelectorConverter) construct(html bool) {
	this.translator =
		create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_xpath_translator()
	if var_html {
		rt.call_method(this.translator, 'registerExtension', [
			create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_xpath_extension_htmlextension(this.translator),
		])
		this.cache = rt.get_static_prop('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_CssSelectorConverter',
			'htmlCache')
	} else {
		this.cache = rt.get_static_prop('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_CssSelectorConverter',
			'xmlCache')
	...
	rt.call_method(rt.call_method(rt.call_method(rt.call_method(this.translator,
		...
		create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_shortcut_elementparser(),
	]), 'registerParserShortcut', [
		create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_shortcut_classparser(),
	]), 'registerParserShortcut', [
		create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_shortcut_hashparser(),
	])
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_CssSelectorConverter) toxpath(cssExpr string, prefix string) rt.PhpVal {
	if this.cache.array_get(rt.new_string(prefix)).array_isset(rt.new_string(cssExpr)) {
		mut var_value :=
			this.cache.array_get(rt.new_string(prefix)).array_get(rt.new_string(cssExpr))
		this.cache.array_get(rt.new_string(prefix)).array_unset(rt.new_string(cssExpr))
		return this.cache.array_get_mut(prefix).array_set(cssExpr, var_value.clone())
	}
	var_value = rt.call_method(this.translator, 'cssToXPath', [
		rt.new_string(cssExpr), rt.new_string(prefix)])
	if rt.is_true(rt.greater_equal(rt.new_int(if !(this.cache.array_get(rt.new_string(prefix))).is_null() {
		this.cache.array_get(rt.new_string(prefix))
	} else {
		rt.new_array()
	}.array_count()), rt.get_static_prop('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_CssSelectorConverter',
		'maxCachedItems')))
	{
		this.cache.array_get(rt.new_string(prefix)).array_unset(rt.call_function('array_key_first', [
			this.cache.array_get(rt.new_string(prefix)),
		]))
	}
	return this.cache.array_get_mut(prefix).array_set(cssExpr, var_value.clone())
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_xpath_extension_htmlextension(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_shortcut_emptystringparser(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Shortcut_EmptyStringParser {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_shortcut_elementparser(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Shortcut_ElementParser {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_shortcut_hashparser(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Shortcut_HashParser {
