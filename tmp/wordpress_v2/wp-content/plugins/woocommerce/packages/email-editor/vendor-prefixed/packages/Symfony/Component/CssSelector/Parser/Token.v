...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Token) isdelimiter(mut var_values Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_array) bool {
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Token.type_delimiter(), this.prop_type)))) {
		return false
	}
