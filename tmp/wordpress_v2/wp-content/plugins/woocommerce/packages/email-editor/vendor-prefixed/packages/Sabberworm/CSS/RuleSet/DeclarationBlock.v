...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) construct(iLineNo i64) {
	this.Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_RuleSet.construct(rt.new_int(iLineNo))
	this.aSelectors = rt.new_array()
}

fn Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock.parse(mut var_oParserState Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState, var_oList rt.PhpVal) rt.PhpVal {
	mut var_aComments := rt.new_array()
	mut var_oResult := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_ruleset_declarationblock(var_oParserState.currentline())
...
end_label_1:
	...
	mut iife_temp_0 := Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_RuleSet{}
	mut iife_result_0 := iife_temp_0.parseruleset(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState', []string{}, var_oParserState), rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock', []string{}, var_oResult))
	return rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock', []string{}, var_oResult)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) setselectors(var_mSelector rt.PhpVal, var_oList rt.PhpVal) {
	...
	for {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_mSelector_shadow, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Property_Selector')))))) {
			if rt.is_true(rt.identical(var_oList, rt.new_null())) || rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_oList, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_KeyFrame')))))) {
				mut iife_temp_1 := Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Property_Selector{}
				mut iife_result_1 := iife_temp_1.isvalid(var_mSelector_shadow.clone())
				if rt.is_true(rt.new_bool(!(rt.is_true(iife_result_1)))) {
					rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedTokenException', []string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedtokenexception('Selector did not match \'' + (Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Property_Selector.selector_validation_rx()).str() + '\'.', var_mSelector_shadow.clone(), rt.new_string('custom'))))
				}
				this.aSelectors.array_set(var_iKey, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_property_selector(var_mSelector_shadow.clone()))
			} else {
				mut iife_temp_2 := Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Property_KeyframeSelector{}
				mut iife_result_2 := iife_temp_2.isvalid(var_mSelector_shadow.clone())
				if rt.is_true(rt.new_bool(!(rt.is_true(iife_result_2)))) {
					rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedTokenException', []string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedtokenexception('Selector did not match \'' + (Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Property_KeyframeSelector.selector_validation_rx()).str() + '\'.', var_mSelector_shadow.clone(), rt.new_string('custom'))))
				}
				this.aSelectors.array_set(var_iKey, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_property_keyframeselector(var_mSelector_shadow.clone()))
			}
		}
	}
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) removeselector(var_mSelector rt.PhpVal) bool {
	mut var_mSelector_mutated := var_mSelector
	if rt.is_true(rt.new_bool(rt.instance_of(var_mSelector_mutated, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Property_Selector'))) {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) getselector() rt.PhpVal {
	return this.getselectors()
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) setselector(var_mSelector rt.PhpVal, var_oList rt.PhpVal) {
	mut var_mSelector_mutated := var_mSelector
	this.setselectors(var_mSelector_mutated.clone(), var_oList.clone())
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) getselectors() rt.PhpVal {
	return this.aSelectors
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) expandshorthands() {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) createshorthands() {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) expandbordershorthand() {
	...
	for {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_mRuleValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_RuleValueList')))))) {
		...
		for {
			...
			if rt.is_true(rt.new_bool(rt.instance_of(var_mValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_Value'))) {
			mut var_mNewValue := var_mValue.dup()
			} else {
			var_mNewValue = var_mValue.clone()
			}
			if rt.is_true(rt.new_bool(rt.instance_of(var_mValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_Size'))) {
			mut var_sNewRuleName := rt.new_string((var_sBorderRule).str() + '-width')
			} else if rt.is_true(rt.new_bool(rt.instance_of(var_mValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_Color'))) {
			...
			mut var_oNewRule := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_rule_rule(var_sNewRuleName.clone(), rt.call_method(var_oRule, 'getLineNo', []rt.PhpVal{}), rt.call_method(var_oRule, 'getColNo', []rt.PhpVal{}))
			...
			this.addrule(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule', []string{}, var_oNewRule))
		}
		this.removerule(var_sBorderRule.clone())
	}
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) expanddimensionsshorthand() {
	...
	for {
		...
		for {
			...
			mut var_oNewRule := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_rule_rule(rt.call_function('sprintf', [var_sExpanded.clone(), var_sPosition.clone()]), rt.call_method(var_oRule, 'getLineNo', []rt.PhpVal{}), rt.call_method(var_oRule, 'getColNo', []rt.PhpVal{}))
			var_oNewRule.setisimportant(rt.call_method(var_oRule, 'getIsImportant', []rt.PhpVal{}))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) expandfontshorthand() {
	...
	for {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_mValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_Value')))))) {
		...
		} else if rt.is_true(rt.new_bool(rt.instance_of(var_mValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_Size'))) && rt.is_true(rt.new_bool(!rt.is_true(rt.identical(rt.call_method(var_mValue, 'getUnit', []rt.PhpVal{}), rt.new_null())))) {
	...
	for {
		...
		mut var_oNewRule := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_rule_rule(var_sProperty.clone(), rt.call_method(var_oRule, 'getLineNo', []rt.PhpVal{}), rt.call_method(var_oRule, 'getColNo', []rt.PhpVal{}))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) expandbackgroundshorthand() {
	...
	for {
		...
		if rt.is_true(rt.new_bool(rt.instance_of(var_mValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_URL'))) {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) expandliststyleshorthand() {
	...
	for {
		...
		if rt.is_true(rt.new_bool(rt.instance_of(var_mValue, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_Url'))) {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) createshorthandproperties(mut var_aProperties Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_array, var_sShorthand rt.PhpVal) {
	...
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(var_aNewValues, rt.new_array())))) && rt.is_true(rt.new_bool(rt.instance_of(var_oRule, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule'))) {
		mut var_oNewRule := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_rule_rule(var_sShorthand.clone(), rt.call_method(var_oRule, 'getLineNo', []rt.PhpVal{}), rt.call_method(var_oRule, 'getColNo', []rt.PhpVal{}))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) createbackgroundshorthand() {
	...
	this.createshorthandproperties(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_array](var_aProperties), rt.new_string('background'))
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) createliststyleshorthand() {
	...
	this.createshorthandproperties(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_array](var_aProperties), rt.new_string('list-style'))
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) createbordershorthand() {
	...
	this.createshorthandproperties(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_array](var_aProperties), rt.new_string('border'))
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) createdimensionsshorthand() {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) createfontshorthand() {
	...
	mut var_oNewRule := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_rule_rule(rt.new_string('font'), rt.call_method(var_oOldRule, 'getLineNo', []rt.PhpVal{}), rt.call_method(var_oOldRule, 'getColNo', []rt.PhpVal{}))
	...
	if var_aRules.array_isset(rt.new_string('line-height')) {
		...
		if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(var_aLHValues.array_get(rt.new_int(0)), rt.new_string('normal'))))) {
			mut var_val := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_rulevaluelist(rt.new_string('/'), this.getlineno())
			...
			var_oNewRule.addvalue(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_RuleValueList', []string{}, var_val))
		}
	} else {
	...
	mut var_oFFValue := create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_rulevaluelist(rt.new_string(','), this.getlineno())
	var_oFFValue.setlistcomponents(var_aFFValues.clone())
	var_oNewRule.addvalue(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_RuleValueList', []string{}, var_oFFValue))
	this.addrule(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Rule_Rule', []string{}, var_oNewRule))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) magic_tostring() rt.PhpVal {
	return this.render(create_automattic_woocommerce_emaileditorvendor_sabberworm_css_outputformat())
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) render(var_oOutputFormat rt.PhpVal) rt.PhpVal {
	mut var_sResult := rt.call_method(var_oOutputFormat, 'comments', [rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock', ['Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_RuleSet'], &this)])
	if this.aSelectors.array_count() == 0 {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_OutputException', []string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_outputexception(rt.new_string('Attempt to print declaration block with missing selector'), this.getlinenumber())))
	}
...
struct Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_OutputException {
	rt.PhpObjectBase
}

fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_ruleset_declarationblock(iLineNo i64) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock {
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_property_keyframeselector(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Property_KeyframeSelector {
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_size(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_Size {
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_outputexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_OutputException {
	mut obj := &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_OutputException{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'parse' {
			...
			return Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_RuleSet_DeclarationBlock.parse(mut dispatch_arg_0, dispatch_arg_1)
		}
		'setSelectors' {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_OutputException) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_OutputException) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_OutputException) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}
