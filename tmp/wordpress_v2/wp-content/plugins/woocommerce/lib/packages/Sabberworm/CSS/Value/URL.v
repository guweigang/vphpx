...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL) construct(mut var_oURL Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSString, iLineNo i64) {
	this.Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue.construct(rt.new_int(iLineNo))
	this.oURL = var_oURL
}

fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL.parse(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	mut var_oAnchor := var_oParserState.anchor()
	mut var_sIdentifier := rt.new_string('')
	...
	for {
		...
		var_sIdentifier = rt.concat(var_sIdentifier, var_sChar)
		rt.post_inc(var_i)
	}
	mut var_bUseUrl := var_oParserState.streql(var_sIdentifier.clone(), rt.new_string('url'))
	...
	var_oParserState.consumewhitespace()
	mut iife_temp_0 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSString{}
	mut iife_result_0 := iife_temp_0.parse(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState',
		[]string{}, var_oParserState))
	mut var_oResult := create_automattic_woocommerce_vendor_sabberworm_css_value_url(iife_result_0,
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL) seturl(mut var_oURL Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSString) {
	this.oURL = var_oURL
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL) geturl() rt.PhpVal {
	return this.oURL
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL) magic_tostring() rt.PhpVal {
	return rt.new_string(this.render(create_automattic_woocommerce_vendor_sabberworm_css_outputformat()))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL) render(var_oOutputFormat rt.PhpVal) string {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_value_url(arg_0 rt.PhpVal, iLineNo i64) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'parse' {
			...
			return Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL.parse(mut dispatch_arg_0)
		}
		'setURL' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSString](if args.len > 0 {
				args[0]
