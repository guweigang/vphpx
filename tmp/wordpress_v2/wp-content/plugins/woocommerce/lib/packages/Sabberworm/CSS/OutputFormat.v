...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat) get(var_sName rt.PhpVal) rt.PhpVal {
	...
	for {
		...
		if !(rt.get_property(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat',
			[]string{}, &this), '{"nodeType":"Expr_Variable","line":261,"name":"sFieldName"}')).is_null() {
			return rt.get_property(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat',
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat) magic_call(var_sMethodName rt.PhpVal, mut var_aArguments Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_array) rt.PhpVal {
		...
		var_sMethodName.clone(), rt.new_string('get')]), rt.new_int(0)))
	{
		...
		Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormatter.class(),
	...
	]))
	{
		...
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Exception',
			[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_exception(
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat) nextlevel() rt.PhpVal {
	if rt.is_true(rt.identical(this.oNextLevelFormat, rt.new_null())) {
		this.oNextLevelFormat = rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat',
			[]string{}, &this).dup()
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat) getformatter() rt.PhpVal {
	if rt.is_true(rt.identical(this.oFormatter, rt.new_null())) {
		this.oFormatter = create_automattic_woocommerce_vendor_sabberworm_css_outputformatter(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat',
			[]string{}, &this))
	}
...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat.create() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat', []string{},
		create_automattic_woocommerce_vendor_sabberworm_css_outputformat())
}
...
fn create_automattic_woocommerce_vendor_sabberworm_css_exception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Exception {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_outputformatter(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormatter {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'__call' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_array](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
