...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_RuleSet_RuleSet.parseruleset(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState, mut var_oRuleSet Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_RuleSet_RuleSet) {
	...
	for true {
		...
		if rt.is_true(rt.get_property(var_oParserState.getsettings(), 'bLenientParsing')) {
			mut iife_temp_0 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Rule_Rule{}
			mut iife_result_0 := iife_temp_0.parse(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState', []string{}, var_oParserState), var_commentsBeforeRule.clone())
...
end_label_1:
		...
		mut iife_temp_1 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Rule_Rule{}
		mut iife_result_1 := iife_temp_1.parse(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState', []string{}, var_oParserState), var_commentsBeforeRule.clone())
