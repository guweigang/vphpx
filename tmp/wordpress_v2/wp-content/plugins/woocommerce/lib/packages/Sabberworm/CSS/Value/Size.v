...
pub fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.absolute_size_units() rt.PhpVal {
...
pub fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.relative_size_units() rt.PhpVal {
...
pub fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.non_size_units() rt.PhpVal {
...
fn init_static_automattic_woocommerce_vendor_sabberworm_css_value_size() {
	rt.init_static_prop('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size', 'SIZE_UNITS',
		rt.new_null())
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) construct(var_fSize rt.PhpVal, var_sUnit rt.PhpVal, bIsColorComponent bool, iLineNo i64) {
	mut var_sUnit_mutated := var_sUnit
	this.Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue.construct(rt.new_int(iLineNo))
...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.parse(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState, bIsColorComponent bool) rt.PhpVal {
	...
	mut var_aSizeUnits :=
		Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.getsizeunits()
	...
	return rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size', [
		'Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue',
	], create_automattic_woocommerce_vendor_sabberworm_css_value_size(rt.new_float(var_sSize.to_f64()),
		var_sUnit, bIsColorComponent, var_oParserState.currentline()))
}

fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.getsizeunits() rt.PhpVal {
	if !(rt.get_static_prop('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size', 'SIZE_UNITS').is_array()) {
		rt.set_static_prop('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size', 'SIZE_UNITS',
			rt.new_array())
		mut iter_2 := rt.call_function('array_merge', [
			Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.absolute_size_units(),
			Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.relative_size_units(),
			Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.non_size_units(),
		]).iterator()
		for {
			item_2 := iter_2.next() or { break }
			mut var_val := item_2.val
			mut var_iSize := rt.new_int(var_val.clone().to_string().len)
			if !(rt.get_static_prop('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size',
				'SIZE_UNITS').array_isset(var_iSize)) {
				rt.get_static_prop('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size',
	...
	return rt.get_static_prop('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size',
		'SIZE_UNITS')
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) setunit(var_sUnit rt.PhpVal) {
	mut var_sUnit_mutated := var_sUnit
	this.sUnit = var_sUnit_mutated.clone()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) getunit() rt.PhpVal {
	return this.sUnit
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) setsize(var_fSize rt.PhpVal) {
	this.fSize = rt.new_float(var_fSize.to_f64())
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) getsize() rt.PhpVal {
	return this.fSize
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) iscolorcomponent() rt.PhpVal {
	return this.bIsColorComponent
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) issize() bool {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) isrelative() bool {
	if rt.is_true(rt.call_function('in_array', [this.sUnit,
		Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.relative_size_units(),
		rt.new_bool(true)]))
	{
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) magic_tostring() rt.PhpVal {
	return rt.new_string(this.render(create_automattic_woocommerce_vendor_sabberworm_css_outputformat()))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) render(var_oOutputFormat rt.PhpVal) string {
...
struct Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue {
	rt.PhpObjectBase
}
...
fn create_automattic_woocommerce_vendor_sabberworm_css_value_size(arg_0 rt.PhpVal, bIsColorComponent bool, iLineNo i64, arg_3 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_value_primitivevalue(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue {
	mut obj := &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'parse' {
			...
			return Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.parse(mut dispatch_arg_0,
				dispatch_arg_1)
		}
		'getSizeUnits' {
			return Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.getsizeunits()
		}
		'setUnit' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}
