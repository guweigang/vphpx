...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) construct(iLineNo i64) {
	this.Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSBlockList.construct(rt.new_int(iLineNo))
}

fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document.parse(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	mut var_oDocument :=
		create_automattic_woocommerce_vendor_sabberworm_css_csslist_document(var_oParserState.currentline())
	mut iife_temp_0 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList{}
	mut iife_result_0 := iife_temp_0.parselist(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState',
		[]string{}, var_oParserState), rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document',
		[]string{}, var_oDocument))
	return mut var_oDocument
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) getalldeclarationblocks() rt.PhpVal {
	mut var_aResult := rt.new_array()
	this.alldeclarationblocks(var_aResult.clone())
	return var_aResult.clone()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) getallselectors() rt.PhpVal {
	return this.getalldeclarationblocks()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) getallrulesets() rt.PhpVal {
	mut var_aResult := rt.new_array()
	this.allrulesets(var_aResult.clone())
	return var_aResult.clone()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) getselectorsbyspecificity(var_sSpecificitySearch rt.PhpVal) rt.PhpVal {
	mut var_aResult := rt.new_array()
	this.allselectors(var_aResult.clone(), var_sSpecificitySearch.clone())
	return var_aResult.clone()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) expandshorthands() {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) createshorthands() {
	mut iter_2 := this.getalldeclarationblocks().iterator()
	for {
		item_2 := iter_2.next() or { break }
		mut var_oDeclaration := item_2.val
		rt.call_method(var_oDeclaration, 'createShorthands', []rt.PhpVal{})
	}
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) render(var_oOutputFormat rt.PhpVal) string {
	...
	return
		(var_oOutputFormat_mutated.comments(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document', []string{}, this))).str() +
		(this.renderlistcontents(var_oOutputFormat_mutated.clone())).str()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) isrootlist() bool {
	return true
}
...
fn create_automattic_woocommerce_vendor_sabberworm_css_csslist_document(iLineNo i64) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_csslist_cssblocklist(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSBlockList {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'parse' {
			...
			return Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document.parse(mut dispatch_arg_0)
		}
