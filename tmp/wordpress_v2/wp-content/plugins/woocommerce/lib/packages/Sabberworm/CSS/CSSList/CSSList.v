...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.parselist(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState, mut var_oList Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList) {
	...
	if rt.is_true(rt.new_bool(var_oParserState_mutated.is_string())) {
		mut iife_temp_0 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Settings{}
		mut iife_result_0 := iife_temp_0.create()
		var_oParserState_mutated = create_automattic_woocommerce_vendor_sabberworm_css_parsing_parserstate(var_oParserState_mutated,
			iife_result_0)
	}
	...
	for rt.is_true(rt.new_bool(!(rt.is_true(var_oParserState_mutated.isend())))) {
		...
		if rt.is_true(var_bLenientParsing) {
			var_oListItem = Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.parselistitem(mut var_oParserState_mutated, mut
				var_oList)
			if rt.has_exception() {
				unsafe {
					goto catch_label_1
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(var_bIsRoot))))
		...
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_SourceException',
			[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_parsing_sourceexception(rt.new_string('Unexpected end of document'),
...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.parselistitem(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState, mut var_oList Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList) rt.PhpVal {
	...
	if rt.is_true(var_oParserState_mutated.comes(rt.new_string('@'))) {
		mut var_oAtRule :=
			Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.parseatrule(mut var_oParserState_mutated)
		if rt.is_true(rt.new_bool(rt.instance_of(var_oAtRule,
			'Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_Charset')))
		{
			if rt.is_true(rt.new_bool(!(rt.is_true(var_bIsRoot)))) {
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_UnexpectedTokenException',
					[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_parsing_unexpectedtokenexception(rt.new_string('@charset may only occur in root document'),
					rt.new_string(''), rt.new_string('custom'),
					var_oParserState_mutated.currentline())))
			}
			if var_oList.getcontents().array_count() > 0 {
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_UnexpectedTokenException',
					[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_parsing_unexpectedtokenexception(rt.new_string('@charset must be the first parseable token in a document'),
					rt.new_string(''), rt.new_string('custom'),
					var_oParserState_mutated.currentline())))
			}
		...
		if rt.is_true(var_bIsRoot) {
			if rt.is_true(rt.get_property(var_oParserState_mutated.getsettings(), 'bLenientParsing')) {
				mut iife_temp_1 :=
					Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_RuleSet_DeclarationBlock{}
				...
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_SourceException',
					[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_parsing_sourceexception(rt.new_string('Unopened {'),
					var_oParserState_mutated.currentline())))
			}
		} else {
			return rt.new_null()
		...
		mut iife_temp_2 :=
			Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_RuleSet_DeclarationBlock{}
		mut iife_result_2 := iife_temp_2.parse(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState',
...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.parseatrule(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	...
	if rt.is_true(rt.identical(var_sIdentifier, rt.new_string('import'))) {
		mut iife_temp_3 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL{}
		mut iife_result_3 := iife_temp_3.parse(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState',
			[]string{}, var_oParserState_mutated))
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(var_oParserState_mutated.comes(rt.new_string(';')))))) {
			var_sMediaQuery = rt.new_string(var_oParserState_mutated.consumeuntil(rt.create_array([
				...
				rt.ArrayItem{
					key: none
					val: Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState.eof()
				},
		...
		return rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_Import',
			[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_property_import(var_oLocation.clone(), if rt.is_true(var_sMediaQuery) {
			var_sMediaQuery
		} else {
			rt.new_null()
		}, var_iIdentifierLineNum.clone()))
	} else if rt.is_true(rt.identical(var_sIdentifier, rt.new_string('charset'))) {
		mut iife_temp_4 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSString{}
		mut iife_result_4 := iife_temp_4.parse(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState',
			[]string{}, var_oParserState_mutated))
		...
		return rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_Charset',
			[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_property_charset(var_oCharsetString.clone(),
			var_iIdentifierLineNum.clone()))
	} else if rt.is_true(Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.identifieris(var_sIdentifier.clone(),
		rt.new_string('keyframes')))
	{
		mut var_oResult :=
			create_automattic_woocommerce_vendor_sabberworm_css_csslist_keyframe(var_iIdentifierLineNum.clone())
		...
		Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.parselist(mut var_oParserState_mutated, mut
			var_oResult)
		if rt.is_true(var_oParserState_mutated.comes(rt.new_string('}'))) {
			var_oParserState_mutated.consume(rt.new_string('}'))
		}
		return rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame',
			[]string{}, var_oResult)
	} else if rt.is_true(rt.identical(var_sIdentifier, rt.new_string('namespace'))) {
		mut var_sPrefix := rt.new_null()
		mut iife_temp_5 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Value{}
		mut iife_result_5 := iife_temp_5.parseprimitivevalue(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState',
			[]string{}, var_oParserState_mutated))
		mut var_mUrl := iife_result_5
		if rt.is_true(rt.new_bool(!(rt.is_true(var_oParserState_mutated.comes(rt.new_string(';')))))) {
			var_sPrefix = var_mUrl.clone()
			mut iife_temp_6 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Value{}
			mut iife_result_6 := iife_temp_6.parseprimitivevalue(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState',
				[]string{}, var_oParserState_mutated))
		...
		if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(var_sPrefix, rt.new_null()))))
			...
			rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_UnexpectedTokenException',
				[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_parsing_unexpectedtokenexception(rt.new_string('Wrong namespace prefix'),
				var_sPrefix.clone(), rt.new_string('custom'), var_iIdentifierLineNum.clone())))
		}
		if !(
			rt.is_true(rt.new_bool(rt.instance_of(var_mUrl, 'Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSString')))
			|| rt.is_true(rt.new_bool(rt.instance_of(var_mUrl, 'Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL')))) {
			rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_UnexpectedTokenException',
				[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_parsing_unexpectedtokenexception(rt.new_string('Wrong namespace url of invalid type'),
				var_mUrl.clone(), rt.new_string('custom'), var_iIdentifierLineNum.clone())))
		}
		return rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_CSSNamespace',
			[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_property_cssnamespace(var_mUrl.clone(),
			...
			rt.new_string(')')])))))
		{
			if rt.is_true(rt.get_property(var_oParserState_mutated.getsettings(), 'bLenientParsing')) {
				...
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_SourceException',
					[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_parsing_sourceexception(rt.new_string('Unmatched brace count in media query'),
					var_oParserState_mutated.currentline())))
			}
		}
		mut var_bUseRuleSet := rt.new_bool(true)
		mut iter_1 := rt.call_function('explode', [rt.new_string('/'),
			Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_AtRule.block_rules()]).iterator()
		for {
			item_1 := iter_1.next() or { break }
			mut var_sBlockRuleName := item_1.val
			if rt.is_true(Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.identifieris(var_sIdentifier.clone(),
		...
		if rt.is_true(var_bUseRuleSet) {
			mut var_oAtRule := create_automattic_woocommerce_vendor_sabberworm_css_ruleset_atruleset(var_sIdentifier.clone(),
				var_sArgs.clone(), var_iIdentifierLineNum.clone())
			mut iife_temp_7 := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_RuleSet_RuleSet{}
			mut iife_result_7 := iife_temp_7.parseruleset(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState',
				[]string{}, var_oParserState_mutated), var_oAtRule.clone())
		} else {
			var_oAtRule = create_automattic_woocommerce_vendor_sabberworm_css_csslist_atruleblocklist(var_sIdentifier.clone(),
				var_sArgs.clone(), var_iIdentifierLineNum.clone())
			Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.parselist(mut var_oParserState_mutated, mut
				rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList](var_oAtRule))
			if rt.is_true(var_oParserState_mutated.comes(rt.new_string('}'))) {
				var_oParserState_mutated.consume(rt.new_string('}'))
			}
		}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList) removedeclarationblockbyselector(var_mSelector rt.PhpVal, bRemoveAll bool) {
	...
	for {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_mSel,
			'Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_Selector'))))))
		{
			mut iife_temp_8 :=
				Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_Selector{}
			mut iife_result_8 := iife_temp_8.isvalid(var_mSel.clone())
			if rt.is_true(rt.new_bool(!(rt.is_true(iife_result_8)))) {
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_UnexpectedTokenException',
					[]string{}, create_automattic_woocommerce_vendor_sabberworm_css_parsing_unexpectedtokenexception(
					"Selector did not match '" +
					(Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_Selector.selector_validation_rx()).str() + "'.",
					var_mSel.clone(), rt.new_string('custom'))))
			}
			var_mSel =
				create_automattic_woocommerce_vendor_sabberworm_css_property_selector(var_mSel.clone())
		}
	}
...
fn create_automattic_woocommerce_vendor_sabberworm_css_parsing_parserstate(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_settings(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Settings {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_parsing_sourceexception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_SourceException {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_ruleset_declarationblock(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_RuleSet_DeclarationBlock {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_property_import(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_Import {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_property_charset(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_Charset {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_csslist_keyframe(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_value_value(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Value {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_property_cssnamespace(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Property_CSSNamespace {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_ruleset_atruleset(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_RuleSet_AtRuleSet {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_csslist_atruleblocklist(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_AtRuleBlockList {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'parseList' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
			Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.parselist(mut dispatch_arg_0, mut
				dispatch_arg_1)
			return rt.new_null()
		}
		'parseListItem' {
			...
			return Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.parselistitem(mut dispatch_arg_0, mut
				dispatch_arg_1)
		}
		'parseAtRule' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState](if args.len > 0 {
		...
		'identifierIs' {
			...
			return Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList.identifieris(dispatch_arg_0,
				dispatch_arg_1)
		}
		'prepend' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
		...
		'renderListContents' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
