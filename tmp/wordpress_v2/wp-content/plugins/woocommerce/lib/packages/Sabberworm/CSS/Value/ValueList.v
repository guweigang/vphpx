...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList) construct(var_aComponents rt.PhpVal, sSeparator string, iLineNo i64) {
	mut var_aComponents_mutated := var_aComponents
	this.Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Value.construct(rt.new_int(iLineNo))
	if !(var_aComponents_mutated.clone().is_array()) {
		var_aComponents_mutated = rt.create_array([
			rt.ArrayItem{ key: none, val: var_aComponents_mutated },
		])
	}
	this.aComponents = var_aComponents_mutated.clone()
	this.sSeparator = rt.new_string(sSeparator)
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList) addlistcomponent(var_mComponent rt.PhpVal) {
	this.aComponents.array_push(var_mComponent.clone())
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList) getlistcomponents() rt.PhpVal {
	return this.aComponents
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList) setlistcomponents(mut var_aComponents Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_array) {
	mut var_aComponents_mutated := var_aComponents
	this.aComponents = var_aComponents_mutated
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList) getlistseparator() rt.PhpVal {
	return this.sSeparator
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList) setlistseparator(var_sSeparator rt.PhpVal) {
	this.sSeparator = var_sSeparator.clone()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList) magic_tostring() rt.PhpVal {
	return this.render(create_automattic_woocommerce_vendor_sabberworm_css_outputformat())
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList) render(var_oOutputFormat rt.PhpVal) rt.PhpVal {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_value_valuelist(arg_0 rt.PhpVal, sSeparator string, iLineNo i64) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList {
