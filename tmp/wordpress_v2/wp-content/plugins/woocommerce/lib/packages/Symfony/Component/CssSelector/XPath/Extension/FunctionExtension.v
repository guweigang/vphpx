...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) getfunctiontranslators() rt.PhpVal {
	return rt.create_array([
		rt.ArrayItem{ key: 'nth-child', val: rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension', [
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) translatenthchild(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr, mut var_function Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode, last bool, addNameTest bool) rt.PhpVal {
	...
	mut iife_temp_0 :=
		Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Parser_Parser{}
	...
	if rt.instance_of(var_e_1,
		'Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException')
	{
		...
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_ExpressionErrorException',
			[]string{}, create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_expressionerrorexception(rt.call_function('sprintf', [
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) translatenthlastoftype(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr, mut var_function Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode) rt.PhpVal {
	if rt.is_true(rt.identical(rt.new_string('*'), var_xpath.getelement())) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_ExpressionErrorException',
			[]string{},
			create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_expressionerrorexception(rt.new_string('"*:nth-of-type()" is not implemented.'))))
	}
	return this.translatenthchild(mut var_xpath, mut var_function, true, false)
}
