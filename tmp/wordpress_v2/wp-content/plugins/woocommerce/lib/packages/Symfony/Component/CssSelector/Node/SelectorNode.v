...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_SelectorNode) getspecificity() rt.PhpVal {
	return rt.call_method(rt.call_method(this.tree, 'getSpecificity', []rt.PhpVal{}), 'plus', [create_automattic_woocommerce_vendor_symfony_component_cssselector_node_specificity(rt.new_int(0), rt.new_int(0), if rt.is_true(this.pseudoElement) { 1 } else { 0 })])
}
