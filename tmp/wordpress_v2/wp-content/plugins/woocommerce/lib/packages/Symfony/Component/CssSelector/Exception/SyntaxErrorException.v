...
fn Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException.unexpectedtoken(expectedValue string, mut var_foundToken Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Parser_Token) rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_self',
		[]string{}, create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_self(rt.call_function('sprintf', [
...
fn Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException.nestednot() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_self',
		[]string{},
		create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_self(rt.new_string('Got nested ::not().')))
}
...
fn Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException.stringasfunctionargument() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_self',
		[]string{},
		create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_self(rt.new_string('String not allowed as function argument.')))
}
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_self(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_self {
