...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode) getspecificity() rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_Specificity', []string{}, create_automattic_woocommerce_vendor_symfony_component_cssselector_node_specificity(rt.new_int(0), rt.new_int(0), if rt.is_true(this.element) { 1 } else { 0 }))
}
