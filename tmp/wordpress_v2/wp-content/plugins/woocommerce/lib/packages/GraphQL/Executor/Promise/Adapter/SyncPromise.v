...
mut iife_temp_0 := Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromiseQueue{}
...
fn Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromise.getqueue() rt.PhpVal {
	mut iife_temp_1 := Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromiseQueue{}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromise) resolve(var_value rt.PhpVal) rt.PhpVal {
	...
	if rt.is_true(rt.equal(switch_val_1, Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromise.pending())) {
		...
		if var_value.clone().is_object() && rt.is_true(rt.call_function('method_exists', [var_value.clone(), rt.new_string('then')])) {
			closure_3_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
				mut var_resolvedValue := if args.len > 0 { args[0].clone() } else { rt.new_null() }
				this.resolve(var_resolvedValue.clone())
				return rt.new_null()
				}
			...
			rt.call_method(var_value, 'then', [rt.new_closure(closure_3_fn), rt.new_closure(closure_4_fn)])
		...
		if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(this.result, var_value)))) {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromise) reject(mut var_reason Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Throwable) rt.PhpVal {
	...
	if rt.is_true(rt.equal(switch_val_2, Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromise.pending())) {
		...
		if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(var_reason, this.result)))) {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromise) then(mut var_onFulfilled Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_?callable, mut var_onRejected Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_?callable) rt.PhpVal {
	if rt.is_true(rt.identical(this.state, Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromise.rejected())) && rt.is_true(rt.identical(var_onRejected, rt.new_null())) {
		return mut this
	}
	if rt.is_true(rt.identical(this.state, Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromise.fulfilled())) && rt.is_true(rt.identical(var_onFulfilled, rt.new_null())) {
		return mut this
	}
	...
	if rt.is_true(rt.new_bool(!rt.is_true(rt.identical(this.state, Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromise.pending())))) {
		this.enqueuewaitingpromises()
	}
...
closure_5_fn := fn [var_waiting, var_result] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	...
	for {
		...
		if rt.is_true(rt.new_bool(rt.instance_of(var_result, 'Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Throwable'))) {
			if rt.is_true(rt.identical(var_onRejected, rt.new_null())) {
				var_child.reject(var_result.clone())
				if rt.has_exception() { unsafe { goto catch_label_1 } }
			} else {
				var_child.resolve(rt.call_callable(var_onRejected, [var_result.clone()]))
				if rt.has_exception() { unsafe { goto catch_label_1 } }
			}
			if rt.has_exception() { unsafe { goto catch_label_1 } }
		} else {
			var_child.resolve(if rt.is_true(rt.identical(var_onFulfilled, rt.new_null())) { var_result } else { rt.call_callable(var_onFulfilled, [var_result.clone()]) })
			if rt.has_exception() { unsafe { goto catch_label_1 } }
		}
		if rt.has_exception() { unsafe { goto catch_label_1 } }
...
mut iife_temp_5 := Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_SyncPromiseQueue{}
mut iife_result_5 := iife_temp_5.enqueue(rt.new_closure(closure_5_fn))
}
...
fn create_automattic_woocommerce_vendor_graphql_executor_promise_adapter_exception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Exception {
...
fn create_automattic_woocommerce_vendor_graphql_executor_promise_adapter_self(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_self {
