...
fn init_static_automattic_woocommerce_vendor_graphql_type_definition_type() {
		rt.init_static_prop('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type', 'builtInScalars', rt.new_null())
		rt.init_static_prop('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type', 'builtInTypes', rt.new_null())
}
...
fn Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type.listof(var_type rt.PhpVal) rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ListOfType', []string{}, create_automattic_woocommerce_vendor_graphql_type_definition_listoftype(var_type.clone()))
}
...
fn Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type.nonnull(var_type rt.PhpVal) rt.PhpVal {
	...
	return rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_NonNull', []string{}, create_automattic_woocommerce_vendor_graphql_type_definition_nonnull(var_type.clone()))
}
...
fn Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type.overridestandardtypes(mut var_types Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_array) {
	rt.set_static_prop('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type', 'builtInTypes', rt.new_null())
	mut iife_temp_0 := Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Introspection{}
	mut iife_result_0 := iife_temp_0.resetcachedinstances()
	mut iife_temp_1 := Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Directive{}
	mut iife_result_1 := iife_temp_1.resetcachedinstances()
	...
	for {
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_type, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ScalarType')))))) {
			...
			mut iife_result_2 := iife_temp_2.printsafe(var_type.clone())
			mut var_notType := iife_result_2
		...
		if rt.is_true(rt.new_bool(!(rt.is_true(Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type.isbuiltinscalarname((rt.get_property(var_type, 'name')).str()))))) {
			...
			mut iife_result_3 := iife_temp_3.printsafe(rt.get_property(var_type, 'name'))
			mut var_notStandardTypeName := iife_result_3
		...
		rt.get_static_prop('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type', 'builtInScalars').array_set(rt.get_property(var_type, 'name'), var_type.clone())
	}
}
