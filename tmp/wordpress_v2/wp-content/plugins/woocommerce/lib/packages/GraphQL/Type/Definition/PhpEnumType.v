...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_PhpEnumType) construct(enumClass string, mut var_name Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_?string, mut var_description Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_?string, mut var_astNode Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_?EnumTypeDefinitionNode, mut var_extensionASTNodes Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_?array) {
	...
	mut var_reflection := create_automattic_woocommerce_vendor_graphql_type_definition_reflectionenum(rt.new_string(enumClass))
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_PhpEnumType) serialize(var_value rt.PhpVal) string {
	...
	if rt.is_true(rt.call_function('is_a', [rt.new_string(this.enumClass), Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_BackedEnum.class(), rt.new_bool(true)])) {
		mut iife_temp_0 := Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_{"nodeType":"Expr_PropertyFetch","line":70,"var":{"nodeType":"Expr_Variable","line":70,"name":"this"},"name":"enumClass"}{}
		mut iife_result_0 := iife_temp_0.from(var_value.clone())
		mut var_instance := iife_result_0
...
catch_label_1:
		...
		if rt.instance_of(var_e_1, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ValueError') || rt.instance_of(var_e_1, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_TypeError') {
			...
			mut iife_result_1 := iife_temp_1.printsafe(var_value.clone())
			mut var_notEnumInstanceOrValue := iife_result_1
...
end_label_1:
	...
	mut iife_result_2 := iife_temp_2.printsafe(var_value.clone())
	mut var_notEnum := iife_result_2
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_PhpEnumType) parsevalue(var_value rt.PhpVal) rt.PhpVal {
	...
	return this.Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_EnumType.parsevalue(var_value.clone())
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_PhpEnumType) basename(class string) string {
	...
	return (rt.call_function('end', [var_parts.clone()])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_PhpEnumType) extractdescription(mut var_reflection Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_{"nodeType":"UnionType","line":106,"types":["ReflectionClassConstant","ReflectionClass"]}) string {
	...
	if var_attributes.clone().array_count() == 1 {
		return (rt.get_property(rt.call_method(var_attributes.array_get(rt.new_int(0)), 'newInstance', []rt.PhpVal{}), 'description')).str()
	}
	if var_attributes.clone().array_count() > 1 {
	...
	mut iife_temp_3 := Class_Automattic_WooCommerce_Vendor_GraphQL_Utils_PhpDoc{}
	mut iife_result_3 := iife_temp_3.unpad(var_comment.clone())
	mut var_unpadded := iife_result_3
	mut iife_temp_4 := Class_Automattic_WooCommerce_Vendor_GraphQL_Utils_PhpDoc{}
	mut iife_result_4 := iife_temp_4.unwrap(var_unpadded.clone())
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_PhpEnumType) deprecationreason(mut var_reflection Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ReflectionClassConstant) string {
	...
	if var_attributes.clone().array_count() == 1 {
		return (rt.get_property(rt.call_method(var_attributes.array_get(rt.new_int(0)), 'newInstance', []rt.PhpVal{}), 'reason')).str()
	}
	if var_attributes.clone().array_count() > 1 {
...
fn create_automattic_woocommerce_vendor_graphql_type_definition_reflectionenum(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ReflectionEnum {
...
fn create_automattic_woocommerce_vendor_graphql_type_definition_{"nodetype":"expr_propertyfetch","line":70,"var":{"nodetype":"expr_variable","line":70,"name":"this"},"name":"enumclass"}(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_{"nodeType":"Expr_PropertyFetch","line":70,"var":{"nodeType":"Expr_Variable","line":70,"name":"this"},"name":"enumClass"} {
...
fn create_automattic_woocommerce_vendor_graphql_type_definition_exception(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Exception {
