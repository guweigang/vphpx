...
fn init_static_automattic_woocommerce_vendor_graphql_type_definition_directive() {
	rt.init_static_prop('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Directive',
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Directive) construct(mut var_config Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_array) {
	...
	this.isRepeatable = if !(var_config.array_get(rt.new_string('isRepeatable'))).is_null() {
		var_config.array_get(rt.new_string('isRepeatable'))
	} else {
		rt.new_bool(false)
	}
	this.locations = var_config.array_get(rt.new_string('locations'))
...
fn Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Directive.resetcachedinstances() {
	rt.set_static_prop('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Directive',
		'internalDirectives', rt.new_null())
}
