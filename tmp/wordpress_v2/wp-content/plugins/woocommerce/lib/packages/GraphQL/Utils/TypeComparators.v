...
fn Class_Automattic_WooCommerce_Vendor_GraphQL_Utils_TypeComparators.isequaltype(mut var_typeA Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type, mut var_typeB Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type) bool {
	...
	if rt.is_true(rt.new_bool(rt.instance_of(rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type', []string{}, var_typeA), 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_NonNull')))
	...
	if rt.is_true(rt.new_bool(rt.instance_of(rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type', []string{}, var_typeA), 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ListOfType')))
...
fn Class_Automattic_WooCommerce_Vendor_GraphQL_Utils_TypeComparators.istypesubtypeof(mut var_schema Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Schema, mut var_maybeSubType Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type, mut var_superType Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type) bool {
	...
	mut iife_result_0 := iife_temp_0.isabstracttype(rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type',
		[]string{}, var_superType))
...
fn Class_Automattic_WooCommerce_Vendor_GraphQL_Utils_TypeComparators.aresamebuiltinscalar(mut var_typeA Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type, mut var_typeB Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type) bool {
	...
	mut iife_result_1 := iife_temp_1.isbuiltinscalar(rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type',
		[]string{}, var_typeA))
	mut iife_temp_2 := Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type{}
	mut iife_result_2 := iife_temp_2.isbuiltinscalar(rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type',
		[]string{}, var_typeB))
	return rt.is_true(iife_result_1) && rt.is_true(iife_result_2)
