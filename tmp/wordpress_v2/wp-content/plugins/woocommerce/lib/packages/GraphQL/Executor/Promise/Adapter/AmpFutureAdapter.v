...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter) convertthenable(var_thenable rt.PhpVal) rt.PhpVal {
	return rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Promise', []string{}, create_automattic_woocommerce_vendor_graphql_executor_promise_promise(var_thenable.clone(), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter', ['PromiseAdapter'], &this)))
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter) then(mut var_promise Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Promise, mut var_onFulfilled Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_?callable, mut var_onRejected Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_?callable) rt.PhpVal {
	...
	catch_label_1:
		...
		if rt.instance_of(var_e_1, 'Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Throwable') {
			mut var_reason := var_e_1.clone()
			if rt.is_true(rt.identical(var_onRejected, rt.new_null())) {
				rt.throw_exception(var_reason)
			}
			return Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter.unwrapresult(rt.call_callable(var_onRejected, [var_reason.clone()]))
			unsafe { goto end_label_1 }
		}
		else {
	...
	end_label_1:
		...
		return Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter.unwrapresult(rt.call_callable(var_onFulfilled, [var_value.clone()]))
		}
	...
	return rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Promise', []string{}, create_automattic_woocommerce_vendor_graphql_executor_promise_promise(var_next.clone(), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter', ['PromiseAdapter'], &this)))
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter) create(mut var_resolver Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_callable) rt.PhpVal {
	...
	closure_3_fn := fn [var_deferred] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		...
		Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter.resolvedeferred(mut rt.new_object('Amp_DeferredFuture', []string{}, var_deferred), var_value.clone())
		if rt.has_exception() { unsafe { goto catch_label_3 } }
		return rt.new_null()
		}
	closure_4_fn := fn [var_deferred] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		mut var_exception := if args.len > 0 { args[0].clone() } else { rt.new_null() }
		var_deferred.error(var_exception.clone())
		if rt.has_exception() { unsafe { goto catch_label_3 } }
		return rt.new_null()
		}
...
end_label_3:
	return rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Promise', []string{}, create_automattic_woocommerce_vendor_graphql_executor_promise_promise(var_deferred.getfuture(), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter', ['PromiseAdapter'], &this)))
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter) createfulfilled(var_value rt.PhpVal) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(rt.instance_of(var_value_mutated, 'Amp_Future'))) {
		return rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Promise', []string{}, create_automattic_woocommerce_vendor_graphql_executor_promise_promise(var_value_mutated.clone(), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter', ['PromiseAdapter'], &this)))
	}
	mut iife_temp_4 := Class_Amp_Future{}
	mut iife_result_4 := iife_temp_4.complete(var_value_mutated.clone())
	return rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Promise', []string{}, create_automattic_woocommerce_vendor_graphql_executor_promise_promise(iife_result_4, rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter', ['PromiseAdapter'], &this)))
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter) createrejected(mut var_reason Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Throwable) rt.PhpVal {
	mut iife_temp_5 := Class_Amp_Future{}
	mut iife_result_5 := iife_temp_5.error(rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Throwable', []string{}, var_reason))
	return rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Promise', []string{}, create_automattic_woocommerce_vendor_graphql_executor_promise_promise(iife_result_5, rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter', ['PromiseAdapter'], &this)))
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter) all(mut var_promisesOrValues Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_iterable) rt.PhpVal {
	mut var_items := if var_promisesOrValues.is_array() { var_promisesOrValues } else { rt.call_function('iterator_to_array', [var_promisesOrValues]) }
	...
	for {
		...
		if rt.is_true(rt.new_bool(rt.instance_of(var_item, 'Amp_Future'))) {
			var_futures.array_set(var_key, var_item.clone())
		}
	}
	closure_7_fn := fn [var_items, var_futures] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		if rt.is_true(rt.identical(var_futures, rt.new_array())) {
			return var_items.clone()
		}
		mut var_resolved := rt.call_function('await', [var_futures.clone()])
		return rt.call_function('array_replace', [var_items.clone(), var_resolved.clone()])
		}
	closure_8_fn := fn [var_items, var_futures] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		if rt.is_true(rt.identical(var_futures, rt.new_array())) {
			return var_items.clone()
		}
		mut var_resolved := rt.call_function('await', [var_futures.clone()])
	...
	mut var_combined := rt.call_function('async', [rt.new_closure(closure_7_fn)])
	return rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Promise', []string{}, create_automattic_woocommerce_vendor_graphql_executor_promise_promise(var_combined.clone(), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter', ['PromiseAdapter'], &this)))
}
...
fn Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter.resolvedeferred(mut var_deferred Class_Amp_DeferredFuture, var_value rt.PhpVal) {
	...
	if rt.is_true(rt.new_bool(rt.instance_of(var_value_mutated, 'Amp_Future'))) {
		closure_9_fn := fn [var_deferred, var_value] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		...
		catch_label_4:
			...
			if rt.instance_of(var_e_4, 'Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_Throwable') {
				...
				var_deferred_mutated.error(var_exception.clone())
				unsafe { goto end_label_4 }
			}
			else {
		...
		closure_10_fn := fn [var_deferred, var_value] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
			var_deferred_mutated.complete(rt.call_method(var_value_mutated, 'await', []rt.PhpVal{}))
		...
		rt.call_function('async', [rt.new_closure(closure_9_fn)])
		return
	}
	var_deferred_mutated.complete(var_value_mutated.clone())
}
...
fn create_automattic_woocommerce_vendor_graphql_executor_promise_adapter_ampfutureadapter(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_AmpFutureAdapter {
...
fn create_amp_deferredfuture(_args ...rt.PhpVal) &Class_Amp_DeferredFuture {
...
fn create_amp_future(_args ...rt.PhpVal) &Class_Amp_Future {
