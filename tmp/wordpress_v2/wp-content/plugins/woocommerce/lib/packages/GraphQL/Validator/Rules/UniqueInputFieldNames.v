...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Validator_Rules_UniqueInputFieldNames) getastvisitor(mut var_context Class_Automattic_WooCommerce_Vendor_GraphQL_Validator_ValidationContext) rt.PhpVal {
	...
	closure_2_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
		...
		rt.call_function('assert', [rt.new_bool(var_knownNames.clone().is_array()),
			rt.new_string('should not happen if the visitor works correctly')])
		this.knownNames = var_knownNames.clone()
		return rt.new_null()
	}
...
fn create_automattic_woocommerce_vendor_graphql_validator_rules_uniqueinputfieldnames(_args ...rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Validator_Rules_UniqueInputFieldNames {
