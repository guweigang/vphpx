...
fn (mut this Class_WC_Shipping_Local_Pickup) init() {
	...
	rt.call_function('add_action', [rt.new_string('woocommerce_update_options_shipping_' + rt.get_property(rt.new_object('WC_Shipping_Local_Pickup', ['WC_Shipping_Method'], &this), 'id')), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_Shipping_Local_Pickup', ['WC_Shipping_Method'], &this) }, rt.ArrayItem{ key: none, val: 'process_admin_options' }])])
}
