...
fn Class_WC_Twenty_Twenty_Two.enqueue_styles(var_styles rt.PhpVal) rt.PhpVal {
	...
	var_styles_mutated.array_set('woocommerce-general', rt.create_array([
		rt.ArrayItem{ key: 'src', val:
			...
			'/assets/css/twenty-twenty-two.css' },
	...
	return rt.call_function('apply_filters', [
		rt.new_string('woocommerce_twenty_twenty_two_styles'),
...
fn create_wc_twenty_twenty_two(_args ...rt.PhpVal) &Class_WC_Twenty_Twenty_Two {
