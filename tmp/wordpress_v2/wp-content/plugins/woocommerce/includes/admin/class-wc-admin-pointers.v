...
fn (mut this Class_WC_Admin_Pointers) create_product_tutorial() {
	...
	if !(rt.get_superglobal('_GET').array_isset(rt.new_string('tutorial')))
	...
	mut var_labels := rt.get_property(var_wp_post_types.array_get(rt.new_string('product')),
		'labels')
	...
	mut iife_result_0 := iife_temp_0.register_script(rt.new_string('wp-admin-scripts'),
		rt.new_string('product-tour'), rt.new_bool(true))
}
...
fn (mut this Class_WC_Admin_Pointers) create_variable_product_tutorial() {
	...
	mut iife_result_1 := iife_temp_1.register_script(rt.new_string('wp-admin-scripts'),
		rt.new_string('variable-product-tour'), rt.new_bool(true))
}
...
fn (mut this Class_WC_Admin_Pointers) create_wc_addons_tutorial() {
	...
	mut iife_result_2 := iife_temp_2.register_script(rt.new_string('wp-admin-scripts'),
		rt.new_string('wc-addons-tour'), rt.new_bool(true))
}
