...
fn (mut this Class_WC_Report_Out_Of_Stock) no_items() {
	rt.call_function('esc_html_e', [rt.new_string('No out of stock products found.'),
...
fn (mut this Class_WC_Report_Out_Of_Stock) get_items(var_current_page rt.PhpVal, var_per_page rt.PhpVal) {
	...
	mut var_query_from := rt.call_function('apply_filters', [
		rt.new_string('woocommerce_report_out_of_stock_query_from'),
...
fn create_wc_report_out_of_stock(_args ...rt.PhpVal) &Class_WC_Report_Out_Of_Stock {
