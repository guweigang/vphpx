...
fn (mut this Class_WC_Legacy_Shipping_Zone) update() bool {
	rt.call_function('wc_deprecated_function', [
...
fn (mut this Class_WC_Legacy_Shipping_Zone) create() bool {
	rt.call_function('wc_deprecated_function', [
...
fn (mut this Class_WC_Legacy_Shipping_Zone) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'update' {
			return rt.new_bool(this.update())
		}
		'create' {
