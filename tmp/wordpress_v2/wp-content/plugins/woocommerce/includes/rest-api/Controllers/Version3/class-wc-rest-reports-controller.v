...
fn (mut this Class_WC_REST_Reports_Controller) get_reports() rt.PhpVal {
	...
	var_reports.array_push(rt.create_array([
		rt.ArrayItem{ key: 'slug', val: 'orders/totals' },
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Orders totals.'),
			rt.new_string('woocommerce'),
		]) },
	]))
	var_reports.array_push(rt.create_array([
		rt.ArrayItem{ key: 'slug', val: 'products/totals' },
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Products totals.'),
			rt.new_string('woocommerce'),
		]) },
	]))
	var_reports.array_push(rt.create_array([
		rt.ArrayItem{ key: 'slug', val: 'customers/totals' },
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Customers totals.'),
			rt.new_string('woocommerce'),
		]) },
	]))
	var_reports.array_push(rt.create_array([
		rt.ArrayItem{ key: 'slug', val: 'coupons/totals' },
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Coupons totals.'),
			rt.new_string('woocommerce'),
		]) },
	]))
	var_reports.array_push(rt.create_array([
		rt.ArrayItem{ key: 'slug', val: 'reviews/totals' },
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Reviews totals.'),
			rt.new_string('woocommerce'),
		]) },
	]))
	var_reports.array_push(rt.create_array([
		rt.ArrayItem{ key: 'slug', val: 'categories/totals' },
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Categories totals.'),
			rt.new_string('woocommerce'),
		]) },
	]))
	var_reports.array_push(rt.create_array([
		rt.ArrayItem{ key: 'slug', val: 'tags/totals' },
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Tags totals.'),
			rt.new_string('woocommerce'),
		]) },
	]))
	var_reports.array_push(rt.create_array([
		rt.ArrayItem{ key: 'slug', val: 'attributes/totals' },
		rt.ArrayItem{ key: 'description', val: rt.call_function('__', [
			rt.new_string('Attributes totals.'),
			rt.new_string('woocommerce'),
		]) },
	]))
...
fn create_wc_rest_reports_v2_controller(_args ...rt.PhpVal) &Class_WC_REST_Reports_V2_Controller {
