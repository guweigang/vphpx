...
fn (mut this Class_WC_REST_Product_Categories_V2_Controller) prepare_item_for_response(var_item rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	return rt.call_function('apply_filters', [
		rt.concat(rt.new_string('woocommerce_rest_prepare_'), rt.get_property(rt.new_object('WC_REST_Product_Categories_V2_Controller', [
...
fn (mut this Class_WC_REST_Product_Categories_V2_Controller) get_item_schema() rt.PhpVal {
	mut var_schema := {
		...
		'title':      rt.get_property(rt.new_object('WC_REST_Product_Categories_V2_Controller', [
			'WC_REST_Product_Categories_V1_Controller',
		], &this), 'taxonomy')
