...
fn (mut this Class_WC_REST_Product_Shipping_Classes_V1_Controller) get_item_schema() rt.PhpVal {
	mut var_schema := {
		...
		'properties': {
			...
			'name':        {
				'description': rt.call_function('__', [
					rt.new_string('Shipping class name.'),
					rt.new_string('woocommerce'),
				])
...
fn create_wc_rest_product_shipping_classes_v1_controller(_args ...rt.PhpVal) &Class_WC_REST_Product_Shipping_Classes_V1_Controller {
