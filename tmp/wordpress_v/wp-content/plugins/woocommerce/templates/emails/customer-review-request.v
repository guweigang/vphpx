...
pub fn init_wp_content_plugins_woocommerce_templates_emails_customer_review_request_php() {
	...
	if !(!rt.is_true(var_review_order_url)) {
		// unsupported statement: Stmt_InlineHTML
		rt.echo_val(rt.call_function('esc_url', [var_review_order_url.dup()]))
		// unsupported statement: Stmt_InlineHTML
		rt.call_function('esc_html_e', [rt.new_string('Leave a review'),
			rt.new_string('woocommerce')])
		// unsupported statement: Stmt_InlineHTML
	}
