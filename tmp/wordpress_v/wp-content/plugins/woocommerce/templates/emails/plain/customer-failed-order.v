...
pub fn init_wp_content_plugins_woocommerce_templates_emails_plain_customer_failed_order_php() {
	...
	print((rt.call_function('esc_html__', [rt.new_string('Unfortunately, we couldn\'t complete your order due to an issue with your payment method.'), rt.new_string('woocommerce')])).str() + '\n\n')
	print((rt.call_function('sprintf', [rt.call_function('esc_html__', [rt.new_string('If you\'d like to continue with your purchase, please return to %s and try a different method of payment.'), rt.new_string('woocommerce')]), rt.call_function('esc_html', [var_blogname.dup()])])).str() + '\n\n')
	print((rt.call_function('esc_html__', [rt.new_string('Your order details are as follows:'), rt.new_string('woocommerce')])).str() + '\n\n')
