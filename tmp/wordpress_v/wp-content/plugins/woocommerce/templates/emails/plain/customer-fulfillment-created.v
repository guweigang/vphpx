...
pub fn init_wp_content_plugins_woocommerce_templates_emails_plain_customer_fulfillment_created_php() {
	...
	print('\n=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n\n')
	print((rt.call_function('esc_html__', [rt.new_string('Woo! Some items you purchased are being fulfilled. You can use the below information to track your shipment:'), rt.new_string('woocommerce')])).str() + '\n\n')
