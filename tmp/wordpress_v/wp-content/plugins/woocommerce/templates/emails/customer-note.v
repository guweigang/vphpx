...
pub fn init_wp_content_plugins_woocommerce_templates_emails_customer_note_php() {
	...
	rt.call_function('esc_html_e', [
		rt.new_string('The following note has been added to your order:'),
		rt.new_string('woocommerce'),
	])
	// unsupported statement: Stmt_InlineHTML
	mut var_safe_note := rt.call_function('wc_wptexturize_order_note', [
		var_customer_note.dup()])
	rt.echo_val(rt.call_function('wpautop', [
		rt.call_function('make_clickable', [var_safe_note.dup()]),
	]))
	// unsupported statement: Stmt_Nop
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('esc_html_e', [
		rt.new_string('As a reminder, here are your order details:'),
		rt.new_string('woocommerce'),
	])
	// unsupported statement: Stmt_InlineHTML
