...
pub fn init_wp_content_plugins_woocommerce_templates_emails_block_customer_fulfillment_created_php() {
	rt.new_bool(rt.is_true(rt.call_function('defined', [rt.new_string('ABSPATH')])) || rt.is_true(// unsupported expression: Expr_Exit))
	// unsupported statement: Stmt_Nop
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_html__', [rt.new_string('Your item is on the way!'), rt.new_string('woocommerce')]))
	// unsupported statement: Stmt_InlineHTML
