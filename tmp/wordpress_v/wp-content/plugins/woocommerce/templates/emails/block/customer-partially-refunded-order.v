...
pub fn init_wp_content_plugins_woocommerce_templates_emails_block_customer_partially_refunded_order_php() {
	rt.new_bool(rt.is_true(rt.call_function('defined', [rt.new_string('ABSPATH')])) || rt.is_true(// unsupported expression: Expr_Exit))
	// unsupported statement: Stmt_Nop
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('printf', [rt.call_function('esc_html__', [rt.new_string('Partial refund: Order %s'), rt.new_string('woocommerce')]), rt.new_string('<!--[woocommerce/order-number]-->')])
	// unsupported statement: Stmt_InlineHTML
	...
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('printf', [rt.call_function('esc_html__', [rt.new_string('Your order from %s has been partially refunded.'), rt.new_string('woocommerce')]), rt.new_string('<!--[woocommerce/site-title]-->')])
	// unsupported statement: Stmt_InlineHTML
