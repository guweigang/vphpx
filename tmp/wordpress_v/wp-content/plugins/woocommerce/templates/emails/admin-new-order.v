...
pub fn init_wp_content_plugins_woocommerce_templates_emails_admin_new_order_php() {
	...
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('printf', [rt.call_function('esc_html', [var_text.dup()]), rt.call_function('esc_html', [rt.call_method(var_order, 'get_formatted_billing_full_name', []rt.PhpVal{})])])
	// unsupported statement: Stmt_InlineHTML
