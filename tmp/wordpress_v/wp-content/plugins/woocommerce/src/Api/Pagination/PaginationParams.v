...
fn Class_Automattic_WooCommerce_Api_Pagination_PaginationParams.validate_args(mut var_args Class_Automattic_WooCommerce_Api_Pagination_array)  {
	Class_Automattic_WooCommerce_Api_Pagination_PaginationParams.validate_limit('first', mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Api_Pagination_?int](if !(var_args.array_get('first')).is_null() { var_args.array_get('first') } else { rt.new_null() }))
	Class_Automattic_WooCommerce_Api_Pagination_PaginationParams.validate_limit('last', mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Api_Pagination_?int](if !(var_args.array_get('last')).is_null() { var_args.array_get('last') } else { rt.new_null() }))
}
...
fn create_automattic_woocommerce_api_pagination_invalidargumentexception() &Class_Automattic_WooCommerce_Api_Pagination_InvalidArgumentException {
...
pub fn init_wp_content_plugins_woocommerce_src_api_pagination_paginationparams_php() {
