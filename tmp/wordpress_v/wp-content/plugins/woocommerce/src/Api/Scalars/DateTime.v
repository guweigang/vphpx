...
fn Class_Automattic_WooCommerce_Api_Scalars_DateTime.serialize(mut var_value Class_Automattic_WooCommerce_Api_Scalars_mixed) string {
	if rt.is_true(rt.new_bool(rt.instance_of(rt.new_object('Automattic_WooCommerce_Api_Scalars_mixed', []string{}, var_value), 'Automattic_WooCommerce_Api_Scalars_DateTimeInterface'))) {
...
fn Class_Automattic_WooCommerce_Api_Scalars_DateTime.parse(value string) rt.PhpVal {
	return create_automattic_woocommerce_api_scalars_datetimeimmutable(rt.new_string(value).dup())
...
catch_label_1:
	...
	if rt.instance_of(var_e_1, 'Automattic_WooCommerce_Api_Scalars_Exception') {
		...
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Api_Scalars_InvalidArgumentException', []string{}, create_automattic_woocommerce_api_scalars_invalidargumentexception(rt.call_function('sprintf', [rt.new_string('Invalid ISO 8601 date/time: %s'), rt.call_method(var_e, 'getMessage', []rt.PhpVal{})]), rt.new_int(0), var_e.dup())))
...
fn create_automattic_woocommerce_api_scalars_datetime() &Class_Automattic_WooCommerce_Api_Scalars_DateTime {
...
fn create_automattic_woocommerce_api_scalars_datetimeimmutable() &Class_Automattic_WooCommerce_Api_Scalars_DateTimeImmutable {
...
fn create_automattic_woocommerce_api_scalars_invalidargumentexception() &Class_Automattic_WooCommerce_Api_Scalars_InvalidArgumentException {
...
fn (mut this Class_Automattic_WooCommerce_Api_Scalars_DateTime) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'serialize' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Api_Scalars_mixed](if args.len > 0 { args[0] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_src_api_scalars_datetime_php() {
