...
struct Class_Automattic_WooCommerce_Api_InputTypes_Coupons_UpdateCouponInput {
	rt.PhpObjectBase
pub mut:
...
fn create_automattic_woocommerce_api_inputtypes_coupons_updatecouponinput() &Class_Automattic_WooCommerce_Api_InputTypes_Coupons_UpdateCouponInput {
	mut obj := &Class_Automattic_WooCommerce_Api_InputTypes_Coupons_UpdateCouponInput{
...
fn (mut this Class_Automattic_WooCommerce_Api_InputTypes_Coupons_UpdateCouponInput) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_Api_InputTypes_Coupons_UpdateCouponInput) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	match prop_name {
		'id' { return this.id }
...
fn (mut this Class_Automattic_WooCommerce_Api_InputTypes_Coupons_UpdateCouponInput) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'id' {
			this.id = val
			return true
...
pub fn init_wp_content_plugins_woocommerce_src_api_inputtypes_coupons_updatecouponinput_php() {
