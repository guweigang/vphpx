...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Formatters) magic_get(var_name rt.PhpVal) rt.PhpVal {
	if !(this.formatters.array_isset(var_name)) {
		...
		return create_automattic_woocommerce_storeapi_formatters_defaultformatter()
	}
...
fn create_automattic_woocommerce_storeapi_formatters_defaultformatter() &Class_Automattic_WooCommerce_StoreApi_Formatters_DefaultFormatter {
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_formatters_php() {
}
