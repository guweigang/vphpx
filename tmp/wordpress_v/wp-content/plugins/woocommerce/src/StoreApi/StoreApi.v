...
fn (mut this Class_Automattic_WooCommerce_StoreApi_StoreApi) init()  {
	mut var_authentication := rt.call_method(Class_Automattic_WooCommerce_StoreApi_StoreApi.container(), 'get', [Class_Automattic_WooCommerce_StoreApi_Authentication.class()])
	rt.call_function('add_filter', [rt.new_string('woocommerce_session_handler'), rt.create_array([rt.ArrayItem{ key: none, val: var_authentication }, rt.ArrayItem{ key: none, val: 'maybe_use_store_api_session_handler' }]), rt.new_int(0)])
	closure_1_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_should_load_namespace', [rt.new_string('wc/store')]))))) && rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_should_load_namespace', [rt.new_string('wc/private')]))))))) {
		return rt.new_null()
	}
	rt.call_method(rt.call_method(Class_Automattic_WooCommerce_StoreApi_StoreApi.container(), 'get', [Class_Automattic_WooCommerce_StoreApi_Legacy.class()]), 'init', []rt.PhpVal{})
	rt.call_method(rt.call_method(Class_Automattic_WooCommerce_StoreApi_StoreApi.container(), 'get', [Class_Automattic_WooCommerce_StoreApi_RoutesController.class()]), 'register_all_routes', []rt.PhpVal{})
	return rt.new_null()
	}
	rt.call_function('add_action', [rt.new_string('rest_api_init'), rt.new_closure(closure_1_fn)])
	closure_2_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_should_load_namespace', [rt.new_string('wc/store')]))))) {
		return rt.new_null()
	}
	rt.call_method(rt.call_method(Class_Automattic_WooCommerce_StoreApi_StoreApi.container(), 'get', [Class_Automattic_WooCommerce_StoreApi_Authentication.class()]), 'init', []rt.PhpVal{})
	return rt.new_null()
	}
	rt.call_function('add_action', [rt.new_string('rest_api_init'), rt.new_closure(closure_2_fn), rt.new_int(11)])
	closure_3_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_routes := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	mut var_ns := if args.len > 1 { args[1].dup() } else { rt.new_null() }
	if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
		return var_routes.dup()
	}
	var_routes = rt.call_function('array_merge', [var_routes.dup(), rt.call_method(rt.call_method(Class_Automattic_WooCommerce_StoreApi_StoreApi.container(), 'get', [Class_Automattic_WooCommerce_StoreApi_RoutesController.class()]), 'get_all_routes', [rt.new_string('v1')])])
	return var_routes.dup()
	}
	rt.call_function('add_action', [rt.new_string('woocommerce_blocks_pre_get_routes_from_namespace'), rt.new_closure(closure_3_fn), rt.new_int(10), rt.new_int(2)])
}
...
fn Class_Automattic_WooCommerce_StoreApi_StoreApi.container(reset bool) rt.PhpVal {
	...
	return create_automattic_woocommerce_storeapi_authentication()
	}
	rt.call_method(var_container, 'register', [Class_Automattic_WooCommerce_StoreApi_Authentication.class(), rt.new_closure(closure_4_fn)])
	closure_5_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_legacy()
	}
	rt.call_method(var_container, 'register', [Class_Automattic_WooCommerce_StoreApi_Legacy.class(), rt.new_closure(closure_5_fn)])
	closure_6_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_storeapi_routescontroller(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_StoreApi_SchemaController.class()]))
	}
	rt.call_method(var_container, 'register', [Class_Automattic_WooCommerce_StoreApi_RoutesController.class(), rt.new_closure(closure_6_fn)])
	closure_7_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_storeapi_schemacontroller(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_StoreApi_Schemas_ExtendSchema.class()]))
	}
	rt.call_method(var_container, 'register', [Class_Automattic_WooCommerce_StoreApi_SchemaController.class(), rt.new_closure(closure_7_fn)])
	closure_8_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_storeapi_schemas_extendschema(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_StoreApi_Formatters.class()]))
	}
	rt.call_method(var_container, 'register', [Class_Automattic_WooCommerce_StoreApi_Schemas_ExtendSchema.class(), rt.new_closure(closure_8_fn)])
	...
	rt.call_method(var_formatters, 'register', [rt.new_string('money'), Class_Automattic_WooCommerce_StoreApi_Formatters_MoneyFormatter.class()])
	rt.call_method(var_formatters, 'register', [rt.new_string('html'), Class_Automattic_WooCommerce_StoreApi_Formatters_HtmlFormatter.class()])
	rt.call_method(var_formatters, 'register', [rt.new_string('currency'), Class_Automattic_WooCommerce_StoreApi_Formatters_CurrencyFormatter.class()])
	return var_formatters.dup()
	}
	rt.call_method(var_container, 'register', [Class_Automattic_WooCommerce_StoreApi_Formatters.class(), rt.new_closure(closure_9_fn)])
	return var_container.dup()
}
...
fn create_automattic_woocommerce_storeapi_routescontroller() &Class_Automattic_WooCommerce_StoreApi_RoutesController {
...
fn create_automattic_woocommerce_storeapi_schemacontroller() &Class_Automattic_WooCommerce_StoreApi_SchemaController {
...
fn create_automattic_woocommerce_storeapi_schemas_extendschema() &Class_Automattic_WooCommerce_StoreApi_Schemas_ExtendSchema {
...
fn create_automattic_woocommerce_storeapi_formatters() &Class_Automattic_WooCommerce_StoreApi_Formatters {
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_storeapi_php() {
}
