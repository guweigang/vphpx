...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_Patterns) get_route_response(mut var_request Class_WP_REST_Request) rt.PhpVal {
	mut var_ptk_client := rt.call_method(fn () rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Blocks_Package{}
		return temp.container()
	}(), 'get', [Class_Automattic_WooCommerce_Blocks_Patterns_PTKClient.class()])
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_Patterns) get_route_post_response(mut var_request Class_WP_REST_Request) rt.PhpVal {
	mut var_ptk_patterns_store := rt.call_method(fn () rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Blocks_Package{}
		return temp.container()
	}(), 'get', [
	...
	mut var_block_patterns := rt.call_method(fn () rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Blocks_Package{}
		return temp.container()
	}(), 'get', [Class_Automattic_WooCommerce_Blocks_BlockPatterns.class()])
...
fn create_automattic_woocommerce_storeapi_routes_v1_patterns() &Class_Automattic_WooCommerce_StoreApi_Routes_V1_Patterns {
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_routes_v1_patterns_php() {
}
