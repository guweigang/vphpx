...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error) construct(var_type rt.PhpVal, var_code rt.PhpVal, var_message rt.PhpVal, var_param rt.PhpVal)  {
	...
	this.code = var_code.dup()
	this.message = var_message.dup()
	this.param = var_param.dup()
}
...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error.invalid_request(var_code rt.PhpVal, var_message rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorType.invalid_request(), var_code.dup(), var_message.dup(), var_param.dup())
}
...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error.request_not_idempotent(var_code rt.PhpVal, var_message rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorType.request_not_idempotent(), var_code.dup(), var_message.dup(), var_param.dup())
}
...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error.processing_error(var_code rt.PhpVal, var_message rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorType.processing_error(), var_code.dup(), var_message.dup(), var_param.dup())
}
...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error.service_unavailable(var_code rt.PhpVal, var_message rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorType.service_unavailable(), var_code.dup(), var_message.dup(), var_param.dup())
}

fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error) to_rest_response() rt.PhpVal {
	mut var_data := rt.create_array([rt.ArrayItem{ key: 'type', val: this.prop_type }, rt.ArrayItem{ key: 'code', val: this.code }, rt.ArrayItem{ key: 'message', val: this.message }])
	if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
		var_data.array_set('param', this.param)
	}
	mut var_status_code := this.get_http_status_code()
	return create_wp_rest_response(var_data.dup(), var_status_code.dup())
}

fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error) get_http_status_code()  {
	mut switch_val_1 := this.prop_type
	if rt.is_true(rt.equal(switch_val_1, Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorType.invalid_request())) {
		return rt.new_int(400)
	} else if rt.is_true(rt.equal(switch_val_1, Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorType.request_not_idempotent())) {
		return rt.new_int(409)
	} else if rt.is_true(rt.equal(switch_val_1, Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorType.processing_error())) {
		return rt.new_int(500)
	} else if rt.is_true(rt.equal(switch_val_1, Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorType.service_unavailable())) {
		return rt.new_int(503)
	} else {
		return rt.new_int(500)
	}
}
...
fn create_automattic_woocommerce_storeapi_routes_v1_agentic_self() &Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_self {
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'invalid_request' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error.invalid_request(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'request_not_idempotent' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error.request_not_idempotent(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'processing_error' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error.processing_error(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'service_unavailable' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error.service_unavailable(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'to_rest_response' {
			return this.to_rest_response()
		}
		'get_http_status_code' {
			this.get_http_status_code()
			return rt.new_null()
		}
		else { return none }
	}
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Error) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		...
		'param' { this.param = val; return true }
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_routes_v1_agentic_error_php() {
