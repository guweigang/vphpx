...
pub fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById.identifier() string {
	return 'product-attributes-by-id'
}
pub fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById.schema_type() string {
	return 'product-attribute'
}
struct Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById {
	rt.PhpObjectBase
}

fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById) get_path() rt.PhpVal {
	return Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById.get_path_regex()
}

fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById.get_path_regex() string {
	return '/products/attributes/(?P<id>[\\d]+)'
}

fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById) get_args() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Unique identifier for the resource.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById', ['Automattic_WooCommerce_StoreApi_Routes_V1_AbstractRoute'], &this) }, rt.ArrayItem{ key: none, val: 'get_response' }]) }, rt.ArrayItem{ key: 'permission_callback', val: '__return_true' }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'context', val: this.get_context_param(rt.create_array([rt.ArrayItem{ key: 'default', val: 'view' }])) }]) }, rt.ArrayItem{ key: 'allow_batch', val: rt.create_array([rt.ArrayItem{ key: 'v1', val: true }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.get_property(rt.new_object('Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById', ['Automattic_WooCommerce_StoreApi_Routes_V1_AbstractRoute'], &this), 'schema') }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])
}

fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById) get_route_response(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) rt.PhpVal {
	mut var_object := rt.call_function('wc_get_attribute', [// unsupported expression: Expr_Cast_Int])
...
fn create_automattic_woocommerce_storeapi_routes_v1_productattributesbyid() &Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById {
	mut obj := &Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById{
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'get_path' {
			return this.get_path()
		}
		'get_path_regex' {
			return rt.new_string(Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById.get_path_regex())
		}
		'get_args' {
...
fn (this &Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributesById) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_routes_v1_productattributesbyid_php() {
}
