...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Messages_MessageError.missing(var_content rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_messages_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorCode.missing(), var_content.dup(), var_param.dup())
}
...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Messages_MessageError.invalid(var_content rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_messages_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorCode.invalid(), var_content.dup(), var_param.dup())
}
...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Messages_MessageError.out_of_stock(var_content rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_messages_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorCode.out_of_stock(), var_content.dup(), var_param.dup())
}
...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Messages_MessageError.payment_declined(var_content rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_messages_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorCode.payment_declined(), var_content.dup(), var_param.dup())
}
...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Messages_MessageError.requires_sign_in(var_content rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_messages_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorCode.requires_sign_in(), var_content.dup(), var_param.dup())
}
...
fn Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Messages_MessageError.requires_3ds(var_content rt.PhpVal, var_param rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_storeapi_routes_v1_agentic_messages_self(Class_Automattic_WooCommerce_Internal_Agentic_Enums_Specs_ErrorCode.requires_3ds(), var_content.dup(), var_param.dup())
}
...
fn create_automattic_woocommerce_storeapi_routes_v1_agentic_messages_self() &Class_Automattic_WooCommerce_StoreApi_Routes_V1_Agentic_Messages_self {
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_routes_v1_agentic_messages_messageerror_php() {
