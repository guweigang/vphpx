...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributeTerms) get_route_response(mut var_request Class_Automattic_WooCommerce_StoreApi_Routes_V1_WP_REST_Request) rt.PhpVal {
	mut var_attribute := rt.call_function('wc_get_attribute', [
		var_request.array_get('attribute_id'),
	])
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(var_attribute))))
...
fn create_automattic_woocommerce_storeapi_routes_v1_productattributeterms() &Class_Automattic_WooCommerce_StoreApi_Routes_V1_ProductAttributeTerms {
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_routes_v1_productattributeterms_php() {
}
