...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ImageAttachmentSchema) get_item_response(var_attachment_id rt.PhpVal) rt.PhpVal {
	...
	mut var_attachment := rt.call_function('wp_get_attachment_image_src', [
		var_attachment_id.dup(), rt.new_string('full')])
	...
	mut var_thumbnail := rt.call_function('wp_get_attachment_image_src', [
		var_attachment_id.dup(), rt.new_string('woocommerce_thumbnail')])
	return
}
...
fn create_automattic_woocommerce_storeapi_schemas_v1_imageattachmentschema() &Class_Automattic_WooCommerce_StoreApi_Schemas_V1_ImageAttachmentSchema {
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_schemas_v1_imageattachmentschema_php() {
}
