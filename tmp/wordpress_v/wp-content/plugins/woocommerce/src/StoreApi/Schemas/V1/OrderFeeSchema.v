...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Schemas_V1_OrderFeeSchema) get_item_response(var_fee rt.PhpVal) rt.PhpVal {
	...
	return rt.create_array([rt.ArrayItem{ key: 'key', val: rt.call_method(var_fee, 'get_id', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'name', val: this.prepare_html_response(rt.call_method(var_fee, 'get_name', []rt.PhpVal{})) }, rt.ArrayItem{ key: 'totals', val: // unsupported expression: Expr_Cast_Object }])
}
...
fn create_automattic_woocommerce_storeapi_schemas_v1_orderfeeschema() &Class_Automattic_WooCommerce_StoreApi_Schemas_V1_OrderFeeSchema {
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_schemas_v1_orderfeeschema_php() {
}
