...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Exceptions_InvalidCartException) construct(var_error_code rt.PhpVal, mut var_error Class_WP_Error, var_additional_data rt.PhpVal) {
...
fn (mut this Class_Automattic_WooCommerce_StoreApi_Exceptions_InvalidCartException) geterrorcode() rt.PhpVal {
	return this.error_code
}

fn (mut this Class_Automattic_WooCommerce_StoreApi_Exceptions_InvalidCartException) geterror() rt.PhpVal {
	return this.error
}

fn (mut this Class_Automattic_WooCommerce_StoreApi_Exceptions_InvalidCartException) getadditionaldata() rt.PhpVal {
...
fn create_automattic_woocommerce_storeapi_exceptions_invalidcartexception(arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) &Class_Automattic_WooCommerce_StoreApi_Exceptions_InvalidCartException {
...
pub fn init_wp_content_plugins_woocommerce_src_storeapi_exceptions_invalidcartexception_php() {
}
