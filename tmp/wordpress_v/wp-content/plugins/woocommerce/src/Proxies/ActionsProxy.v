...
fn (mut this Class_Automattic_WooCommerce_Proxies_ActionsProxy) did_action(var_tag rt.PhpVal) rt.PhpVal {
	return rt.call_function('did_action', [var_tag.dup()])
}
...
fn (mut this Class_Automattic_WooCommerce_Proxies_ActionsProxy) apply_filters(var_tag rt.PhpVal, var_value rt.PhpVal, var_parameters rt.PhpVal) rt.PhpVal {
	return rt.call_function('apply_filters', [var_tag.dup(), var_value.dup(),
		var_parameters.dup()])
}

fn create_automattic_woocommerce_proxies_actionsproxy() &Class_Automattic_WooCommerce_Proxies_ActionsProxy {
...
pub fn init_wp_content_plugins_woocommerce_src_proxies_actionsproxy_php() {
}
