...
pub fn Class_Automattic_WooCommerce_Internal_ProductDownloads_ApprovedDirectories_ApprovedDirectoriesException.invalid_url() i64 {
	return 1
}

pub fn Class_Automattic_WooCommerce_Internal_ProductDownloads_ApprovedDirectories_ApprovedDirectoriesException.db_error() i64 {
	return 2
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductDownloads_ApprovedDirectories_ApprovedDirectoriesException) construct(var_message rt.PhpVal) {
	this.message = var_message.to_string()
}

fn (mut this Class_Automattic_WooCommerce_Internal_ProductDownloads_ApprovedDirectories_ApprovedDirectoriesException) getmessage() string {
	return this.message
}

fn create_automattic_woocommerce_internal_productdownloads_approveddirectories_approveddirectoriesexception(arg_0 rt.PhpVal) &Class_Automattic_WooCommerce_Internal_ProductDownloads_ApprovedDirectories_ApprovedDirectoriesException {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_productdownloads_approveddirectories_approveddirectoriesexception_php() {
}
