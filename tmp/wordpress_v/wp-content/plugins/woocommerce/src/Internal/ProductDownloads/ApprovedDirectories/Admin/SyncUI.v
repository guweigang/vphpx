...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductDownloads_ApprovedDirectories_Admin_SyncUI) init_hooks() {
	if rt.is_true(rt.new_bool(!(rt.is_true(fn () rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Internal_Utilities_Users{}
		return temp.is_site_administrator()
	}()))))
	{
		return rt.new_null()
	}
...
fn create_automattic_woocommerce_internal_productdownloads_approveddirectories_admin_syncui() &Class_Automattic_WooCommerce_Internal_ProductDownloads_ApprovedDirectories_Admin_SyncUI {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_productdownloads_approveddirectories_admin_syncui_php() {
}
