...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Section) add_subsection(mut var_block_config Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_array) rt.PhpVal {
	mut var_block := create_automattic_woocommerce_internal_features_productblockeditor_producttemplates_subsection(var_block_config.dup(), this.get_root_template(), rt.new_object('Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Section', ['Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductBlock', 'SectionInterface'], &this).dup())
...
fn create_automattic_woocommerce_internal_features_productblockeditor_producttemplates_subsection() &Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_Subsection {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_features_productblockeditor_producttemplates_section_php() {
}
