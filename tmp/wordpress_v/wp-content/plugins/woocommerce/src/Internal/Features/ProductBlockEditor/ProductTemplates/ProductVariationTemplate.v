...
pub fn Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductVariationTemplate.group_ids() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: 'GENERAL', val: 'general' }, rt.ArrayItem{ key: 'PRICING', val: 'pricing' }, rt.ArrayItem{ key: 'INVENTORY', val: 'inventory' }, rt.ArrayItem{ key: 'SHIPPING', val: 'shipping' }])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductVariationTemplate) get_title() string {
	return (rt.call_function('__', [rt.new_string('Product Variation Template'), rt.new_string('woocommerce')])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductVariationTemplate) get_description() string {
	return (rt.call_function('__', [rt.new_string('Template for the product variation form'), rt.new_string('woocommerce')])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductVariationTemplate) add_group_blocks()  {
	this.add_group(rt.create_array([rt.ArrayItem{ key: 'id', val: Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_{"nodeType":"Expr_Variable","line":70,"name":"this"}.group_ids().array_get('GENERAL') }, rt.ArrayItem{ key: 'order', val: 10 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'title', val: rt.call_function('__', [rt.new_string('General'), rt.new_string('woocommerce')]) }]) }]))
	this.add_group(rt.create_array([rt.ArrayItem{ key: 'id', val: Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_{"nodeType":"Expr_Variable","line":79,"name":"this"}.group_ids().array_get('INVENTORY') }, rt.ArrayItem{ key: 'order', val: 30 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'title', val: rt.call_function('__', [rt.new_string('Inventory'), rt.new_string('woocommerce')]) }]) }]))
	this.add_group(rt.create_array([rt.ArrayItem{ key: 'id', val: Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_{"nodeType":"Expr_Variable","line":88,"name":"this"}.group_ids().array_get('SHIPPING') }, rt.ArrayItem{ key: 'order', val: 40 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'title', val: rt.call_function('__', [rt.new_string('Shipping'), rt.new_string('woocommerce')]) }]) }]))
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductVariationTemplate) add_general_group_blocks()  {
	...
	mut var_general_group := this.get_group_by_id(Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_{"nodeType":"Expr_Variable","line":103,"name":"this"}.group_ids().array_get('GENERAL'))
	rt.call_method(var_general_group, 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'general-single-variation-notice' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-single-variation-notice' }, rt.ArrayItem{ key: 'order', val: 10 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'content', val: rt.call_function('__', [rt.new_string('<strong>You’re editing details specific to this variation.</strong> Some information, like description and images, will be inherited from the main product, <noticeLink><parentProductName/></noticeLink>.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'info' }, rt.ArrayItem{ key: 'isDismissible', val: true }, rt.ArrayItem{ key: 'name', val: Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_{"nodeType":"Expr_Variable","line":113,"name":"this"}.single_variation_notice_dismissed_option() }]) }])])
	mut var_basic_details := rt.call_method(var_general_group, 'add_section', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-details-section' }, rt.ArrayItem{ key: 'order', val: 10 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'title', val: rt.call_function('__', [rt.new_string('Variation details'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('This info will be displayed on the product page, category pages, social media, and search results.'), rt.new_string('woocommerce')]) }]) }])])
	...
	if rt.is_true(var_is_calc_taxes_enabled) {
		rt.call_method(var_basic_details, 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-tax-class' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-select-field' }, rt.ArrayItem{ key: 'order', val: 40 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'label', val: rt.call_function('__', [rt.new_string('Tax class'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'help', val: rt.call_function('sprintf', [rt.call_function('__', [rt.new_string('Apply a tax rate if this product qualifies for tax reduction or exemption. %1$sLearn more%2$s'), rt.new_string('woocommerce')]), rt.new_string('<a href="https://woocommerce.com/document/setting-up-taxes-in-woocommerce/#shipping-tax-class" target="_blank" rel="noreferrer">'), rt.new_string('</a>')]) }, rt.ArrayItem{ key: 'property', val: 'tax_class' }, rt.ArrayItem{ key: 'options', val: fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_SimpleProductTemplate{}; return temp.get_tax_classes(arg_0) }(rt.new_string('product_variation')) }]) }])])
	}
	rt.call_method(var_basic_details, 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-note' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-text-area-field' }, rt.ArrayItem{ key: 'order', val: 20 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'property', val: 'description' }, rt.ArrayItem{ key: 'label', val: rt.call_function('__', [rt.new_string('Note'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'help', val: 'Enter an optional note displayed on the product page when customers select this variation.' }, rt.ArrayItem{ key: 'lock', val: rt.create_array([rt.ArrayItem{ key: 'move', val: true }]) }]) }])])
	rt.call_method(var_basic_details, 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-visibility' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-checkbox-field' }, rt.ArrayItem{ key: 'order', val: 30 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'property', val: 'status' }, rt.ArrayItem{ key: 'label', val: rt.call_function('__', [rt.new_string('Hide in product catalog'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'checkedValue', val: 'private' }, rt.ArrayItem{ key: 'uncheckedValue', val: 'publish' }]) }])])
	mut var_images_section := rt.call_method(var_general_group, 'add_section', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-images-section' }, rt.ArrayItem{ key: 'order', val: 30 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'title', val: rt.call_function('__', [rt.new_string('Image'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('sprintf', [rt.call_function('__', [rt.new_string('Drag images, upload new ones or select files from your library. For best results, use JPEG files that are 1000 by 1000 pixels or larger. %1$sHow to prepare images?%2$s'), rt.new_string('woocommerce')]), rt.new_string('<a href="https://woocommerce.com/posts/how-to-take-professional-product-photos-top-tips" target="_blank" rel="noreferrer">'), rt.new_string('</a>')]) }]) }])])
	rt.call_method(var_images_section, 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-image' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-images-field' }, rt.ArrayItem{ key: 'order', val: 10 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'property', val: 'image' }, rt.ArrayItem{ key: 'multiple', val: false }]) }])])
...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductVariationTemplate) add_inventory_group_blocks()  {
	mut var_inventory_group := this.get_group_by_id(Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_{"nodeType":"Expr_Variable","line":279,"name":"this"}.group_ids().array_get('INVENTORY'))
	rt.call_method(var_inventory_group, 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'inventory-single-variation-notice' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-single-variation-notice' }, rt.ArrayItem{ key: 'order', val: 10 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'content', val: rt.call_function('__', [rt.new_string('<strong>You’re editing details specific to this variation.</strong> Some information, like description and images, will be inherited from the main product, <noticeLink><parentProductName/></noticeLink>.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'info' }, rt.ArrayItem{ key: 'isDismissible', val: true }, rt.ArrayItem{ key: 'name', val: Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_{"nodeType":"Expr_Variable","line":289,"name":"this"}.single_variation_notice_dismissed_option() }]) }])])
	mut var_product_inventory_section := rt.call_method(var_inventory_group, 'add_section', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-inventory-section' }, rt.ArrayItem{ key: 'order', val: 20 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'title', val: rt.call_function('__', [rt.new_string('Inventory'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('sprintf', [rt.call_function('__', [rt.new_string('Set up and manage inventory for this product, including status and available quantity. %1$sManage store inventory settings%2$s'), rt.new_string('woocommerce')]), '<a href="' + (rt.call_function('admin_url', [rt.new_string('admin.php?page=wc-settings&tab=products&section=inventory')])).str() + '" target="_blank" rel="noreferrer">', rt.new_string('</a>')]) }, rt.ArrayItem{ key: 'blockGap', val: 'unit-40' }]) }])])
	mut var_product_inventory_inner_section := rt.call_method(var_product_inventory_section, 'add_subsection', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-inventory-inner-section' }, rt.ArrayItem{ key: 'order', val: 10 }])])
...
fn (mut this Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_ProductVariationTemplate) add_shipping_group_blocks()  {
	mut var_shipping_group := this.get_group_by_id(Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_{"nodeType":"Expr_Variable","line":422,"name":"this"}.group_ids().array_get('SHIPPING'))
	rt.call_method(var_shipping_group, 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'shipping-single-variation-notice' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-single-variation-notice' }, rt.ArrayItem{ key: 'order', val: 10 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'content', val: rt.call_function('__', [rt.new_string('<strong>You’re editing details specific to this variation.</strong> Some information, like description and images, will be inherited from the main product, <noticeLink><parentProductName/></noticeLink>.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'info' }, rt.ArrayItem{ key: 'isDismissible', val: true }, rt.ArrayItem{ key: 'name', val: Class_Automattic_WooCommerce_Internal_Features_ProductBlockEditor_ProductTemplates_{"nodeType":"Expr_Variable","line":432,"name":"this"}.single_variation_notice_dismissed_option() }]) }])])
	rt.call_method(rt.call_method(var_shipping_group, 'add_section', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-virtual-section' }, rt.ArrayItem{ key: 'order', val: 20 }])]), 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-virtual' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-toggle-field' }, rt.ArrayItem{ key: 'order', val: 10 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'property', val: 'virtual' }, rt.ArrayItem{ key: 'checkedValue', val: false }, rt.ArrayItem{ key: 'uncheckedValue', val: true }, rt.ArrayItem{ key: 'label', val: rt.call_function('__', [rt.new_string('This variation requires shipping or pickup'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'uncheckedHelp', val: rt.call_function('__', [rt.new_string('This variation will not trigger your customer\'s shipping calculator in cart or at checkout. This product also won\'t require your customers to enter their shipping details at checkout. <a href="https://woocommerce.com/document/managing-products/#adding-a-virtual-product" target="_blank" rel="noreferrer">Read more about virtual products</a>.'), rt.new_string('woocommerce')]) }]) }])])
	mut var_product_fee_and_dimensions_section := rt.call_method(var_shipping_group, 'add_section', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-fee-and-dimensions-section' }, rt.ArrayItem{ key: 'order', val: 30 }, rt.ArrayItem{ key: 'attributes', val: rt.create_array([rt.ArrayItem{ key: 'title', val: rt.call_function('__', [rt.new_string('Fees & dimensions'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('sprintf', [rt.call_function('__', [rt.new_string('Set up shipping costs and enter dimensions used for accurate rate calculations. %1$sHow to get started?%2$s'), rt.new_string('woocommerce')]), rt.new_string('<a href="https://woocommerce.com/posts/how-to-calculate-shipping-costs-for-your-woocommerce-store/" target="_blank" rel="noreferrer">'), rt.new_string('</a>')]) }]) }])])
	rt.call_method(var_product_fee_and_dimensions_section, 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-shipping-class' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-shipping-class-field' }, rt.ArrayItem{ key: 'order', val: 10 }])])
	rt.call_method(var_product_fee_and_dimensions_section, 'add_block', [rt.create_array([rt.ArrayItem{ key: 'id', val: 'product-variation-shipping-dimensions' }, rt.ArrayItem{ key: 'blockName', val: 'woocommerce/product-shipping-dimensions-fields' }, rt.ArrayItem{ key: 'order', val: 20 }])])
}
...
pub fn init_wp_content_plugins_woocommerce_src_internal_features_productblockeditor_producttemplates_productvariationtemplate_php() {
}
