...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) register_hooks()  {
	rt.call_function('add_action', [rt.new_string('woocommerce_before_order_object_save'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'handle_before_order_save' }]), rt.new_int(10), rt.new_int(1)])
	rt.call_function('add_action', [rt.new_string('woocommerce_new_order'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'handle_woocommerce_new_order' }]), rt.new_int(10), rt.new_int(2)])
	rt.call_function('add_action', [rt.new_string('woocommerce_update_order'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'handle_woocommerce_update_order' }]), rt.new_int(10), rt.new_int(2)])
	rt.call_function('add_action', [rt.new_string('woocommerce_before_delete_order'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'handle_woocommerce_before_delete_order' }]), rt.new_int(10), rt.new_int(2)])
	rt.call_function('add_action', [rt.new_string('woocommerce_trash_order'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'handle_woocommerce_trash_order' }]), rt.new_int(10), rt.new_int(1)])
	rt.call_function('add_action', [rt.new_string('woocommerce_untrash_order'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'handle_woocommerce_untrash_order' }]), rt.new_int(10), rt.new_int(2)])
	rt.call_function('add_action', [rt.new_string('woocommerce_order_status_changed'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'handle_woocommerce_order_status_changed' }]), rt.new_int(10), rt.new_int(4)])
	rt.call_function('add_action', [rt.new_string('woocommerce_order_refunded'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'handle_woocommerce_order_refunded' }]), rt.new_int(10), rt.new_int(2)])
	rt.call_function('add_action', [rt.new_string('woocommerce_refund_deleted'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'handle_woocommerce_refund_deleted' }]), rt.new_int(10), rt.new_int(2)])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) handle_before_order_save(var_order rt.PhpVal)  {
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.instance_of(var_order, 'Automattic_WooCommerce_Internal_Caches_WC_Order')))))) || rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) {
		return rt.new_null()
	}
	mut var_order_id := rt.call_method(var_order, 'get_id', []rt.PhpVal{})
	if rt.is_true(rt.greater(var_order_id, rt.new_int(0))) {
		this.pre_save_customer_ids.array_set(var_order_id, // unsupported expression: Expr_Cast_Int)
	}
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) handle_woocommerce_update_order(var_order_id rt.PhpVal, var_order rt.PhpVal)  {
	mut var_order_id_mutated := var_order_id
	var_order_id_mutated = // unsupported expression: Expr_Cast_Int
	this.invalidate((var_order_id_mutated).to_i64())
	if this.did_customer_change((var_order_id_mutated).to_i64(), var_order.dup()) {
		this.invalidate_orders_list()
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) did_customer_change(order_id i64, var_order rt.PhpVal) bool {
	...
	mut var_old_customer_id := this.pre_save_customer_ids.array_get(order_id_mutated)
	mut var_new_customer_id := if rt.is_true(rt.new_bool(rt.instance_of(var_order, 'Automattic_WooCommerce_Internal_Caches_WC_Order'))) { // unsupported expression: Expr_Cast_Int } else { rt.new_int(0) }
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) handle_woocommerce_order_refunded(var_order_id rt.PhpVal, var_refund_id rt.PhpVal)  {
	...
	var_order_id_mutated = // unsupported expression: Expr_Cast_Int
	var_refund_id_mutated = // unsupported expression: Expr_Cast_Int
	this.invalidate((var_order_id_mutated).to_i64())
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) invalidate(order_id i64)  {
	mut order_id_mutated := order_id
	rt.call_method(rt.call_method(rt.call_function('wc_get_container', []rt.PhpVal{}), 'get', [Class_Automattic_WooCommerce_Internal_Caches_VersionStringGenerator.class()]), 'delete_version', [rt.new_string("order_${var_order_id.to_string()}")])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) invalidate_refund(refund_id i64)  {
	...
	rt.call_method(rt.call_method(rt.call_function('wc_get_container', []rt.PhpVal{}), 'get', [Class_Automattic_WooCommerce_Internal_Caches_VersionStringGenerator.class()]), 'delete_version', [rt.new_string("refund_${var_refund_id.to_string()}")])
}

fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) invalidate_orders_list()  {
	rt.call_method(rt.call_method(rt.call_function('wc_get_container', []rt.PhpVal{}), 'get', [Class_Automattic_WooCommerce_Internal_Caches_VersionStringGenerator.class()]), 'delete_version', [rt.new_string('list_orders')])
}

fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) invalidate_refunds_list()  {
	rt.call_method(rt.call_method(rt.call_function('wc_get_container', []rt.PhpVal{}), 'get', [Class_Automattic_WooCommerce_Internal_Caches_VersionStringGenerator.class()]), 'delete_version', [rt.new_string('list_refunds')])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) invalidate_order_refunds_list(order_id i64)  {
	...
	if order_id_mutated > 0 {
		rt.call_method(rt.call_method(rt.call_function('wc_get_container', []rt.PhpVal{}), 'get', [Class_Automattic_WooCommerce_Internal_Caches_VersionStringGenerator.class()]), 'delete_version', [rt.new_string("list_order_refunds_${var_order_id.to_string()}")])
	}
}

fn create_automattic_woocommerce_internal_caches_ordersversionstringinvalidator() &Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator {
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'handle_woocommerce_order_status_changed' {
			...
			this.handle_woocommerce_order_status_changed(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
			return rt.new_null()
		}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Caches_OrdersVersionStringInvalidator) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'pre_save_customer_ids' { this.pre_save_customer_ids = val; return true }
...
pub fn init_wp_content_plugins_woocommerce_src_internal_caches_ordersversionstringinvalidator_php() {
