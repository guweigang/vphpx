...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_POSIntegration) create_feed() rt.PhpVal {
	return create_automattic_woocommerce_internal_productfeed_storage_jsonfilefeed(rt.new_string('pos-catalog-feed'))
}
...
fn create_automattic_woocommerce_internal_productfeed_integrations_poscatalog_posintegration() &Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_POSIntegration {
...
fn create_automattic_woocommerce_internal_productfeed_storage_jsonfilefeed() &Class_Automattic_WooCommerce_Internal_ProductFeed_Storage_JsonFileFeed {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_productfeed_integrations_poscatalog_posintegration_php() {
