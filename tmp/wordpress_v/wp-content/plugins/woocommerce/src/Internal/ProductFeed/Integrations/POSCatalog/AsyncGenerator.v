...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator) init(mut var_integration Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_POSIntegration)  {
	this.integration = var_integration.dup()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator) get_status(mut var_args Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_?array) rt.PhpVal {
	...
	mut var_status := rt.call_function('get_option', [var_option_key.dup()])
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(var_status.dup().is_array())) && !(this.validate_status(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_array](var_status))))) {
		var_status = rt.new_bool(rt.new_bool(false))
	}
	if rt.is_true(rt.new_bool(var_status.dup().is_array())) {
	...
	if rt.is_true(rt.new_bool(rt.is_true(rt.call_function('class_exists', [Class_ActionScheduler_AsyncRequest_QueueRunner.class()])) && rt.is_true(rt.call_function('class_exists', [Class_ActionScheduler_Store.class()])))) {
		mut var_store := fn () rt.PhpVal { mut temp := Class_ActionScheduler_Store{}; return temp.instance() }()
		mut var_async_request := create_actionscheduler_asyncrequest_queuerunner(var_store.dup())
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator) feed_generation_action(option_key string)  {
	...
	mut var_status := rt.call_function('get_option', [rt.new_string(option_key_mutated).dup()])
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_status.dup().is_array()))))) || !(var_status.array_isset(rt.new_string('state'))))) || rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) {
	...
	rt.call_function('update_option', [rt.new_string(option_key_mutated).dup(), var_status.dup()])
	mut var_feed := rt.call_method(this.integration, 'create_feed', []rt.PhpVal{})
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	mut var_walker := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_ProductFeed_Feed_ProductWalker{}; return temp.from_integration(arg_0, arg_1) }(this.integration, var_feed.dup())
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	mut var_args := if !(var_status.array_get('args')).is_null() { var_status.array_get('args') } else { rt.new_array() }
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(var_args.array_isset(rt.new_string('_product_fields')) && rt.is_true(rt.new_bool(var_args.array_get('_product_fields').is_string())))) && !(!rt.is_true(var_args.array_get('_product_fields'))))) {
		rt.call_method(rt.call_method(this.integration, 'get_product_mapper', []rt.PhpVal{}), 'set_fields', [var_args.array_get('_product_fields')])
		if rt.has_exception() { unsafe { goto catch_label_1 } }
	}
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(var_args.array_isset(rt.new_string('_variation_fields')) && rt.is_true(rt.new_bool(var_args.array_get('_variation_fields').is_string())))) && !(!rt.is_true(var_args.array_get('_variation_fields'))))) {
		rt.call_method(rt.call_method(this.integration, 'get_product_mapper', []rt.PhpVal{}), 'set_variation_fields', [var_args.array_get('_variation_fields')])
		if rt.has_exception() { unsafe { goto catch_label_1 } }
	}
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	closure_1_fn := fn [mut var_status, var_option_key] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_progress := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	...
	rt.call_method(var_walker, 'walk', [rt.new_closure(closure_1_fn)])
	if rt.has_exception() { unsafe { goto catch_label_1 } }
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator) force_regeneration(mut var_args Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_?array) rt.PhpVal {
	...
	mut var_option_key := rt.new_string(this.get_option_key(mut var_args_mutated))
	mut var_status := rt.call_function('get_option', [var_option_key.dup()])
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_status.dup().is_array()))))) || !(this.validate_status(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_array](var_status))))) {
		return this.get_status(mut var_args_mutated)
	}
	mut switch_val_1 := if !(var_status.array_get('state')).is_null() { var_status.array_get('state') } else { rt.new_string('') }
	if rt.is_true(rt.equal(switch_val_1, Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator.state_scheduled())) {
		...
		rt.call_function('wp_delete_file', [// unsupported expression: Expr_Cast_String])
		rt.call_function('delete_option', [var_option_key.dup()])
		return this.get_status(mut var_args_mutated)
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator) feed_deletion_action(option_key string, path string)  {
	mut option_key_mutated := option_key
	rt.call_function('delete_option', [rt.new_string(option_key_mutated).dup()])
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator) get_option_key(mut var_args Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_?array) string {
	...
	if !(!rt.is_true(var_normalized_args)) {
		rt.call_function('ksort', [var_normalized_args.dup()])
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator) validate_status(mut var_status Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_array) bool {
	mut var_status_mutated := var_status
	if rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator.state_completed(), var_status_mutated.array_get('state'))) {
		if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('file_exists', [var_status_mutated.array_get('path')]))))) {
			return false
		}
		if !(var_status_mutated.array_isset(rt.new_string('completed_at'))) {
			return false
		}
		if rt.is_true(rt.less(rt.add(var_status_mutated.array_get('completed_at'), Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator.feed_expiry()), rt.call_function('time', []rt.PhpVal{}))) {
			return false
		}
	}
	...
	if rt.is_true(rt.new_bool(rt.is_true(rt.identical(Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator.state_scheduled(), var_status_mutated.array_get('state'))) && rt.is_true(rt.new_bool(!(var_status_mutated.array_isset(rt.new_string('scheduled_at'))) || rt.is_true(rt.greater(rt.sub(rt.call_function('time', []rt.PhpVal{}), var_status_mutated.array_get('scheduled_at')), var_scheduled_timeout)))))) {
		return false
	}
	return true
}
...
fn create_automattic_woocommerce_internal_productfeed_integrations_poscatalog_asyncgenerator() &Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_AsyncGenerator {
...
fn create_actionscheduler_asyncrequest_queuerunner() &Class_ActionScheduler_AsyncRequest_QueueRunner {
...
fn create_automattic_woocommerce_internal_productfeed_feed_productwalker() &Class_Automattic_WooCommerce_Internal_ProductFeed_Feed_ProductWalker {
...
fn create_automattic_woocommerce_internal_productfeed_integrations_poscatalog_exception() &Class_Automattic_WooCommerce_Internal_ProductFeed_Integrations_POSCatalog_Exception {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_productfeed_integrations_poscatalog_asyncgenerator_php() {
