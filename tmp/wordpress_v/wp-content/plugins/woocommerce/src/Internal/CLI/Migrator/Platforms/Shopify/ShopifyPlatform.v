...
fn Class_Automattic_WooCommerce_Internal_CLI_Migrator_Platforms_Shopify_ShopifyPlatform.init()  {
	rt.call_function('add_filter', [rt.new_string('woocommerce_migrator_platforms'), rt.create_array([rt.ArrayItem{ key: none, val: Class_Automattic_WooCommerce_Internal_CLI_Migrator_Platforms_Shopify_Automattic_WooCommerce_Internal_CLI_Migrator_Platforms_Shopify_ShopifyPlatform.class() }, rt.ArrayItem{ key: none, val: 'register_platform' }])])
}
...
fn Class_Automattic_WooCommerce_Internal_CLI_Migrator_Platforms_Shopify_ShopifyPlatform.register_platform(mut var_platforms Class_Automattic_WooCommerce_Internal_CLI_Migrator_Platforms_Shopify_array) rt.PhpVal {
	...
	var_platforms_mutated.array_set('shopify', rt.create_array([rt.ArrayItem{ key: 'name', val: 'Shopify' }, rt.ArrayItem{ key: 'description', val: 'Import products and data from Shopify stores' }, rt.ArrayItem{ key: 'fetcher', val: Class_Automattic_WooCommerce_Internal_CLI_Migrator_Platforms_Shopify_ShopifyFetcher.class() }, rt.ArrayItem{ key: 'mapper', val: Class_Automattic_WooCommerce_Internal_CLI_Migrator_Platforms_Shopify_ShopifyMapper.class() }, rt.ArrayItem{ key: 'credentials', val: rt.create_array([rt.ArrayItem{ key: 'shop_url', val: 'Enter shop URL (e.g., mystore.myshopify.com):' }, rt.ArrayItem{ key: 'access_token', val: 'Enter access token:' }]) }]))
	return rt.new_object('Automattic_WooCommerce_Internal_CLI_Migrator_Platforms_Shopify_array', []string{}, var_platforms_mutated)
}
...
pub fn init_wp_content_plugins_woocommerce_src_internal_cli_migrator_platforms_shopify_shopifyplatform_php() {
