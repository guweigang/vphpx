...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Frontend_NotificationManagementService) get_resend_verification_email_url(mut var_notification Class_Automattic_WooCommerce_Internal_StockNotifications_Notification) string {
	...
	return (rt.call_function('wp_nonce_url', [var_url.dup(),
		rt.new_string('wc_bis_resend_verification_email_nonce')])).str()
}

fn create_automattic_woocommerce_internal_stocknotifications_frontend_notificationmanagementservice() &Class_Automattic_WooCommerce_Internal_StockNotifications_Frontend_NotificationManagementService {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_stocknotifications_frontend_notificationmanagementservice_php() {
