...
fn Class_Automattic_WooCommerce_Internal_StockNotifications_Utilities_HasherHelper.wp_fast_hash(key string) string {
	...
	mut var_hashed := rt.call_function('sodium_crypto_generichash', [
		...
		rt.new_int(30)])
	return '$generic$' +(rt.call_function('sodium_bin2base64', [var_hashed.dup(), rt.get_constant('SODIUM_BASE64_VARIANT_URLSAFE_NO_PADDING')])).str()
}
...
pub fn init_wp_content_plugins_woocommerce_src_internal_stocknotifications_utilities_hasherhelper_php() {
