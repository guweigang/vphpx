...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationEmail) get_additional_template_args() rt.PhpVal {
	...
	mut var_button_link := rt.call_function('apply_filters', [
		...
		rt.call_function('add_query_arg', [var_query_args.dup(),
...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationEmail) init_form_fields() {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationEmail', [
		'WC_Email',
...
pub fn init_wp_content_plugins_woocommerce_src_internal_stocknotifications_emails_customerstocknotificationemail_php() {
