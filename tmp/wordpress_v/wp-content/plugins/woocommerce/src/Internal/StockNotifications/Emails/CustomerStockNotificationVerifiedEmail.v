...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) construct() {
	this.dispatch_set_prop('id', rt.new_string('customer_stock_notification_verified'))
	this.dispatch_set_prop('customer_email', rt.new_bool(true))
	this.dispatch_set_prop('title', rt.call_function('__', [
		rt.new_string('Back in stock sign-up confirmation'),
		rt.new_string('woocommerce'),
	]))
	this.dispatch_set_prop('description', rt.call_function('__', [
		rt.new_string('Email sent to customers after completing the sign-up process successfully.'),
		rt.new_string('woocommerce'),
	]))
	this.dispatch_set_prop('template_html',
		rt.new_string('emails/customer-stock-notification-verified.php'))
	this.dispatch_set_prop('template_plain',
		rt.new_string('emails/plain/customer-stock-notification-verified.php'))
	this.dispatch_set_prop('placeholders', rt.create_array([
		rt.ArrayItem{ key: '{product_name}', val: '' },
		rt.ArrayItem{ key: '{site_title}', val: '' },
	]))
	rt.call_function('add_action', [
		rt.new_string('woocommerce_email_stock_notification_verified_notification'),
		rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
				'WC_Email',
			], &this) },
...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) get_default_subject() rt.PhpVal {
	return rt.call_function('__', [
		rt.new_string('You have joined the "{product_name}" waitlist.'),
		rt.new_string('woocommerce'),
	])
}

fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) get_default_heading() rt.PhpVal {
	return rt.call_function('__', [rt.new_string('Sign-up successful'),
		rt.new_string('woocommerce')])
}

fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) get_default_intro_content() rt.PhpVal {
	return rt.call_function('__', [
		rt.new_string('Thanks for joining the waitlist! You will hear from us again when "{product_name}" is back in stock.'),
		rt.new_string('woocommerce'),
	])
}

fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) get_default_additional_content() rt.PhpVal {
	return rt.call_function('__', [rt.new_string('Thanks for shopping with us.'),
		rt.new_string('woocommerce')])
}

fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) get_intro_content() rt.PhpVal {
	return rt.call_function('apply_filters', [
		...
		rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
			'WC_Email',
		], &this), 'object'),
		rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
			'WC_Email',
		], &this),
	])
}

fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) get_content_html() rt.PhpVal {
	return rt.call_function('wc_get_template_html', [
		...
		rt.call_function('array_merge', [
			...
			rt.create_array([
				rt.ArrayItem{ key: 'notification', val: rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
					'WC_Email',
				], &this), 'object') },
				rt.ArrayItem{ key: 'product', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
					'WC_Email',
				...
				rt.ArrayItem{ key: 'email', val: rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
					'WC_Email',
				], &this) },
			]),
		]),
...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) get_content_plain() rt.PhpVal {
	return rt.call_function('wc_get_template_html', [
		rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
			'WC_Email',
		], &this), 'template_plain'),
...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) get_additional_template_args() rt.PhpVal {
	mut var_notification := rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
		'WC_Email',
	], &this), 'object')
	...
	mut var_is_guest := rt.new_bool(rt.new_bool(!(rt.is_true(rt.call_function('is_a', [
		var_user.dup(),
		rt.new_string('WP_User'),
	])))))
	return rt.create_array([rt.ArrayItem{ key: 'is_guest', val: var_is_guest },
...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) trigger(var_notification rt.PhpVal) {
...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) prepare_email(mut var_notification Class_Automattic_WooCommerce_Internal_StockNotifications_Notification) {
	mut var_notification_mutated := var_notification
...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) maybe_setup_notification_locale(var_notification rt.PhpVal) {
	mut var_notification_mutated := var_notification
...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) maybe_restore_notification_locale(var_notification rt.PhpVal) {
	mut var_notification_mutated := var_notification
	mut var_customer_locale := rt.call_method(var_notification_mutated, 'get_meta', [
		rt.new_string('_customer_locale'),
	])
...
fn (mut this Class_Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail) init_form_fields() {
	this.Class_WC_Email.init_form_fields()
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
		'WC_Email',
	...
	mut var_placeholder_text := rt.call_function('sprintf', [
		rt.call_function('__', [rt.new_string('Available placeholders: %s'),
			rt.new_string('woocommerce')]),
		'<code>' +
			(rt.call_function('esc_html', [rt.call_function('implode', [rt.new_string('</code>, <code>'), rt.func_array_keys(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', ['WC_Email'], &this), 'placeholders'))])])).str() +
			'</code>',
	])
	...
	mut var_inject_index := rt.call_function('array_search', [
		...
		rt.func_array_keys(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
			'WC_Email',
		], &this), 'form_fields')),
		rt.new_bool(true)])
	...
	this.dispatch_set_prop('form_fields', rt.add(rt.add(rt.call_function('array_slice', [
		...
		var_inject_index.dup(),
		rt.sub(rt.new_int(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_StockNotifications_Emails_CustomerStockNotificationVerifiedEmail', [
			'WC_Email',
...
pub fn init_wp_content_plugins_woocommerce_src_internal_stocknotifications_emails_customerstocknotificationverifiedemail_php() {
