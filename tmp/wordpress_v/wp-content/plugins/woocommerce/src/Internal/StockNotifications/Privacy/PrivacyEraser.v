...
fn Class_Automattic_WooCommerce_Internal_StockNotifications_Privacy_PrivacyEraser.erase_notification_data(email_address string) rt.PhpVal {
	...
	}(rt.create_array([rt.ArrayItem{ key: 'user_email', val: email_address }]))
	{
		...
		for {
			...
			rt.call_method(var_notification, 'set_user_email', [
				var_anonymous_email.dup()])
			rt.call_method(var_notification, 'set_user_id', [
				rt.new_int(0)])
...
fn create_automattic_woocommerce_internal_stocknotifications_privacy_wc_abstract_privacy() &Class_Automattic_WooCommerce_Internal_StockNotifications_Privacy_WC_Abstract_Privacy {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_stocknotifications_privacy_privacyeraser_php() {
