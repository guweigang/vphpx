...
fn (mut this Class_Automattic_WooCommerce_Internal_DataStores_StockNotifications_StockNotificationsMetaDataStore) delete_by_notification_id(var_notification_id rt.PhpVal) bool {
	...
	mut var_result := rt.call_method(var_wpdb, 'delete', [var_table.dup(), rt.create_array([rt.ArrayItem{ key: 'notification_id', val: var_notification_id }]), rt.create_array([rt.ArrayItem{ key: none, val: '%d' }])])
...
fn create_automattic_woocommerce_internal_datastores_stocknotifications_stocknotificationsmetadatastore() &Class_Automattic_WooCommerce_Internal_DataStores_StockNotifications_StockNotificationsMetaDataStore {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_datastores_stocknotifications_stocknotificationsmetadatastore_php() {
