...
fn (mut this Class_Automattic_WooCommerce_Internal_PushNotifications_Notifications_NewOrderNotification) write_meta(key string)  {
	...
	if rt.is_true(rt.new_bool(rt.instance_of(var_order, 'WC_Order'))) {
		rt.call_method(var_order, 'update_meta_data', [rt.new_string(key), // unsupported expression: Expr_Cast_String])
...
pub fn init_wp_content_plugins_woocommerce_src_internal_pushnotifications_notifications_newordernotification_php() {
