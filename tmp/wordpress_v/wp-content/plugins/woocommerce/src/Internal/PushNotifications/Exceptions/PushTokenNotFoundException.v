...
fn (mut this Class_Automattic_WooCommerce_Internal_PushNotifications_Exceptions_PushTokenNotFoundException) construct()  {
	this.Class_WC_Data_Exception.construct(rt.new_string('woocommerce_invalid_push_token'), rt.new_string('Push token could not be found.'), Class_WP_Http.not_found())
}
...
pub fn init_wp_content_plugins_woocommerce_src_internal_pushnotifications_exceptions_pushtokennotfoundexception_php() {
