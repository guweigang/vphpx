...
fn (mut this Class_Automattic_WooCommerce_Internal_PushNotifications_Exceptions_PushTokenInvalidDataException) construct(message string)  {
	this.Class_WC_Data_Exception.construct(rt.new_string('woocommerce_invalid_data'), rt.new_string(message), Class_WP_Http.bad_request())
}
...
pub fn init_wp_content_plugins_woocommerce_src_internal_pushnotifications_exceptions_pushtokeninvaliddataexception_php() {
