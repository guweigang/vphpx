...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller) register_routes()  {
	rt.call_function('register_rest_route', [rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'namespace'), '/' + (this.rest_base).str(), rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'get_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'get_item_permissions_check' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.editable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'update_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'update_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: this.get_endpoint_args_for_item_schema(Class_WP_REST_Server.editable()) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'get_item_schema' }]) }])])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller) get_item_permissions_check(var_request rt.PhpVal) bool {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_check_manager_permissions', [rt.new_string('settings'), rt.new_string('read')]))))) {
		return (create_wp_error(rt.new_string('rest_forbidden'), rt.call_function('__', [rt.new_string('Sorry, you are not allowed to access email settings.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: rt.call_function('rest_authorization_required_code', []rt.PhpVal{}) }]))).to_bool()
	}
	return true
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller) update_item_permissions_check(var_request rt.PhpVal) bool {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_check_manager_permissions', [rt.new_string('settings'), rt.new_string('edit')]))))) {
		return (create_wp_error(rt.new_string('rest_forbidden'), rt.call_function('__', [rt.new_string('Sorry, you are not allowed to edit email settings.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: rt.call_function('rest_authorization_required_code', []rt.PhpVal{}) }]))).to_bool()
	}
	return true
}
...
catch_label_1:
	...
	if rt.instance_of(var_e_1, 'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Exception') {
		mut var_e := var_e_1.dup()
		return create_wp_error(rt.new_string('woocommerce_rest_email_settings_error'), rt.call_method(var_e, 'getMessage', []rt.PhpVal{}), rt.create_array([rt.ArrayItem{ key: 'status', val: 500 }]))
		unsafe { goto end_label_1 }
	}
	else {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller) update_item(var_request rt.PhpVal) rt.PhpVal {
	...
	return rt.new_bool(var_def.array_isset(rt.new_string('id')) && rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('in_array', [var_type.dup(), Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Schema_EmailSettingsSchema.non_editable_types(), rt.new_bool(true)]))))))
	}
	...
	mut var_reply_to_enabled := rt.call_function('get_option', [rt.new_string('woocommerce_email_reply_to_enabled'), rt.new_string('no')])
	if var_values_to_update.array_isset(rt.new_string('woocommerce_email_reply_to_enabled')) {
		var_reply_to_enabled = rt.call_function('wc_bool_to_string', [var_values_to_update.array_get('woocommerce_email_reply_to_enabled')])
	}
	var_values_to_update = rt.call_function('apply_filters', [rt.new_string('woocommerce_emails_api_settings_schema_validate_and_sanitize_settings'), var_values_to_update.dup(), var_settings_by_id.dup()])
	if rt.is_true(rt.call_function('is_wp_error', [var_values_to_update.dup()])) {
		return var_values_to_update.dup()
	}
	...
	}
	{
		...
		for {
			...
			mut var_validation_result := rt.new_bool(this.validate_setting_value(var_setting_id.dup(), var_sanitized_value.dup(), var_reply_to_enabled.dup()))
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller) validate_setting_value(var_setting_id rt.PhpVal, var_value rt.PhpVal, var_reply_to_enabled rt.PhpVal) bool {
	...
	if rt.is_true(rt.equal(switch_val_1, rt.new_string('woocommerce_email_from_name'))) {
		if rt.is_true(rt.new_bool(!rt.is_true(var_value_mutated) || rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_value_mutated.dup().is_string()))))))) {
			return (create_wp_error(rt.new_string('rest_invalid_param'), rt.call_function('__', [rt.new_string('Email sender name cannot be empty.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 400 }]))).to_bool()
		}
	} else if rt.is_true(rt.equal(switch_val_1, rt.new_string('woocommerce_email_from_address'))) {
		if rt.is_true(rt.new_bool(!rt.is_true(var_value_mutated) || rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('is_email', [var_value_mutated.dup()]))))))) {
			return (create_wp_error(rt.new_string('rest_invalid_param'), rt.call_function('__', [rt.new_string('Please enter a valid email address.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 400 }]))).to_bool()
		}
		...
		if rt.is_true(rt.new_bool(var_value_mutated.dup().is_string())) {
			var_value_mutated = rt.call_function('filter_var', [var_value_mutated.dup(), rt.get_constant('FILTER_VALIDATE_BOOLEAN'), rt.get_constant('FILTER_NULL_ON_FAILURE')])
		}
		if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_value_mutated.dup().is_bool()))))) && rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) {
			return (create_wp_error(rt.new_string('rest_invalid_param'), rt.call_function('__', [rt.new_string('Reply-to enabled must be a boolean value.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 400 }]))).to_bool()
		}
	} else if rt.is_true(rt.equal(switch_val_1, rt.new_string('woocommerce_email_reply_to_name'))) {
		if rt.is_true(rt.new_bool(rt.is_true(var_check_reply_to) && rt.is_true(rt.new_bool(!rt.is_true(var_value_mutated) || rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_value_mutated.dup().is_string()))))))))) {
			return (create_wp_error(rt.new_string('rest_invalid_param'), rt.call_function('__', [rt.new_string('Reply-to name cannot be empty when reply-to is enabled.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 400 }]))).to_bool()
		}
	} else if rt.is_true(rt.equal(switch_val_1, rt.new_string('woocommerce_email_reply_to_address'))) {
		if rt.is_true(rt.new_bool(rt.is_true(var_check_reply_to) && rt.is_true(rt.new_bool(!rt.is_true(var_value_mutated) || rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('is_email', [var_value_mutated.dup()]))))))))) {
			return (create_wp_error(rt.new_string('rest_invalid_param'), rt.call_function('__', [rt.new_string('Please enter a valid reply-to email address.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 400 }]))).to_bool()
		}
	}
	return true
}

fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller) sanitize_setting_value(var_setting_type rt.PhpVal, var_value rt.PhpVal)  {
	mut var_setting_type_mutated := var_setting_type
	mut var_value_mutated := var_value
	mut switch_val_2 := var_setting_type_mutated
	if rt.is_true(rt.equal(switch_val_2, rt.new_string('text'))) || rt.is_true(rt.equal(switch_val_2, rt.new_string('select'))) || rt.is_true(rt.equal(switch_val_2, rt.new_string('color'))) {
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_settings_email_controller() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'init' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Schema_EmailSettingsSchema](if args.len > 0 { args[0] } else { rt.new_null() })
		...
		'validate_setting_value' {
			...
			return rt.new_bool(this.validate_setting_value(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2))
		}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Email_Controller) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		...
		'settings_emails_instance' { this.settings_emails_instance = val; return true }
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_settings_email_controller_php() {
