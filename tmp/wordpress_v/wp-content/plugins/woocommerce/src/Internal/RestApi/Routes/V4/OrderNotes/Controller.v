...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) get_query_schema() rt.PhpVal {
	return rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'collection_query'), 'get_query_schema', []rt.PhpVal{})
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) prepare_links(var_item rt.PhpVal, mut var_request Class_WP_REST_Request, mut var_response Class_WP_REST_Response) rt.PhpVal {
	...
	return rt.create_array([rt.ArrayItem{ key: 'self', val: rt.create_array([rt.ArrayItem{ key: 'href', val: rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('/%s/%s/%d'), rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'namespace'), this.rest_base, // unsupported expression: Expr_Cast_Int])]) }]) }, rt.ArrayItem{ key: 'collection', val: rt.create_array([rt.ArrayItem{ key: 'href', val: rt.call_function('add_query_arg', [rt.create_array([rt.ArrayItem{ key: 'order_id', val: // unsupported expression: Expr_Cast_Int }]), rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('/%s/%s'), rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'namespace'), this.rest_base])])]) }]) }])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) get_item_response(var_note rt.PhpVal, mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	return rt.call_method(this.item_schema, 'get_item_response', [var_note_mutated.dup(), var_request])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) get_item_permissions_check(var_request rt.PhpVal) bool {
	mut var_order := this.get_order_by_note_id(// unsupported expression: Expr_Cast_Int)
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_check_post_permissions', [rt.new_string('shop_order'), rt.new_string('read'), rt.call_method(var_order, 'get_id', []rt.PhpVal{})]))))) {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) get_items_permissions_check(var_request rt.PhpVal) bool {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_check_post_permissions', [rt.new_string('shop_order'), rt.new_string('read'), // unsupported expression: Expr_Cast_Int]))))) {
		return (this.get_authentication_error_by_method(rt.call_method(var_request, 'get_method', []rt.PhpVal{}))).to_bool()
	}
	return true
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) create_item_permissions_check(var_request rt.PhpVal) bool {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_check_post_permissions', [rt.new_string('shop_order'), rt.new_string('create'), // unsupported expression: Expr_Cast_Int]))))) {
		return (this.get_authentication_error_by_method(rt.call_method(var_request, 'get_method', []rt.PhpVal{}))).to_bool()
	}
	return true
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) delete_item_permissions_check(var_request rt.PhpVal) bool {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_check_post_permissions', [rt.new_string('shop_order'), rt.new_string('delete'), rt.call_method(var_order, 'get_id', []rt.PhpVal{})]))))) {
		return (this.get_authentication_error_by_method(rt.call_method(var_request, 'get_method', []rt.PhpVal{}))).to_bool()
	}
	return true
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) get_item(var_request rt.PhpVal) rt.PhpVal {
	mut var_note := this.get_note_by_id((// unsupported expression: Expr_Cast_Int).to_i64())
	...
	return this.prepare_item_for_response(var_note.dup(), var_request.dup())
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) get_items(var_request rt.PhpVal) rt.PhpVal {
	mut var_order := this.get_order_by_id((// unsupported expression: Expr_Cast_Int).to_i64())
	if rt.is_true(rt.new_bool(!(rt.is_true(var_order)))) {
		return this.get_route_error_by_code(Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller.invalid_id())
	}
	mut var_query_args := rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'collection_query'), 'get_query_args', [var_request.dup()])
	mut var_results := rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'collection_query'), 'get_query_results', [var_query_args.dup(), var_request.dup()])
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) create_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_order := this.get_order_by_id((// unsupported expression: Expr_Cast_Int).to_i64())
	mut var_note_id := if rt.is_true(var_order) { rt.call_method(var_order, 'add_order_note', [rt.call_function('wp_kses_post', [var_request.array_get('note')]), var_request.array_get('is_customer_note'), rt.new_bool(true)]) } else { rt.new_null() }
	...
	rt.call_function('do_action', [(this.get_hook_prefix()).str() + 'created', var_note.dup(), var_request.dup()])
	...
	rt.call_method(var_response, 'header', [rt.new_string('Location'), rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('/%s/%s/%d'), rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'namespace'), this.rest_base, var_note_id.dup()])])])
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) delete_item(var_request rt.PhpVal) rt.PhpVal {
	...
	rt.call_method(var_request, 'set_param', [rt.new_string('context'), rt.new_string('edit')])
	mut var_response := this.prepare_item_for_response(var_note.dup(), var_request.dup())
	mut var_result := rt.call_function('wc_delete_order_note', [// unsupported expression: Expr_Cast_Int])
	...
	rt.call_function('do_action', [(this.get_hook_prefix()).str() + 'deleted', var_note.dup(), var_response.dup(), var_request.dup()])
	return var_response.dup()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) get_order_by_id(order_id i64) rt.PhpVal {
	...
	return if rt.is_true(rt.new_bool(rt.is_true(var_order) && rt.is_true(rt.identical(rt.new_string('shop_order'), rt.call_method(var_order, 'get_type', []rt.PhpVal{}))))) { var_order } else { rt.new_null() }
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) get_order_by_note_id(var_note_id rt.PhpVal) rt.PhpVal {
	...
	mut var_note := if rt.is_true(rt.new_bool(rt.instance_of(var_note_id_mutated, 'WP_Comment'))) { var_note_id_mutated } else { this.get_note_by_id((// unsupported expression: Expr_Cast_Int).to_i64()) }
	if rt.is_true(rt.new_bool(!(rt.is_true(var_note)))) {
		return rt.new_null()
	}
	return this.get_order_by_id((// unsupported expression: Expr_Cast_Int).to_i64())
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) get_note_by_id(note_id i64) rt.PhpVal {
	...
	mut var_note := rt.call_function('get_comment', [rt.new_int(note_id_mutated).dup()])
	return if rt.is_true(rt.new_bool(rt.is_true(var_note) && rt.is_true(rt.identical(rt.new_string('order_note'), rt.get_property(var_note, 'comment_type'))))) { var_note } else { rt.new_null() }
}
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_ordernotes_controller() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Controller) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'init' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_Schema_OrderNoteSchema](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_OrderNotes_CollectionQuery](if args.len > 1 { args[1] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_ordernotes_controller_php() {
