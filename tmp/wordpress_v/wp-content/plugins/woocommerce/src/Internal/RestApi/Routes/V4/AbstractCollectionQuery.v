...
pub fn Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractCollectionQuery.operators() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: none, val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractCollectionQuery.operator_is() }, rt.ArrayItem{ key: none, val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractCollectionQuery.operator_is_not() }, rt.ArrayItem{ key: none, val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractCollectionQuery.operator_less_than() }, rt.ArrayItem{ key: none, val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractCollectionQuery.operator_greater_than() }, rt.ArrayItem{ key: none, val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractCollectionQuery.operator_less_than_or_equal() }, rt.ArrayItem{ key: none, val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractCollectionQuery.operator_greater_than_or_equal() }, rt.ArrayItem{ key: none, val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractCollectionQuery.operator_between() }])
}
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_abstractcollectionquery_php() {
