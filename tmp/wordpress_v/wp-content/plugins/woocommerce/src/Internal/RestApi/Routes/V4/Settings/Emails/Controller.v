...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller) register_routes()  {
	rt.call_function('register_rest_route', [rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'namespace'), '/' + (this.rest_base).str(), rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'get_items' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'get_items_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'post_id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Filter by template post ID.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }]) }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'get_item_schema' }]) }])])
	rt.call_function('register_rest_route', [rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'namespace'), '/' + (this.rest_base).str() + '/(?P<email_id>[\\w-]+)', rt.create_array([rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'email_id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Email template ID.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'get_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'get_item_permissions_check' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.editable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'update_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'update_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: this.get_endpoint_args_for_item_schema(Class_WP_REST_Server.editable()) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this) }, rt.ArrayItem{ key: none, val: 'get_item_schema' }]) }])])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller) get_items(var_request rt.PhpVal) rt.PhpVal {
	mut var_emails := rt.call_method(fn () rt.PhpVal { mut temp := Class_WC_Emails{}; return temp.instance() }(), 'get_emails', []rt.PhpVal{})
	...
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	{
		...
		for {
			...
			mut var_item := rt.call_method(this.schema, 'get_item_response', [var_email.dup(), var_request.dup()])
			if rt.has_exception() { unsafe { goto catch_label_1 } }
			mut var_post_id := rt.call_method(var_request, 'get_param', [rt.new_string('post_id')])
			if rt.has_exception() { unsafe { goto catch_label_1 } }
			...
			if rt.has_exception() { unsafe { goto catch_label_1 } }
			var_items.array_push(var_item.dup())
			if rt.has_exception() { unsafe { goto catch_label_1 } }
		}
	}
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	return rt.call_function('rest_ensure_response', [var_items.dup()])
	unsafe { goto end_label_1 }

catch_label_1:
	mut var_e_1 := rt.get_and_clear_exception()
	if rt.instance_of(var_e_1, 'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Exception') {
		mut var_e := var_e_1.dup()
		return create_wp_error(rt.new_string('woocommerce_rest_emails_settings_error'), rt.call_method(var_e, 'getMessage', []rt.PhpVal{}), rt.create_array([rt.ArrayItem{ key: 'status', val: 500 }]))
		unsafe { goto end_label_1 }
	}
	else {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller) get_item(var_request rt.PhpVal) rt.PhpVal {
	mut var_email_id := var_request.array_get('email_id')
	mut var_email := this.get_email_by_id((var_email_id).str())
	if rt.is_true(rt.new_bool(!(rt.is_true(var_email)))) {
		return create_wp_error(rt.new_string('woocommerce_rest_email_not_found'), rt.call_function('__', [rt.new_string('Email template not found.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 404 }]))
	}
	mut var_response := rt.call_method(this.schema, 'get_item_response', [var_email.dup(), var_request.dup()])
...
catch_label_2:
	...
	if rt.instance_of(var_e_2, 'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Exception') {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller) update_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_validated := rt.call_method(this.schema, 'validate_and_sanitize_settings', [var_email.dup(), var_values_to_update.dup()])
	if rt.is_true(rt.call_function('is_wp_error', [var_validated.dup()])) {
		return var_validated.dup()
	}
	mut var_updated_fields := rt.new_array()
	{
		mut iter_1 := var_validated.iterator()
		for {
			item_1 := iter_1.next() or { break }
			mut var_value := item_1.val
			mut var_key := item_1.key
			rt.call_method(var_email, 'update_option', [var_key.dup(), var_value.dup()])
			var_updated_fields.array_push(var_key.dup())
		}
	}
	rt.call_method(fn () rt.PhpVal { mut temp := Class_WC_Emails{}; return temp.instance() }(), 'init', []rt.PhpVal{})
	mut var_updated_email := this.get_email_by_id((var_email_id).str())
	if rt.is_true(rt.new_bool(!(rt.is_true(var_updated_email)))) {
		return create_wp_error(rt.new_string('woocommerce_rest_email_update_error'), rt.call_function('__', [rt.new_string('Failed to retrieve updated email settings.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 500 }]))
	}
	if !(!rt.is_true(var_updated_fields)) {
		rt.call_function('do_action', [rt.new_string('woocommerce_settings_updated'), var_updated_fields.dup(), this.rest_base])
	}
	mut var_response := rt.call_method(this.schema, 'get_item_response', [var_updated_email.dup(), var_request.dup()])
...
catch_label_3:
	...
	if rt.instance_of(var_e_3, 'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Exception') {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller) get_item_response(var_item rt.PhpVal, mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	return rt.call_method(this.schema, 'get_item_response', [var_item_mutated.dup(), var_request])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller) get_email_by_id(email_id string) rt.PhpVal {
	...
	mut var_emails := rt.call_method(fn () rt.PhpVal { mut temp := Class_WC_Emails{}; return temp.instance() }(), 'get_emails', []rt.PhpVal{})
	{
		...
		for {
			item_1 := iter_1.next() or { break }
			mut var_email := item_1.val
			if rt.is_true(rt.identical(rt.get_property(var_email, 'id'), rt.new_string(email_id_mutated))) {
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_settings_emails_controller() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Controller) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'init' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Settings_Emails_Schema_EmailsSettingsSchema](if args.len > 0 { args[0] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_settings_emails_controller_php() {
