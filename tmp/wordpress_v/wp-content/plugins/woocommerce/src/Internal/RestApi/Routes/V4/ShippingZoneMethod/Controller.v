...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) check_permissions(var_request rt.PhpVal) bool {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_shipping_enabled', []rt.PhpVal{}))))) {
		return (create_wp_error(rt.new_string('rest_shipping_disabled'), rt.call_function('__', [rt.new_string('Shipping is disabled.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: Class_WP_Http.service_unavailable() }]))).to_bool()
	}
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_check_manager_permissions', [rt.new_string('settings'), var_context.dup()]))))) {
		return (this.get_authentication_error_by_method(var_method.dup())).to_bool()
	}
	return true
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) get_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_method := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_WC_Shipping_Zones{}; return temp.get_shipping_method(arg_0) }(var_instance_id.dup())
	...
	return rt.call_function('rest_ensure_response', [this.prepare_item_for_response(var_method.dup(), var_request_mutated.dup())])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) create_item(var_request rt.PhpVal) rt.PhpVal {
	mut var_request_mutated := var_request
	mut var_zone := this.validate_zone(var_request_mutated.array_get('zone_id'))
	if rt.is_true(rt.call_function('is_wp_error', [var_zone.dup()])) {
		return var_zone.dup()
	}
	mut var_method_validation := rt.new_bool(this.validate_method_type(var_request_mutated.array_get('method_id')))
	if rt.is_true(rt.call_function('is_wp_error', [var_method_validation.dup()])) {
		return var_method_validation.dup()
	}
	mut var_instance_id := rt.call_method(var_zone, 'add_shipping_method', [var_request_mutated.array_get('method_id')])
	...
	mut var_result := rt.call_method(this.shipping_method_service, 'update_shipping_zone_method', [var_method.dup(), var_instance_id.dup(), rt.call_method(var_request_mutated, 'get_params', []rt.PhpVal{}), rt.call_method(var_zone, 'get_id', []rt.PhpVal{})])
	...
	mut var_response := this.prepare_item_for_response(var_method.dup(), var_request_mutated.dup())
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) update_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_zone := this.validate_zone_by_method_instance(var_instance_id.dup())
	if rt.is_true(rt.call_function('is_wp_error', [var_zone.dup()])) {
		return var_zone.dup()
	}
	if var_request_mutated.array_isset(rt.new_string('enabled')) || var_request_mutated.array_isset(rt.new_string('settings')) || var_request_mutated.array_isset(rt.new_string('order')) {
		mut var_result := rt.call_method(this.shipping_method_service, 'update_shipping_zone_method', [var_method.dup(), var_instance_id.dup(), rt.call_method(var_request_mutated, 'get_params', []rt.PhpVal{}), rt.call_method(var_zone, 'get_id', []rt.PhpVal{})])
		if rt.is_true(rt.call_function('is_wp_error', [var_result.dup()])) {
			return var_result.dup()
		}
	...
	var_request_mutated.array_set('zone_id', rt.call_method(var_zone, 'get_id', []rt.PhpVal{}))
	return this.prepare_item_for_response(var_method.dup(), var_request_mutated.dup())
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) delete_item(var_request rt.PhpVal) rt.PhpVal {
	...
	rt.call_method(var_request_mutated, 'set_param', [rt.new_string('context'), rt.new_string('view')])
	var_request_mutated.array_set('zone_id', rt.call_method(var_zone, 'get_id', []rt.PhpVal{}))
	mut var_response := this.prepare_item_for_response(var_method.dup(), var_request_mutated.dup())
	mut var_result := rt.call_method(var_zone, 'delete_shipping_method', [var_instance_id.dup()])
	if rt.is_true(rt.new_bool(!(rt.is_true(var_result)))) {
		return this.get_route_error_by_code((Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller.invalid_id()).str())
	}
	rt.call_function('do_action', [rt.new_string('woocommerce_rest_delete_shipping_zone_method'), var_method.dup(), var_zone.dup(), var_response.dup(), var_request_mutated.dup()])
	return var_response.dup()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) get_item_response(var_zone rt.PhpVal, mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	mut var_request_mutated := var_request
	return rt.call_method(this.method_schema, 'get_item_response', [var_zone_mutated.dup(), var_request_mutated.dup(), this.get_fields_for_response(rt.new_object('WP_REST_Request', []string{}, var_request_mutated))])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) get_route_error_by_code(error_code string) rt.PhpVal {
	mut var_custom_errors := rt.create_array([rt.ArrayItem{ key: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller.invalid_zone_id(), val: rt.create_array([rt.ArrayItem{ key: 'message', val: rt.call_function('__', [rt.new_string('Invalid shipping zone ID.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'status', val: Class_WP_Http.not_found() }]) }, rt.ArrayItem{ key: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller.invalid_method_type(), val: rt.create_array([rt.ArrayItem{ key: 'message', val: rt.call_function('__', [rt.new_string('Invalid shipping method type.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'status', val: Class_WP_Http.bad_request() }]) }, rt.ArrayItem{ key: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller.zone_mismatch(), val: rt.create_array([rt.ArrayItem{ key: 'message', val: rt.call_function('__', [rt.new_string('Shipping method does not belong to the specified zone.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'status', val: Class_WP_Http.bad_request() }]) }])
	if var_custom_errors.array_isset(rt.new_string(error_code)) {
		return this.get_route_error_response(rt.new_string((this.get_error_prefix()).str() + error_code), var_custom_errors.array_get(error_code).array_get('message'), var_custom_errors.array_get(error_code).array_get('status'))
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) validate_zone(var_zone_id rt.PhpVal) rt.PhpVal {
	mut var_zone := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_WC_Shipping_Zones{}; return temp.get_zone(arg_0) }(var_zone_id.dup())
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(var_zone)))) || rt.is_true(rt.new_bool(rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) && rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(var_zone, 'get_zone_name', []rt.PhpVal{}))))))))) {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) validate_method_type(var_method_id rt.PhpVal) bool {
	mut var_available_methods := rt.call_method(rt.call_method(rt.call_function('WC', []rt.PhpVal{}), 'shipping', []rt.PhpVal{}), 'get_shipping_methods', []rt.PhpVal{})
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) validate_zone_by_method_instance(var_instance_id rt.PhpVal) rt.PhpVal {
	...
	mut var_zone := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_WC_Shipping_Zones{}; return temp.get_zone_by(arg_0, arg_1) }(rt.new_string('instance_id'), var_instance_id_mutated.dup())
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_shippingzonemethod_controller() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'init' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_ShippingMethodSchema](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_ShippingZoneMethodService](if args.len > 1 { args[1] } else { rt.new_null() })
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZoneMethod_Controller) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		...
		'method_schema' { this.method_schema = val; return true }
		'shipping_method_service' { this.shipping_method_service = val; return true }
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_shippingzonemethod_controller_php() {
