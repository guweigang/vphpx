...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller) get_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_user := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Automattic_WooCommerce_Internal_Utilities_Users{}; return temp.get_user_in_current_site(arg_0) }(var_request_mutated.array_get('id'))
	...
	mut var_customer := this.prepare_item_for_response(create_wc_customer(rt.get_property(var_user, 'ID')), var_request_mutated.dup())
	mut var_response := rt.call_function('rest_ensure_response', [var_customer.dup()])
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller) get_item_response(var_customer rt.PhpVal, mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	mut var_request_mutated := var_request
	return rt.call_method(this.item_schema, 'get_item_response', [var_customer_mutated.dup(), var_request_mutated.dup(), this.get_fields_for_response(rt.new_object('WP_REST_Request', []string{}, var_request_mutated))])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller) get_items(var_request rt.PhpVal) rt.PhpVal {
	mut var_request_mutated := var_request
	mut var_query_args := rt.call_method(this.collection_query, 'get_query_args', [var_request_mutated.dup()])
	mut var_results := rt.call_method(this.collection_query, 'get_query_results', [var_query_args.dup(), var_request_mutated.dup()])
	mut var_items := rt.new_array()
	{
		...
		for {
			...
			var_items.array_push(this.prepare_response_for_collection(this.prepare_item_for_response(var_customer.dup(), var_request_mutated.dup())))
		}
	}
	mut var_pagination_util := create_automattic_woocommerce_storeapi_utilities_pagination()
	mut var_response := var_pagination_util.add_headers(rt.call_function('rest_ensure_response', [var_items.dup()]), var_request_mutated.dup(), var_results.array_get('total'), var_results.array_get('pages'))
	return var_response.dup()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller) create_item(var_request rt.PhpVal) rt.PhpVal {
	...
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	rt.call_method(this.update_utils, 'update_customer_from_request', [var_customer.dup(), var_request_mutated.dup(), rt.new_bool(true)])
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	...
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	rt.call_function('do_action', [(this.get_hook_prefix()).str() + 'created', var_user_data.dup(), var_request_mutated.dup()])
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	rt.call_method(var_request_mutated, 'set_param', [rt.new_string('context'), rt.new_string('edit')])
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	mut var_response := this.prepare_item_for_response(var_customer.dup(), var_request_mutated.dup())
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	rt.call_method(var_response, 'set_status', [Class_WP_Http.created()])
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	rt.call_method(var_response, 'header', [rt.new_string('Location'), rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('/%s/%s/%d'), rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'namespace'), this.rest_base, rt.call_method(var_customer, 'get_id', []rt.PhpVal{})])])])
	if rt.has_exception() { unsafe { goto catch_label_1 } }
	return var_response.dup()
...
catch_label_1:
	...
	if rt.instance_of(var_e_1, 'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_WC_REST_Exception') {
	...
	else if rt.instance_of(var_e_1, 'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Exception') {
		mut var_e := var_e_1.dup()
		return this.get_route_error_by_code(Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller.cannot_create())
		unsafe { goto end_label_1 }
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller) update_item(var_request rt.PhpVal) rt.PhpVal {
	...
	rt.call_method(this.update_utils, 'update_customer_from_request', [var_customer.dup(), var_request_mutated.dup(), rt.new_bool(false)])
	if rt.has_exception() { unsafe { goto catch_label_2 } }
	mut var_user_data := rt.call_function('get_userdata', [rt.call_method(var_customer, 'get_id', []rt.PhpVal{})])
	if rt.has_exception() { unsafe { goto catch_label_2 } }
	this.update_additional_fields_for_object(var_user_data.dup(), var_request_mutated.dup())
	if rt.has_exception() { unsafe { goto catch_label_2 } }
	rt.call_function('do_action', [(this.get_hook_prefix()).str() + 'updated', var_user_data.dup(), var_request_mutated.dup()])
	if rt.has_exception() { unsafe { goto catch_label_2 } }
	rt.call_method(var_request_mutated, 'set_param', [rt.new_string('context'), rt.new_string('edit')])
	if rt.has_exception() { unsafe { goto catch_label_2 } }
	return this.prepare_item_for_response(var_customer.dup(), var_request_mutated.dup())
	unsafe { goto end_label_2 }

catch_label_2:
	mut var_e_2 := rt.get_and_clear_exception()
	if rt.instance_of(var_e_2, 'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_WC_REST_Exception') {
		mut var_e := var_e_2.dup()
		return create_wp_error(rt.call_method(var_e, 'getErrorCode', []rt.PhpVal{}), rt.call_method(var_e, 'getMessage', []rt.PhpVal{}), rt.create_array([rt.ArrayItem{ key: 'status', val: rt.call_method(var_e, 'getCode', []rt.PhpVal{}) }]))
		unsafe { goto end_label_2 }
	}
	else if rt.instance_of(var_e_2, 'Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Exception') {
		mut var_e := var_e_2.dup()
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller) delete_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_force := if var_request_mutated.array_isset(rt.new_string('force')) { // unsupported expression: Expr_Cast_Bool } else { rt.new_bool(false) }
	...
	mut var_user_data := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Automattic_WooCommerce_Internal_Utilities_Users{}; return temp.get_user_in_current_site(arg_0) }(var_id.dup())
	if rt.is_true(rt.call_function('is_wp_error', [var_user_data.dup()])) {
		return this.get_route_error_by_code(Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller.invalid_id())
	}
	rt.call_method(var_request_mutated, 'set_param', [rt.new_string('context'), rt.new_string('edit')])
	mut var_response := this.prepare_item_for_response(create_wc_customer(var_id.dup()), var_request_mutated.dup())
	...
	rt.call_function('do_action', [(this.get_hook_prefix()).str() + 'deleted', var_user_data.dup(), var_response.dup(), var_request_mutated.dup()])
	return var_response.dup()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller) get_items_permissions_check(var_request rt.PhpVal) bool {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_check_user_permissions', [rt.new_string('read')]))))) {
		return (this.get_authentication_error_by_method(rt.call_method(var_request_mutated, 'get_method', []rt.PhpVal{}))).to_bool()
	}
	return true
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller) update_item_permissions_check(var_request rt.PhpVal) bool {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_rest_check_user_permissions', [rt.new_string('edit'), rt.get_property(var_user, 'ID')]))))) {
		return (this.get_authentication_error_by_method(rt.call_method(var_request_mutated, 'get_method', []rt.PhpVal{}))).to_bool()
	}
	mut var_allowed_roles := this.get_allowed_roles()
	mut var_customer := create_wc_customer(rt.get_property(var_user, 'ID'))
	if rt.is_true(rt.new_bool(rt.is_true(var_customer) && rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('in_array', [rt.call_method(, 'get_role', []rt.PhpVal{}), var_allowed_roles.dup(), rt.new_bool(true)]))))))) {
		mut var_non_editable_props := rt.create_array([rt.ArrayItem{ key: none, val: 'email' }, rt.ArrayItem{ key: none, val: 'password' }])
		mut var_customer_prop := rt.create_array([rt.ArrayItem{ key: , val:  }])
		{
			mut iter_1 := var_non_editable_props.iterator()
			for {
				item_1 := iter_1.next() or { break }
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_customers_controller() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller {
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_customers_automattic_woocommerce_internal_utilities_users() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Automattic_WooCommerce_Internal_Utilities_Users {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_Controller) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'init' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_CustomerSchema](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_CollectionQuery](if args.len > 1 { args[1] } else { rt.new_null() })
			mut dispatch_arg_2 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Customers_UpdateUtils](if args.len > 2 { args[2] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_customers_controller_php() {
