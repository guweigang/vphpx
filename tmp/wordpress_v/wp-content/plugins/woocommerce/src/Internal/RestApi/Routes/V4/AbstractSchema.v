...
pub fn Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractSchema.view_edit_embed_context() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }, rt.ArrayItem{ key: none, val: 'embed' }])
}
pub fn Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractSchema.view_edit_context() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractSchema) get_item_schema() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: '$schema', val: 'http://json-schema.org/draft-04/schema#' }, rt.ArrayItem{ key: 'title', val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_static.identifier() }, rt.ArrayItem{ key: 'type', val: 'object' }, rt.ArrayItem{ key: 'properties', val: this.get_item_schema_properties() }])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractSchema) get_writable_item_schema_properties() rt.PhpVal {
	return rt.call_function('array_filter', [this.get_item_schema_properties(), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractSchema', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'filter_writable_props' }])])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractSchema) filter_writable_props(mut var_schema Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_array) bool {
	return (rt.new_bool(!rt.is_true(var_schema.array_get('readonly')))).to_bool()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractSchema) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'filter_writable_props' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_array](if args.len > 0 { args[0] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_abstractschema_php() {
