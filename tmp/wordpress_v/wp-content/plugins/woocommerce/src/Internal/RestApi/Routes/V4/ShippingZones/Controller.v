...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) init(mut var_zone_schema Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_ShippingZoneSchema, mut var_shipping_zone_service Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_ShippingZoneService)  {
	this.item_schema = var_zone_schema.dup()
	this.shipping_zone_service = var_shipping_zone_service.dup()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) get_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_zone := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_WC_Shipping_Zones{}; return temp.get_zone_by(arg_0, arg_1) }(rt.new_string('zone_id'), var_zone_id.dup())
	if rt.is_true(rt.new_bool(!(rt.is_true(var_zone)))) {
		return this.get_route_error_response(rt.new_string((this.get_error_prefix()).str() + 'invalid_id'), rt.call_function('__', [rt.new_string('Invalid resource ID.'), rt.new_string('woocommerce')]), Class_WP_Http.not_found())
	}
	return rt.call_function('rest_ensure_response', [this.prepare_item_for_response(var_zone.dup(), var_request.dup())])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) get_items(var_request rt.PhpVal) rt.PhpVal {
	mut var_zones := rt.call_method(this.shipping_zone_service, 'get_sorted_shipping_zones', []rt.PhpVal{})
	mut var_items := rt.new_array()
	{
		...
		for {
			...
			mut var_zone_id := var_zone_data.array_get('zone_id')
			mut var_zone := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_WC_Shipping_Zones{}; return temp.get_zone(arg_0) }(var_zone_id.dup())
			var_items.array_push(this.prepare_response_for_collection(this.prepare_item_for_response(var_zone.dup(), var_request.dup())))
		}
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) get_item_response(var_zone rt.PhpVal, mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	return rt.call_method(this.item_schema, 'get_item_response', [var_zone_mutated.dup(), var_request, this.get_fields_for_response(rt.new_object('WP_REST_Request', []string{}, var_request))])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) check_permissions(var_request rt.PhpVal) bool {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('wc_shipping_enabled', []rt.PhpVal{}))))) {
		return (this.get_route_error_response(rt.new_string((this.get_error_prefix()).str() + 'disabled'), rt.call_function('__', [rt.new_string('Shipping is disabled.'), rt.new_string('woocommerce')]), Class_WP_Http.service_unavailable())).to_bool()
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) create_item(var_request rt.PhpVal) rt.PhpVal {
	mut var_zone := rt.call_method(this.shipping_zone_service, 'create_shipping_zone', [rt.call_method(var_request, 'get_params', []rt.PhpVal{})])
	...
	if rt.is_true(rt.identical(rt.new_int(0), rt.call_method(var_zone, 'get_id', []rt.PhpVal{}))) {
		return this.get_route_error_response(rt.new_string((this.get_error_prefix()).str() + 'cannot_create'), rt.call_function('__', [rt.new_string('Resource cannot be created. Check for validation errors or server logs for details.'), rt.new_string('woocommerce')]), Class_WP_Http.internal_server_error())
	}
	mut var_response := rt.call_function('rest_ensure_response', [this.prepare_item_for_response(var_zone.dup(), var_request.dup())])
	rt.call_method(var_response, 'set_status', [rt.new_int(201)])
	rt.call_method(var_response, 'header', [rt.new_string('Location'), rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('/%s/%s/%d'), rt.get_property(rt.new_object('Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller', ['Automattic_WooCommerce_Internal_RestApi_Routes_V4_AbstractController'], &this), 'namespace'), this.rest_base, rt.call_method(var_zone, 'get_id', []rt.PhpVal{})])])])
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) delete_item(var_request rt.PhpVal) rt.PhpVal {
	mut var_zone_id := // unsupported expression: Expr_Cast_Int
	mut var_zone := this.validate_zone(var_zone_id.dup())
	if rt.is_true(rt.call_function('is_wp_error', [var_zone.dup()])) {
		return var_zone.dup()
	}
	mut var_response := rt.call_function('rest_ensure_response', [this.prepare_item_for_response(var_zone.dup(), var_request.dup())])
	fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_WC_Shipping_Zones{}; return temp.delete_zone(arg_0) }(var_zone_id.dup())
	return var_response.dup()
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) validate_zone(var_zone_id rt.PhpVal) rt.PhpVal {
	...
	mut var_zone := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_WC_Shipping_Zones{}; return temp.get_zone(arg_0) }(var_zone_id_mutated.dup())
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) update_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_result := rt.call_method(this.shipping_zone_service, 'update_shipping_zone', [var_zone.dup(), rt.call_method(var_request, 'get_params', []rt.PhpVal{})])
	if rt.is_true(rt.call_function('is_wp_error', [var_result.dup()])) {
		return var_result.dup()
	}
	return rt.call_function('rest_ensure_response', [this.prepare_item_for_response(var_result.dup(), var_request.dup())])
}
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_shippingzones_controller() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller {
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'init' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_ShippingZoneSchema](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_ShippingZoneService](if args.len > 1 { args[1] } else { rt.new_null() })
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_ShippingZones_Controller) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		...
		'shipping_zone_service' { this.shipping_zone_service = val; return true }
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_shippingzones_controller_php() {
