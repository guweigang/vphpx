...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema) get_item_response(var_order_item rt.PhpVal, mut var_request Class_WP_REST_Request, mut var_include_fields Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_array) rt.PhpVal {
	...
	mut var_data := rt.create_array([rt.ArrayItem{ key: 'id', val: rt.call_method(var_order_item, 'get_id', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'name', val: rt.call_method(var_order_item, 'get_name', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'tax_class', val: rt.call_method(var_order_item, 'get_tax_class', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'tax_status', val: rt.call_method(var_order_item, 'get_tax_status', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'total', val: rt.call_function('wc_format_decimal', [rt.call_method(var_order_item, 'get_total', []rt.PhpVal{}), var_dp.dup()]) }, rt.ArrayItem{ key: 'total_tax', val: rt.call_function('wc_format_decimal', [rt.call_method(var_order_item, 'get_total_tax', []rt.PhpVal{}), var_dp.dup()]) }, rt.ArrayItem{ key: 'taxes', val: this.prepare_taxes(var_order_item.dup(), rt.new_object('WP_REST_Request', []string{}, var_request)) }, rt.ArrayItem{ key: 'meta_data', val: this.prepare_meta_data(var_order_item.dup()) }])
	return var_data.dup()
}
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_orders_schema_orderfeeschema() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema {
	mut obj := &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema{
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
...
fn (this &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderFeeSchema) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_orders_schema_orderfeeschema_php() {
