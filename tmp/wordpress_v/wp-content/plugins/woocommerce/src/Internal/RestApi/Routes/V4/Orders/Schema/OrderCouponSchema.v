...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderCouponSchema) get_item_response(var_order_item rt.PhpVal, mut var_request Class_WP_REST_Request, mut var_include_fields Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_array) rt.PhpVal {
	...
	mut var_coupon := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_WC_Coupon{}; return temp.from_order_item(arg_0) }(var_order_item.dup())
	return rt.create_array([rt.ArrayItem{ key: 'id', val: rt.call_method(var_order_item, 'get_id', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'code', val: rt.call_method(var_order_item, 'get_code', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'discount', val: rt.call_function('wc_format_decimal', [rt.call_method(var_order_item, 'get_discount', []rt.PhpVal{}), var_dp.dup()]) }, rt.ArrayItem{ key: 'discount_tax', val: rt.call_function('wc_format_decimal', [rt.call_method(var_order_item, 'get_discount_tax', []rt.PhpVal{}), var_dp.dup()]) }, rt.ArrayItem{ key: 'discount_type', val: rt.call_method(var_coupon, 'get_discount_type', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'nominal_amount', val: // unsupported expression: Expr_Cast_Double }, rt.ArrayItem{ key: 'free_shipping', val: rt.call_method(var_coupon, 'get_free_shipping', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'meta_data', val: this.prepare_meta_data(var_order_item.dup()) }])
}
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_orders_schema_ordercouponschema() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderCouponSchema {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_orders_schema_ordercouponschema_php() {
