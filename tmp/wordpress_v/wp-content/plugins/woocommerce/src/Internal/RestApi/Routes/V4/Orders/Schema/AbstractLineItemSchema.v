...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_AbstractLineItemSchema) get_meta_data_schema() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Meta data.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'array' }, rt.ArrayItem{ key: 'context', val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_AbstractLineItemSchema.view_edit_embed_context() }, rt.ArrayItem{ key: 'items', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'object' }, rt.ArrayItem{ key: 'properties', val: rt.create_array([rt.ArrayItem{ key: 'id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Meta ID.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }, rt.ArrayItem{ key: 'context', val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_AbstractLineItemSchema.view_edit_embed_context() }, rt.ArrayItem{ key: 'readonly', val: true }]) }, rt.ArrayItem{ key: 'key', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Meta key.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'context', val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_AbstractLineItemSchema.view_edit_embed_context() }]) }, rt.ArrayItem{ key: 'value', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Meta value.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: rt.create_array([rt.ArrayItem{ key: none, val: 'null' }, rt.ArrayItem{ key: none, val: 'object' }, rt.ArrayItem{ key: none, val: 'string' }, rt.ArrayItem{ key: none, val: 'number' }, rt.ArrayItem{ key: none, val: 'boolean' }, rt.ArrayItem{ key: none, val: 'integer' }, rt.ArrayItem{ key: none, val: 'array' }]) }, rt.ArrayItem{ key: 'context', val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_AbstractLineItemSchema.view_edit_embed_context() }]) }, rt.ArrayItem{ key: 'display_key', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Meta key for UI display.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'context', val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_AbstractLineItemSchema.view_edit_embed_context() }]) }, rt.ArrayItem{ key: 'display_value', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Meta value for UI display.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: rt.create_array([rt.ArrayItem{ key: none, val: 'null' }, rt.ArrayItem{ key: none, val: 'object' }, rt.ArrayItem{ key: none, val: 'string' }, rt.ArrayItem{ key: none, val: 'number' }, rt.ArrayItem{ key: none, val: 'boolean' }, rt.ArrayItem{ key: none, val: 'integer' }, rt.ArrayItem{ key: none, val: 'array' }]) }, rt.ArrayItem{ key: 'context', val: Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_AbstractLineItemSchema.view_edit_embed_context() }]) }]) }]) }])
}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_AbstractLineItemSchema) prepare_meta_data(var_order_item rt.PhpVal) rt.PhpVal {
	mut var_formatted_meta_data := rt.call_method(var_order_item, 'get_all_formatted_meta_data', [rt.new_null()])
	mut var_return := rt.new_array()
	{
		...
		for {
			...
			var_return.array_push(rt.create_array([rt.ArrayItem{ key: 'id', val: var_meta_id }, rt.ArrayItem{ key: 'key', val: rt.get_property(var_meta, 'key') }, rt.ArrayItem{ key: 'value', val: rt.get_property(var_meta, 'value') }, rt.ArrayItem{ key: 'display_key', val: rt.call_function('wc_clean', [rt.get_property(var_meta, 'display_key')]) }, rt.ArrayItem{ key: 'display_value', val: rt.call_function('wc_clean', [rt.get_property(var_meta, 'display_value')]) }]))
		}
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_AbstractLineItemSchema) prepare_taxes(var_order_item rt.PhpVal, mut var_request Class_WP_REST_Request) rt.PhpVal {
	...
	mut var_return := rt.new_array()
	if rt.is_true(rt.new_bool(rt.is_true(var_taxes) && !(!rt.is_true(var_taxes.array_get('total'))))) {
		{
			mut iter_1 := var_taxes.array_get('total').iterator()
			for {
				item_1 := iter_1.next() or { break }
				mut var_tax := item_1.val
				mut var_tax_rate_id := item_1.key
				var_return.array_push(rt.create_array([rt.ArrayItem{ key: 'id', val: var_tax_rate_id }, rt.ArrayItem{ key: 'total', val: rt.call_function('wc_format_decimal', [var_tax.dup(), var_dp.dup()]) }, rt.ArrayItem{ key: 'subtotal', val: rt.call_function('wc_format_decimal', [if !(var_taxes.array_get('subtotal').array_get(var_tax_rate_id)).is_null() { var_taxes.array_get('subtotal').array_get(var_tax_rate_id) } else { var_tax }, var_dp.dup()]) }]))
			}
		}
	}
	return var_return.dup()
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_orders_schema_abstractlineitemschema_php() {
