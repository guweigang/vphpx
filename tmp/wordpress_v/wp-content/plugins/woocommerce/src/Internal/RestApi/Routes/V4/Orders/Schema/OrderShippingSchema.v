...
fn (mut this Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderShippingSchema) get_item_response(var_order_item rt.PhpVal, mut var_request Class_WP_REST_Request, mut var_include_fields Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_array) rt.PhpVal {
	...
	mut var_data := rt.create_array([rt.ArrayItem{ key: 'id', val: rt.call_method(var_order_item, 'get_id', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'method_title', val: rt.call_method(var_order_item, 'get_method_title', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'method_id', val: rt.call_method(var_order_item, 'get_method_id', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'instance_id', val: rt.call_method(var_order_item, 'get_instance_id', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'total', val: rt.call_function('wc_format_decimal', [rt.call_method(var_order_item, 'get_total', []rt.PhpVal{}), var_dp.dup()]) }, rt.ArrayItem{ key: 'total_tax', val: rt.call_function('wc_format_decimal', [rt.call_method(var_order_item, 'get_total_tax', []rt.PhpVal{}), var_dp.dup()]) }, rt.ArrayItem{ key: 'taxes', val: this.prepare_taxes(var_order_item.dup(), rt.new_object('WP_REST_Request', []string{}, var_request)) }, rt.ArrayItem{ key: 'meta_data', val: this.prepare_meta_data(var_order_item.dup()) }])
	return var_data.dup()
}
...
fn create_automattic_woocommerce_internal_restapi_routes_v4_orders_schema_ordershippingschema() &Class_Automattic_WooCommerce_Internal_RestApi_Routes_V4_Orders_Schema_OrderShippingSchema {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_restapi_routes_v4_orders_schema_ordershippingschema_php() {
