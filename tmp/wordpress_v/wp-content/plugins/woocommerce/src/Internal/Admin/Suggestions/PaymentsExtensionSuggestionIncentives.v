...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_Suggestions_PaymentsExtensionSuggestionIncentives) get_incentives(suggestion_id string, country_code string, incentive_type string, skip_visibility_check bool) rt.PhpVal {
	...
	return rt.call_method(var_provider, 'is_visible', [var_incentive.array_get('id'), rt.new_string(country_code)])
	}
		var_incentives = rt.call_function('array_filter', [var_incentives.dup(), rt.new_closure(closure_1_fn)])
	}
...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_Suggestions_PaymentsExtensionSuggestionIncentives) get_incentive_instance(suggestion_id string) rt.PhpVal {
	if this.instances.array_isset(rt.new_string(suggestion_id)) {
		return this.instances.array_get(suggestion_id)
	}
	...
	mut var_provider_class := this.suggestion_incentives_class_map.array_get(suggestion_id)
...
fn create_automattic_woocommerce_internal_admin_suggestions_paymentsextensionsuggestionincentives() &Class_Automattic_WooCommerce_Internal_Admin_Suggestions_PaymentsExtensionSuggestionIncentives {
...
fn create_automattic_woocommerce_internal_admin_suggestions_exception() &Class_Automattic_WooCommerce_Internal_Admin_Suggestions_Exception {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_admin_suggestions_paymentsextensionsuggestionincentives_php() {
