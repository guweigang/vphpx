...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_GoCardless) is_account_connected(mut var_payment_gateway Class_WC_Payment_Gateway) bool {
	return !(!rt.is_true(var_payment_gateway.get_option(rt.new_string('access_token'), rt.new_string(''))))
...
fn create_automattic_woocommerce_internal_admin_settings_paymentsproviders_gocardless() &Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_GoCardless {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_admin_settings_paymentsproviders_gocardless_php() {
