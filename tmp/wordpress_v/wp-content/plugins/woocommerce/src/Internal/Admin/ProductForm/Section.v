...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_ProductForm_Section) construct(var_id rt.PhpVal, var_plugin_id rt.PhpVal, var_additional_args rt.PhpVal) {
	...
	mut var_missing_arguments := fn (arg_0 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Internal_Admin_ProductForm_Section{}
...
pub fn init_wp_content_plugins_woocommerce_src_internal_admin_productform_section_php() {
}
