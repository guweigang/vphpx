...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_WCPayPromotion_WCPaymentGatewayPreInstallWCPayPromotion) construct() {
	mut var_wc_pay_spec := fn () rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Internal_Admin_WCPayPromotion_Init{}
		return temp.get_wc_pay_promotion_spec()
	}()
	...
	if rt.is_true(rt.call_function('property_exists', [var_wc_pay_spec.dup(),
...
fn Class_Automattic_WooCommerce_Internal_Admin_WCPayPromotion_WCPaymentGatewayPreInstallWCPayPromotion.is_dismissed() bool {
	...
	return var_settings.array_isset(rt.new_string('is_dismissed'))
		&& rt.is_true(rt.identical(rt.new_string('yes'), var_settings.array_get('is_dismissed')))
}
...
fn create_automattic_woocommerce_internal_admin_wcpaypromotion_wc_payment_gateway() &Class_Automattic_WooCommerce_Internal_Admin_WCPayPromotion_WC_Payment_Gateway {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_admin_wcpaypromotion_wcpaymentgatewaypreinstallwcpaypromotion_php() {
