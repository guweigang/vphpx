...
fn (mut this Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_Klarna) needs_setup(mut var_payment_gateway Class_WC_Payment_Gateway) bool {
	if rt.is_true(rt.new_bool(rt.is_true(rt.call_function('class_exists', [rt.new_string('\\KP_Settings_Page')])) && rt.is_true(rt.call_function('is_callable', [rt.new_string('\\KP_Settings_Page::get_setting_status')])))) {
		return !(rt.is_true(rt.call_function('wc_string_to_bool', [fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_KP_Settings_Page{}; return temp.get_setting_status(arg_0) }(rt.new_string('credentials'))])))
	}
...
fn create_automattic_woocommerce_internal_admin_settings_paymentsproviders_klarna() &Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_Klarna {
...
fn create_automattic_woocommerce_internal_admin_settings_paymentsproviders_kp_settings_page() &Class_Automattic_WooCommerce_Internal_Admin_Settings_PaymentsProviders_KP_Settings_Page {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_admin_settings_paymentsproviders_klarna_php() {
