...
fn (mut this Class_Automattic_WooCommerce_Internal_DependencyManagement_ContainerException) construct(var_message rt.PhpVal, code i64, mut var_previous Class_Automattic_WooCommerce_Internal_DependencyManagement_?Exception)  {
	this.Class_Automattic_WooCommerce_Internal_DependencyManagement_Exception.construct(var_message.dup(), rt.new_int(code), rt.new_object('Automattic_WooCommerce_Internal_DependencyManagement_?Exception', []string{}, var_previous))
}
...
fn create_automattic_woocommerce_internal_dependencymanagement_exception() &Class_Automattic_WooCommerce_Internal_DependencyManagement_Exception {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_dependencymanagement_containerexception_php() {
}
