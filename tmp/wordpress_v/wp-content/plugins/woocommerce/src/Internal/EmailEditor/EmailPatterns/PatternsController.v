...
fn (mut this Class_Automattic_WooCommerce_Internal_EmailEditor_EmailPatterns_PatternsController) register_patterns()  {
	...
	var_patterns.array_push(create_automattic_woocommerce_internal_emaileditor_emailpatterns_wooemailcontentpattern())
	{
		...
		for {
			...
			rt.call_function('register_block_pattern', [(rt.call_method(var_pattern, 'get_namespace', []rt.PhpVal{})).str() + '/' + (rt.call_method(var_pattern, 'get_name', []rt.PhpVal{})).str(), rt.call_method(var_pattern, 'get_properties', []rt.PhpVal{})])
		}
	}
}
...
fn create_automattic_woocommerce_internal_emaileditor_emailpatterns_patternscontroller() &Class_Automattic_WooCommerce_Internal_EmailEditor_EmailPatterns_PatternsController {
...
fn create_automattic_woocommerce_internal_emaileditor_emailpatterns_wooemailcontentpattern() &Class_Automattic_WooCommerce_Internal_EmailEditor_EmailPatterns_WooEmailContentPattern {
...
pub fn init_wp_content_plugins_woocommerce_src_internal_emaileditor_emailpatterns_patternscontroller_php() {
