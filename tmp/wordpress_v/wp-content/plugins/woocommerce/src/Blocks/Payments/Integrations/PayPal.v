...
fn (mut this Class_Automattic_WooCommerce_Blocks_Payments_Integrations_PayPal) get_payment_method_data() rt.PhpVal {
	...
	mut var_buttons := create_automattic_woocommerce_gateways_paypal_buttons(var_gateway.dup())
...
fn (mut this Class_Automattic_WooCommerce_Blocks_Payments_Integrations_PayPal) get_description() string {
	...
	return var_description.dup().to_string().trim_space()
}
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_payments_integrations_paypal_php() {
}
