...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_AddToCartWithOptions_VariationSelectorAttributeName) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) string {
	...
	mut var_label_text := rt.call_function('esc_html', [
		rt.call_function('wc_attribute_label', [var_attribute_name.dup()]),
	])
	return (rt.call_function('sprintf', [rt.new_string('<label %s>%s</label>'),
		var_wrapper_attributes.dup(), var_label_text.dup()])).str()
}
...
fn create_automattic_woocommerce_blocks_blocktypes_addtocartwithoptions_variationselectorattributename() &Class_Automattic_WooCommerce_Blocks_BlockTypes_AddToCartWithOptions_VariationSelectorAttributeName {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_addtocartwithoptions_variationselectorattributename_php() {
