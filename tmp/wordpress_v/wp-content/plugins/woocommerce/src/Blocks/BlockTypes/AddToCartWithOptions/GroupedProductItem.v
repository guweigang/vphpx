...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_AddToCartWithOptions_GroupedProductItem) set_is_descendant_of_grouped_product_selector_context(var_context rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(
		rt.is_true(rt.identical(rt.new_string('woocommerce/product-price'), var_block.array_get('blockName')))
		|| rt.is_true(rt.identical(rt.new_string('woocommerce/product-stock-indicator'), var_block.array_get('blockName')))))
	{
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_AddToCartWithOptions_GroupedProductItem) get_product_row(var_product_id rt.PhpVal, var_attributes rt.PhpVal, var_block rt.PhpVal) string {
	...
	mut var_post := rt.call_function('get_post', [var_product_id.dup()])
	...
	}(var_block.dup(), rt.create_array([rt.ArrayItem{ key: 'postType', val: 'product' },
	...
	var_post = var_previous_post.dup()
...
fn create_automattic_woocommerce_blocks_blocktypes_addtocartwithoptions_groupedproductitem() &Class_Automattic_WooCommerce_Blocks_BlockTypes_AddToCartWithOptions_GroupedProductItem {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_addtocartwithoptions_groupedproductitem_php() {
