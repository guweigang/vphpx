...
struct Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartItemsBlock {
	rt.PhpObjectBase
pub mut:
	block_name rt.PhpVal = rt.new_string('mini-cart-items-block')
}

fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartItemsBlock) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartItemsBlock) render_experimental_iapi_markup(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	mut var_wrapper_attributes := rt.call_function('get_block_wrapper_attributes', [
		rt.create_array([rt.ArrayItem{ key: 'class', val: 'wc-block-mini-cart__items' },
...
fn create_automattic_woocommerce_blocks_blocktypes_minicartitemsblock() &Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartItemsBlock {
	mut obj := &Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartItemsBlock{
		PhpObjectBase: rt.PhpObjectBase{}
		block_name:    rt.new_string('mini-cart-items-block')
	}
	return obj
}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartItemsBlock) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'render' {
...
fn (this &Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartItemsBlock) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	match prop_name {
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_MiniCartItemsBlock) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'block_name' {
			this.block_name = val
			return true
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_minicartitemsblock_php() {
}
