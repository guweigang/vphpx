...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CheckoutOrderSummaryBlock) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	...
	mut var_regex_for_checkout_order_summary_totals :=
		rt.new_string(rt.new_string('/<div data-block-name="woocommerce\\/checkout-order-summary-totals-block"(.+?)>/'))
	mut var_order_summary_totals_content :=
		rt.new_string(rt.new_string('<div data-block-name="woocommerce/checkout-order-summary-totals-block" class="wp-block-woocommerce-checkout-order-summary-totals-block">'))
	...
	if rt.is_true(rt.call_function('preg_match', [var_regex_for_checkout_order_summary_totals.dup(),
		var_content_mutated.dup()]))
	{
...
fn create_automattic_woocommerce_blocks_blocktypes_checkoutordersummaryblock() &Class_Automattic_WooCommerce_Blocks_BlockTypes_CheckoutOrderSummaryBlock {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_checkoutordersummaryblock_php() {
}
