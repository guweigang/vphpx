...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_AbstractInnerBlock) register_block_type() {
	...
	rt.call_function('register_block_type_from_metadata', [var_metadata_path.dup(),
		var_block_settings.dup()])
}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_AbstractInnerBlock) get_block_type_script(var_key rt.PhpVal) rt.PhpVal {
	...
	return this.Class_Automattic_WooCommerce_Blocks_BlockTypes_AbstractBlock.get_block_type_script(var_key.dup())
}
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_abstractinnerblock_php() {
}
