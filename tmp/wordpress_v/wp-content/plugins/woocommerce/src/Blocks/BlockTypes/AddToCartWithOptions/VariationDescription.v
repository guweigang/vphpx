...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_AddToCartWithOptions_VariationDescription) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) string {
	...
	return '<div ' + var_context_directive.str() + ' ' +
		(rt.call_function('get_block_wrapper_attributes', [var_wrapper_attributes.dup()])).str() +
...
fn create_automattic_woocommerce_blocks_blocktypes_addtocartwithoptions_variationdescription() &Class_Automattic_WooCommerce_Blocks_BlockTypes_AddToCartWithOptions_VariationDescription {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_addtocartwithoptions_variationdescription_php() {
