...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_Accordion_AccordionGroup) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	...
	])))
	{
		mut var_interactivity_context := rt.create_array([
			rt.ArrayItem{ key: 'autoclose', val: var_attributes.array_get('autoclose') },
...
fn create_automattic_woocommerce_blocks_blocktypes_accordion_accordiongroup() &Class_Automattic_WooCommerce_Blocks_BlockTypes_Accordion_AccordionGroup {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_accordion_accordiongroup_php() {
