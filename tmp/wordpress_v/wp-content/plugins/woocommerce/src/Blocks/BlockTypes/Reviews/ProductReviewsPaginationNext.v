...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_Reviews_ProductReviewsPaginationNext) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) string {
	...
	mut var_max_page := rt.get_property(create_automattic_woocommerce_blocks_blocktypes_reviews_wp_comment_query(var_comment_vars.dup()),
		'max_num_pages')
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_Reviews_ProductReviewsPaginationNext) get_pagination_arrow(var_block rt.PhpVal) rt.PhpVal {
	...
	if !(!rt.is_true(rt.get_property(var_block, 'context').array_get('reviews/paginationArrow')))
		...
		mut var_arrow_classes :=
			rt.new_string(rt.new_string('wp-block-woocommerce-product-reviews-pagination-next-arrow is-arrow-${var_arrow_attribute.to_string()}'))
...
fn create_automattic_woocommerce_blocks_blocktypes_reviews_productreviewspaginationnext() &Class_Automattic_WooCommerce_Blocks_BlockTypes_Reviews_ProductReviewsPaginationNext {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_reviews_productreviewspaginationnext_php() {
