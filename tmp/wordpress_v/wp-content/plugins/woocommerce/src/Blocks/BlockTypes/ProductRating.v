...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRating) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) string {
	...
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(rt.is_true(var_product)
		...
		closure_1_fn := fn [var_post_id, var_product_rating, var_product_reviews_count, var_is_descendent_of_single_product_block, var_is_descendent_of_single_product_template] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
				...
				|| rt.is_true(rt.identical(rt.new_bool(false), var_product_permalink))))
			{
				...
				var_html = rt.call_function('sprintf', [
					...
					if rt.is_true(rt.new_bool(rt.is_true(var_is_descendent_of_single_product_block)
...
fn create_automattic_woocommerce_blocks_blocktypes_productrating() &Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRating {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_productrating_php() {
}
