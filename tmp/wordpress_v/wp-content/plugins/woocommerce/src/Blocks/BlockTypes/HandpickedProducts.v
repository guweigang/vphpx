...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_HandpickedProducts) set_block_query_args(var_query_args rt.PhpVal) {
	...
	mut var_ids := rt.call_function('array_map', [rt.new_string('absint'),
		...
		], &this), 'attributes').array_get('products')])
	var_query_args_mutated.array_set('post__in', var_ids.dup())
	var_query_args_mutated.array_set('posts_per_page', var_ids.dup().array_count())
...
fn create_automattic_woocommerce_blocks_blocktypes_handpickedproducts() &Class_Automattic_WooCommerce_Blocks_BlockTypes_HandpickedProducts {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_handpickedproducts_php() {
}
