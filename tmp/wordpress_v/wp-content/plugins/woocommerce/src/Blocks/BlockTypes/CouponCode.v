...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) enqueue_data(mut var_attributes Class_Automattic_WooCommerce_Blocks_BlockTypes_array) {
	...
	if rt.is_true(rt.new_bool(
		rt.is_true(rt.new_bool(!(rt.is_true(rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Blocks_BlockTypes_CouponCode', ['Automattic_WooCommerce_Blocks_BlockTypes_AbstractBlock'], &this), 'asset_data_registry'), 'exists', [rt.new_string('couponTypes')])))))
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) string {
	...
	mut var_source := if !(var_attributes_mutated.array_get('source')).is_null() {
		var_attributes_mutated.array_get('source')
	} else {
	...
	mut var_rendering_context := this.get_rendering_context(var_block.dup())
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) get_block_attributes(mut var_parsed_block Class_Automattic_WooCommerce_Blocks_BlockTypes_array, var_fallback rt.PhpVal) rt.PhpVal {
	...
	mut var_attributes := if !(var_parsed_block_mutated.array_get('attrs')).is_null() {
		var_parsed_block_mutated.array_get('attrs')
	} else {
		if !var_fallback.is_null() { var_fallback } else { rt.new_array() }
	}
	return if rt.is_true(rt.new_bool(var_attributes.dup().is_array())) {
		var_attributes
	} else {
		rt.new_array()
	}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) get_coupon_code(mut var_attributes Class_Automattic_WooCommerce_Blocks_BlockTypes_array) string {
	mut var_attributes_mutated := var_attributes
	mut var_coupon_code := if !(var_attributes_mutated.array_get('couponCode')).is_null() {
		var_attributes_mutated.array_get('couponCode')
	} else {
		rt.new_string('')
	}
	return (if rt.is_true(rt.new_bool(var_coupon_code.dup().is_string())) {
		var_coupon_code
	} else {
		rt.new_string('')
	}).str()
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) get_rendering_context(var_block rt.PhpVal) rt.PhpVal {
	if rt.is_true(rt.new_bool(
		rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(rt.instance_of(var_block, 'WP_Block')))
		&& rt.get_property(var_block, 'context').array_isset(rt.new_string('renderingContext'))))
		&& rt.is_true(rt.new_bool(rt.instance_of(rt.get_property(var_block, 'context').array_get('renderingContext'), 'Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context')))))
	{
		return rt.get_property(var_block, 'context').array_get('renderingContext')
	}
	mut var_theme_controller := rt.call_method(fn () rt.PhpVal {
	...
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_rendering_context(rt.call_method(var_theme_controller,
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) build_coupon_html(coupon_code string, mut var_attributes Class_Automattic_WooCommerce_Blocks_BlockTypes_array, mut var_rendering_context Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context) string {
	...
	}(rt.new_object('Automattic_WooCommerce_Blocks_BlockTypes_array', []string{},
		var_attributes_mutated), rt.new_object('Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context',
	...
	mut var_declarations := if !(var_block_styles.array_get('declarations')).is_null() {
		var_block_styles.array_get('declarations')
	} else {
		rt.new_array()
	}
	...
	mut var_css := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Blocks_BlockTypes_WP_Style_Engine{}
		return temp.compile_css(arg_0, arg_1)
	}(var_merged_styles.dup(), rt.new_string(''))
	return (rt.call_function('sprintf', [
		rt.new_string('<span class="woocommerce-coupon-code" style="%s">%s</span>'),
		rt.call_function('esc_attr', [var_css.dup()]),
		rt.call_function('esc_html', [rt.new_string(coupon_code_mutated).dup()]),
	])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) has_valid_background_color(mut var_declarations Class_Automattic_WooCommerce_Blocks_BlockTypes_array) bool {
	...
	if !rt.is_true(var_declarations_mutated.array_get('background-color')) {
		return false
	}
	return this.is_css_color_value((var_declarations_mutated.array_get('background-color')).str())
}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) resolve_background_color(mut var_attributes Class_Automattic_WooCommerce_Blocks_BlockTypes_array, mut var_rendering_context Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context) string {
	mut var_attributes_mutated := var_attributes
	mut var_rendering_context_mutated := var_rendering_context
	if !rt.is_true(var_attributes_mutated.array_get('backgroundColor')) {
		return (Class_Automattic_WooCommerce_Blocks_BlockTypes_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode.default_styles().array_get('background-color')).str()
	}
	mut var_color_slug := var_attributes_mutated.array_get('backgroundColor')
	mut var_normalized := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_EmailEditor_Integrations_Utils_Styles_Helper{}
		return temp.get_normalized_block_styles(arg_0, arg_1)
	}(rt.new_object('Automattic_WooCommerce_Blocks_BlockTypes_array', []string{},
		var_attributes_mutated), rt.new_object('Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context',
		[]string{}, var_rendering_context_mutated))
	mut var_color := if !(var_normalized.array_get('color').array_get('background')).is_null() {
		var_normalized.array_get('color').array_get('background')
	} else {
		rt.new_string('')
	}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) is_css_color_value(value string) bool {
	return
		rt.is_true(rt.new_bool(rt.is_true(rt.call_function('str_starts_with', [rt.new_string(value), rt.new_string('#')]))
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) wrap_for_email(coupon_html string, mut var_parsed_block Class_Automattic_WooCommerce_Blocks_BlockTypes_array) string {
	...
	mut var_table_attrs := rt.create_array([
		rt.ArrayItem{ key: 'style', val: fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
			mut temp := Class_Automattic_WooCommerce_Blocks_BlockTypes_WP_Style_Engine{}
			return temp.compile_css(arg_0, arg_1)
		}(rt.create_array([rt.ArrayItem{ key: 'border-collapse', val: 'collapse' },
			rt.ArrayItem{ key: 'width', val: '100%' }]), rt.new_string('')) },
	...
	mut var_cell_attrs := rt.create_array([
		...
		rt.ArrayItem{ key: 'style', val: fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
			mut temp := Class_Automattic_WooCommerce_Blocks_BlockTypes_WP_Style_Engine{}
			return temp.compile_css(arg_0, arg_1)
		}(rt.create_array([rt.ArrayItem{ key: 'padding', val: '10px 0' },
			rt.ArrayItem{ key: 'text-align', val: var_align }]), rt.new_string('')) },
	...
	}(rt.new_string(coupon_html_mutated), var_table_attrs.dup(), var_cell_attrs.dup())).str()
}
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode) get_alignment(mut var_parsed_block Class_Automattic_WooCommerce_Blocks_BlockTypes_array) string {
	...
	mut var_align := if !(var_parsed_block_mutated.array_get('attrs').array_get('align')).is_null() {
		var_parsed_block_mutated.array_get('attrs').array_get('align')
	} else {
		rt.new_string('center')
	}
	if rt.is_true(rt.new_bool(
		rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_align.dup().is_string())))))
		|| rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('in_array', [var_align.dup(), var_allowed.dup(), rt.new_bool(true)])))))))
	{
		return 'center'
	}
...
fn create_automattic_woocommerce_blocks_blocktypes_couponcode() &Class_Automattic_WooCommerce_Blocks_BlockTypes_CouponCode {
...
fn create_automattic_woocommerce_blocks_blocktypes_wp_style_engine() &Class_Automattic_WooCommerce_Blocks_BlockTypes_WP_Style_Engine {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_couponcode_php() {
