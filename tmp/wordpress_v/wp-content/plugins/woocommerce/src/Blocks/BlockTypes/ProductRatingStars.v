...
struct Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars {
	rt.PhpObjectBase
pub mut:
	block_name  rt.PhpVal = rt.new_string('product-rating-stars')
	api_version rt.PhpVal = rt.new_string('3')
}

fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars) register_block_type_assets() rt.PhpVal {
	return rt.new_null()
}

fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars) get_block_type_uses_context() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: none, val: 'query' },
		rt.ArrayItem{ key: none, val: 'queryId' }, rt.ArrayItem{ key: none, val: 'postId' }])
}

fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	...
	if rt.is_true(var_product) {
		...
		closure_1_fn := fn [var_product_rating, var_product_reviews_count] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
			...
			mut var_product_permalink := rt.call_function('get_permalink', []rt.PhpVal{})
...
fn create_automattic_woocommerce_blocks_blocktypes_productratingstars() &Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars {
	mut obj := &Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars{
		PhpObjectBase: rt.PhpObjectBase{}
		block_name:    rt.new_string('product-rating-stars')
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
...
fn (this &Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	match prop_name {
...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_ProductRatingStars) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'block_name' {
			this.block_name = val
			return true
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_productratingstars_php() {
}
