...
fn (mut this Class_Automattic_WooCommerce_Blocks_BlockTypes_CatalogSorting) render(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) rt.PhpVal {
	...
	rt.call_function('woocommerce_catalog_ordering', [var_attributes.dup()])
	...
	return rt.call_function('sprintf', [rt.new_string('<div %1$s>%2$s</div>'),
		var_wrapper_attributes.dup(), var_catalog_sorting.dup()])
}
...
fn create_automattic_woocommerce_blocks_blocktypes_catalogsorting() &Class_Automattic_WooCommerce_Blocks_BlockTypes_CatalogSorting {
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_blocktypes_catalogsorting_php() {
