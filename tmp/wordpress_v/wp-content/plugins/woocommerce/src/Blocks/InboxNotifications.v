...
fn Class_Automattic_WooCommerce_Blocks_InboxNotifications.delete_surface_cart_checkout_blocks_notification() {
	fn (arg_0 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Admin_Notes_Notes{}
		return temp.delete_notes_with_name(arg_0)
	}(Class_Automattic_WooCommerce_Blocks_Automattic_WooCommerce_Blocks_InboxNotifications.surface_cart_checkout_note_name())
}
...
pub fn init_wp_content_plugins_woocommerce_src_blocks_inboxnotifications_php() {
}
