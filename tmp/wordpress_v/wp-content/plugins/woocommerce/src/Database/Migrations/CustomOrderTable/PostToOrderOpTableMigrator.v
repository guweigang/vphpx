	...
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'destination', val: rt.create_array([
			rt.ArrayItem{ key: 'table_name', val: fn () rt.PhpVal {
				...
				return temp.get_operational_data_table_name()
			}() },
...
pub fn init_wp_content_plugins_woocommerce_src_database_migrations_customordertable_posttoorderoptablemigrator_php() {
}
