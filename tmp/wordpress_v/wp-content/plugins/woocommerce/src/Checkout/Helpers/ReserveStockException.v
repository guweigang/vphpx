...
fn (mut this Class_Automattic_WooCommerce_Checkout_Helpers_ReserveStockException) construct(var_code rt.PhpVal, var_message rt.PhpVal, http_status_code i64, var_data rt.PhpVal)  {
	this.error_code = var_code.dup()
	this.error_data = var_data.dup()
	this.Class_Automattic_WooCommerce_Checkout_Helpers_Exception.construct(var_message.dup(), rt.new_int(http_status_code))
}
...
fn create_automattic_woocommerce_checkout_helpers_exception() &Class_Automattic_WooCommerce_Checkout_Helpers_Exception {
...
fn (mut this Class_Automattic_WooCommerce_Checkout_Helpers_ReserveStockException) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'error_code' { this.error_code = val; return true }
		'error_data' { this.error_data = val; return true }
...
pub fn init_wp_content_plugins_woocommerce_src_checkout_helpers_reservestockexception_php() {
