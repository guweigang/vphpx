...
fn (mut this Class_Automattic_WooCommerce_Admin_Overrides_ThemeUpgrader) install(var_package rt.PhpVal, var_args rt.PhpVal) rt.PhpVal {
	mut var_defaults := rt.create_array([rt.ArrayItem{ key: 'clear_update_cache', val: true }])
	mut var_parsed_args := rt.call_function('wp_parse_args', [var_args.dup(), var_defaults.dup()])
	this.init()
	this.install_strings()
	rt.call_function('add_filter', [rt.new_string('upgrader_source_selection'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_Overrides_ThemeUpgrader', ['Automattic_WooCommerce_Admin_Overrides_Theme_Upgrader'], &this) }, rt.ArrayItem{ key: none, val: 'check_package' }])])
	rt.call_function('add_filter', [rt.new_string('upgrader_post_install'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_Overrides_ThemeUpgrader', ['Automattic_WooCommerce_Admin_Overrides_Theme_Upgrader'], &this) }, rt.ArrayItem{ key: none, val: 'check_parent_theme_filter' }]), rt.new_int(10), rt.new_int(3)])
	...
	mut var_result := this.run(rt.create_array([rt.ArrayItem{ key: 'package', val: var_package }, rt.ArrayItem{ key: 'destination', val: rt.call_function('get_theme_root', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'clear_destination', val: false }, rt.ArrayItem{ key: 'clear_working', val: true }, rt.ArrayItem{ key: 'hook_extra', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'theme' }, rt.ArrayItem{ key: 'action', val: 'install' }]) }]))
	rt.call_function('remove_action', [rt.new_string('upgrader_process_complete'), rt.new_string('wp_clean_themes_cache'), rt.new_int(9)])
	rt.call_function('remove_filter', [rt.new_string('upgrader_source_selection'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_Overrides_ThemeUpgrader', ['Automattic_WooCommerce_Admin_Overrides_Theme_Upgrader'], &this) }, rt.ArrayItem{ key: none, val: 'check_package' }])])
	rt.call_function('remove_filter', [rt.new_string('upgrader_post_install'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_Overrides_ThemeUpgrader', ['Automattic_WooCommerce_Admin_Overrides_Theme_Upgrader'], &this) }, rt.ArrayItem{ key: none, val: 'check_parent_theme_filter' }])])
...
fn create_automattic_woocommerce_admin_overrides_theme_upgrader() &Class_Automattic_WooCommerce_Admin_Overrides_Theme_Upgrader {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_overrides_themeupgrader_php() {
