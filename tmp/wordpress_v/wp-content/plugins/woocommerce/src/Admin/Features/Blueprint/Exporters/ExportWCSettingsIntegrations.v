...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_Blueprint_Exporters_ExportWCSettingsIntegrations) export() rt.PhpVal {
	if !(!(rt.get_property(rt.call_function('WC', []rt.PhpVal{}), 'integrations')).is_null()) {
		return create_automattic_woocommerce_blueprint_steps_setsiteoptions(rt.new_array())
	}
	...
	return create_automattic_woocommerce_blueprint_steps_setsiteoptions(var_settings.dup())
}
...
fn create_automattic_woocommerce_admin_features_blueprint_exporters_exportwcsettingsintegrations() &Class_Automattic_WooCommerce_Admin_Features_Blueprint_Exporters_ExportWCSettingsIntegrations {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_features_blueprint_exporters_exportwcsettingsintegrations_php() {
