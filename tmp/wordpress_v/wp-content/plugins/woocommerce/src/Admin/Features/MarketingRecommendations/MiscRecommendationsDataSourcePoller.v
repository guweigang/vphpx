...
fn Class_Automattic_WooCommerce_Admin_Features_MarketingRecommendations_MiscRecommendationsDataSourcePoller.get_data_sources() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: none, val: (fn () rt.PhpVal { mut temp := Class_WC_Helper{}; return temp.get_woocommerce_com_base_url() }()).str() + 'wp-json/wccom/marketing-tab/misc/recommendations.json' }])
}
...
pub fn init_wp_content_plugins_woocommerce_src_admin_features_marketingrecommendations_miscrecommendationsdatasourcepoller_php() {
