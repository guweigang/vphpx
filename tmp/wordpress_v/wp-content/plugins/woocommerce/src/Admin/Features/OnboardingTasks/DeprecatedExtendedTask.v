...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_DeprecatedExtendedTask) construct(var_task_list rt.PhpVal, var_args rt.PhpVal) {
	...
	mut var_task_args := rt.call_function('wp_parse_args', [var_args.dup(),
	...
	this.id = var_task_args.array_get('id')
	this.additional_info = var_task_args.array_get('additional_info')
	this.content = var_task_args.array_get('content')
	this.is_complete = var_task_args.array_get('is_complete')
	this.is_dismissable = var_task_args.array_get('is_dismissable')
	this.is_snoozeable = var_task_args.array_get('is_snoozeable')
	this.can_view = var_task_args.array_get('can_view')
	this.level = var_task_args.array_get('level')
	this.time = var_task_args.array_get('time')
	this.title = var_task_args.array_get('title')
}
...
pub fn init_wp_content_plugins_woocommerce_src_admin_features_onboardingtasks_deprecatedextendedtask_php() {
}
