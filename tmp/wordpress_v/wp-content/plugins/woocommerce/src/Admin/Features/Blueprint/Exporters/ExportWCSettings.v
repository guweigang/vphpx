...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_Blueprint_Exporters_ExportWCSettings) export() rt.PhpVal {
	return create_automattic_woocommerce_blueprint_steps_setsiteoptions(rt.call_method(this.setting_options, 'get_page_options', [this.get_page_id()]))
}
...
pub fn init_wp_content_plugins_woocommerce_src_admin_features_blueprint_exporters_exportwcsettings_php() {
