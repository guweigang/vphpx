...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_AsyncProductEditorCategoryField_Init) construct() {
	...
	}(Class_Automattic_WooCommerce_Admin_Features_AsyncProductEditorCategoryField_Automattic_WooCommerce_Admin_Features_AsyncProductEditorCategoryField_Init.feature_id()))
	{
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_AsyncProductEditorCategoryField_Init) enqueue_scripts() {
	...
	}(rt.new_string('wp-admin-scripts'), rt.new_string('product-category-metabox'),
		rt.new_bool(true))
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_AsyncProductEditorCategoryField_Init) enqueue_styles() {
	...
	rt.call_function('wp_register_style', [
		...
		fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
			mut temp := Class_Automattic_WooCommerce_Internal_Admin_WCAdminAssets{}
			return temp.get_url(arg_0, arg_1)
		}(rt.new_string('product-category-metabox/style'), rt.new_string('css')),
		rt.new_array(),
		var_version.dup(),
	])
...
pub fn init_wp_content_plugins_woocommerce_src_admin_features_asyncproducteditorcategoryfield_init_php() {
}
