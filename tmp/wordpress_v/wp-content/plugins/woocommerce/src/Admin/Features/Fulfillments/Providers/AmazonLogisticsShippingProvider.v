...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_AmazonLogisticsShippingProvider) get_tracking_url(tracking_number string) string {
	...
	return 'https://www.amazon.com/progress-tracker/package/ref=ppx_yo_dt_b_track_package_o0?_=' +
		rt.call_function('rawurlencode', [rt.new_string(tracking_number_mutated).dup()]).to_string().to_upper()
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_AmazonLogisticsShippingProvider) try_parse_tracking_number(tracking_number string, shipping_from string, shipping_to string) rt.PhpVal {
	...
	tracking_number_mutated = rt.call_function('preg_replace', [
		rt.new_string('/\\s+/'), rt.new_string(''), rt.new_string(tracking_number_mutated).dup()]).to_string().to_upper()
				...
				closure_20_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
					closure_19_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
						closure_18_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
									...
									closure_15_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
										closure_14_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
											closure_13_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
												closure_12_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
													closure_11_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
														closure_10_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
																		...
																		closure_6_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
																			closure_5_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
																				closure_4_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
																					closure_3_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
																						closure_2_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
																							closure_1_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
																								return if rt.is_true(rt.identical(rt.new_string('US'),
																									rt.new_string(shipping_from)))
																								{
																									rt.new_int(100)
																								} else {
																									rt.new_int(95)
																							...
																							return if rt.is_true(rt.identical(rt.new_string('CA'),
																								rt.new_string(shipping_from)))
																							{
																								rt.new_int(100)
																							} else {
																						...
																						return if rt.is_true(rt.identical(rt.new_string('MX'),
																							rt.new_string(shipping_from)))
																						{
																							rt.new_int(100)
																						} else {
																					...
																					return if rt.is_true(rt.call_function('in_array', [
																						rt.new_string(shipping_from),
																						rt.create_array([
																							rt.ArrayItem{
																								key: none
																				...
																				return if rt.is_true(rt.identical(rt.new_string('GB'),
																					rt.new_string(shipping_from)))
																				{
																					rt.new_int(100)
																				} else {
															...
															return if rt.is_true(rt.identical(rt.new_string('DE'),
																rt.new_string(shipping_from)))
															{
																rt.new_int(95)
															} else {
														...
														{ rt.new_int(95) } else { rt.new_int(75) }
													}
													return if rt.is_true(rt.identical(rt.new_string('AU'),
														rt.new_string(shipping_from)))
													{
														rt.new_int(100)
													} else {
												...
												return if rt.is_true(rt.identical(rt.new_string('IN'),
													rt.new_string(shipping_from)))
												{
													rt.new_int(100)
												} else {
											...
											return if rt.is_true(rt.identical(rt.new_string('JP'),
												rt.new_string(shipping_from)))
											{
												rt.new_int(100)
											} else {
										...
										return if rt.is_true(rt.identical(rt.new_string('SG'),
											rt.new_string(shipping_from)))
										{
											rt.new_int(100)
										} else {
							...
							{ rt.new_int(95) } else { rt.new_int(80) }
						}
						return if rt.is_true(rt.call_function('in_array', [
							rt.new_string(shipping_from),
							rt.create_array([rt.ArrayItem{ key: none, val: 'US' },
						...
						{ rt.new_int(90) } else { rt.new_int(70) }
					}
					return if rt.is_true(rt.call_function('in_array', [
						rt.new_string(shipping_from),
						rt.create_array([rt.ArrayItem{ key: none, val: 'US' },
					...
					{ rt.new_int(88) } else { rt.new_int(75) }
				}
	...
	])
	{
		...
		for {
			...
			if rt.is_true(rt.call_function('preg_match', [var_pattern.dup(),
				rt.new_string(tracking_number_mutated).dup()]))
			{
...
fn create_automattic_woocommerce_admin_features_fulfillments_providers_amazonlogisticsshippingprovider() &Class_Automattic_WooCommerce_Admin_Features_Fulfillments_Providers_AmazonLogisticsShippingProvider {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_features_fulfillments_providers_amazonlogisticsshippingprovider_php() {
