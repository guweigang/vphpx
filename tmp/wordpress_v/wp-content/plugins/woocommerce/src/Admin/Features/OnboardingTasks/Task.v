...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) construct(var_task_list rt.PhpVal)  {
	this.task_list = var_task_list.dup()
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) get_parent_option(var_option_name rt.PhpVal) rt.PhpVal {
	if rt.is_true(rt.new_bool(rt.is_true(this.task_list) && rt.get_property(this.task_list, 'options').array_isset(var_option_name))) {
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) prefix_event(var_event_name rt.PhpVal) string {
	...
	return (rt.call_method(this.task_list, 'prefix_event', [var_event_name.dup()])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) get_action_label() rt.PhpVal {
	return rt.call_function('__', [rt.new_string('Let\'s go'), rt.new_string('woocommerce')])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) is_dismissed() bool {
	...
	mut var_dismissed := rt.call_function('get_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.dismissed_option(), rt.new_array()])
	return (rt.call_function('in_array', [this.get_id(), var_dismissed.dup(), rt.new_bool(true)])).to_bool()
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) dismiss() bool {
	...
	mut var_update := rt.call_function('update_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.dismissed_option(), rt.call_function('array_unique', [var_dismissed.dup()])])
	if rt.is_true(var_update) {
		this.record_tracks_event(rt.new_string('dismiss_task'), rt.create_array([rt.ArrayItem{ key: 'task_name', val: this.get_id() }]))
	}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) undo_dismiss() rt.PhpVal {
	mut var_dismissed := rt.call_function('get_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.dismissed_option(), rt.new_array()])
	var_dismissed = rt.call_function('array_diff', [var_dismissed.dup(), rt.create_array([rt.ArrayItem{ key: none, val: this.get_id() }])])
	mut var_update := rt.call_function('update_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.dismissed_option(), var_dismissed.dup()])
	if rt.is_true(var_update) {
		this.record_tracks_event(rt.new_string('undo_dismiss_task'), rt.create_array([rt.ArrayItem{ key: 'task_name', val: this.get_id() }]))
	}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) get_snoozed_until() rt.PhpVal {
	rt.call_function('wc_deprecated_function', [@STRUCT + '::' + @FN, rt.new_string('7.2.0')])
	mut var_snoozed_tasks := rt.call_function('get_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.snoozed_option(), rt.new_array()])
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) is_snoozed() bool {
	...
	mut var_snoozed := rt.call_function('get_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.snoozed_option(), rt.new_array()])
	return var_snoozed.array_isset(this.get_id()) && rt.is_true(rt.greater(var_snoozed.array_get(this.get_id()), rt.mul(rt.call_function('time', []rt.PhpVal{}), rt.new_int(1000))))
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) snooze(duration string) bool {
	...
	mut var_snoozed := rt.call_function('get_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.snoozed_option(), rt.new_array()])
	mut var_snoozed_until := rt.add(this.duration_to_ms.array_get(duration), rt.mul(rt.call_function('time', []rt.PhpVal{}), rt.new_int(1000)))
	var_snoozed.array_set(this.get_id(), var_snoozed_until.dup())
	mut var_update := rt.call_function('update_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.snoozed_option(), var_snoozed.dup()])
	if rt.is_true(var_update) {
		if rt.is_true(var_update) {
			this.record_tracks_event(rt.new_string('remindmelater_task'), rt.create_array([rt.ArrayItem{ key: 'task_name', val: this.get_id() }]))
		}
	}
	return (var_update).to_bool()
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) undo_snooze() rt.PhpVal {
	...
	mut var_update := rt.call_function('update_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.snoozed_option(), var_snoozed.dup()])
	if rt.is_true(var_update) {
		this.record_tracks_event(rt.new_string('undo_remindmelater_task'), rt.create_array([rt.ArrayItem{ key: 'task_name', val: this.get_id() }]))
	}
	return var_update.dup()
}

fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) has_previously_completed() rt.PhpVal {
	mut var_complete := rt.call_function('get_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.completed_option(), rt.new_array()])
	return rt.call_function('in_array', [this.get_id(), var_complete.dup(), rt.new_bool(true)])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) possibly_track_completion()  {
	...
	mut var_completed_tasks := rt.call_function('get_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.completed_option(), rt.new_array()])
	var_completed_tasks.array_push(this.get_id())
	rt.call_function('update_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.completed_option(), var_completed_tasks.dup()])
	this.record_tracks_event(rt.new_string('task_completed'), rt.create_array([rt.ArrayItem{ key: 'task_name', val: this.get_id() }]))
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) set_active()  {
	...
	rt.call_function('set_transient', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.active_task_transient(), this.get_id(), rt.get_constant('DAY_IN_SECONDS')])
}

fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) is_active() rt.PhpVal {
	return rt.identical(rt.call_function('get_transient', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.active_task_transient()]), this.get_id())
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) is_complete() rt.PhpVal {
	return fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task{}; return temp.is_actioned() }()
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) in_progress_label() rt.PhpVal {
	return rt.call_function('esc_html__', [rt.new_string('In progress'), rt.new_string('woocommerce')])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) is_visited() bool {
	...
	mut var_response := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_Admin_WCAdminUser{}; return temp.get_user_data_field(arg_0, arg_1) }(var_user_id.dup(), rt.new_string('task_list_tracked_started_tasks'))
	mut var_tracked_tasks := if rt.is_true(var_response) { rt.call_function('json_decode', [var_response.dup(), rt.new_bool(true)]) } else { rt.new_array() }
	return var_tracked_tasks.array_isset(this.get_id()) && rt.is_true(rt.greater(var_tracked_tasks.array_get(this.get_id()), rt.new_int(0)))
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) get_json() rt.PhpVal {
	...
	return rt.create_array([rt.ArrayItem{ key: 'id', val: this.get_id() }, rt.ArrayItem{ key: 'parentId', val: this.get_parent_id() }, rt.ArrayItem{ key: 'title', val: this.get_title() }, rt.ArrayItem{ key: 'badge', val: this.get_badge() }, rt.ArrayItem{ key: 'canView', val: this.can_view() }, rt.ArrayItem{ key: 'content', val: this.get_content() }, rt.ArrayItem{ key: 'additionalInfo', val: this.get_additional_info() }, rt.ArrayItem{ key: 'actionLabel', val: this.get_action_label() }, rt.ArrayItem{ key: 'actionUrl', val: this.get_action_url() }, rt.ArrayItem{ key: 'isComplete', val: var_is_complete }, rt.ArrayItem{ key: 'isInProgress', val: this.is_in_progress() }, rt.ArrayItem{ key: 'inProgressLabel', val: this.in_progress_label() }, rt.ArrayItem{ key: 'time', val: this.get_time() }, rt.ArrayItem{ key: 'level', val: 3 }, rt.ArrayItem{ key: 'isActioned', val: this.is_actioned() }, rt.ArrayItem{ key: 'isDismissed', val: this.is_dismissed() }, rt.ArrayItem{ key: 'isDismissable', val: this.is_dismissable() }, rt.ArrayItem{ key: 'isSnoozed', val: false }, rt.ArrayItem{ key: 'isSnoozeable', val: false }, rt.ArrayItem{ key: 'isVisited', val: this.is_visited() }, rt.ArrayItem{ key: 'isDisabled', val: false }, rt.ArrayItem{ key: 'snoozedUntil', val: rt.new_null() }, rt.ArrayItem{ key: 'additionalData', val: Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.convert_object_to_camelcase(this.get_additional_data()) }, rt.ArrayItem{ key: 'eventPrefix', val: this.prefix_event(rt.new_string('')) }, rt.ArrayItem{ key: 'recordViewEvent', val: this.get_record_view_event() }])
}
...
fn Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.convert_object_to_camelcase(var_data rt.PhpVal) rt.PhpVal {
	...
	mut var_new_object := // unsupported expression: Expr_Cast_Object
	{
		...
		for {
			...
			mut var_new_key := rt.call_function('lcfirst', [rt.call_function('implode', [rt.new_string(''), rt.call_function('array_map', [rt.new_string('ucfirst'), rt.call_function('explode', [rt.new_string('_'), var_key.dup()])])])])
			rt.set_property(var_new_object, '{"nodeType":"Expr_Variable","line":571,"name":"new_key"}', var_value.dup())
		}
	}
	return var_new_object.dup()
}

fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) mark_actioned() rt.PhpVal {
	mut var_actioned := rt.call_function('get_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.actioned_option(), rt.new_array()])
	var_actioned.array_push(this.get_id())
	mut var_update := rt.call_function('update_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.actioned_option(), rt.call_function('array_unique', [var_actioned.dup()])])
	if rt.is_true(var_update) {
		this.record_tracks_event(rt.new_string('actioned_task'), rt.create_array([rt.ArrayItem{ key: 'task_name', val: this.get_id() }]))
	}
	return var_update.dup()
}
...
fn Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.is_task_actioned(var_id rt.PhpVal) rt.PhpVal {
	mut var_actioned := rt.call_function('get_option', [Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.actioned_option(), rt.new_array()])
	return rt.call_function('in_array', [var_id.dup(), var_actioned.dup(), rt.new_bool(true)])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'sort' {
			...
			return Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Task.sort(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		else { return none }
	}
}
...
pub fn init_wp_content_plugins_woocommerce_src_admin_features_onboardingtasks_task_php() {
}
