...
fn Class_Automattic_WooCommerce_Admin_Features_Navigation_RemovedDeprecated.handle_deprecated_method_call(var_name rt.PhpVal) {
	...
	if rt.is_true(rt.call_function('class_exists', [rt.new_string('WC_Tracks')])) {
		fn (arg_0 rt.PhpVal) rt.PhpVal {
			...
			return temp.record_event(arg_0)
		}(rt.new_string('deprecated_navigation_method_called'))
	}
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_Navigation_RemovedDeprecated) magic_call(var_name rt.PhpVal, var_arguments rt.PhpVal) {
	Class_Automattic_WooCommerce_Admin_Features_Navigation_RemovedDeprecated.handle_deprecated_method_call(var_name.dup())
}
...
fn create_automattic_woocommerce_admin_features_navigation_removeddeprecated() &Class_Automattic_WooCommerce_Admin_Features_Navigation_RemovedDeprecated {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_features_navigation_removeddeprecated_php() {
