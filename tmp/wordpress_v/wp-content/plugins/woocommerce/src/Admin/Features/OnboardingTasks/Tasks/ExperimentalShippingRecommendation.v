...
fn (mut this Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Tasks_ExperimentalShippingRecommendation) can_view() rt.PhpVal {
	...
	}(rt.new_string('shipping-smart-defaults'))
}
...
fn Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Tasks_ExperimentalShippingRecommendation.has_plugins_active() rt.PhpVal {
	return fn (arg_0 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Admin_PluginsHelper{}
		return temp.is_plugin_active(arg_0)
...
fn Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Tasks_ExperimentalShippingRecommendation.has_jetpack_connected() bool {
	mut var_jetpack_connection_manager := fn () rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Internal_Jetpack_JetpackConnection{}
		return temp.get_manager()
	}()
	return
...
fn create_automattic_woocommerce_admin_features_onboardingtasks_tasks_experimentalshippingrecommendation() &Class_Automattic_WooCommerce_Admin_Features_OnboardingTasks_Tasks_ExperimentalShippingRecommendation {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_features_onboardingtasks_tasks_experimentalshippingrecommendation_php() {
}
