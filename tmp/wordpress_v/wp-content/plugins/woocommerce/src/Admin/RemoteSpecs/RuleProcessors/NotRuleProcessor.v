...
fn (mut this Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_NotRuleProcessor) process(var_rule rt.PhpVal, var_stored_state rt.PhpVal) bool {
	mut var_evaluated_operand := rt.call_method(this.rule_evaluator, 'evaluate', [rt.get_property(var_rule, 'operand'), var_stored_state.dup()])
...
pub fn init_wp_content_plugins_woocommerce_src_admin_remotespecs_ruleprocessors_notruleprocessor_php() {
