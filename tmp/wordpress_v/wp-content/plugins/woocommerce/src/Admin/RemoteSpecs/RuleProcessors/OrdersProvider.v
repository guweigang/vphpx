...
fn (mut this Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_OrdersProvider) get_order_count() rt.PhpVal {
	...
	mut var_orders_count := rt.call_function('array_sum', [var_status_counts.dup()])
	return var_orders_count.dup()
}
...
pub fn init_wp_content_plugins_woocommerce_src_admin_remotespecs_ruleprocessors_ordersprovider_php() {
