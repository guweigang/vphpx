...
fn (mut this Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_PublishBeforeTimeRuleProcessor) process(var_rule rt.PhpVal, var_stored_state rt.PhpVal) rt.PhpVal {
	return rt.less_equal(rt.call_method(this.date_time_provider, 'get_now', []rt.PhpVal{}), create_automattic_woocommerce_admin_remotespecs_ruleprocessors_datetime(rt.get_property(var_rule, 'publish_before')))
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_PublishBeforeTimeRuleProcessor) validate(var_rule rt.PhpVal) bool {
	...
	create_automattic_woocommerce_admin_remotespecs_ruleprocessors_datetime(rt.get_property(var_rule, 'publish_before'))
...
pub fn init_wp_content_plugins_woocommerce_src_admin_remotespecs_ruleprocessors_publishbeforetimeruleprocessor_php() {
