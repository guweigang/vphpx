...
fn (mut this Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_Transformers_ArrayValues) transform(var_value rt.PhpVal, mut var_arguments Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_Transformers_?stdClass, var_default_value rt.PhpVal) rt.PhpVal {
	...
	return rt.call_function('array_values', [var_value.dup()])
}
...
fn create_automattic_woocommerce_admin_remotespecs_ruleprocessors_transformers_arrayvalues() &Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_Transformers_ArrayValues {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_remotespecs_ruleprocessors_transformers_arrayvalues_php() {
}
