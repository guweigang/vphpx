...
fn (mut this Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_Transformers_ArraySearch) transform(var_value rt.PhpVal, mut var_arguments Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_Transformers_?stdClass, var_default_value rt.PhpVal) rt.PhpVal {
	...
	mut var_key := rt.call_function('array_search', [rt.get_property(var_arguments, 'value'), var_value.dup(), rt.new_bool(true)])
...
fn create_automattic_woocommerce_admin_remotespecs_ruleprocessors_transformers_arraysearch() &Class_Automattic_WooCommerce_Admin_RemoteSpecs_RuleProcessors_Transformers_ArraySearch {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_remotespecs_ruleprocessors_transformers_arraysearch_php() {
}
