...
fn (mut this Class_Automattic_WooCommerce_Admin_API_ProductForm) register_routes()  {
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str(), rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_Automattic_WooCommerce_Admin_API_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_ProductForm', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_form_config' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_ProductForm', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_product_form_permission_check' }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_ProductForm', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str() + '/fields', rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_Automattic_WooCommerce_Admin_API_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_ProductForm', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_fields' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_ProductForm', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_product_form_permission_check' }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_ProductForm', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_ProductForm) get_product_form_permission_check(var_request rt.PhpVal) bool {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('current_user_can', [rt.new_string('manage_woocommerce')]))))) {
		return (create_automattic_woocommerce_admin_api_wp_error(rt.new_string('woocommerce_rest_cannot_create'), rt.call_function('__', [rt.new_string('Sorry, you are not allowed to retrieve product form data.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: rt.call_function('rest_authorization_required_code', []rt.PhpVal{}) }]))).to_bool()
	}
	return true
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_ProductForm) get_fields(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_json := rt.call_function('array_map', [rt.new_closure(closure_1_fn), fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_Admin_ProductForm_FormFactory{}; return temp.get_fields() }()])
	return rt.call_function('rest_ensure_response', [var_json.dup()])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_ProductForm) get_form_config(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_fields := rt.call_function('array_map', [rt.new_closure(closure_3_fn), fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_Admin_ProductForm_FormFactory{}; return temp.get_fields() }()])
	closure_6_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	closure_5_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_subsection := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return rt.call_method(var_subsection, 'get_json', []rt.PhpVal{})
	}
	mut var_subsection := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return rt.call_method(var_subsection, 'get_json', []rt.PhpVal{})
	}
	mut var_subsections := rt.call_function('array_map', [rt.new_closure(closure_5_fn), fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_Admin_ProductForm_FormFactory{}; return temp.get_subsections() }()])
	...
	mut var_sections := rt.call_function('array_map', [rt.new_closure(closure_7_fn), fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_Admin_ProductForm_FormFactory{}; return temp.get_sections() }()])
	...
	mut var_tabs := rt.call_function('array_map', [rt.new_closure(closure_9_fn), fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Internal_Admin_ProductForm_FormFactory{}; return temp.get_tabs() }()])
	return rt.call_function('rest_ensure_response', [rt.create_array([rt.ArrayItem{ key: 'fields', val: var_fields }, rt.ArrayItem{ key: 'subsections', val: var_subsections }, rt.ArrayItem{ key: 'sections', val: var_sections }, rt.ArrayItem{ key: 'tabs', val: var_tabs }])])
}
...
fn create_automattic_woocommerce_admin_api_productform() &Class_Automattic_WooCommerce_Admin_API_ProductForm {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_productform_php() {
