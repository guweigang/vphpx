...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Customers) prepare_reports_query(var_request rt.PhpVal) rt.PhpVal {
	mut var_args := this.Class_Automattic_WooCommerce_Admin_API_Automattic_WooCommerce_Admin_API_Reports_Customers_Controller.prepare_reports_query(var_request.dup())
	var_args.array_set('customers', var_request.array_get('include'))
	return var_args.dup()
}

fn (mut this Class_Automattic_WooCommerce_Admin_API_Customers) get_collection_params() rt.PhpVal {
	mut var_params := this.Class_Automattic_WooCommerce_Admin_API_Automattic_WooCommerce_Admin_API_Reports_Customers_Controller.get_collection_params()
	var_params.array_set('include', var_params.array_get('customers'))
...
fn create_automattic_woocommerce_admin_api_customers() &Class_Automattic_WooCommerce_Admin_API_Customers {
...
fn create_automattic_woocommerce_admin_api_automattic_woocommerce_admin_api_reports_customers_controller() &Class_Automattic_WooCommerce_Admin_API_Automattic_WooCommerce_Admin_API_Reports_Customers_Controller {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_customers_php() {
