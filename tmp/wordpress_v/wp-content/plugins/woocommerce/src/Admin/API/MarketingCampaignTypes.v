...
fn (mut this Class_Automattic_WooCommerce_Admin_API_MarketingCampaignTypes) get_items(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_responses := rt.new_array()
	{
		...
		for {
			...
			{
				mut iter_2 := rt.call_method(var_channel, 'get_supported_campaign_types', []rt.PhpVal{}).iterator()
				for {
					item_2 := iter_2.next() or { break }
					mut var_campaign_type := item_2.val
					mut var_response := this.prepare_item_for_response(var_campaign_type.dup(), var_request.dup())
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_MarketingCampaignTypes) prepare_item_for_response(var_item rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	mut var_data := rt.create_array([rt.ArrayItem{ key: 'id', val: rt.call_method(var_item, 'get_id', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'name', val: rt.call_method(var_item, 'get_name', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'description', val: rt.call_method(var_item, 'get_description', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'channel', val: rt.create_array([rt.ArrayItem{ key: 'slug', val: rt.call_method(rt.call_method(var_item, 'get_channel', []rt.PhpVal{}), 'get_slug', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'name', val: rt.call_method(rt.call_method(var_item, 'get_channel', []rt.PhpVal{}), 'get_name', []rt.PhpVal{}) }]) }, rt.ArrayItem{ key: 'create_url', val: rt.call_method(var_item, 'get_create_url', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'icon_url', val: rt.call_method(var_item, 'get_icon_url', []rt.PhpVal{}) }])
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_MarketingCampaignTypes) get_item_schema() rt.PhpVal {
	mut var_schema := rt.create_array([rt.ArrayItem{ key: '$schema', val: 'http://json-schema.org/draft-04/schema#' }, rt.ArrayItem{ key: 'title', val: 'marketing_campaign_type' }, rt.ArrayItem{ key: 'type', val: 'object' }, rt.ArrayItem{ key: 'properties', val: rt.create_array([rt.ArrayItem{ key: 'id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('The unique identifier for the marketing campaign type.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]) }, rt.ArrayItem{ key: 'name', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Name of the marketing campaign type.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]) }, rt.ArrayItem{ key: 'description', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Description of the marketing campaign type.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]) }, rt.ArrayItem{ key: 'channel', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('The marketing channel that this campaign type belongs to.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'object' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }]) }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'properties', val: rt.create_array([rt.ArrayItem{ key: 'slug', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('The unique identifier of the marketing channel that this campaign type belongs to.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]) }, rt.ArrayItem{ key: 'name', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('The name of the marketing channel that this campaign type belongs to.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]) }]) }]) }, rt.ArrayItem{ key: 'create_url', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('URL to the create campaign page for this campaign type.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]) }, rt.ArrayItem{ key: 'icon_url', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('URL to an image/icon for the campaign type.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]) }]) }])
...
fn create_automattic_woocommerce_admin_api_marketingcampaigntypes() &Class_Automattic_WooCommerce_Admin_API_MarketingCampaignTypes {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_marketingcampaigntypes_php() {
