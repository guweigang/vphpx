...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Coupons_Query) get_data() rt.PhpVal {
	rt.call_function('wc_deprecated_function', [@STRUCT + '::' + @FN, rt.new_string('9.3.0'), rt.new_string('`GenericQuery`, `\\WC_Object_Query`, or direct `DataStore` use')])
	mut var_args := rt.call_function('apply_filters', [rt.new_string('woocommerce_analytics_coupons_query_args'), this.get_query_vars()])
	mut var_data_store := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_API_Reports_Coupons_WC_Data_Store{}; return temp.load(arg_0) }(rt.new_string('report-coupons'))
...
fn create_automattic_woocommerce_admin_api_reports_coupons_query() &Class_Automattic_WooCommerce_Admin_API_Reports_Coupons_Query {
...
fn create_automattic_woocommerce_admin_api_reports_coupons_wc_data_store() &Class_Automattic_WooCommerce_Admin_API_Reports_Coupons_WC_Data_Store {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_reports_coupons_query_php() {
