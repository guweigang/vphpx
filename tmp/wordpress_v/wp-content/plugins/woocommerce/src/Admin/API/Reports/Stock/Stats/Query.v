...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Stock_Stats_Query) get_data() rt.PhpVal {
	mut var_data_store := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_API_Reports_Stock_Stats_WC_Data_Store{}; return temp.load(arg_0) }(rt.new_string('report-stock-stats'))
	mut var_results := rt.call_method(var_data_store, 'get_data', []rt.PhpVal{})
	return rt.call_function('apply_filters', [rt.new_string('woocommerce_analytics_stock_stats_query'), var_results.dup()])
}
...
fn create_automattic_woocommerce_admin_api_reports_stock_stats_wc_object_query() &Class_Automattic_WooCommerce_Admin_API_Reports_Stock_Stats_WC_Object_Query {
...
fn create_automattic_woocommerce_admin_api_reports_stock_stats_wc_data_store() &Class_Automattic_WooCommerce_Admin_API_Reports_Stock_Stats_WC_Data_Store {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_reports_stock_stats_query_php() {
