...
fn (mut this Class_Automattic_WooCommerce_Admin_API_MarketingOverview) register_routes()  {
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str() + '/activate-plugin', rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_Automattic_WooCommerce_Admin_API_WP_REST_Server.editable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_MarketingOverview', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'activate_plugin' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_MarketingOverview', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'install_plugins_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'plugin', val: rt.create_array([rt.ArrayItem{ key: 'required', val: true }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'validate_callback', val: 'rest_validate_request_arg' }, rt.ArrayItem{ key: 'sanitize_callback', val: 'sanitize_title_with_dashes' }]) }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_MarketingOverview', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_item_schema' }]) }])])
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str() + '/installed-plugins', rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_Automattic_WooCommerce_Admin_API_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_MarketingOverview', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_installed_plugins' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_MarketingOverview', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items_permissions_check' }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_MarketingOverview', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
}

fn (mut this Class_Automattic_WooCommerce_Admin_API_MarketingOverview) activate_plugin(var_request rt.PhpVal) rt.PhpVal {
	mut var_plugin_slug := rt.call_method(var_request, 'get_param', [rt.new_string('plugin')])
	if rt.is_true(rt.new_bool(!(rt.is_true(fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_PluginsHelper{}; return temp.is_plugin_installed(arg_0) }(var_plugin_slug.dup()))))) {
		return create_automattic_woocommerce_admin_api_wp_error(rt.new_string('woocommerce_rest_invalid_plugin'), rt.call_function('__', [rt.new_string('Invalid plugin.'), rt.new_string('woocommerce')]), rt.new_int(404))
	}
	mut var_result := rt.call_function('activate_plugin', [fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_PluginsHelper{}; return temp.get_plugin_path_from_slug(arg_0) }(var_plugin_slug.dup())])
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_result.dup().is_null()))))) {
		return create_automattic_woocommerce_admin_api_wp_error(rt.new_string('woocommerce_rest_invalid_plugin'), rt.call_function('__', [rt.new_string('The plugin could not be activated.'), rt.new_string('woocommerce')]), rt.new_int(500))
	}
	return rt.call_function('rest_ensure_response', [rt.create_array([rt.ArrayItem{ key: 'status', val: 'success' }])])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_MarketingOverview) get_installed_plugins(var_request rt.PhpVal) rt.PhpVal {
	return rt.call_function('rest_ensure_response', [fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_Marketing_InstalledExtensions{}; return temp.get_data() }()])
}
...
fn create_automattic_woocommerce_admin_api_marketingoverview() &Class_Automattic_WooCommerce_Admin_API_MarketingOverview {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_marketingoverview_php() {
