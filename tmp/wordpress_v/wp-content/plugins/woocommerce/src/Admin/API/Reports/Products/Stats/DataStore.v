...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore) assign_report_columns()  {
	mut var_table_name := fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore{}; return temp.get_db_table_name() }()
	this.dispatch_set_prop('report_columns', rt.create_array([rt.ArrayItem{ key: 'items_sold', val: 'SUM(product_qty) as items_sold' }, rt.ArrayItem{ key: 'net_revenue', val: 'SUM(product_net_revenue) AS net_revenue' }, rt.ArrayItem{ key: 'orders_count', val: "COUNT( DISTINCT ( CASE WHEN product_gross_revenue >= 0 THEN ${var_table_name.to_string()}.order_id END ) ) as orders_count" }, rt.ArrayItem{ key: 'products_count', val: 'COUNT(DISTINCT product_id) as products_count' }, rt.ArrayItem{ key: 'variations_count', val: 'COUNT(DISTINCT variation_id) as variations_count' }]))
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore) update_sql_query_params(var_query_args rt.PhpVal)  {
	...
	mut var_order_product_lookup_table := fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore{}; return temp.get_db_table_name() }()
	...
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'total_query'), 'add_sql_clause', [rt.new_string('where'), var_products_where_clause.dup()])
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'total_query'), 'add_sql_clause', [rt.new_string('join'), var_products_from_clause.dup()])
	this.add_intervals_sql_params(var_query_args.dup(), var_order_product_lookup_table.dup())
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'add_sql_clause', [rt.new_string('where'), var_products_where_clause.dup()])
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'add_sql_clause', [rt.new_string('join'), var_products_from_clause.dup()])
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'add_sql_clause', [rt.new_string('select'), (this.get_sql_clause(rt.new_string('select'))).str() + ' AS time_interval'])
}

fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore) get_default_query_vars() rt.PhpVal {
	mut var_defaults := this.Class_Automattic_WooCommerce_Admin_API_Reports_Products_DataStore.get_default_query_vars()
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore) get_data(var_query_args rt.PhpVal) rt.PhpVal {
	return fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_API_Reports_DataStore{}; return temp.get_data(arg_0) }(var_query_args.dup())
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore) get_noncached_stats_data(var_query_args rt.PhpVal, var_params rt.PhpVal, var_data rt.PhpVal, var_expected_interval_count rt.PhpVal) rt.PhpVal {
	...
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'add_sql_clause', [rt.new_string('where_time'), this.get_sql_clause(rt.new_string('where_time'))])
	mut var_db_intervals := rt.call_method(var_wpdb, 'get_col', [rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'get_query_statement', []rt.PhpVal{})])
	...
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'total_query'), 'add_sql_clause', [rt.new_string('select'), var_selections.dup()])
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'total_query'), 'add_sql_clause', [rt.new_string('where_time'), this.get_sql_clause(rt.new_string('where_time'))])
	mut var_totals := rt.call_method(var_wpdb, 'get_results', [rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'total_query'), 'get_query_statement', []rt.PhpVal{}), rt.get_constant('ARRAY_A')])
	mut var_totals_query := rt.create_array([rt.ArrayItem{ key: 'from_clause', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'total_query'), 'get_sql_clause', [rt.new_string('join')]) }, rt.ArrayItem{ key: 'where_time_clause', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'total_query'), 'get_sql_clause', [rt.new_string('where_time')]) }, rt.ArrayItem{ key: 'where_clause', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'total_query'), 'get_sql_clause', [rt.new_string('where')]) }])
	mut var_intervals_query := rt.create_array([rt.ArrayItem{ key: 'select_clause', val: this.get_sql_clause(rt.new_string('select')) }, rt.ArrayItem{ key: 'from_clause', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'get_sql_clause', [rt.new_string('join')]) }, rt.ArrayItem{ key: 'where_time_clause', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'get_sql_clause', [rt.new_string('where_time')]) }, rt.ArrayItem{ key: 'where_clause', val: rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'get_sql_clause', [rt.new_string('where')]) }, rt.ArrayItem{ key: 'order_by', val: this.get_sql_clause(rt.new_string('order_by')) }, rt.ArrayItem{ key: 'limit', val: this.get_sql_clause(rt.new_string('limit')) }])
	mut var_segmenter := create_automattic_woocommerce_admin_api_reports_products_stats_segmenter(var_query_args.dup(), rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'report_columns'))
	...
	if rt.is_true(rt.identical(rt.new_null(), var_totals)) {
		return create_automattic_woocommerce_admin_api_reports_products_stats_wp_error(rt.new_string('woocommerce_analytics_products_stats_result_failed'), rt.call_function('__', [rt.new_string('Sorry, fetching revenue data failed.'), rt.new_string('woocommerce')]))
	}
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'add_sql_clause', [rt.new_string('order_by'), this.get_sql_clause(rt.new_string('order_by'))])
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'add_sql_clause', [rt.new_string('limit'), this.get_sql_clause(rt.new_string('limit'))])
	rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'add_sql_clause', [rt.new_string('select'), rt.new_string(", MAX(${var_table_name.to_string()}.date_created) AS datetime_anchor")])
	if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
		rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'add_sql_clause', [rt.new_string('select'), ', ' + (var_selections).str()])
	}
	var_intervals = rt.call_method(var_wpdb, 'get_results', [rt.call_method(rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore', ['Automattic_WooCommerce_Admin_API_Reports_Products_DataStore', 'DataStoreInterface'], &this), 'interval_query'), 'get_query_statement', []rt.PhpVal{}), rt.get_constant('ARRAY_A')])
...
fn create_automattic_woocommerce_admin_api_reports_products_stats_datastore() &Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_DataStore {
...
fn create_automattic_woocommerce_admin_api_reports_products_stats_segmenter() &Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_Segmenter {
...
fn create_automattic_woocommerce_admin_api_reports_products_stats_wp_error() &Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_WP_Error {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_reports_products_stats_datastore_php() {
