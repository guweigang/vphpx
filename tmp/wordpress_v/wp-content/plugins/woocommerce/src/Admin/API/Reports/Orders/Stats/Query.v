...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Orders_Stats_Query) get_default_query_vars() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: 'fields', val: rt.create_array([rt.ArrayItem{ key: none, val: 'net_revenue' }, rt.ArrayItem{ key: none, val: 'avg_order_value' }, rt.ArrayItem{ key: none, val: 'orders_count' }, rt.ArrayItem{ key: none, val: 'avg_items_per_order' }, rt.ArrayItem{ key: none, val: 'num_items_sold' }, rt.ArrayItem{ key: none, val: 'coupons' }, rt.ArrayItem{ key: none, val: 'coupons_count' }, rt.ArrayItem{ key: none, val: 'total_customers' }]) }])
}
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_reports_orders_stats_query_php() {
