...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Marketing) register_routes()  {
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str() + '/recommended', rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_Automattic_WooCommerce_Admin_API_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Marketing', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_recommended_plugins' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Marketing', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_recommended_plugins_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'per_page', val: this.get_collection_params().array_get('per_page') }, rt.ArrayItem{ key: 'category', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'validate_callback', val: 'rest_validate_request_arg' }, rt.ArrayItem{ key: 'sanitize_callback', val: 'sanitize_title_with_dashes' }]) }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Marketing', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str() + '/knowledge-base', rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_Automattic_WooCommerce_Admin_API_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Marketing', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_knowledge_base_posts' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Marketing', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'category', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'validate_callback', val: 'rest_validate_request_arg' }, rt.ArrayItem{ key: 'sanitize_callback', val: 'sanitize_title_with_dashes' }]) }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Marketing', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str() + '/misc-recommendations', rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_Automattic_WooCommerce_Admin_API_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Marketing', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_misc_recommendations' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Marketing', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_recommended_plugins_permissions_check' }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Marketing', ['Automattic_WooCommerce_Admin_API_WC_REST_Data_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Marketing) get_recommended_plugins(var_request rt.PhpVal) rt.PhpVal {
	mut var_category := if !(!rt.is_true(rt.call_method(var_request, 'get_param', [rt.new_string('category')]))) { rt.call_method(var_request, 'get_param', [rt.new_string('category')]) } else { rt.new_string('marketing') }
	mut var_all_plugins := fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_Features_MarketingRecommendations_Init{}; return temp.get_recommended_plugins() }()
	mut var_valid_plugins := rt.new_array()
	mut var_per_page := rt.call_method(var_request, 'get_param', [rt.new_string('per_page')])
	{
		mut iter_1 := var_all_plugins.iterator()
		for {
			item_1 := iter_1.next() or { break }
			mut var_plugin := item_1.val
			mut var_plugin_categories := if !(!rt.is_true(var_plugin.array_get('categories'))) { var_plugin.array_get('categories') } else { rt.create_array([rt.ArrayItem{ key: none, val: 'marketing' }]) }
			if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_PluginsHelper{}; return temp.is_plugin_installed(arg_0) }(var_plugin.array_get('plugin')))))) && rt.is_true(rt.call_function('in_array', [var_category.dup(), var_plugin_categories.dup(), rt.new_bool(true)])))) {
				var_valid_plugins.array_push(var_plugin.dup())
			}
		}
	}
	return rt.call_function('rest_ensure_response', [rt.call_function('array_slice', [var_valid_plugins.dup(), rt.new_int(0), var_per_page.dup()])])
}

fn (mut this Class_Automattic_WooCommerce_Admin_API_Marketing) get_knowledge_base_posts(var_request rt.PhpVal) rt.PhpVal {
	mut var_marketing_specs := rt.call_method(rt.call_function('wc_get_container', []rt.PhpVal{}), 'get', [Class_Automattic_WooCommerce_Internal_Admin_Marketing_MarketingSpecs.class()])
	mut var_category := rt.call_method(var_request, 'get_param', [rt.new_string('category')])
	return rt.call_function('rest_ensure_response', [rt.call_method(var_marketing_specs, 'get_knowledge_base_posts', [var_category.dup()])])
}

fn (mut this Class_Automattic_WooCommerce_Admin_API_Marketing) get_misc_recommendations(var_request rt.PhpVal) rt.PhpVal {
	mut var_misc_recommendations := fn () rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Admin_Features_MarketingRecommendations_Init{}; return temp.get_misc_recommendations() }()
	return rt.call_function('rest_ensure_response', [var_misc_recommendations.dup()])
}
...
fn create_automattic_woocommerce_admin_api_marketing() &Class_Automattic_WooCommerce_Admin_API_Marketing {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_marketing_php() {
