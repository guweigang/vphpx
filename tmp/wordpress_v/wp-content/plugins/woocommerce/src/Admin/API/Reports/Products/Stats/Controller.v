...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_Controller) construct()  {
	rt.call_function('add_filter', [rt.new_string('woocommerce_analytics_products_stats_select_query'), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Products_Stats_Controller', ['Automattic_WooCommerce_Admin_API_Reports_GenericStatsController'], &this) }, rt.ArrayItem{ key: none, val: 'set_default_report_data' }])])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_Controller) get_datastore_data(var_query_args rt.PhpVal) rt.PhpVal {
	...
	mut var_query := create_automattic_woocommerce_admin_api_reports_genericquery(var_query_args_mutated.dup(), rt.new_string('products-stats'))
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_Controller) prepare_reports_query(var_request rt.PhpVal) rt.PhpVal {
	mut var_query_args := rt.create_array([rt.ArrayItem{ key: 'fields', val: rt.create_array([rt.ArrayItem{ key: none, val: 'items_sold' }, rt.ArrayItem{ key: none, val: 'net_revenue' }, rt.ArrayItem{ key: none, val: 'orders_count' }, rt.ArrayItem{ key: none, val: 'products_count' }, rt.ArrayItem{ key: none, val: 'variations_count' }]) }])
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_Controller) prepare_item_for_response(var_report rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	return rt.call_function('apply_filters', [rt.new_string('woocommerce_rest_prepare_report_products_stats'), var_response.dup(), var_report.dup(), var_request.dup()])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_Controller) set_default_report_data(var_results rt.PhpVal) rt.PhpVal {
	...
	if !rt.is_true(var_results_mutated) {
		var_results_mutated = create_automattic_woocommerce_admin_api_reports_products_stats_stdclass()
		rt.set_property(var_results_mutated, 'total', rt.new_int(0))
		rt.set_property(var_results_mutated, 'totals', create_automattic_woocommerce_admin_api_reports_products_stats_stdclass())
...
fn create_automattic_woocommerce_admin_api_reports_products_stats_stdclass() &Class_Automattic_WooCommerce_Admin_API_Reports_Products_Stats_stdClass {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_reports_products_stats_controller_php() {
