...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Stock_Stats_Controller) get_item_schema() rt.PhpVal {
	...
	mut var_status_options := rt.call_function('wc_get_product_stock_status_options', []rt.PhpVal{})
	{
		...
		for {
			...
			var_totals.array_set(var_status, rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('sprintf', [rt.call_function('__', [rt.new_string('Number of %s products.'), rt.new_string('woocommerce')]), var_label.dup()]) }, rt.ArrayItem{ key: 'type', val: 'integer' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]))
		}
	}
...
fn create_automattic_woocommerce_admin_api_reports_stock_stats_controller() &Class_Automattic_WooCommerce_Admin_API_Reports_Stock_Stats_Controller {
...
fn create_automattic_woocommerce_admin_api_reports_stock_stats_wc_rest_reports_controller() &Class_Automattic_WooCommerce_Admin_API_Reports_Stock_Stats_WC_REST_Reports_Controller {
...
fn create_automattic_woocommerce_admin_api_reports_stock_stats_query() &Class_Automattic_WooCommerce_Admin_API_Reports_Stock_Stats_Query {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_reports_stock_stats_controller_php() {
