...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Controller) get_datastore_data(var_query_args rt.PhpVal) rt.PhpVal {
	mut var_query := create_automattic_woocommerce_admin_api_reports_genericquery(var_query_args.dup(), rt.new_string('downloads'))
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Controller) prepare_item_for_response(var_report rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	rt.get_property(var_response, 'data').array_set('date', rt.call_function('get_date_from_gmt', [var_report.array_get('date_gmt'), rt.new_string('Y-m-d H:i:s')]))
	mut var_product_id := rt.new_int(rt.new_int(var_report.array_get('product_id').to_i64()))
	mut var__product := rt.call_function('wc_get_product', [var_product_id.dup()])
	if rt.is_true(var__product) {
		mut var_file_path := rt.call_method(var__product, 'get_file_download_path', [var_report.array_get('download_id')])
		mut var_filename := rt.call_function('basename', [var_file_path.dup()])
		rt.get_property(var_response, 'data').array_set('file_name', rt.call_function('apply_filters', [rt.new_string('woocommerce_file_download_filename'), var_filename.dup(), var_product_id.dup()]))
		rt.get_property(var_response, 'data').array_set('file_path', var_file_path.dup())
	} else {
		rt.get_property(var_response, 'data').array_set('file_name', '')
		rt.get_property(var_response, 'data').array_set('file_path', '')
	}
	mut var_customer := create_automattic_woocommerce_admin_api_reports_downloads_wc_customer(var_report.array_get('user_id'))
	rt.get_property(var_response, 'data').array_set('username', var_customer.get_username())
	rt.get_property(var_response, 'data').array_set('order_number', this.get_order_number(var_report.array_get('order_id')))
	return rt.call_function('apply_filters', [rt.new_string('woocommerce_rest_prepare_report_downloads'), var_response.dup(), var_report.dup(), var_request.dup()])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Controller) prepare_links(var_object rt.PhpVal) rt.PhpVal {
	mut var_links := rt.create_array([rt.ArrayItem{ key: 'product', val: rt.create_array([rt.ArrayItem{ key: 'href', val: rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('/%s/%s/%d'), rt.get_property(rt.new_object('Automattic_WooCommerce_Admin_API_Reports_Downloads_Controller', ['Automattic_WooCommerce_Admin_API_Reports_GenericController', 'ExportableInterface'], &this), 'namespace'), rt.new_string('products'), var_object.array_get('product_id')])]) }, rt.ArrayItem{ key: 'embeddable', val: true }]) }])
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Controller) get_item_schema() rt.PhpVal {
	mut var_schema := rt.create_array([rt.ArrayItem{ key: '$schema', val: 'http://json-schema.org/draft-04/schema#' }, rt.ArrayItem{ key: 'title', val: 'report_downloads' }, rt.ArrayItem{ key: 'type', val: 'object' }, rt.ArrayItem{ key: 'properties', val: rt.create_array([rt.ArrayItem{ key: 'id', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'integer' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('ID.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'product_id', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'integer' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Product ID.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'date', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('The date of the download, in the site\'s timezone.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'date-time' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]) }, rt.ArrayItem{ key: 'date_gmt', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('The date of the download, as GMT.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'date-time' }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'readonly', val: true }]) }, rt.ArrayItem{ key: 'download_id', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Download ID.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'file_name', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('File name.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'file_path', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('File URL.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'order_id', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'integer' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Order ID.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'order_number', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Order Number.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'user_id', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'integer' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('User ID for the downloader.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'username', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('User name of the downloader.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'ip_address', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'readonly', val: true }, rt.ArrayItem{ key: 'context', val: rt.create_array([rt.ArrayItem{ key: none, val: 'view' }, rt.ArrayItem{ key: none, val: 'edit' }]) }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('IP address for the downloader.'), rt.new_string('woocommerce')]) }]) }]) }])
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Controller) get_collection_params() rt.PhpVal {
	...
	var_params.array_get_mut('orderby').array_set('enum', this.apply_custom_orderby_filters(rt.create_array([rt.ArrayItem{ key: none, val: 'date' }, rt.ArrayItem{ key: none, val: 'product' }])))
	...
	var_params.array_set('customer_includes', rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Limit response to objects that have the specified user ids.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'array' }, rt.ArrayItem{ key: 'sanitize_callback', val: 'wp_parse_id_list' }, rt.ArrayItem{ key: 'validate_callback', val: 'rest_validate_request_arg' }, rt.ArrayItem{ key: 'items', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'integer' }]) }]))
	var_params.array_set('customer_excludes', rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Limit response to objects that don\'t have the specified user ids.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'array' }, rt.ArrayItem{ key: 'sanitize_callback', val: 'wp_parse_id_list' }, rt.ArrayItem{ key: 'validate_callback', val: 'rest_validate_request_arg' }, rt.ArrayItem{ key: 'items', val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'integer' }]) }]))
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Controller) get_export_columns() rt.PhpVal {
	mut var_export_columns := rt.create_array([rt.ArrayItem{ key: 'date', val: rt.call_function('__', [rt.new_string('Date'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'product', val: rt.call_function('__', [rt.new_string('Product title'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'file_name', val: rt.call_function('__', [rt.new_string('File name'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'order_number', val: rt.call_function('__', [rt.new_string('Order #'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'user_id', val: rt.call_function('__', [rt.new_string('User Name'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'ip_address', val: rt.call_function('__', [rt.new_string('IP'), rt.new_string('woocommerce')]) }])
	return rt.call_function('apply_filters', [rt.new_string('woocommerce_filter_downloads_export_columns'), var_export_columns.dup()])
}
...
fn (mut this Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Controller) prepare_item_for_export(var_item rt.PhpVal) rt.PhpVal {
	mut var_export_item := rt.create_array([rt.ArrayItem{ key: 'date', val: var_item.array_get('date') }, rt.ArrayItem{ key: 'product', val: var_item.array_get('_embedded').array_get('product').array_get(0).array_get('name') }, rt.ArrayItem{ key: 'file_name', val: var_item.array_get('file_name') }, rt.ArrayItem{ key: 'order_number', val: var_item.array_get('order_number') }, rt.ArrayItem{ key: 'user_id', val: var_item.array_get('username') }, rt.ArrayItem{ key: 'ip_address', val: var_item.array_get('ip_address') }])
	return rt.call_function('apply_filters', [rt.new_string('woocommerce_report_downloads_prepare_export_item'), var_export_item.dup(), var_item.dup()])
}
...
fn create_automattic_woocommerce_admin_api_reports_downloads_controller() &Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_Controller {
...
fn create_automattic_woocommerce_admin_api_reports_downloads_wc_customer() &Class_Automattic_WooCommerce_Admin_API_Reports_Downloads_WC_Customer {
...
pub fn init_wp_content_plugins_woocommerce_src_admin_api_reports_downloads_controller_php() {
