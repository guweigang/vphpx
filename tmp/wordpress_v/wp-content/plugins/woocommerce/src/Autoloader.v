...
fn Class_Automattic_WooCommerce_Autoloader.init() bool {
	mut var_autoloader := rt.new_string((rt.call_function('dirname', [rt.new_string(@DIR)])).str() + '/vendor/autoload_packages.php')
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('is_readable', [var_autoloader.dup()]))))) {
...
pub fn init_wp_content_plugins_woocommerce_src_autoloader_php() {
