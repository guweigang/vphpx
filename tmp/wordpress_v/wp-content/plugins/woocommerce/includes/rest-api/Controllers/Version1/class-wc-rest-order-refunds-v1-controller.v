...
fn (mut this Class_WC_REST_Order_Refunds_V1_Controller) construct()  {
	rt.call_function('add_filter', [rt.concat(rt.concat(rt.new_string('woocommerce_rest_'), this.post_type), rt.new_string('_trashable')), rt.new_string('__return_false')])
	rt.call_function('add_filter', [rt.concat(rt.concat(rt.new_string('woocommerce_rest_'), this.post_type), rt.new_string('_query')), rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'query_args' }]), rt.new_int(10), rt.new_int(2)])
}

fn (mut this Class_WC_REST_Order_Refunds_V1_Controller) register_routes()  {
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str(), rt.create_array([rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'order_id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('The order ID.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: this.get_collection_params() }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.creatable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'create_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'create_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: this.get_endpoint_args_for_item_schema(Class_WP_REST_Server.creatable()) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str() + '/(?P<id>[\\d]+)', rt.create_array([rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'order_id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('The order ID.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }]) }, rt.ArrayItem{ key: 'id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Unique identifier for the resource.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'context', val: this.get_context_param(rt.create_array([rt.ArrayItem{ key: 'default', val: 'view' }])) }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.deletable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'delete_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'delete_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'force', val: rt.create_array([rt.ArrayItem{ key: 'default', val: true }, rt.ArrayItem{ key: 'type', val: 'boolean' }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Required to be true, as resource does not support trashing.'), rt.new_string('woocommerce')]) }]) }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Order_Refunds_V1_Controller', ['WC_REST_Orders_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
}
...
fn (mut this Class_WC_REST_Order_Refunds_V1_Controller) prepare_item_for_response(var_post rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_refund := rt.call_function('wc_get_order', [var_post_mutated.dup()])
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(var_refund)))) || rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) {
	...
	mut var_data := rt.create_array([rt.ArrayItem{ key: 'id', val: rt.call_method(var_refund, 'get_id', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'date_created', val: rt.call_function('wc_rest_prepare_date_response', [rt.call_method(var_refund, 'get_date_created', []rt.PhpVal{})]) }, rt.ArrayItem{ key: 'amount', val: rt.call_function('wc_format_decimal', [rt.call_method(var_refund, 'get_amount', []rt.PhpVal{}), var_dp.dup()]) }, rt.ArrayItem{ key: 'reason', val: rt.call_method(var_refund, 'get_reason', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'line_items', val: rt.new_array() }])
	{
		...
		for {
			...
			mut var_line_item := { 'id': var_item_id, 'name': var_item.array_get('name'), 'sku': var_product_sku, 'product_id': // unsupported expression: Expr_Cast_Int, 'variation_id': // unsupported expression: Expr_Cast_Int, 'quantity': rt.call_function('wc_stock_amount', [var_item.array_get('qty')]), 'tax_class': if !(!rt.is_true(var_item.array_get('tax_class'))) { var_item.array_get('tax_class') } else { rt.new_string('') }, 'price': rt.call_function('wc_format_decimal', [rt.call_method(var_refund, 'get_item_total', [var_item.dup(), rt.new_bool(false), rt.new_bool(false)]), var_dp.dup()]), 'subtotal': rt.call_function('wc_format_decimal', [rt.call_method(var_refund, 'get_line_subtotal', [var_item.dup(), rt.new_bool(false), rt.new_bool(false)]), var_dp.dup()]), 'subtotal_tax': rt.call_function('wc_format_decimal', [var_item.array_get('line_subtotal_tax'), var_dp.dup()]), 'total': rt.call_function('wc_format_decimal', [rt.call_method(var_refund, 'get_line_total', [var_item.dup(), rt.new_bool(false), rt.new_bool(false)]), var_dp.dup()]), 'total_tax': rt.call_function('wc_format_decimal', [var_item.array_get('line_tax'), var_dp.dup()]), 'taxes': rt.new_array(), 'meta': var_item_meta }
...
fn (mut this Class_WC_REST_Order_Refunds_V1_Controller) query_args(var_args rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	var_args_mutated.array_set('post_status', rt.func_array_keys(rt.call_function('wc_get_order_statuses', []rt.PhpVal{})))
	var_args_mutated.array_set('post_parent__in', rt.create_array([rt.ArrayItem{ key: none, val: rt.call_function('absint', [var_request.array_get('order_id')]) }]))
...
fn (mut this Class_WC_REST_Order_Refunds_V1_Controller) create_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_order_data := rt.call_function('get_post', [// unsupported expression: Expr_Cast_Int])
	if !rt.is_true(var_order_data) {
		return create_wp_error(rt.new_string('woocommerce_rest_invalid_order'), rt.call_function('__', [rt.new_string('Order is invalid'), rt.new_string('woocommerce')]), rt.new_int(400))
	}
	...
	mut var_post := rt.call_function('get_post', [rt.call_method(var_refund, 'get_id', []rt.PhpVal{})])
...
fn (mut this Class_WC_REST_Order_Refunds_V1_Controller) get_item_schema() rt.PhpVal {
	mut var_schema := { '$schema': rt.new_string('http://json-schema.org/draft-04/schema#'), 'title': this.post_type, 'type': rt.new_string('object'), 'properties': { 'id': { 'description': rt.call_function('__', [rt.new_string('Unique identifier for the resource.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'date_created': { 'description': rt.call_function('__', [rt.new_string('The date the order refund was created, in the site\'s timezone.'), rt.new_string('woocommerce')]), 'type': rt.new_string('date-time'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'amount': { 'description': rt.call_function('__', [rt.new_string('Refund amount.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{} }, 'reason': { 'description': rt.call_function('__', [rt.new_string('Reason for refund.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{} }, 'line_items': { 'description': rt.call_function('__', [rt.new_string('Line items data.'), rt.new_string('woocommerce')]), 'type': rt.new_string('array'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true), 'items': { 'type': rt.new_string('object'), 'properties': { 'id': { 'description': rt.call_function('__', [rt.new_string('Item ID.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'name': { 'description': rt.call_function('__', [rt.new_string('Product name.'), rt.new_string('woocommerce')]), 'type': rt.new_string('mixed'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'sku': { 'description': rt.call_function('__', [rt.new_string('Product SKU.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'product_id': { 'description': rt.call_function('__', [rt.new_string('Product ID.'), rt.new_string('woocommerce')]), 'type': rt.new_string('mixed'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'variation_id': { 'description': rt.call_function('__', [rt.new_string('Variation ID, if applicable.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'quantity': { 'description': rt.call_function('__', [rt.new_string('Quantity ordered.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'tax_class': { 'description': rt.call_function('__', [rt.new_string('Tax class of product.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'price': { 'description': rt.call_function('__', [rt.new_string('Product price.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'subtotal': { 'description': rt.call_function('__', [rt.new_string('Line subtotal (before discounts).'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'subtotal_tax': { 'description': rt.call_function('__', [rt.new_string('Line subtotal tax (before discounts).'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'total': { 'description': rt.call_function('__', [rt.new_string('Line total (after discounts).'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'total_tax': { 'description': rt.call_function('__', [rt.new_string('Line total tax (after discounts).'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'taxes': { 'description': rt.call_function('__', [rt.new_string('Line taxes.'), rt.new_string('woocommerce')]), 'type': rt.new_string('array'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true), 'items': { 'type': rt.new_string('object'), 'properties': { 'id': { 'description': rt.call_function('__', [rt.new_string('Tax rate ID.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'total': { 'description': rt.call_function('__', [rt.new_string('Tax total.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'subtotal': { 'description': rt.call_function('__', [rt.new_string('Tax subtotal.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) } } } }, 'meta': { 'description': rt.call_function('__', [rt.new_string('Line item meta data.'), rt.new_string('woocommerce')]), 'type': rt.new_string('array'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true), 'items': { 'type': rt.new_string('object'), 'properties': { 'key': { 'description': rt.call_function('__', [rt.new_string('Meta key.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'label': { 'description': rt.call_function('__', [rt.new_string('Meta label.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'value': { 'description': rt.call_function('__', [rt.new_string('Meta value.'), rt.new_string('woocommerce')]), 'type': rt.new_string('mixed'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) } } } } } } } } }
...
pub fn init_wp_content_plugins_woocommerce_includes_rest_api_controllers_version1_class_wc_rest_order_refunds_v1_controller_php() {
