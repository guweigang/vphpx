...
struct Class_WC_REST_Product_Brands_Controller {
	rt.PhpObjectBase
pub mut:
...
fn create_wc_rest_product_brands_controller() &Class_WC_REST_Product_Brands_Controller {
	mut obj := &Class_WC_REST_Product_Brands_Controller{
...
fn (mut this Class_WC_REST_Product_Brands_Controller) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_WC_REST_Product_Brands_Controller) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	match prop_name {
...
fn (mut this Class_WC_REST_Product_Brands_Controller) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'rest_base' {
			this.rest_base = val
			return true
...
pub fn init_wp_content_plugins_woocommerce_includes_rest_api_controllers_version3_class_wc_rest_product_brands_controller_php() {
