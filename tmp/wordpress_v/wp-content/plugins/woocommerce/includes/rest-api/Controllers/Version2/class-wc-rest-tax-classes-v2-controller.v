...
fn (mut this Class_WC_REST_Tax_Classes_V2_Controller) register_routes()  {
	rt.call_function('register_rest_route', [this.namespace, '/' + (rt.get_property(rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this), 'rest_base')).str(), rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: this.get_collection_params() }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.creatable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'create_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'create_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: this.get_endpoint_args_for_item_schema(Class_WP_REST_Server.creatable()) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
	rt.call_function('register_rest_route', [this.namespace, '/' + (rt.get_property(rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this), 'rest_base')).str() + '/(?P<slug>\\w[\\w\\s\\-]*)', rt.create_array([rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'slug', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Unique slug for the resource.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'string' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items_permissions_check' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.deletable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'delete_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'delete_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'force', val: rt.create_array([rt.ArrayItem{ key: 'default', val: false }, rt.ArrayItem{ key: 'type', val: 'boolean' }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Required to be true, as resource does not support trashing.'), rt.new_string('woocommerce')]) }]) }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Tax_Classes_V2_Controller', ['WC_REST_Tax_Classes_V1_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
}

fn (mut this Class_WC_REST_Tax_Classes_V2_Controller) get_item(var_request rt.PhpVal) rt.PhpVal {
	if rt.is_true(rt.identical(rt.new_string('standard'), var_request.array_get('slug'))) {
		mut var_tax_class := rt.create_array([rt.ArrayItem{ key: 'slug', val: 'standard' }, rt.ArrayItem{ key: 'name', val: rt.call_function('__', [rt.new_string('Standard rate'), rt.new_string('woocommerce')]) }])
	} else {
		var_tax_class = fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_WC_Tax{}; return temp.get_tax_class_by(arg_0, arg_1) }(rt.new_string('slug'), rt.call_function('sanitize_title', [var_request.array_get('slug')]))
	}
...
fn create_wc_rest_tax_classes_v2_controller() &Class_WC_REST_Tax_Classes_V2_Controller {
...
pub fn init_wp_content_plugins_woocommerce_includes_rest_api_controllers_version2_class_wc_rest_tax_classes_v2_controller_php() {
