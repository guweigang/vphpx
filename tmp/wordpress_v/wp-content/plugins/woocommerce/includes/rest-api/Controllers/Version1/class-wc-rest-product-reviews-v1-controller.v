...
fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) register_routes()  {
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str(), rt.create_array([rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'product_id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Unique identifier for the variable product.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }]) }, rt.ArrayItem{ key: 'id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Unique identifier for the variation.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: this.get_collection_params() }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.creatable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'create_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'create_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.call_function('array_merge', [this.get_endpoint_args_for_item_schema(Class_WP_REST_Server.creatable()), rt.create_array([rt.ArrayItem{ key: 'review', val: rt.create_array([rt.ArrayItem{ key: 'required', val: true }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Review content.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'name', val: rt.create_array([rt.ArrayItem{ key: 'required', val: true }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Name of the reviewer.'), rt.new_string('woocommerce')]) }]) }, rt.ArrayItem{ key: 'email', val: rt.create_array([rt.ArrayItem{ key: 'required', val: true }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Email of the reviewer.'), rt.new_string('woocommerce')]) }]) }])]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str() + '/(?P<id>[\\d]+)', rt.create_array([rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'product_id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Unique identifier for the variable product.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }]) }, rt.ArrayItem{ key: 'id', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Unique identifier for the resource.'), rt.new_string('woocommerce')]) }, rt.ArrayItem{ key: 'type', val: 'integer' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'context', val: this.get_context_param(rt.create_array([rt.ArrayItem{ key: 'default', val: 'view' }])) }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.editable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'update_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'update_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: this.get_endpoint_args_for_item_schema(Class_WP_REST_Server.editable()) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.deletable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'delete_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'delete_item_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'force', val: rt.create_array([rt.ArrayItem{ key: 'default', val: false }, rt.ArrayItem{ key: 'type', val: 'boolean' }, rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Whether to bypass trash and force deletion.'), rt.new_string('woocommerce')]) }]) }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WC_REST_Product_Reviews_V1_Controller', ['WC_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
}
...
fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) get_item_permissions_check(var_request rt.PhpVal) bool {
	mut var_review := this.get_review((// unsupported expression: Expr_Cast_Int).to_i64(), (// unsupported expression: Expr_Cast_Int).to_i64())
...
fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) get_items(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_reviews := rt.call_function('get_approved_comments', [var_product_id.dup()])
	mut var_data := rt.new_array()
	{
		...
		for {
			...
			mut var_review := this.prepare_item_for_response(var_review_data.dup(), var_request.dup())
			var_review = this.prepare_response_for_collection(var_review.dup())
			var_data.array_push(var_review.dup())
		}
	}
...
fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) get_review(id i64, product_id i64) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(0 >= product_id_mutated || rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) {
		return create_wp_error(rt.new_string('woocommerce_rest_product_invalid_id'), rt.call_function('__', [rt.new_string('Invalid product ID.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 404 }]))
	}
	mut var_review := if 0 <= id { rt.call_function('get_comment', [rt.new_int(id)]) } else { rt.new_null() }
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!rt.is_true(var_review) || !rt.is_true(rt.get_property(var_review, 'comment_ID')) || rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) || !rt.is_true(rt.get_property(var_review, 'comment_post_ID')))) || rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) {
		return create_wp_error(rt.new_string('woocommerce_rest_product_review_invalid_id'), rt.call_function('__', [rt.new_string('Invalid product review ID.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 404 }]))
	}
	return var_review.dup()
}
...
fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) get_item(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_delivery := this.prepare_item_for_response(var_review.dup(), var_request.dup())
	mut var_response := rt.call_function('rest_ensure_response', [var_delivery.dup()])
...
fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) create_item(var_request rt.PhpVal) rt.PhpVal {
	...
	var_prepared_review = rt.call_function('apply_filters', [rt.new_string('rest_pre_insert_product_review'), var_prepared_review.dup(), var_request.dup()])
	mut var_product_review_id := rt.call_function('wp_insert_comment', [var_prepared_review.dup()])
	if rt.is_true(rt.new_bool(!(rt.is_true(var_product_review_id)))) {
		return create_wp_error(rt.new_string('rest_product_review_failed_create'), rt.call_function('__', [rt.new_string('Creating product review failed.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 500 }]))
	}
	rt.call_function('update_comment_meta', [var_product_review_id.dup(), rt.new_string('rating'), if !(!rt.is_true(var_request.array_get('rating'))) { var_request.array_get('rating') } else { rt.new_string('0') }])
	mut var_product_review := rt.call_function('get_comment', [var_product_review_id.dup()])
	this.update_additional_fields_for_object(var_product_review.dup(), var_request.dup())
	rt.call_function('do_action', [rt.new_string('woocommerce_rest_insert_product_review'), var_product_review.dup(), var_request.dup(), rt.new_bool(true)])
	rt.call_method(var_request, 'set_param', [rt.new_string('context'), rt.new_string('edit')])
	mut var_response := this.prepare_item_for_response(var_product_review.dup(), var_request.dup())
	var_response = rt.call_function('rest_ensure_response', [var_response.dup()])
	rt.call_method(var_response, 'set_status', [rt.new_int(201)])
	mut var_base := rt.call_function('str_replace', [rt.new_string('(?P<product_id>[\\d]+)'), var_product_id.dup(), this.rest_base])
	rt.call_method(var_response, 'header', [rt.new_string('Location'), rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('/%s/%s/%d'), this.namespace, var_base.dup(), var_product_review_id.dup()])])])
	return var_response.dup()
}

fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) update_item(var_request rt.PhpVal) rt.PhpVal {
	mut var_product_review_id := // unsupported expression: Expr_Cast_Int
	mut var_product_id := // unsupported expression: Expr_Cast_Int
	...
	mut var_prepared_review := this.prepare_item_for_database(var_request.dup())
	mut var_updated := rt.call_function('wp_update_comment', [var_prepared_review.dup()])
	if rt.is_true(rt.identical(rt.new_int(0), var_updated)) {
		return create_wp_error(rt.new_string('rest_product_review_failed_edit'), rt.call_function('__', [rt.new_string('Updating product review failed.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 500 }]))
	}
	if !(!rt.is_true(var_request.array_get('rating'))) {
		rt.call_function('update_comment_meta', [var_product_review_id.dup(), rt.new_string('rating'), var_request.array_get('rating')])
	}
	mut var_product_review := rt.call_function('get_comment', [var_product_review_id.dup()])
	this.update_additional_fields_for_object(var_product_review.dup(), var_request.dup())
	rt.call_function('do_action', [rt.new_string('woocommerce_rest_insert_product_review'), var_product_review.dup(), var_request.dup(), rt.new_bool(true)])
...
fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) delete_item(var_request rt.PhpVal) rt.PhpVal {
	mut var_product_id := // unsupported expression: Expr_Cast_Int
	mut var_product_review_id := // unsupported expression: Expr_Cast_Int
	mut var_product_review := this.get_review((var_product_review_id).to_i64(), (var_product_id).to_i64())
	...
	if rt.is_true(rt.call_function('is_wp_error', [var_product_review.dup()])) {
		return var_product_review.dup()
	}
	mut var_supports_trash := rt.call_function('apply_filters', [rt.new_string('rest_product_review_trashable'), rt.greater(rt.get_constant('EMPTY_TRASH_DAYS'), rt.new_int(0)), var_product_review.dup()])
	rt.call_method(var_request, 'set_param', [rt.new_string('context'), rt.new_string('edit')])
	mut var_response := this.prepare_item_for_response(var_product_review.dup(), var_request.dup())
	if rt.is_true(var_force) {
		mut var_result := rt.call_function('wp_delete_comment', [var_product_review_id.dup(), rt.new_bool(true)])
	} else {
		if rt.is_true(rt.new_bool(!(rt.is_true(var_supports_trash)))) {
			return create_wp_error(rt.new_string('rest_trash_not_supported'), rt.call_function('__', [rt.new_string('The product review does not support trashing.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 501 }]))
		}
		if rt.is_true(rt.identical(rt.new_string('trash'), rt.get_property(var_product_review, 'comment_approved'))) {
			return create_wp_error(rt.new_string('rest_already_trashed'), rt.call_function('__', [rt.new_string('The comment has already been trashed.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 410 }]))
		}
		var_result = rt.call_function('wp_trash_comment', [rt.get_property(var_product_review, 'comment_ID')])
	}
	if rt.is_true(rt.new_bool(!(rt.is_true(var_result)))) {
		return create_wp_error(rt.new_string('rest_cannot_delete'), rt.call_function('__', [rt.new_string('The product review cannot be deleted.'), rt.new_string('woocommerce')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 500 }]))
	}
	rt.call_function('do_action', [rt.new_string('rest_delete_product_review'), var_product_review.dup(), var_response.dup(), var_request.dup()])
	return var_response.dup()
}
...
fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) prepare_item_for_response(var_review rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_data := rt.create_array([rt.ArrayItem{ key: 'id', val: // unsupported expression: Expr_Cast_Int }, rt.ArrayItem{ key: 'date_created', val: rt.call_function('wc_rest_prepare_date_response', [rt.get_property(var_review_mutated, 'comment_date_gmt')]) }, rt.ArrayItem{ key: 'review', val: rt.get_property(var_review_mutated, 'comment_content') }, rt.ArrayItem{ key: 'rating', val: // unsupported expression: Expr_Cast_Int }, rt.ArrayItem{ key: 'name', val: rt.get_property(var_review_mutated, 'comment_author') }, rt.ArrayItem{ key: 'email', val: rt.get_property(var_review_mutated, 'comment_author_email') }, rt.ArrayItem{ key: 'verified', val: rt.call_function('wc_review_is_from_verified_owner', [rt.get_property(var_review_mutated, 'comment_ID')]) }])
	...
	rt.call_method(var_response, 'add_links', [this.prepare_links(var_review_mutated.dup(), var_request.dup())])
	return rt.call_function('apply_filters', [rt.new_string('woocommerce_rest_prepare_product_review'), var_response.dup(), var_review_mutated.dup(), var_request.dup()])
}

fn (mut this Class_WC_REST_Product_Reviews_V1_Controller) prepare_item_for_database(var_request rt.PhpVal) rt.PhpVal {
	mut var_prepared_review := rt.create_array([rt.ArrayItem{ key: 'comment_approved', val: 1 }, rt.ArrayItem{ key: 'comment_type', val: 'review' }])
	if var_request.array_isset(rt.new_string('id')) {
		var_prepared_review.array_set('comment_ID', // unsupported expression: Expr_Cast_Int)
	}
	if var_request.array_isset(rt.new_string('review')) {
		var_prepared_review.array_set('comment_content', var_request.array_get('review'))
	}
	if var_request.array_isset(rt.new_string('product_id')) {
		var_prepared_review.array_set('comment_post_ID', // unsupported expression: Expr_Cast_Int)
	}
	if var_request.array_isset(rt.new_string('name')) {
		var_prepared_review.array_set('comment_author', var_request.array_get('name'))
	}
	if var_request.array_isset(rt.new_string('email')) {
		var_prepared_review.array_set('comment_author_email', .array_get())
	}
...
fn create_wc_rest_product_reviews_v1_controller() &Class_WC_REST_Product_Reviews_V1_Controller {
...
pub fn init_wp_content_plugins_woocommerce_includes_rest_api_controllers_version1_class_wc_rest_product_reviews_v1_controller_php() {
