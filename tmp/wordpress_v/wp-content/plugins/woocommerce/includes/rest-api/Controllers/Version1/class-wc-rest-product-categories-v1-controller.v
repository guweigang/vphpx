...
pub mut:
		...
		rest_base rt.PhpVal = rt.new_string('products/categories')
		taxonomy rt.PhpVal = rt.new_string('product_cat')
}

fn (mut this Class_WC_REST_Product_Categories_V1_Controller) prepare_item_for_response(var_item rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	if rt.is_true(var_image_id) {
		...
		var_data.array_set('image', rt.create_array([rt.ArrayItem{ key: 'id', val: // unsupported expression: Expr_Cast_Int }, rt.ArrayItem{ key: 'date_created', val: rt.call_function('wc_rest_prepare_date_response', [rt.get_property(var_attachment, 'post_date_gmt')]) }, rt.ArrayItem{ key: 'date_modified', val: rt.call_function('wc_rest_prepare_date_response', [rt.get_property(var_attachment, 'post_modified_gmt')]) }, rt.ArrayItem{ key: 'src', val: rt.call_function('wp_get_attachment_url', [var_image_id.dup()]) }, rt.ArrayItem{ key: 'title', val: rt.call_function('get_the_title', [var_attachment.dup()]) }, rt.ArrayItem{ key: 'alt', val: rt.call_function('get_post_meta', [var_image_id.dup(), rt.new_string('_wp_attachment_image_alt'), rt.new_bool(true)]) }]))
	}
	...
	return rt.call_function('apply_filters', [rt.concat(rt.new_string('woocommerce_rest_prepare_'), this.taxonomy), var_response.dup(), var_item.dup(), var_request.dup()])
}

fn (mut this Class_WC_REST_Product_Categories_V1_Controller) update_term_meta_fields(var_term rt.PhpVal, var_request rt.PhpVal) bool {
	...
	if var_request.array_isset(rt.new_string('image')) {
		...
		if rt.is_true(rt.new_bool(rt.is_true(var_image_id) && rt.is_true(rt.call_function('wp_attachment_is_image', [var_image_id.dup()])))) {
			...
			if !(!rt.is_true(var_request.array_get('image').array_get('title'))) {
				rt.call_function('wp_update_post', [rt.create_array([rt.ArrayItem{ key: 'ID', val: var_image_id }, rt.ArrayItem{ key: 'post_title', val: rt.call_function('wc_clean', [var_request.array_get('image').array_get('title')]) }])])
			}
		} else {
...
fn (mut this Class_WC_REST_Product_Categories_V1_Controller) get_item_schema() rt.PhpVal {
	mut var_schema := { '$schema': rt.new_string('http://json-schema.org/draft-04/schema#'), 'title': this.taxonomy, 'type': rt.new_string('object'), 'properties': { 'id': { 'description': rt.call_function('__', [rt.new_string('Unique identifier for the resource.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'name': { 'description': rt.call_function('__', [rt.new_string('Category name.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'arg_options': { 'sanitize_callback': rt.new_string('sanitize_text_field') } }, 'slug': { 'description': rt.call_function('__', [rt.new_string('An alphanumeric identifier for the resource unique to its type.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'arg_options': { 'sanitize_callback': map[string]rt.PhpVal{} } }, 'parent': { 'description': rt.call_function('__', [rt.new_string('The ID for the parent of the resource.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{} }, 'description': { 'description': rt.call_function('__', [rt.new_string('HTML description of the resource.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'arg_options': { 'sanitize_callback': rt.new_string('wp_filter_post_kses') } }, 'display': { 'description': rt.call_function('__', [rt.new_string('Category archive display type.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'default': rt.new_string('default'), 'enum': map[string]rt.PhpVal{}, 'context': map[string]rt.PhpVal{} }, 'image': { 'description': rt.call_function('__', [rt.new_string('Image data.'), rt.new_string('woocommerce')]), 'type': rt.new_string('object'), 'context': map[string]rt.PhpVal{}, 'properties': { 'id': { 'description': rt.call_function('__', [rt.new_string('Image ID.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{} }, 'date_created': { 'description': rt.call_function('__', [rt.new_string('The date the image was created, in the site\'s timezone.'), rt.new_string('woocommerce')]), 'type': rt.new_string('date-time'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'date_modified': { 'description': rt.call_function('__', [rt.new_string('The date the image was last modified, in the site\'s timezone.'), rt.new_string('woocommerce')]), 'type': rt.new_string('date-time'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'src': { 'description': rt.call_function('__', [rt.new_string('Image URL.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'format': rt.new_string('uri'), 'context': map[string]rt.PhpVal{} }, 'title': { 'description': rt.call_function('__', [rt.new_string('Image name.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{} }, 'alt': { 'description': rt.call_function('__', [rt.new_string('Image alternative text.'), rt.new_string('woocommerce')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{} } } }, 'menu_order': { 'description': rt.call_function('__', [rt.new_string('Menu order, used to custom sort the resource.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{} }, 'count': { 'description': rt.call_function('__', [rt.new_string('Number of published products for the resource.'), rt.new_string('woocommerce')]), 'type': rt.new_string('integer'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) } } }
...
fn create_wc_rest_product_categories_v1_controller() &Class_WC_REST_Product_Categories_V1_Controller {
	mut obj := &Class_WC_REST_Product_Categories_V1_Controller{
		...
		rest_base: rt.new_string('products/categories')
...
pub fn init_wp_content_plugins_woocommerce_includes_rest_api_controllers_version1_class_wc_rest_product_categories_v1_controller_php() {
