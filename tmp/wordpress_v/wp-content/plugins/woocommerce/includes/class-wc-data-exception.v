...
fn (mut this Class_WC_Data_Exception) construct(var_code rt.PhpVal, var_message rt.PhpVal, http_status_code i64, var_data rt.PhpVal)  {
	...
	this.error_data = rt.call_function('array_merge', [rt.create_array([rt.ArrayItem{ key: 'status', val: http_status_code }]), var_data.dup()])
	this.Class_Exception.construct(var_message.dup(), rt.new_int(http_status_code))
}
...
pub fn init_wp_content_plugins_woocommerce_includes_class_wc_data_exception_php() {
