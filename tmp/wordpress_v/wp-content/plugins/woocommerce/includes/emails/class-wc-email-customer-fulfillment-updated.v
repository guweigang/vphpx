...
fn (mut this Class_WC_Email_Customer_Fulfillment_Updated) trigger(var_order_id rt.PhpVal, var_fulfillment rt.PhpVal, order bool, customer_note string) {
		...
		rt.new_string('WC_Order')]))
	{
		...
		this.customer_note = rt.new_string(customer_note).dup()
...
pub fn init_wp_content_plugins_woocommerce_includes_emails_class_wc_email_customer_fulfillment_updated_php() {
	...
	return create_wc_email_customer_fulfillment_updated()
}
