...
fn (mut this Class_WC_Email_Customer_Partially_Refunded_Order) get_option_key() string {
	mut var_id := rt.new_string(rt.new_string('customer_refunded_order'))
	return
...
pub fn init_wp_content_plugins_woocommerce_includes_emails_class_wc_email_customer_partially_refunded_order_php() {
	...
	return create_wc_email_customer_partially_refunded_order()
}
