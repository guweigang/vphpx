...
fn (mut this Class_WC_Settings_Products) get_settings_for_default_section() rt.PhpVal {
	...
	mut var_default_weight_unit := var_locale_info.array_get('US').array_get('weight_unit')
	mut var_default_dimension_unit := var_locale_info.array_get('US').array_get('dimension_unit')
	mut var_settings := rt.create_array([
		...
		rt.ArrayItem{ key: none, val: rt.create_array([
			...
			rt.ArrayItem{ key: 'options', val: rt.create_array([
				rt.ArrayItem{ key: 'kg', val: fn (arg_0 rt.PhpVal) rt.PhpVal {
					mut temp := Class_Automattic_WooCommerce_Utilities_I18nUtil{}
					return temp.get_weight_unit_label(arg_0)
				}(rt.new_string('kg')) },
				rt.ArrayItem{ key: 'g', val: fn (arg_0 rt.PhpVal) rt.PhpVal {
					mut temp := Class_Automattic_WooCommerce_Utilities_I18nUtil{}
					return temp.get_weight_unit_label(arg_0)
				}(rt.new_string('g')) },
				rt.ArrayItem{ key: 'lbs', val: fn (arg_0 rt.PhpVal) rt.PhpVal {
					mut temp := Class_Automattic_WooCommerce_Utilities_I18nUtil{}
					return temp.get_weight_unit_label(arg_0)
				}(rt.new_string('lbs')) },
				rt.ArrayItem{ key: 'oz', val: fn (arg_0 rt.PhpVal) rt.PhpVal {
					mut temp := Class_Automattic_WooCommerce_Utilities_I18nUtil{}
					return temp.get_weight_unit_label(arg_0)
				}(rt.new_string('oz')) },
			]) },
		...
		rt.ArrayItem{ key: none, val: rt.create_array([
			...
			rt.ArrayItem{ key: 'type', val: 'select' },
			rt.ArrayItem{ key: 'options', val: rt.create_array([
				rt.ArrayItem{ key: 'm', val: fn (arg_0 rt.PhpVal) rt.PhpVal {
					mut temp := Class_Automattic_WooCommerce_Utilities_I18nUtil{}
					return temp.get_dimensions_unit_label(arg_0)
				}(rt.new_string('m')) },
				rt.ArrayItem{ key: 'cm', val: fn (arg_0 rt.PhpVal) rt.PhpVal {
					mut temp := Class_Automattic_WooCommerce_Utilities_I18nUtil{}
					return temp.get_dimensions_unit_label(arg_0)
				}(rt.new_string('cm')) },
				rt.ArrayItem{ key: 'mm', val: fn (arg_0 rt.PhpVal) rt.PhpVal {
					mut temp := Class_Automattic_WooCommerce_Utilities_I18nUtil{}
					return temp.get_dimensions_unit_label(arg_0)
				}(rt.new_string('mm')) },
				rt.ArrayItem{ key: 'in', val: fn (arg_0 rt.PhpVal) rt.PhpVal {
					mut temp := Class_Automattic_WooCommerce_Utilities_I18nUtil{}
					return temp.get_dimensions_unit_label(arg_0)
				}(rt.new_string('in')) },
				rt.ArrayItem{ key: 'yd', val: fn (arg_0 rt.PhpVal) rt.PhpVal {
					mut temp := Class_Automattic_WooCommerce_Utilities_I18nUtil{}
					return temp.get_dimensions_unit_label(arg_0)
				}(rt.new_string('yd')) },
			]) },
...
pub fn init_wp_content_plugins_woocommerce_includes_admin_settings_class_wc_settings_products_php() {
	...
	{
		return create_wc_settings_products()
	}
	return create_wc_settings_products()
}
