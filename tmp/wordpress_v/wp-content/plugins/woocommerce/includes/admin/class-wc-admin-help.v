...
fn (mut this Class_WC_Admin_Help) add_tabs() {
	...
	if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(var_screen))))
...
pub fn init_wp_content_plugins_woocommerce_includes_admin_class_wc_admin_help_php() {
