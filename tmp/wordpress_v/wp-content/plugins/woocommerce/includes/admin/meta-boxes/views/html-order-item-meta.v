...
pub fn init_wp_content_plugins_woocommerce_includes_admin_meta_boxes_views_html_order_item_meta_php() {
	...
	if rt.is_true(var_meta_data) {
		// unsupported statement: Stmt_InlineHTML
		{
			...
			for {
				...
				// unsupported statement: Stmt_InlineHTML
				rt.echo_val(rt.call_function('esc_attr', [var_meta_id.dup()]))
				// unsupported statement: Stmt_InlineHTML
