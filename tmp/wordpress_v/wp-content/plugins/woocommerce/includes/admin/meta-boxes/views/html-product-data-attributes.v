...
pub fn init_wp_content_plugins_woocommerce_includes_admin_meta_boxes_views_html_product_data_attributes_php() {
	...
	mut var_product_attributes := rt.call_method(var_product_object, 'get_attributes', [rt.new_string('edit')])
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('esc_html_e', [rt.new_string('Add descriptive pieces of information that customers can use to search for this product on your store, such as “Material” or “Size”.'), rt.new_string('woocommerce')])
	// unsupported statement: Stmt_InlineHTML
	...
	rt.call_function('esc_html_e', [rt.new_string('Close'), rt.new_string('woocommerce')])
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('esc_html_e', [rt.new_string('Save attributes'), rt.new_string('woocommerce')])
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('do_action', [rt.new_string('woocommerce_product_options_attributes')])
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('esc_html_e', [rt.new_string('Create value'), rt.new_string('woocommerce')])
	// unsupported statement: Stmt_InlineHTML
