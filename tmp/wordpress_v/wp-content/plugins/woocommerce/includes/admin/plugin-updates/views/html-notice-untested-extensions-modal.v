...
pub fn init_wp_content_plugins_woocommerce_includes_admin_plugin_updates_views_html_notice_untested_extensions_modal_php() {
	...
	rt.call_function('esc_html_e', [rt.new_string("Are you sure you're ready?"),
		rt.new_string('woocommerce')])
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_html', [var_untested_plugins_msg.dup()]))
	// unsupported statement: Stmt_InlineHTML
