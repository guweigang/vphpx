...
fn (mut this Class_WC_Updates_Screen_Updates) update_screen_modal() {
	...
	if !rt.is_true(var_updateable_plugins.array_get('woocommerce/woocommerce.php'))
		|| !rt.is_true(rt.get_property(var_updateable_plugins.array_get('woocommerce/woocommerce.php'), 'update'))
		|| !rt.is_true(rt.get_property(rt.get_property(var_updateable_plugins.array_get('woocommerce/woocommerce.php'), 'update'), 'new_version')) {
		return rt.new_null()
	}
	...
	this.dispatch_set_prop('new_version', rt.call_function('wc_clean', [
		rt.get_property(rt.get_property(var_updateable_plugins.array_get('woocommerce/woocommerce.php'),
			'update'), 'new_version'),
	]))
	this.dispatch_set_prop('major_untested_plugins', this.get_untested_plugins(rt.get_property(rt.new_object('WC_Updates_Screen_Updates', [
		'WC_Plugin_Updates',
	], &this), 'new_version'), var_version_type.dup()))
...
pub fn init_wp_content_plugins_woocommerce_includes_admin_plugin_updates_class_wc_updates_screen_updates_php() {
