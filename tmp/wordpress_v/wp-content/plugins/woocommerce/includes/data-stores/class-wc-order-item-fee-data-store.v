...
fn (mut this Class_WC_Order_Item_Fee_Data_Store) save_item_data(var_item rt.PhpVal) {
	...
	for var_key, var_value in var_save_values {
		rt.call_function('update_metadata', [rt.new_string('order_item'),
			var_id.dup(), rt.new_string(key), var_value.dup()])
	}
}
...
fn create_wc_order_item_fee_data_store() &Class_WC_Order_Item_Fee_Data_Store {
...
pub fn init_wp_content_plugins_woocommerce_includes_data_stores_class_wc_order_item_fee_data_store_php() {
