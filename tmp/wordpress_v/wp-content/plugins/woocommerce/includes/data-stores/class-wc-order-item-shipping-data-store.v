...
fn (mut this Class_WC_Order_Item_Shipping_Data_Store) read(var_item rt.PhpVal) {
	...
	if rt.is_true(rt.new_bool(
		rt.is_true(rt.identical(rt.new_string(''), rt.call_method(var_item, 'get_instance_id', []rt.PhpVal{})))
		&& rt.is_true(rt.call_function('strstr', [rt.call_method(var_item, 'get_method_id', []rt.PhpVal{}), rt.new_string(':')]))))
	{
		...
		rt.call_method(var_item, 'set_method_id', [var_legacy_method_id.array_get(0)])
		rt.call_method(var_item, 'set_instance_id', [var_legacy_method_id.array_get(1)])
	}
...
fn create_wc_order_item_shipping_data_store() &Class_WC_Order_Item_Shipping_Data_Store {
...
pub fn init_wp_content_plugins_woocommerce_includes_data_stores_class_wc_order_item_shipping_data_store_php() {
