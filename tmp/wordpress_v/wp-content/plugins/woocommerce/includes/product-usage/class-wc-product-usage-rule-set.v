...
fn (mut this Class_WC_Product_Usage_Rule_Set) get_rule(rule_name string) rt.PhpVal {
	...
	return this.rules.array_get(rule_name)
}
...
pub fn init_wp_content_plugins_woocommerce_includes_product_usage_class_wc_product_usage_rule_set_php() {
