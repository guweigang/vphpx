...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Comment_Comment) construct(sComment string, iLineNo i64) {
	this.sComment = rt.new_string(sComment).dup()
	this.setposition(rt.new_int(iLineNo))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Comment_Comment) getcomment() rt.PhpVal {
	return this.sComment
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Comment_Comment) setcomment(var_sComment rt.PhpVal) {
	this.sComment = var_sComment.dup()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Comment_Comment) magic_tostring() rt.PhpVal {
	return rt.new_string(this.render(create_automattic_woocommerce_vendor_sabberworm_css_outputformat()))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Comment_Comment) render(var_oOutputFormat rt.PhpVal) string {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_comment_comment(sComment string, iLineNo i64) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Comment_Comment {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_sabberworm_css_comment_comment_php() {
}
