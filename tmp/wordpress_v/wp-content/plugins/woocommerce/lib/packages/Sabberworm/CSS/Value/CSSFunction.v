...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction) construct(var_sName rt.PhpVal, var_aArguments rt.PhpVal, sSeparator string, iLineNo i64) {
	...
	this.Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList.construct(var_aArguments_mutated.dup(),
		rt.new_string(sSeparator_mutated), rt.new_int(iLineNo))
}

fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction.parse(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState, bIgnoreCase bool) rt.PhpVal {
	...
	mut var_aArguments := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Value{}
		return temp.parsevalue(arg_0, arg_1)
	}(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState', []string{},
		var_oParserState), rt.create_array([rt.ArrayItem{ key: none, val: '=' },
		rt.ArrayItem{ key: none, val: ' ' }, rt.ArrayItem{ key: none, val: ',' }]))
	var_mResult = create_automattic_woocommerce_vendor_sabberworm_css_value_cssfunction(var_mResult,
		var_aArguments, rt.new_string(','), var_oParserState.currentline())
	var_oParserState.consume(rt.new_string(')'))
	return var_mResult.dup()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction) getname() rt.PhpVal {
	return this.sName
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction) setname(var_sName rt.PhpVal) {
	this.sName = var_sName.dup()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction) getarguments() rt.PhpVal {
	return rt.get_property(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction', [
		'Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList',
	], &this), 'aComponents')
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction) magic_tostring() rt.PhpVal {
	return rt.new_string(this.render(create_automattic_woocommerce_vendor_sabberworm_css_outputformat()))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction) render(var_oOutputFormat rt.PhpVal) string {
	mut var_aArguments :=
		this.Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList.render(var_oOutputFormat.dup())
...
fn create_automattic_woocommerce_vendor_sabberworm_css_value_cssfunction(sSeparator string, iLineNo i64, arg_2 rt.PhpVal, arg_3 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction {
...
fn create_automattic_woocommerce_vendor_sabberworm_css_value_valuelist() &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'parse' {
			...
			return Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSFunction.parse(mut dispatch_arg_0,
				dispatch_arg_1)
		}
		'getName' {
			return this.getname()
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_sabberworm_css_value_cssfunction_php() {
}
