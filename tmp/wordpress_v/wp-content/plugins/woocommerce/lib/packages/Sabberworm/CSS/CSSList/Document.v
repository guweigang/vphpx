...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document.parse(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	...
	fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSList{}
		return temp.parselist(arg_0, arg_1)
	}(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState', []string{},
		var_oParserState), rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_Document',
...
fn create_automattic_woocommerce_vendor_sabberworm_css_csslist_cssblocklist() &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_CSSBlockList {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_sabberworm_css_csslist_document_php() {
}
