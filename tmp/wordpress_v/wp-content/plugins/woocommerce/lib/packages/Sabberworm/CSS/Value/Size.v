...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.parse(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState, bIsColorComponent bool) rt.PhpVal {
	...
	mut var_aSizeUnits := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.getsizeunits()
	{
	...
	return create_automattic_woocommerce_vendor_sabberworm_css_value_size(// unsupported expression: Expr_Cast_Double, var_sUnit, bIsColorComponent, var_oParserState.currentline())
}
...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.getsizeunits() rt.PhpVal {
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(// unsupported expression: Expr_StaticPropertyFetch.is_array()))))) {
		...
		{
			mut iter_1 := rt.call_function('array_merge', [Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.absolute_size_units(), Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.relative_size_units(), Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.non_size_units()]).iterator()
			for {
				item_1 := iter_1.next() or { break }
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) issize() bool {
	if rt.is_true(rt.call_function('in_array', [this.sUnit, Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.non_size_units(), rt.new_bool(true)])) {
		return false
	}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) isrelative() bool {
	if rt.is_true(rt.call_function('in_array', [this.sUnit, Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.relative_size_units(), rt.new_bool(true)])) {
		return true
	}
...
fn create_automattic_woocommerce_vendor_sabberworm_css_value_primitivevalue() &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_PrimitiveValue {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'parse' {
			...
			return Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_Size.parse(mut dispatch_arg_0, dispatch_arg_1)
		}
		'getSizeUnits' {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_sabberworm_css_value_size_php() {
}
