...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) construct(iLineNo i64) {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) setvendorkeyframe(var_vendorKeyFrame rt.PhpVal) {
	this.vendorKeyFrame = var_vendorKeyFrame.dup()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) getvendorkeyframe() rt.PhpVal {
	return this.vendorKeyFrame
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) setanimationname(var_animationName rt.PhpVal) {
	this.animationName = var_animationName.dup()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) getanimationname() rt.PhpVal {
	return this.animationName
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) magic_tostring() rt.PhpVal {
	return this.render(create_automattic_woocommerce_vendor_sabberworm_css_outputformat())
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) render(var_oOutputFormat rt.PhpVal) rt.PhpVal {
	mut var_sResult := rt.call_method(var_oOutputFormat, 'comments', [
		rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame', [
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) isrootlist() bool {
	return false
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) atrulename() rt.PhpVal {
	return this.vendorKeyFrame
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame) atruleargs() rt.PhpVal {
	return this.animationName
}
...
fn create_automattic_woocommerce_vendor_sabberworm_css_csslist_keyframe(iLineNo i64) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_CSSList_KeyFrame {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_sabberworm_css_csslist_keyframe_php() {
}
