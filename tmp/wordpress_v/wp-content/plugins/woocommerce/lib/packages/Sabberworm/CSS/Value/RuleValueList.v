...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_RuleValueList) construct(sSeparator string, iLineNo i64) {
	this.Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList.construct(rt.new_array(),
...
fn create_automattic_woocommerce_vendor_sabberworm_css_value_rulevaluelist(sSeparator string, iLineNo i64) &Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_RuleValueList {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_sabberworm_css_value_rulevaluelist_php() {
}
