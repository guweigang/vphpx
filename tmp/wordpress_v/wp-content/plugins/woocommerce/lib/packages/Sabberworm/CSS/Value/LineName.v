...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_LineName.parse(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	...
	var_oParserState.consume(rt.new_string(']'))
	return create_automattic_woocommerce_vendor_sabberworm_css_value_linename(var_aNames.dup(),
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_LineName) render(var_oOutputFormat rt.PhpVal) string {
	return '[' + (this.Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_ValueList.render(fn () rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_OutputFormat{}
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_sabberworm_css_value_linename_php() {
}
