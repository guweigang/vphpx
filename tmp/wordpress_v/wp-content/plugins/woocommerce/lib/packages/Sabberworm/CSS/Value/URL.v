...
fn Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_URL.parse(mut var_oParserState Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	...
	var_oParserState.consumewhitespace()
	mut var_oResult := create_automattic_woocommerce_vendor_sabberworm_css_value_url(fn (arg_0 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Vendor_Sabberworm_CSS_Value_CSSString{}
		return temp.parse(arg_0)
	}(rt.new_object('Automattic_WooCommerce_Vendor_Sabberworm_CSS_Parsing_ParserState', []string{},
		var_oParserState)), var_oParserState.currentline())
	if rt.is_true(var_bUseUrl) {
		var_oParserState.consumewhitespace()
		var_oParserState.consume(rt.new_string(')'))
	}
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_sabberworm_css_value_url_php() {
}
