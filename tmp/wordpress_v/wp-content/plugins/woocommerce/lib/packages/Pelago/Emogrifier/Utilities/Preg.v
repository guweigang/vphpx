...
fn (mut this Class_Automattic_WooCommerce_Vendor_Pelago_Emogrifier_Utilities_Preg) logorthrowpreglasterror()  {
	...
	if rt.is_true(this.throwExceptions) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Pelago_Emogrifier_Utilities_RuntimeException', []string{}, create_automattic_woocommerce_vendor_pelago_emogrifier_utilities_runtimeexception(var_message.dup(), rt.new_int(1592870147))))
	}
...
fn create_automattic_woocommerce_vendor_pelago_emogrifier_utilities_runtimeexception() &Class_Automattic_WooCommerce_Vendor_Pelago_Emogrifier_Utilities_RuntimeException {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_pelago_emogrifier_utilities_preg_php() {
