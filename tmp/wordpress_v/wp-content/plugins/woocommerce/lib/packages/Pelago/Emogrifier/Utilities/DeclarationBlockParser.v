	...
	mut var_properties := rt.new_array()
	{
		...
		for {
			...
			if rt.is_true(rt.identical(var_propertyName, rt.new_string(''))) {
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Pelago_Emogrifier_Utilities_UnexpectedValueException', []string{}, create_automattic_woocommerce_vendor_pelago_emogrifier_utilities_unexpectedvalueexception(rt.new_string('An empty property name was encountered.'), rt.new_int(1727046409))))
			}
...
fn create_automattic_woocommerce_vendor_pelago_emogrifier_utilities_unexpectedvalueexception() &Class_Automattic_WooCommerce_Vendor_Pelago_Emogrifier_Utilities_UnexpectedValueException {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_pelago_emogrifier_utilities_declarationblockparser_php() {
