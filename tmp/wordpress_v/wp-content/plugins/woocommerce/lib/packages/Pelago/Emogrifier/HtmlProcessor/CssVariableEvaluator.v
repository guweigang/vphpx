...
fn (mut this Class_Automattic_WooCommerce_Vendor_Pelago_Emogrifier_HtmlProcessor_CssVariableEvaluator) evaluatevariablesinelementanddescendants(mut var_element Class_Automattic_WooCommerce_Vendor_Pelago_Emogrifier_HtmlProcessor_DOMElement, mut var_ancestorVariableDefinitions Class_Automattic_WooCommerce_Vendor_Pelago_Emogrifier_HtmlProcessor_array) rt.PhpVal {
	...
	if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
		mut var_declarations := rt.call_method(create_automattic_woocommerce_vendor_pelago_emogrifier_utilities_declarationblockparser(), 'parse', [var_style.dup()])
...
fn create_automattic_woocommerce_vendor_pelago_emogrifier_htmlprocessor_cssvariableevaluator() &Class_Automattic_WooCommerce_Vendor_Pelago_Emogrifier_HtmlProcessor_CssVariableEvaluator {
...
fn create_automattic_woocommerce_vendor_pelago_emogrifier_htmlprocessor_closure() &Class_Automattic_WooCommerce_Vendor_Pelago_Emogrifier_HtmlProcessor_Closure {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_pelago_emogrifier_htmlprocessor_cssvariableevaluator_php() {
