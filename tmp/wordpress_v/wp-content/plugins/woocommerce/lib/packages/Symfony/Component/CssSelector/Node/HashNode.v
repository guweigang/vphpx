...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_HashNode) construct(mut var_selector Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NodeInterface, id string) {
	this.selector = var_selector.dup()
	this.id = id
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_HashNode) getselector() rt.PhpVal {
	return this.selector
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_HashNode) getid() string {
	return this.id
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_HashNode) getspecificity() rt.PhpVal {
	return rt.call_method(rt.call_method(this.selector, 'getSpecificity', []rt.PhpVal{}), 'plus', [
		create_automattic_woocommerce_vendor_symfony_component_cssselector_node_specificity(rt.new_int(1),
			rt.new_int(0), rt.new_int(0)),
	])
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_HashNode) magic_tostring() string {
	return (rt.call_function('sprintf', [rt.new_string('%s[%s#%s]'),
		this.getnodename(), this.selector, this.id])).str()
}
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_node_hashnode(arg_0 rt.PhpVal, id string) &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_HashNode {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_symfony_component_cssselector_node_hashnode_php() {
}
