...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_CssSelectorConverter) toxpath(cssExpr string, prefix string) rt.PhpVal {
	return if !(this.cache.array_get(prefix).array_get(cssExpr)).is_null() { this.cache.array_get(prefix).array_get(cssExpr) } else { this.cache.array_get_mut(prefix).array_set(cssExpr, rt.call_method(this.translator, 'cssToXPath', [
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_xpath_extension_htmlextension() &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension {
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_parser_shortcut_emptystringparser() &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Parser_Shortcut_EmptyStringParser {
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_parser_shortcut_elementparser() &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Parser_Shortcut_ElementParser {
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_parser_shortcut_classparser() &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Parser_Shortcut_ClassParser {
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_parser_shortcut_hashparser() &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Parser_Shortcut_HashParser {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_symfony_component_cssselector_cssselectorconverter_php() {
}
