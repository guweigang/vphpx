...
fn fdiv(num1 f64, num2 f64) f64 {
	return (fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_Vendor_Symfony_Polyfill_Php80_Php80{}
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_symfony_polyfill_php80_bootstrap_php() {
