...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) setflag(flag i64, on bool) rt.PhpVal {
	...
	return rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension', []string{}, this)
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) translatefunction(mut var_node Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode, mut var_translator Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator) rt.PhpVal {
	mut var_xpath := var_translator.nodetoxpath(var_node.getselector())
	return var_translator.addfunction(var_xpath.dup(), rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode', []string{}, var_node))
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) translateattribute(mut var_node Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_AttributeNode, mut var_translator Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator) rt.PhpVal {
	...
	mut var_attribute := if rt.is_true(var_safe) { '@' + (var_name).str() } else { rt.call_function('sprintf', [rt.new_string('attribute::*[name() = %s]'), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(var_name.dup())]) }
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) translateelement(mut var_node Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(rt.is_true(var_element) && this.hasflag((Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension.element_name_in_lower_case()).to_i64()))) {
	...
	mut var_xpath := create_automattic_woocommerce_vendor_symfony_component_cssselector_xpath_xpathexpr(rt.new_string(''), var_element.dup())
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_xpath_xpathexpr() &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'translateSelector' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 1 { args[1] } else { rt.new_null() })
			return this.translateselector(mut dispatch_arg_0, mut dispatch_arg_1)
		}
		'translateCombinedSelector' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_CombinedSelectorNode](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 1 { args[1] } else { rt.new_null() })
			return this.translatecombinedselector(mut dispatch_arg_0, mut dispatch_arg_1)
		}
		'translateNegation' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NegationNode](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 1 { args[1] } else { rt.new_null() })
			return this.translatenegation(mut dispatch_arg_0, mut dispatch_arg_1)
		}
		'translateFunction' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 1 { args[1] } else { rt.new_null() })
			return this.translatefunction(mut dispatch_arg_0, mut dispatch_arg_1)
		}
		'translatePseudo' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_PseudoNode](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 1 { args[1] } else { rt.new_null() })
			return this.translatepseudo(mut dispatch_arg_0, mut dispatch_arg_1)
		}
		'translateAttribute' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_AttributeNode](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 1 { args[1] } else { rt.new_null() })
			return this.translateattribute(mut dispatch_arg_0, mut dispatch_arg_1)
		}
		'translateClass' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ClassNode](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 1 { args[1] } else { rt.new_null() })
			return this.translateclass(mut dispatch_arg_0, mut dispatch_arg_1)
		}
		'translateHash' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_HashNode](if args.len > 0 { args[0] } else { rt.new_null() })
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 1 { args[1] } else { rt.new_null() })
			return this.translatehash(mut dispatch_arg_0, mut dispatch_arg_1)
		}
		'translateElement' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode](if args.len > 0 { args[0] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_symfony_component_cssselector_xpath_extension_nodeextension_php() {
}
