...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NegationNode) construct(mut var_selector Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NodeInterface, mut var_subSelector Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NodeInterface) {
	this.selector = var_selector.dup()
	this.subSelector = var_subSelector.dup()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NegationNode) getselector() rt.PhpVal {
	return this.selector
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NegationNode) getsubselector() rt.PhpVal {
	return this.subSelector
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NegationNode) getspecificity() rt.PhpVal {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NegationNode) magic_tostring() string {
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_node_negationnode(arg_0 rt.PhpVal, arg_1 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NegationNode {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NegationNode) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NodeInterface](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_symfony_component_cssselector_node_negationnode_php() {
}
