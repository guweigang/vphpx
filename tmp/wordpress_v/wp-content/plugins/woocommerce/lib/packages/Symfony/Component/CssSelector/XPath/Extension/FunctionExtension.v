...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) getfunctiontranslators() rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: 'nth-child', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension', ['Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_AbstractExtension'], &this) }, rt.ArrayItem{ key: none, val: 'translateNthChild' }]) }, rt.ArrayItem{ key: 'nth-last-child', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension', ['Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_AbstractExtension'], &this) }, rt.ArrayItem{ key: none, val: 'translateNthLastChild' }]) }, rt.ArrayItem{ key: 'nth-of-type', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension', ['Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_AbstractExtension'], &this) }, rt.ArrayItem{ key: none, val: 'translateNthOfType' }]) }, rt.ArrayItem{ key: 'nth-last-of-type', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension', ['Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_AbstractExtension'], &this) }, rt.ArrayItem{ key: none, val: 'translateNthLastOfType' }]) }, rt.ArrayItem{ key: 'contains', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension', ['Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_AbstractExtension'], &this) }, rt.ArrayItem{ key: none, val: 'translateContains' }]) }, rt.ArrayItem{ key: 'lang', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension', ['Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_AbstractExtension'], &this) }, rt.ArrayItem{ key: none, val: 'translateLang' }]) }])
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) translatenthchild(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr, mut var_function Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode, last bool, addNameTest bool) rt.PhpVal {
...
catch_label_1:
	...
	if rt.instance_of(var_e_1, 'Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_SyntaxErrorException') {
		mut var_e := var_e_1.dup()
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_ExpressionErrorException', []string{}, create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_expressionerrorexception(rt.call_function('sprintf', [rt.new_string('Invalid series: "%s".'), rt.call_function('implode', [rt.new_string('", "'), var_function.getarguments()])]), rt.new_int(0), var_e.dup())))
		unsafe { goto end_label_1 }
	}
	else {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) translatenthlastchild(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr, mut var_function Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode) rt.PhpVal {
	return this.translatenthchild(mut var_xpath, mut var_function, true, false)
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) translatenthoftype(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr, mut var_function Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode) rt.PhpVal {
	return this.translatenthchild(mut var_xpath, mut var_function, false, false)
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) translatenthlastoftype(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr, mut var_function Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode) rt.PhpVal {
	if rt.is_true(rt.identical(rt.new_string('*'), var_xpath.getelement())) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_ExpressionErrorException', []string{}, create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_expressionerrorexception(rt.new_string('"*:nth-of-type()" is not implemented.'))))
	}
	return this.translatenthchild(mut var_xpath, mut var_function, true, false)
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) translatecontains(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr, mut var_function Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode) rt.PhpVal {
	mut var_arguments := var_function.getarguments()
	{
		...
		for {
			...
			if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.is_true(rt.call_method(var_token, 'isString', []rt.PhpVal{})) || rt.is_true(rt.call_method(var_token, 'isIdentifier', []rt.PhpVal{}))))))) {
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_ExpressionErrorException', []string{}, create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_expressionerrorexception('Expected a single string or identifier for :contains(), got ' + (rt.call_function('implode', [rt.new_string(', '), var_arguments.dup()])).str())))
			}
		}
	}
	return var_xpath.addcondition(rt.call_function('sprintf', [rt.new_string('contains(string(.), %s)'), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.call_method(var_arguments.array_get(0), 'getValue', []rt.PhpVal{}))]))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) translatelang(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr, mut var_function Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode) rt.PhpVal {
	mut var_arguments := var_function.getarguments()
	{
		mut iter_1 := var_arguments.iterator()
		for {
			...
			mut var_token := item_1.val
			if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(rt.is_true(rt.call_method(var_token, 'isString', []rt.PhpVal{})) || rt.is_true(rt.call_method(var_token, 'isIdentifier', []rt.PhpVal{}))))))) {
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_ExpressionErrorException', []string{}, create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_expressionerrorexception('Expected a single string or identifier for :lang(), got ' + (rt.call_function('implode', [rt.new_string(', '), var_arguments.dup()])).str())))
			}
		}
	}
	return var_xpath.addcondition(rt.call_function('sprintf', [rt.new_string('lang(%s)'), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.call_method(var_arguments.array_get(0), 'getValue', []rt.PhpVal{}))]))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_FunctionExtension) getname() string {
	return 'function'
}
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_symfony_component_cssselector_xpath_extension_functionextension_php() {
}
