...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ClassNode) construct(mut var_selector Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_NodeInterface, name string) {
	this.selector = var_selector.dup()
	this.name = name
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ClassNode) getselector() rt.PhpVal {
	return this.selector
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ClassNode) getname() string {
	return this.name
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ClassNode) getspecificity() rt.PhpVal {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ClassNode) magic_tostring() string {
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_node_classnode(arg_0 rt.PhpVal, name string) &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ClassNode {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_symfony_component_cssselector_node_classnode_php() {
}
