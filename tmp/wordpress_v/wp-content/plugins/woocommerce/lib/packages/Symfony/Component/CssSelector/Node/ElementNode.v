...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode) construct(mut var_namespace Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_?string, mut var_element Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_?string)  {
	mut var_element_mutated := var_element
	this.namespace = var_namespace.dup()
	this.element = var_element_mutated.dup()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode) getnamespace() string {
	return (this.namespace).str()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode) getelement() string {
	return (this.element).str()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode) getspecificity() rt.PhpVal {
	return create_automattic_woocommerce_vendor_symfony_component_cssselector_node_specificity(rt.new_int(0), rt.new_int(0), if rt.is_true(this.element) { rt.new_int(1) } else { rt.new_int(0) })
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode) magic_tostring() string {
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_node_elementnode(arg_0 rt.PhpVal, arg_1 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_ElementNode) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_?string](if args.len > 0 { args[0] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_symfony_component_cssselector_node_elementnode_php() {
}
