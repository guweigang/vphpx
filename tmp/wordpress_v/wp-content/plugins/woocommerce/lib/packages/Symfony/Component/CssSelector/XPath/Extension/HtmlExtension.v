...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) construct(mut var_translator Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator) {
	rt.call_method(rt.call_method(var_translator.getextension(rt.new_string('node')), 'setFlag', [
		Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension.element_name_in_lower_case(),
		rt.new_bool(true),
	]), 'setFlag', [
		Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_NodeExtension.attribute_name_in_lower_case(),
		rt.new_bool(true),
	])
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) getpseudoclasstranslators() rt.PhpVal {
	return rt.create_array([
		rt.ArrayItem{ key: 'checked', val: rt.create_array([
			rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension', [
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) getfunctiontranslators() rt.PhpVal {
	return rt.create_array([
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) translatechecked(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr) rt.PhpVal {
	return var_xpath.addcondition(rt.new_string('(@checked ' +
		"and (name(.) = 'input' or name(.) = 'command')" +
		"and (@type = 'checkbox' or @type = 'radio'))"))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) translatelink(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr) rt.PhpVal {
	return var_xpath.addcondition(rt.new_string("@href and (name(.) = 'a' or name(.) = 'link' or name(.) = 'area')"))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) translatedisabled(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr) rt.PhpVal {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) translateenabled(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr) rt.PhpVal {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) translatelang(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr, mut var_function Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode) rt.PhpVal {
	mut var_arguments := var_function.getarguments()
	{
		...
		for {
			...
			if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(
				rt.is_true(rt.call_method(var_token, 'isString', []rt.PhpVal{}))
				|| rt.is_true(rt.call_method(var_token, 'isIdentifier', []rt.PhpVal{})))))))
			{
				rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Exception_ExpressionErrorException',
					[]string{}, create_automattic_woocommerce_vendor_symfony_component_cssselector_exception_expressionerrorexception(
					'Expected a single string or identifier for :lang(), got ' +
					(rt.call_function('implode', [rt.new_string(', '), var_arguments.dup()])).str())))
			}
		}
	}
	return var_xpath.addcondition(rt.call_function('sprintf', [
		...
		fn (arg_0 rt.PhpVal) rt.PhpVal {
			...
			return temp.getxpathliteral(arg_0)
		}(rt.new_string(
			rt.call_method(var_arguments.array_get(0), 'getValue', []rt.PhpVal{}).to_string().to_lower() +
			'-')),
	]))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) translateselected(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr) rt.PhpVal {
	return var_xpath.addcondition(rt.new_string("(@selected and name(.) = 'option')"))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) translateinvalid(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr) rt.PhpVal {
	return var_xpath.addcondition(rt.new_string('0'))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) translatehover(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr) rt.PhpVal {
	return var_xpath.addcondition(rt.new_string('0'))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) translatevisited(mut var_xpath Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr) rt.PhpVal {
	return var_xpath.addcondition(rt.new_string('0'))
}

fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) getname() string {
	return 'html'
}
...
fn create_automattic_woocommerce_vendor_symfony_component_cssselector_xpath_extension_htmlextension(arg_0 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Extension_HtmlExtension) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_Translator](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'translateChecked' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_XPath_XPathExpr](if args.len > 0 {
				args[0]
			} else {
				rt.new_null()
			})
		...
		'translateLang' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_Symfony_Component_CssSelector_Node_FunctionNode](if args.len > 1 {
				args[1]
			} else {
				rt.new_null()
			})
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_symfony_component_cssselector_xpath_extension_htmlextension_php() {
}
