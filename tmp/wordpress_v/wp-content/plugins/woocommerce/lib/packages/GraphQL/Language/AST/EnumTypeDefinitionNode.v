...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_EnumTypeDefinitionNode) getname() rt.PhpVal {
	return this.name
}

fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_EnumTypeDefinitionNode) construct(mut var_vars Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_array) {
...
fn create_automattic_woocommerce_vendor_graphql_language_ast_enumtypedefinitionnode(arg_0 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_EnumTypeDefinitionNode {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_language_ast_enumtypedefinitionnode_php() {
