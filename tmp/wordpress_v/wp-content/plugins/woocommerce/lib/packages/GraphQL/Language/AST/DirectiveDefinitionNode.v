...
pub mut:
	...
	repeatable  rt.PhpVal = rt.new_null()
	locations   rt.PhpVal = rt.new_null()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_DirectiveDefinitionNode) construct(mut var_vars Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_array) {
...
fn create_automattic_woocommerce_vendor_graphql_language_ast_directivedefinitionnode(arg_0 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_DirectiveDefinitionNode {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_language_ast_directivedefinitionnode_php() {
