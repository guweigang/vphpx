...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_InputObjectTypeDefinitionNode) getname() rt.PhpVal {
	return this.name
}

fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_InputObjectTypeDefinitionNode) construct(mut var_vars Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_array) {
...
fn create_automattic_woocommerce_vendor_graphql_language_ast_inputobjecttypedefinitionnode(arg_0 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_InputObjectTypeDefinitionNode {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_language_ast_inputobjecttypedefinitionnode_php() {
