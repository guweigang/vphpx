...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ResolveInfo) construct(mut var_fieldDefinition Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_FieldDefinition, mut var_fieldNodes Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ArrayObject, mut var_parentType Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ObjectType, mut var_path Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_array, mut var_schema Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Schema, mut var_fragments Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_array, var_rootValue rt.PhpVal, mut var_operation Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_OperationDefinitionNode, mut var_variableValues Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_array, mut var_unaliasedPath Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_array)  {
	...
	this.fieldDefinition = var_fieldDefinition.dup()
	this.fieldName = rt.get_property(var_fieldDefinition, 'name')
	this.returnType = var_fieldDefinition.gettype()
	this.fieldNodes = var_fieldNodes.dup()
	this.parentType = var_parentType_mutated.dup()
	this.path = var_path.dup()
	this.unaliasedPath = var_unaliasedPath.dup()
	...
	mut var_fields := rt.new_array()
	{
		...
		for {
			...
			if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
				var_fields = rt.call_function('array_merge_recursive', [var_fields.dup(), this.foldselectionset(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](var_selectionSet), depth)])
			}
		}
	}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ResolveInfo) getfieldselectionwithaliases(depth i64) rt.PhpVal {
	mut var_fields := rt.new_array()
	{
		...
		for {
			...
			mut var_selectionSet := rt.get_property(var_fieldNode, 'selectionSet')
			if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
				mut var_field := rt.call_method(this.parentType, 'getField', [rt.get_property(rt.get_property(var_fieldNode, 'name'), 'value')])
				mut var_fieldType := rt.call_method(var_field, 'getType', []rt.PhpVal{})
				var_fields = rt.call_function('array_merge_recursive', [var_fields.dup(), this.foldselectionwithalias(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](var_selectionSet), depth, mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type](var_fieldType))])
			}
		}
	}
	return var_fields.dup()
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ResolveInfo) lookahead(mut var_options Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_array) rt.PhpVal {
	return create_automattic_woocommerce_vendor_graphql_type_definition_queryplan(this.parentType, this.schema, this.fieldNodes, this.variableValues, this.fragments, var_options.dup())
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ResolveInfo) foldselectionset(mut var_selectionSet Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode, descend i64) rt.PhpVal {
	...
	mut var_fields := rt.new_array()
	{
		mut iter_1 := rt.get_property(var_selectionSet_mutated, 'selections').iterator()
		for {
			item_1 := iter_1.next() or { break }
			...
			if rt.is_true(rt.new_bool(rt.instance_of(var_selection, 'Automattic_WooCommerce_Vendor_GraphQL_Language_AST_FieldNode'))) {
				var_fields.array_set(rt.get_property(rt.get_property(var_selection, 'name'), 'value'), if rt.is_true(rt.new_bool(descend > 0 && rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) { rt.call_function('array_merge_recursive', [if !(var_fields.array_get(rt.get_property(rt.get_property(var_selection, 'name'), 'value'))).is_null() { var_fields.array_get(rt.get_property(rt.get_property(var_selection, 'name'), 'value')) } else { rt.new_array() }, this.foldselectionset(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](rt.get_property(var_selection, 'selectionSet')), descend - 1)]) } else { rt.new_bool(true) })
				...
				var_fields = rt.call_function('array_merge_recursive', [this.foldselectionset(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](rt.get_property(var_fragment, 'selectionSet')), descend), var_fields.dup()])
				...
				var_fields = rt.call_function('array_merge_recursive', [this.foldselectionset(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](rt.get_property(var_selection, 'selectionSet')), descend), var_fields.dup()])
			}
		}
	}
	return var_fields.dup()
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ResolveInfo) foldselectionwithalias(mut var_selectionSet Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode, descend i64, mut var_parentType Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type) rt.PhpVal {
	...
	mut var_parentType_mutated := var_parentType
	mut var_fields := rt.new_array()
	if rt.is_true(rt.new_bool(rt.instance_of(var_parentType_mutated, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_WrappingType'))) {
		var_parentType_mutated = rt.call_method(var_parentType_mutated, 'getInnermostType', []rt.PhpVal{})
	}
	{
		mut iter_1 := rt.get_property(var_selectionSet_mutated, 'selections').iterator()
		for {
			...
			if rt.is_true(rt.new_bool(rt.instance_of(var_selection, 'Automattic_WooCommerce_Vendor_GraphQL_Language_AST_FieldNode'))) {
				...
				mut var_aliasName := if !(rt.get_property(rt.get_property(var_selection, 'alias'), 'value')).is_null() { rt.get_property(rt.get_property(var_selection, 'alias'), 'value') } else { var_fieldName }
				...
				rt.call_function('assert', [rt.new_bool(rt.instance_of(var_parentType_mutated, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_HasFieldsType')), rt.new_string('ensured by query validation')])
				// unsupported expression: Expr_AssignRef
				mut var_fieldDef := rt.call_method(var_parentType_mutated, 'getField', [var_fieldName.dup()])
				var_aliasInfo.array_set('args', fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Values{}; return temp.getargumentvalues(arg_0, arg_1, arg_2) }(var_fieldDef.dup(), var_selection.dup(), this.variableValues))
				mut var_fieldType := rt.call_method(var_fieldDef, 'getType', []rt.PhpVal{})
				mut var_namedFieldType := var_fieldType.dup()
				if rt.is_true(rt.new_bool(rt.instance_of(var_namedFieldType, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_WrappingType'))) {
					var_namedFieldType = rt.call_method(var_namedFieldType, 'getInnermostType', []rt.PhpVal{})
				}
				var_aliasInfo.array_set('type', var_namedFieldType.dup())
				if descend <= 0 {
					continue
				}
				...
				if rt.is_true(rt.new_bool(rt.instance_of(var_namedFieldType, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_UnionType'))) {
					var_aliasInfo.array_set('unions', this.foldselectionwithalias(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](var_nestedSelectionSet), descend, mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type](var_fieldType)))
					continue
				}
				var_aliasInfo.array_set('selectionSet', this.foldselectionwithalias(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](var_nestedSelectionSet), descend - 1, mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type](var_fieldType)))
			} else if rt.is_true(rt.new_bool(rt.instance_of(var_selection, 'Automattic_WooCommerce_Vendor_GraphQL_Language_AST_FragmentSpreadNode'))) {
				mut var_spreadName := rt.get_property(rt.get_property(var_selection, 'name'), 'value')
				mut var_fragment := if !(this.fragments.array_get(var_spreadName)).is_null() { this.fragments.array_get(var_spreadName) } else { rt.new_null() }
				if rt.is_true(rt.identical(var_fragment, rt.new_null())) {
				...
				var_fieldType = rt.call_method(this.schema, 'getType', [rt.get_property(rt.get_property(rt.get_property(var_fragment, 'typeCondition'), 'name'), 'value')])
				rt.call_function('assert', [rt.new_bool(rt.instance_of(var_fieldType, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type')), rt.new_string('ensured by query validation')])
				var_fields = rt.call_function('array_merge_recursive', [this.foldselectionwithalias(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](rt.get_property(var_fragment, 'selectionSet')), descend, mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type](var_fieldType)), var_fields.dup()])
			} else if rt.is_true(rt.new_bool(rt.instance_of(var_selection, 'Automattic_WooCommerce_Vendor_GraphQL_Language_AST_InlineFragmentNode'))) {
				mut var_typeCondition := rt.get_property(var_selection, 'typeCondition')
				var_fieldType = if rt.is_true(rt.identical(var_typeCondition, rt.new_null())) { var_parentType_mutated } else { rt.call_method(this.schema, 'getType', [rt.get_property(rt.get_property(var_typeCondition, 'name'), 'value')]) }
				rt.call_function('assert', [rt.new_bool(rt.instance_of(var_fieldType, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type')), rt.new_string('ensured by query validation')])
				if rt.is_true(rt.new_bool(rt.instance_of(var_parentType_mutated, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_UnionType'))) {
					rt.call_function('assert', [rt.new_bool(rt.instance_of(var_fieldType, 'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_NamedType')), rt.new_string('ensured by query validation')])
					// unsupported expression: Expr_AssignRef
					var_fieldTypeInfo.array_set('type', var_fieldType.dup())
					var_fieldTypeInfo.array_set('selectionSet', this.foldselectionwithalias(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](rt.get_property(var_selection, 'selectionSet')), descend, mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type](var_fieldType)))
					continue
				}
				var_fields = rt.call_function('array_merge_recursive', [this.foldselectionwithalias(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](rt.get_property(var_selection, 'selectionSet')), descend, mut rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type](var_fieldType)), var_fields.dup()])
			}
		}
	}
	return var_fields.dup()
...
fn create_automattic_woocommerce_vendor_graphql_type_definition_queryplan() &Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_QueryPlan {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ResolveInfo) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ArrayObject](if args.len > 1 { args[1] } else { rt.new_null() })
			mut dispatch_arg_2 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ObjectType](if args.len > 2 { args[2] } else { rt.new_null() })
			...
			mut dispatch_arg_4 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Schema](if args.len > 4 { args[4] } else { rt.new_null() })
			...
			mut dispatch_arg_7 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_OperationDefinitionNode](if args.len > 7 { args[7] } else { rt.new_null() })
			mut dispatch_arg_8 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_array](if args.len > 8 { args[8] } else { rt.new_null() })
			mut dispatch_arg_9 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_array](if args.len > 9 { args[9] } else { rt.new_null() })
			this.construct(mut dispatch_arg_0, mut dispatch_arg_1, mut dispatch_arg_2, mut dispatch_arg_3, mut dispatch_arg_4, mut dispatch_arg_5, dispatch_arg_6, mut dispatch_arg_7, mut dispatch_arg_8, mut dispatch_arg_9)
			return rt.new_null()
		}
		'getFieldSelection' {
		...
		'foldSelectionWithAlias' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_SelectionSetNode](if args.len > 0 { args[0] } else { rt.new_null() })
			dispatch_arg_1 := (if args.len > 1 { args[1] } else { rt.new_null() }).to_i64()
			mut dispatch_arg_2 := rt.cast_object_ptr[Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type](if args.len > 2 { args[2] } else { rt.new_null() })
			return this.foldselectionwithalias(mut dispatch_arg_0, dispatch_arg_1, mut dispatch_arg_2)
		}
		else { return none }
	}
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ResolveInfo) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'fieldDefinition' { this.fieldDefinition = val; return true }
		'fieldName' { this.fieldName = val; return true }
		'returnType' { this.returnType = val; return true }
		'fieldNodes' { this.fieldNodes = val; return true }
		'parentType' { this.parentType = val; return true }
		...
		'operation' { this.operation = val; return true }
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_type_definition_resolveinfo_php() {
