...
pub mut:
	...
	typeCondition       rt.PhpVal = rt.new_null()
	directives          rt.PhpVal = rt.new_null()
	selectionSet        rt.PhpVal = rt.new_null()
}

fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_FragmentDefinitionNode) construct(mut var_vars Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_array) {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_FragmentDefinitionNode) getselectionset() rt.PhpVal {
...
fn create_automattic_woocommerce_vendor_graphql_language_ast_fragmentdefinitionnode(arg_0 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_FragmentDefinitionNode {
...
fn (this &Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_FragmentDefinitionNode) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	match prop_name {
		...
		'typeCondition' { return this.typeCondition }
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_language_ast_fragmentdefinitionnode_php() {
