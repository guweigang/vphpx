...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_EnumTypeExtensionNode) construct(mut var_vars Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_array) {
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_EnumTypeExtensionNode) getname() rt.PhpVal {
	return this.name
}
...
fn create_automattic_woocommerce_vendor_graphql_language_ast_enumtypeextensionnode(arg_0 rt.PhpVal) &Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_EnumTypeExtensionNode {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_language_ast_enumtypeextensionnode_php() {
