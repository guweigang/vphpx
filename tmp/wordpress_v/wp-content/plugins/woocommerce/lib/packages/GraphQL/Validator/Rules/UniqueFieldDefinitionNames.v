...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Validator_Rules_UniqueFieldDefinitionNames) getsdlvisitor(mut var_context Class_Automattic_WooCommerce_Vendor_GraphQL_Validator_SDLValidationContext) rt.PhpVal {
	...
	closure_1_fn := fn [var_context, var_schema, mut var_knownFieldNames] (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	...
	mut var_checkFieldUniqueness := rt.new_closure(closure_1_fn)
...
fn create_automattic_woocommerce_vendor_graphql_validator_rules_uniquefielddefinitionnames() &Class_Automattic_WooCommerce_Vendor_GraphQL_Validator_Rules_UniqueFieldDefinitionNames {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_validator_rules_uniquefielddefinitionnames_php() {
