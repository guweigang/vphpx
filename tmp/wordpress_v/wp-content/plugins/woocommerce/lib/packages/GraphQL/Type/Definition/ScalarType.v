...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ScalarType) assertvalid() {
	...
	}(rt.get_property(rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_ScalarType', [
		'Automattic_WooCommerce_Vendor_GraphQL_Type_Definition_Type',
		'OutputType',
		'InputType',
		'LeafType',
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_type_definition_scalartype_php() {
