...
pub mut:
	...
	definitions rt.PhpVal = rt.new_null()
}
...
fn create_automattic_woocommerce_vendor_graphql_language_ast_documentnode() &Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_DocumentNode {
	mut obj := &Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_DocumentNode{
		PhpObjectBase: rt.PhpObjectBase{}
		kind:          rt.new_null()
		definitions:   rt.new_null()
	}
	return obj
}
...
fn (this &Class_Automattic_WooCommerce_Vendor_GraphQL_Language_AST_DocumentNode) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	match prop_name {
		...
		'definitions' { return this.definitions }
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_language_ast_documentnode_php() {
