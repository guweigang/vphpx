...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter) convertthenable(var_thenable rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_vendor_graphql_executor_promise_promise(var_thenable.dup(), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter', ['PromiseAdapter'], &this).dup())
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter) then(mut var_promise Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Promise, mut var_onFulfilled Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_?callable, mut var_onRejected Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_?callable) rt.PhpVal {
	...
	return create_automattic_woocommerce_vendor_graphql_executor_promise_promise(rt.call_method(var_reactPromise, 'then', [var_onFulfilled, var_onRejected]), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter', ['PromiseAdapter'], &this).dup())
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter) create(mut var_resolver Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_callable) rt.PhpVal {
	mut var_reactPromise := create_react_promise_promise(var_resolver.dup())
	return create_automattic_woocommerce_vendor_graphql_executor_promise_promise(var_reactPromise.dup(), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter', ['PromiseAdapter'], &this).dup())
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter) createfulfilled(var_value rt.PhpVal) rt.PhpVal {
	mut var_reactPromise := rt.call_function('resolve', [var_value.dup()])
	return create_automattic_woocommerce_vendor_graphql_executor_promise_promise(var_reactPromise.dup(), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter', ['PromiseAdapter'], &this).dup())
}
...
fn (mut this Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter) all(mut var_promisesOrValues Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_iterable) rt.PhpVal {
	...
	return rt.call_function('array_map', [rt.new_closure(closure_2_fn), rt.func_array_keys(var_promisesOrValuesArray.dup())])
	}
	mut var_reactPromise := rt.call_method(rt.call_function('all', [var_promisesOrValuesArray.dup()]), 'then', [rt.new_closure(closure_3_fn)])
	return create_automattic_woocommerce_vendor_graphql_executor_promise_promise(var_reactPromise.dup(), rt.new_object('Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter', ['PromiseAdapter'], &this).dup())
}
...
fn create_automattic_woocommerce_vendor_graphql_executor_promise_adapter_reactpromiseadapter() &Class_Automattic_WooCommerce_Vendor_GraphQL_Executor_Promise_Adapter_ReactPromiseAdapter {
...
fn create_react_promise_promise() &Class_React_Promise_Promise {
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_graphql_executor_promise_adapter_reactpromiseadapter_php() {
