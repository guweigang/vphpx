...
fn Class_Automattic_WooCommerce_Vendor_League_ISO3166_Guards.guardagainstinvalidname(name string)  {
	if rt.is_true(rt.identical(rt.new_string(''), rt.new_string(name.trim_space()))) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_League_ISO3166_Exception_DomainException', []string{}, create_automattic_woocommerce_vendor_league_iso3166_exception_domainexception(rt.new_string('Expected string, got empty string'))))
	}
}

fn Class_Automattic_WooCommerce_Vendor_League_ISO3166_Guards.guardagainstinvalidalpha2(alpha2 string)  {
	if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_League_ISO3166_Exception_DomainException', []string{}, create_automattic_woocommerce_vendor_league_iso3166_exception_domainexception(rt.call_function('sprintf', [rt.new_string('Not a valid alpha2 key: %s'), rt.new_string(alpha2)]))))
	}
}

fn Class_Automattic_WooCommerce_Vendor_League_ISO3166_Guards.guardagainstinvalidalpha3(alpha3 string)  {
	if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_League_ISO3166_Exception_DomainException', []string{}, create_automattic_woocommerce_vendor_league_iso3166_exception_domainexception(rt.call_function('sprintf', [rt.new_string('Not a valid alpha3 key: %s'), rt.new_string(alpha3)]))))
	}
}

fn Class_Automattic_WooCommerce_Vendor_League_ISO3166_Guards.guardagainstinvalidnumeric(numeric string)  {
	if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_Vendor_League_ISO3166_Exception_DomainException', []string{}, create_automattic_woocommerce_vendor_league_iso3166_exception_domainexception(rt.call_function('sprintf', [rt.new_string('Not a valid numeric key: %s'), rt.new_string(numeric)]))))
	}
}
...
pub fn init_wp_content_plugins_woocommerce_lib_packages_league_iso3166_guards_php() {
