...
fn Class_Automattic_WooCommerce_EmailEditor_Email_Editor_Container.init()  {
	rt.call_method(rt.call_method(Class_Automattic_WooCommerce_EmailEditor_Email_Editor_Container.container(), 'get', [Class_Automattic_WooCommerce_EmailEditor_Bootstrap.class()]), 'init', []rt.PhpVal{})
}
...
fn Class_Automattic_WooCommerce_EmailEditor_Email_Editor_Container.container(reset bool) rt.PhpVal {
	...
	if rt.is_true(var_container) {
		return var_container.dup()
	}
	var_container = create_automattic_woocommerce_emaileditor_container()
	closure_1_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_integrations_core_initializer()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer.class(), rt.new_closure(closure_1_fn)])
	closure_2_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_integrations_woocommerce_initializer()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Initializer.class(), rt.new_closure(closure_2_fn)])
	closure_3_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_theme_controller()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Theme_Controller.class(), rt.new_closure(closure_3_fn)])
	closure_4_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_user_theme()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_User_Theme.class(), rt.new_closure(closure_4_fn)])
	closure_5_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_settings_controller(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Theme_Controller.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Settings_Controller.class(), rt.new_closure(closure_5_fn)])
	closure_6_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_templates_templates_registry()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Templates_Templates_Registry.class(), rt.new_closure(closure_6_fn)])
	closure_7_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_templates_templates(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Templates_Templates_Registry.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Templates_Templates.class(), rt.new_closure(closure_7_fn)])
	closure_8_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_patterns_patterns()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Patterns_Patterns.class(), rt.new_closure(closure_8_fn)])
	closure_9_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_preprocessors_cleanup_preprocessor()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Cleanup_Preprocessor.class(), rt.new_closure(closure_9_fn)])
	closure_10_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_preprocessors_blocks_width_preprocessor()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Blocks_Width_Preprocessor.class(), rt.new_closure(closure_10_fn)])
	closure_11_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_preprocessors_typography_preprocessor(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Settings_Controller.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Typography_Preprocessor.class(), rt.new_closure(closure_11_fn)])
	closure_12_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_preprocessors_spacing_preprocessor()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Spacing_Preprocessor.class(), rt.new_closure(closure_12_fn)])
	closure_13_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_preprocessors_quote_preprocessor()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Quote_Preprocessor.class(), rt.new_closure(closure_13_fn)])
	closure_14_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_postprocessors_highlighting_postprocessor()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Postprocessors_Highlighting_Postprocessor.class(), rt.new_closure(closure_14_fn)])
	closure_15_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_postprocessors_variables_postprocessor(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Theme_Controller.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Postprocessors_Variables_Postprocessor.class(), rt.new_closure(closure_15_fn)])
	closure_16_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_postprocessors_border_style_postprocessor()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Postprocessors_Border_Style_Postprocessor.class(), rt.new_closure(closure_16_fn)])
	closure_17_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_assets_manager(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Settings_Controller.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Theme_Controller.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_User_Theme.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Logger_Email_Editor_Logger.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Assets_Manager.class(), rt.new_closure(closure_17_fn)])
	closure_18_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_process_manager(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Cleanup_Preprocessor.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Blocks_Width_Preprocessor.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Typography_Preprocessor.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Spacing_Preprocessor.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Quote_Preprocessor.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Postprocessors_Highlighting_Postprocessor.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Postprocessors_Variables_Postprocessor.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Postprocessors_Border_Style_Postprocessor.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Process_Manager.class(), rt.new_closure(closure_18_fn)])
	closure_19_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_content_renderer(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Process_Manager.class()]), create_automattic_woocommerce_emaileditor_email_css_inliner(), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Theme_Controller.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Logger_Email_Editor_Logger.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Content_Renderer.class(), rt.new_closure(closure_19_fn)])
	closure_20_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_renderer_renderer(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Content_Renderer.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Templates_Templates.class()]), create_automattic_woocommerce_emaileditor_email_css_inliner(), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Theme_Controller.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_PersonalizationTags_Personalization_Tags_Registry.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Process_Manager.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_Renderer.class(), rt.new_closure(closure_20_fn)])
	closure_21_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_personalizationtags_personalization_tags_registry(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Logger_Email_Editor_Logger.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_PersonalizationTags_Personalization_Tags_Registry.class(), rt.new_closure(closure_21_fn)])
	closure_22_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_personalizer(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_PersonalizationTags_Personalization_Tags_Registry.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Personalizer.class(), rt.new_closure(closure_22_fn)])
	closure_23_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_send_preview_email(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_Renderer.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Personalizer.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Send_Preview_Email.class(), rt.new_closure(closure_23_fn)])
	closure_24_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_email_api_controller(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_PersonalizationTags_Personalization_Tags_Registry.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Email_Api_Controller.class(), rt.new_closure(closure_24_fn)])
	closure_25_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_dependency_check()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Dependency_Check.class(), rt.new_closure(closure_25_fn)])
	closure_26_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_logger_email_editor_logger()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Logger_Email_Editor_Logger.class(), rt.new_closure(closure_26_fn)])
	closure_27_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_emaileditor_engine_site_style_sync_controller()
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Site_Style_Sync_Controller.class(), rt.new_closure(closure_27_fn)])
	closure_28_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_engine_email_editor(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Email_Api_Controller.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Templates_Templates.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Patterns_Patterns.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Send_Preview_Email.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_PersonalizationTags_Personalization_Tags_Registry.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Logger_Email_Editor_Logger.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Assets_Manager.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Engine_Email_Editor.class(), rt.new_closure(closure_28_fn)])
	closure_29_fn := fn (this_ptr rt.PhpVal, args []rt.PhpVal) rt.PhpVal {
	mut var_container := if args.len > 0 { args[0].dup() } else { rt.new_null() }
	return create_automattic_woocommerce_emaileditor_bootstrap(rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Engine_Email_Editor.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer.class()]), rt.call_method(var_container, 'get', [Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Initializer.class()]))
	}
	rt.call_method(var_container, 'set', [Class_Automattic_WooCommerce_EmailEditor_Bootstrap.class(), rt.new_closure(closure_29_fn)])
	return var_container.dup()
}
...
fn create_automattic_woocommerce_emaileditor_container() &Class_Automattic_WooCommerce_EmailEditor_Container {
...
fn create_automattic_woocommerce_emaileditor_integrations_core_initializer() &Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer {
...
fn create_automattic_woocommerce_emaileditor_integrations_woocommerce_initializer() &Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Initializer {
...
fn create_automattic_woocommerce_emaileditor_engine_settings_controller() &Class_Automattic_WooCommerce_EmailEditor_Engine_Settings_Controller {
...
fn create_automattic_woocommerce_emaileditor_engine_templates_templates() &Class_Automattic_WooCommerce_EmailEditor_Engine_Templates_Templates {
...
fn create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_preprocessors_typography_preprocessor() &Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Preprocessors_Typography_Preprocessor {
...
fn create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_postprocessors_highlighting_postprocessor() &Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Postprocessors_Highlighting_Postprocessor {
...
fn create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_postprocessors_variables_postprocessor() &Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Postprocessors_Variables_Postprocessor {
...
fn create_automattic_woocommerce_emaileditor_engine_assets_manager() &Class_Automattic_WooCommerce_EmailEditor_Engine_Assets_Manager {
...
fn create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_process_manager() &Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Process_Manager {
...
fn create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_content_renderer() &Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Content_Renderer {
...
fn create_automattic_woocommerce_emaileditor_engine_renderer_renderer() &Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_Renderer {
...
fn create_automattic_woocommerce_emaileditor_engine_personalizationtags_personalization_tags_registry() &Class_Automattic_WooCommerce_EmailEditor_Engine_PersonalizationTags_Personalization_Tags_Registry {
...
fn create_automattic_woocommerce_emaileditor_engine_personalizer() &Class_Automattic_WooCommerce_EmailEditor_Engine_Personalizer {
...
fn create_automattic_woocommerce_emaileditor_engine_send_preview_email() &Class_Automattic_WooCommerce_EmailEditor_Engine_Send_Preview_Email {
...
fn create_automattic_woocommerce_emaileditor_engine_email_api_controller() &Class_Automattic_WooCommerce_EmailEditor_Engine_Email_Api_Controller {
...
fn create_automattic_woocommerce_emaileditor_engine_dependency_check() &Class_Automattic_WooCommerce_EmailEditor_Engine_Dependency_Check {
...
fn create_automattic_woocommerce_emaileditor_engine_logger_email_editor_logger() &Class_Automattic_WooCommerce_EmailEditor_Engine_Logger_Email_Editor_Logger {
...
fn create_automattic_woocommerce_emaileditor_engine_email_editor() &Class_Automattic_WooCommerce_EmailEditor_Engine_Email_Editor {
...
fn create_automattic_woocommerce_emaileditor_bootstrap() &Class_Automattic_WooCommerce_EmailEditor_Bootstrap {
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_src_class_email_editor_container_php() {
