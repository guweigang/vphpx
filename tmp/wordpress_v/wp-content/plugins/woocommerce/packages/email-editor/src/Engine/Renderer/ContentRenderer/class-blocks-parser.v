...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Blocks_Parser) parse(var_document rt.PhpVal) rt.PhpVal {
	this.Class_WP_Block_Parser.parse(var_document.dup())
...
fn create_automattic_woocommerce_emaileditor_engine_renderer_contentrenderer_blocks_parser() &Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Blocks_Parser {
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_src_engine_renderer_contentrenderer_class_blocks_parser_php() {
