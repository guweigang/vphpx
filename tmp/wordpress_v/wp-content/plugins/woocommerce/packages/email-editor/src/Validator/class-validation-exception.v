...
fn Class_Automattic_WooCommerce_EmailEditor_Validator_Validation_Exception.create_from_wp_error(mut var_wp_error Class_WP_Error) rt.PhpVal {
	mut var_exception := rt.call_method(fn () rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_EmailEditor_Validator_Validation_Exception{}
		return temp.create()
	}(), 'withMessage', [var_wp_error.get_error_message()])
	rt.set_property(var_exception, 'wp_error', var_wp_error.dup())
	return var_exception.dup()
}
...
fn create_automattic_woocommerce_emaileditor_unexpectedvalueexception() &Class_Automattic_WooCommerce_EmailEditor_UnexpectedValueException {
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_src_validator_class_validation_exception_php() {
