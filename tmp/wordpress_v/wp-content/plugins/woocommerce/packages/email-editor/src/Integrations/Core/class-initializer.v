...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer) adjust_theme_json(mut var_editor_theme_json Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_WP_Theme_JSON) rt.PhpVal {
	mut var_theme_json := // unsupported expression: Expr_Cast_String
	var_theme_json = rt.call_function('json_decode', [var_theme_json.dup(), rt.new_bool(true)])
	var_editor_theme_json.merge(create_automattic_woocommerce_emaileditor_integrations_core_wp_theme_json(var_theme_json.dup(), rt.new_string('default')))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer) allow_styles(mut var_allowed_styles Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_?array) rt.PhpVal {
	...
	if rt.is_true(rt.new_bool(!(rt.is_true(rt.new_bool(var_allowed_styles_mutated.dup().is_array()))))) {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer) update_block_settings(mut var_settings Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_array) rt.PhpVal {
	...
	if rt.is_true(rt.call_function('in_array', [var_settings_mutated.array_get('name'), Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer.allowed_block_types(), rt.new_bool(true)])) {
	...
	if rt.is_true(rt.call_function('in_array', [var_settings_mutated.array_get('name'), Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer.render_only_block_types(), rt.new_bool(true)])) {
		var_settings_mutated.array_set('render_email_callback', rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer', []string{}, &this) }, rt.ArrayItem{ key: none, val: 'render_block' }]))
	}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer) render_block(block_content string, mut var_parsed_block Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_array, mut var_rendering_context Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context) string {
	if var_parsed_block.array_isset(rt.new_string('blockName')) {
		mut var_block_renderer := this.get_block_renderer((var_parsed_block.array_get('blockName')).str())
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Initializer) get_block_renderer(block_name string) rt.PhpVal {
	if this.renderers.array_isset(rt.new_string(block_name)) {
		return this.renderers.array_get(block_name)
	}
	...
	this.renderers.array_set(block_name, var_renderer.dup())
	return var_renderer.dup()
}
...
fn create_automattic_woocommerce_emaileditor_integrations_core_wp_theme_json() &Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_WP_Theme_JSON {
...
fn create_automattic_woocommerce_emaileditor_integrations_core_renderer_blocks_list_item() &Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Renderer_Blocks_List_Item {
...
fn create_automattic_woocommerce_emaileditor_integrations_core_renderer_blocks_buttons() &Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Renderer_Blocks_Buttons {
...
fn create_automattic_woocommerce_emaileditor_integrations_core_renderer_blocks_quote() &Class_Automattic_WooCommerce_EmailEditor_Integrations_Core_Renderer_Blocks_Quote {
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_src_integrations_core_class_initializer_php() {
