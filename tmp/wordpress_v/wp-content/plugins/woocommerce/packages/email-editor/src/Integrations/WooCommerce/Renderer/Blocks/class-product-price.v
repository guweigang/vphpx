...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_Product_Price) render_content(block_content string, mut var_parsed_block Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_array, mut var_rendering_context Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context) string {
	mut var_product := this.get_product_from_context(rt.new_object('Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_array', []string{}, var_parsed_block))
	if rt.is_true(rt.new_bool(!(rt.is_true(var_product)))) {
		return ''
	}
	mut var_attributes := if !(var_parsed_block.array_get('attrs')).is_null() { var_parsed_block.array_get('attrs') } else { rt.new_array() }
	mut var_price_content := rt.new_string(this.generate_price_html(mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product](var_product), mut rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_array](var_attributes), mut var_rendering_context))
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_Product_Price) generate_price_html(mut var_product Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product, mut var_attributes Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_array, mut var_rendering_context Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context) string {
	...
	mut var_price_styles := rt.create_array([rt.ArrayItem{ key: 'display', val: 'block' }, rt.ArrayItem{ key: 'margin', val: '0' }, rt.ArrayItem{ key: 'padding', val: '0' }, rt.ArrayItem{ key: 'font-family', val: 'inherit' }, rt.ArrayItem{ key: 'color', val: 'inherit' }, rt.ArrayItem{ key: 'text-decoration', val: 'none' }])
	mut var_custom_styles := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditor_Integrations_Utils_Styles_Helper{}; return temp.get_block_styles(arg_0, arg_1, arg_2) }(rt.new_object('Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_array', []string{}, var_attributes_mutated), rt.new_object('Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context', []string{}, var_rendering_context), rt.create_array([rt.ArrayItem{ key: none, val: 'border' }, rt.ArrayItem{ key: none, val: 'background-color' }, rt.ArrayItem{ key: none, val: 'color' }, rt.ArrayItem{ key: none, val: 'typography' }, rt.ArrayItem{ key: none, val: 'spacing' }]))
	var_price_styles = rt.call_function('array_merge', [var_price_styles.dup(), var_custom_styles.array_get('declarations')])
	mut var_style_attr := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WP_Style_Engine{}; return temp.compile_css(arg_0, arg_1) }(var_price_styles.dup(), rt.new_string(''))
	return (rt.call_function('sprintf', [rt.new_string('<div class="wc-block-components-product-price" style="%s">%s</div>'), rt.call_function('esc_attr', [var_style_attr.dup()]), var_price_html.dup()])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_Product_Price) build_price_from_scratch(mut var_product Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product) string {
	...
	if rt.is_true(rt.equal(switch_val_1, rt.new_string('simple'))) || rt.is_true(rt.equal(switch_val_1, rt.new_string('external'))) {
		...
		if rt.is_true(rt.new_bool(rt.instance_of(var_product_mutated, 'Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product_Variable'))) {
		...
		if rt.is_true(rt.new_bool(rt.instance_of(var_product_mutated, 'Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product_Grouped'))) {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_Product_Price) build_simple_product_price(mut var_product Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product) string {
	mut var_product_mutated := var_product
	mut var_regular_price := rt.call_function('wc_get_price_to_display', [var_product_mutated.dup(), rt.create_array([rt.ArrayItem{ key: 'price', val: // unsupported expression: Expr_Cast_Double }])])
	mut var_sale_price := if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) { rt.call_function('wc_get_price_to_display', [var_product_mutated.dup(), rt.create_array([rt.ArrayItem{ key: 'price', val: // unsupported expression: Expr_Cast_Double }])]) } else { rt.new_string('') }
	...
	if rt.is_true(rt.new_bool(rt.is_true(rt.call_method(var_product_mutated, 'is_on_sale', []rt.PhpVal{})) && rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) {
		return (rt.call_function('sprintf', [rt.new_string('<del style="text-decoration: line-through; font-size: 0.9em; margin-right: 0.5em;">%s</del><span>%s</span>'), rt.call_function('wc_price', [var_regular_price.dup(), rt.create_array([rt.ArrayItem{ key: 'in_span', val: false }])]), rt.call_function('wc_price', [var_sale_price.dup(), rt.create_array([rt.ArrayItem{ key: 'in_span', val: false }])])])).str()
	} else {
		return (rt.call_function('sprintf', [rt.new_string('<span>%s</span>'), rt.call_function('wc_price', [var_regular_price.dup(), rt.create_array([rt.ArrayItem{ key: 'in_span', val: false }])])])).str()
	}
	return ''
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_Product_Price) build_variable_product_price(mut var_product Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product_Variable) string {
	mut var_product_mutated := var_product
	mut var_min_price := rt.call_method(var_product_mutated, 'get_variation_price', [rt.new_string('min'), rt.new_bool(true)])
	mut var_max_price := rt.call_method(var_product_mutated, 'get_variation_price', [rt.new_string('max'), rt.new_bool(true)])
	return (rt.call_function('sprintf', [rt.new_string('<span>%s — %s</span>'), rt.call_function('wc_price', [// unsupported expression: Expr_Cast_Double, rt.create_array([rt.ArrayItem{ key: 'in_span', val: false }])]), rt.call_function('wc_price', [// unsupported expression: Expr_Cast_Double, rt.create_array([rt.ArrayItem{ key: 'in_span', val: false }])])])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_Product_Price) build_grouped_product_price(mut var_product Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product_Grouped) string {
	...
	mut var_prices := rt.new_array()
	{
		...
		for {
			...
			if rt.is_true(rt.new_bool(rt.is_true(var_child) && rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical))) {
				var_prices.array_push(rt.call_function('wc_get_price_to_display', [var_child.dup(), rt.create_array([rt.ArrayItem{ key: 'price', val: // unsupported expression: Expr_Cast_Double }])]))
			}
		}
	}
	...
	mut var_min_price := rt.call_function('min', [var_prices.dup()])
	mut var_max_price := rt.call_function('max', [var_prices.dup()])
	return (rt.call_function('sprintf', [rt.new_string('<span>%s — %s</span>'), rt.call_function('wc_price', [// unsupported expression: Expr_Cast_Double, rt.create_array([rt.ArrayItem{ key: 'in_span', val: false }])]), rt.call_function('wc_price', [// unsupported expression: Expr_Cast_Double, rt.create_array([rt.ArrayItem{ key: 'in_span', val: false }])])])).str()
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_Product_Price) apply_email_wrapper(price_html string, mut var_parsed_block Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_array) string {
	...
	mut var_align := if !(var_parsed_block.array_get('attrs').array_get('textAlign')).is_null() { var_parsed_block.array_get('attrs').array_get('textAlign') } else { rt.new_string('left') }
	mut var_wrapper_styles := rt.create_array([rt.ArrayItem{ key: 'border-collapse', val: 'collapse' }, rt.ArrayItem{ key: 'width', val: '100%' }])
	mut var_cell_styles := rt.create_array([rt.ArrayItem{ key: 'padding', val: '5px 0' }, rt.ArrayItem{ key: 'text-align', val: var_align }, rt.ArrayItem{ key: 'font-family', val: 'inherit' }])
	mut var_table_attrs := rt.create_array([rt.ArrayItem{ key: 'style', val: fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WP_Style_Engine{}; return temp.compile_css(arg_0, arg_1) }(var_wrapper_styles.dup(), rt.new_string('')) }, rt.ArrayItem{ key: 'width', val: '100%' }])
	mut var_cell_attrs := rt.create_array([rt.ArrayItem{ key: 'class', val: 'email-product-price-cell' }, rt.ArrayItem{ key: 'style', val: fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WP_Style_Engine{}; return temp.compile_css(arg_0, arg_1) }(var_cell_styles.dup(), rt.new_string('')) }, rt.ArrayItem{ key: 'align', val: var_align }])
	return (fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditor_Integrations_Utils_Table_Wrapper_Helper{}; return temp.render_table_wrapper(arg_0, arg_1, arg_2) }(rt.new_string(price_html_mutated), var_table_attrs.dup(), var_cell_attrs.dup())).str()
}
...
fn create_automattic_woocommerce_emaileditor_integrations_woocommerce_renderer_blocks_product_price() &Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_Product_Price {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_Product_Price) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'generate_price_html' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_array](if args.len > 1 { args[1] } else { rt.new_null() })
			mut dispatch_arg_2 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Engine_Renderer_ContentRenderer_Rendering_Context](if args.len > 2 { args[2] } else { rt.new_null() })
			return rt.new_string(this.generate_price_html(mut dispatch_arg_0, mut dispatch_arg_1, mut dispatch_arg_2))
		}
		...
		'build_variable_product_price' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product_Variable](if args.len > 0 { args[0] } else { rt.new_null() })
			return rt.new_string(this.build_variable_product_price(mut dispatch_arg_0))
		}
		'build_grouped_product_price' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditor_Integrations_WooCommerce_Renderer_Blocks_WC_Product_Grouped](if args.len > 0 { args[0] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_src_integrations_woocommerce_renderer_blocks_class_product_price_php() {
