...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_Tokenizer) construct() {
	...
	mut var_escaping :=
		create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_tokenizer_tokenizerescaping(var_patterns.dup())
	this.handlers = rt.create_array([
		...
		rt.ArrayItem{ key: none, val: create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_identifierhandler(var_patterns.dup(),
			var_escaping.dup()) },
		rt.ArrayItem{ key: none, val: create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_hashhandler(var_patterns.dup(),
			var_escaping.dup()) },
		rt.ArrayItem{ key: none, val: create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_stringhandler(var_patterns.dup(),
			var_escaping.dup()) },
		rt.ArrayItem{
			key: none
			val: create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_numberhandler(var_patterns.dup())
		},
		rt.ArrayItem{
			key: none
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_tokenizer_tokenizerpatterns() &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_tokenizer_tokenizerescaping() &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerEscaping {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_whitespacehandler() &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Handler_WhitespaceHandler {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_identifierhandler() &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Handler_IdentifierHandler {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_hashhandler() &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Handler_HashHandler {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_stringhandler() &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Handler_StringHandler {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_numberhandler() &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Handler_NumberHandler {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_parser_handler_commenthandler() &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Handler_CommentHandler {
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_symfony_component_cssselector_parser_tokenizer_tokenizer_php() {
}
