...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_SelectorNode) construct(mut var_tree Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_NodeInterface, mut var_pseudoElement Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_?string)  {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_SelectorNode) gettree() rt.PhpVal {
	return this.tree
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_SelectorNode) getpseudoelement() string {
	return (this.pseudoElement).str()
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_SelectorNode) getspecificity() rt.PhpVal {
	return rt.call_method(rt.call_method(this.tree, 'getSpecificity', []rt.PhpVal{}), 'plus', [create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_specificity(rt.new_int(0), rt.new_int(0), if rt.is_true(this.pseudoElement) { rt.new_int(1) } else { rt.new_int(0) })])
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_SelectorNode) magic_tostring() string {
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_selectornode(arg_0 rt.PhpVal, arg_1 rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_SelectorNode {
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_symfony_component_cssselector_node_selectornode_php() {
}
