...
struct Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName {
	rt.PhpObjectBase
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName) construct(mut var_aComponents Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_array, iLineNo i64) {
	this.Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_ValueList.construct(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_array',
		[]string{}, var_aComponents), rt.new_string(' '), rt.new_int(iLineNo))
}

fn Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName.parse(mut var_oParserState Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) rt.PhpVal {
	...
	var_oParserState.consume(rt.new_string(']'))
	return create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_linename(var_aNames.dup(),
		var_oParserState.currentline())
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName) magic_tostring() rt.PhpVal {
	return rt.new_string(this.render(create_automattic_woocommerce_emaileditorvendor_sabberworm_css_outputformat()))
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName) render(var_oOutputFormat rt.PhpVal) string {
	return '[' + (this.Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_ValueList.render(fn () rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_OutputFormat{}
		return temp.createcompact()
	}())).str() + ']'
}
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_linename(arg_0 rt.PhpVal, iLineNo i64) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName {
	mut obj := &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName{
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
		...
		'parse' {
			...
			return Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName.parse(mut dispatch_arg_0)
		}
		'__toString' {
...
fn (this &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_LineName) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_sabberworm_css_value_linename_php() {
}
