...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns) construct() {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns) getnewlineescapepattern() string {
	return '~' + this.newLineEscapePattern + '~'
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns) getsimpleescapepattern() string {
	return '~' + this.simpleEscapePattern + '~'
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns) getunicodeescapepattern() string {
	return '~' + this.unicodeEscapePattern + '~i'
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns) getidentifierpattern() string {
	return '~^' + (this.identifierPattern).str() + '~i'
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns) gethashpattern() string {
	return '~^' + (this.hashPattern).str() + '~i'
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns) getnumberpattern() string {
	return '~^' + this.numberPattern + '~'
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns) getquotedstringpattern(quote string) string {
	return '~^' +
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_symfony_component_cssselector_parser_tokenizer_tokenizerpatterns_php() {
}
