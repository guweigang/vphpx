...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_AttributeMatchingExtension) translateequals(mut var_xpath Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_XPathExpr, attribute string, mut var_value Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string) rt.PhpVal {
	return var_xpath.addcondition(rt.call_function('sprintf', [rt.new_string('%s = %s'), rt.new_string(attribute), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string', []string{}, var_value))]))
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_AttributeMatchingExtension) translateincludes(mut var_xpath Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_XPathExpr, attribute string, mut var_value Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string) rt.PhpVal {
	return var_xpath.addcondition(if rt.is_true(var_value) { rt.call_function('sprintf', [rt.new_string('%1$s and contains(concat(\' \', normalize-space(%1$s), \' \'), %2$s)'), rt.new_string(attribute), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.new_string(' ' + (var_value).str() + ' '))]) } else { rt.new_string('0') })
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_AttributeMatchingExtension) translatedashmatch(mut var_xpath Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_XPathExpr, attribute string, mut var_value Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string) rt.PhpVal {
	return var_xpath.addcondition(rt.call_function('sprintf', [rt.new_string('%1$s and (%1$s = %2$s or starts-with(%1$s, %3$s))'), rt.new_string(attribute), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string', []string{}, var_value)), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.new_string((var_value).str() + '-'))]))
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_AttributeMatchingExtension) translateprefixmatch(mut var_xpath Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_XPathExpr, attribute string, mut var_value Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string) rt.PhpVal {
	return var_xpath.addcondition(if rt.is_true(var_value) { rt.call_function('sprintf', [rt.new_string('%1$s and starts-with(%1$s, %2$s)'), rt.new_string(attribute), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string', []string{}, var_value))]) } else { rt.new_string('0') })
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_AttributeMatchingExtension) translatesuffixmatch(mut var_xpath Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_XPathExpr, attribute string, mut var_value Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string) rt.PhpVal {
	return var_xpath.addcondition(if rt.is_true(var_value) { rt.call_function('sprintf', [rt.new_string('%1$s and substring(%1$s, string-length(%1$s)-%2$s) = %3$s'), rt.new_string(attribute), var_value.to_string().len - 1, fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string', []string{}, var_value))]) } else { rt.new_string('0') })
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_AttributeMatchingExtension) translatesubstringmatch(mut var_xpath Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_XPathExpr, attribute string, mut var_value Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string) rt.PhpVal {
	return var_xpath.addcondition(if rt.is_true(var_value) { rt.call_function('sprintf', [rt.new_string('%1$s and contains(%1$s, %2$s)'), rt.new_string(attribute), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string', []string{}, var_value))]) } else { rt.new_string('0') })
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_AttributeMatchingExtension) translatedifferent(mut var_xpath Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_XPathExpr, attribute string, mut var_value Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string) rt.PhpVal {
	return var_xpath.addcondition(rt.call_function('sprintf', [if rt.is_true(var_value) { rt.new_string('not(%1$s) or %1$s != %2$s') } else { rt.new_string('%s != %s') }, rt.new_string(attribute), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Translator{}; return temp.getxpathliteral(arg_0) }(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_XPath_Extension_?string', []string{}, var_value))]))
}
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_symfony_component_cssselector_xpath_extension_attributematchingextension_php() {
}
