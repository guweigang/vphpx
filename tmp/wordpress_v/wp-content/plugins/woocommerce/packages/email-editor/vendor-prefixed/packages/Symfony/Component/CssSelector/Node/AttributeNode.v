...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) construct(mut var_selector Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_NodeInterface, mut var_namespace Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_?string, attribute string, operator string, mut var_value Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_?string)  {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) getselector() rt.PhpVal {
	return this.selector
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) getnamespace() string {
	return (this.namespace).str()
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) getattribute() string {
	return this.attribute
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) getoperator() string {
	return this.operator
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) getvalue() string {
	return (this.value).str()
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) getspecificity() rt.PhpVal {
	return rt.call_method(rt.call_method(this.selector, 'getSpecificity', []rt.PhpVal{}), 'plus', [create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_specificity(rt.new_int(0), rt.new_int(1), rt.new_int(0))])
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) magic_tostring() string {
	mut var_attribute := rt.new_string(if rt.is_true(this.namespace) { (this.namespace).str() + '|' + this.attribute } else { this.attribute })
	return (if rt.is_true(rt.identical(rt.new_string('exists'), this.operator)) { rt.call_function('sprintf', [rt.new_string('%s[%s[%s]]'), this.getnodename(), this.selector, var_attribute.dup()]) } else { rt.call_function('sprintf', [rt.new_string('%s[%s[%s %s \'%s\']]'), this.getnodename(), this.selector, var_attribute.dup(), this.operator, this.value]) }).str()
}
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_attributenode(arg_0 rt.PhpVal, arg_1 rt.PhpVal, attribute string, operator string, arg_4 rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_AttributeNode) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			...
			mut dispatch_arg_4 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_?string](if args.len > 4 { args[4] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_symfony_component_cssselector_node_attributenode_php() {
}
