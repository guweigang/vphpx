...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Property_Charset) setcharset(var_sCharset rt.PhpVal) {
		...
		'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_CSSString')))
	{
		...
		create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_cssstring(var_sCharset_mutated.dup())
	}
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_sabberworm_css_property_charset_php() {
}
