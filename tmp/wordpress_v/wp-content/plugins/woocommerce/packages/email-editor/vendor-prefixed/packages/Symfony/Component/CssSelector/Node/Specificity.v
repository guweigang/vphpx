...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_Specificity) plus(mut var_specificity Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_self) rt.PhpVal {
	return create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_self(rt.add(this.a, rt.get_property(var_specificity, 'a')), rt.add(this.b, rt.get_property(var_specificity, 'b')), rt.add(this.c, rt.get_property(var_specificity, 'c')))
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_Specificity) getvalue() i64 {
	return (rt.add(rt.add(rt.mul(this.a, Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_Specificity.a_factor()), rt.mul(this.b, Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_Specificity.b_factor())), rt.mul(this.c, Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_Specificity.c_factor()))).to_i64()
}
...
fn create_automattic_woocommerce_emaileditorvendor_symfony_component_cssselector_node_self() &Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_self {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_Specificity) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'plus' {
			mut dispatch_arg_0 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Symfony_Component_CssSelector_Node_self](if args.len > 0 { args[0] } else { rt.new_null() })
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_symfony_component_cssselector_node_specificity_php() {
}
