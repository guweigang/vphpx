...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_CalcRuleValueList) construct(iLineNo i64) {
	this.Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_RuleValueList.construct(rt.new_string(','),
		rt.new_int(iLineNo))
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_CalcRuleValueList) render(var_oOutputFormat rt.PhpVal) rt.PhpVal {
	return rt.call_method(var_oOutputFormat, 'implode', [rt.new_string(' '),
		rt.get_property(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_CalcRuleValueList', [
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_value_calcrulevaluelist(iLineNo i64) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Value_CalcRuleValueList {
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_sabberworm_css_value_calcrulevaluelist_php() {
}
