...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parser) construct(var_sText rt.PhpVal, var_oParserSettings rt.PhpVal, iLineNo i64) {
	...
	if rt.is_true(rt.identical(var_oParserSettings_mutated, rt.new_null())) {
		var_oParserSettings_mutated = fn () rt.PhpVal {
			mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Settings{}
			return temp.create()
		}()
	}
	this.oParserState = create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_parserstate(var_sText.dup(),
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parser) parse() rt.PhpVal {
	return fn (arg_0 rt.PhpVal) rt.PhpVal {
		mut temp := Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_CSSList_Document{}
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_sabberworm_css_parser_php() {
}
