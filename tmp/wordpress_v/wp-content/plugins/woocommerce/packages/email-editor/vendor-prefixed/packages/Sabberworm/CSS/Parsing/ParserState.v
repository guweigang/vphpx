...
pub fn Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState.eof() rt.PhpVal {
	return none
}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) construct(var_sText rt.PhpVal, mut var_oParserSettings Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Settings, iLineNo i64)  {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) setcharset(var_sCharset rt.PhpVal)  {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) getcharset() rt.PhpVal {
	return this.sCharset
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) currentline() rt.PhpVal {
	return this.iLineNo
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) currentcolumn() rt.PhpVal {
	return this.iCurrentPosition
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) getsettings() rt.PhpVal {
	return this.oParserSettings
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) anchor() rt.PhpVal {
	return create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_anchor(this.iCurrentPosition, rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState', []string{}, &this).dup())
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) setposition(var_iPosition rt.PhpVal)  {
	this.iCurrentPosition = var_iPosition.dup()
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) parseidentifier(bIgnoreCase bool) rt.PhpVal {
	if rt.is_true(this.isend()) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException', []string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedeofexception(rt.new_string(''), rt.new_string(''), rt.new_string('identifier'), this.iLineNo)))
	}
	mut var_sResult := this.parsecharacter(rt.new_bool(true))
	if rt.is_true(rt.identical(var_sResult, rt.new_null())) {
		rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedTokenException', []string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedtokenexception(var_sResult.dup(), this.peek(5, 0), rt.new_string('identifier'), this.iLineNo)))
	}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) parsecharacter(var_bIsForIdentifier rt.PhpVal) rt.PhpVal {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) consumewhitespace() rt.PhpVal {
...
catch_label_1:
			...
			if rt.instance_of(var_e_1, 'Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException') {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) comes(var_sString rt.PhpVal, bCaseInsensitive bool) rt.PhpVal {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) peek(iLength i64, iOffset i64) string {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) consume(mValue i64) rt.PhpVal {
	if rt.is_true(rt.new_bool(rt.new_int(mValue).is_string())) {
		...
		if rt.is_true(rt.greater(rt.add(this.iCurrentPosition, rt.new_int(mValue)), this.iLength)) {
			rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException', []string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedeofexception(rt.new_int(mValue).dup(), this.peek(5, 0), rt.new_string('count'), this.iLineNo)))
		}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) consumeexpression(var_mExpression rt.PhpVal, var_iMaxLength rt.PhpVal) rt.PhpVal {
	...
	rt.throw_exception(rt.new_object('Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedTokenException', []string{}, create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedtokenexception(var_mExpression.dup(), this.peek(5, 0), rt.new_string('expression'), this.iLineNo)))
	return rt.new_null()
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) consumecomment() rt.PhpVal {
	...
	if rt.is_true(// unsupported expression: Expr_BinaryOp_NotIdentical) {
		return create_automattic_woocommerce_emaileditorvendor_sabberworm_css_comment_comment(rt.call_function('substr', [var_mComment.dup(), rt.new_int(1)]), var_iLineNo.dup())
	}
	return var_mComment.dup()
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) isend() rt.PhpVal {
	return rt.greater_equal(this.iCurrentPosition, this.iLength)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) consumeuntil(var_aEnd rt.PhpVal, bIncludeEnd bool, consumeEnd bool, mut var_comments Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_array) rt.PhpVal {
	...
	if rt.is_true(rt.call_function('in_array', [Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState.eof(), var_aEnd_mutated.dup()])) {
		return var_out.dup()
	}
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) inputleft() rt.PhpVal {
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) streql(var_sString1 rt.PhpVal, var_sString2 rt.PhpVal, bCaseInsensitive bool) rt.PhpVal {
	return rt.new_null()
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) backtrack(var_iAmount rt.PhpVal)  {
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) strlen(var_sString rt.PhpVal) i64 {
	return i64(0)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) substr(var_iStart rt.PhpVal, var_iLength rt.PhpVal) rt.PhpVal {
	mut var_iStart_mutated := var_iStart
	mut var_iLength_mutated := var_iLength
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) strtolower(var_sString rt.PhpVal) string {
	return ''
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) strsplit(var_sString rt.PhpVal) rt.PhpVal {
	return rt.new_null()
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) strpos(var_sString rt.PhpVal, var_sNeedle rt.PhpVal, var_iOffset rt.PhpVal) rt.PhpVal {
	return rt.new_null()
}
...
struct Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException {
	rt.PhpObjectBase
}
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_parserstate(arg_0 rt.PhpVal, iLineNo i64, arg_2 rt.PhpVal) &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState {
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_anchor() &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_Anchor {
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_parsing_unexpectedeofexception() &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException {
	mut obj := &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException{
		PhpObjectBase: rt.PhpObjectBase{}
	}
	return obj
}
...
fn create_automattic_woocommerce_emaileditorvendor_sabberworm_css_comment_comment() &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Comment_Comment {
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_ParserState) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			...
			mut dispatch_arg_1 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Settings](if args.len > 1 { args[1] } else { rt.new_null() })
		...
		'consumeUntil' {
			...
			mut dispatch_arg_3 := rt.cast_object_ptr[Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_array](if args.len > 3 { args[3] } else { rt.new_null() })
...
fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	return none
}

fn (this &Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	return this.PhpObjectBase.dispatch_get_prop(prop_name)
}

fn (mut this Class_Automattic_WooCommerce_EmailEditorVendor_Sabberworm_CSS_Parsing_UnexpectedEOFException) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	return this.PhpObjectBase.dispatch_set_prop(prop_name, val)
}
...
pub fn init_wp_content_plugins_woocommerce_packages_email_editor_vendor_prefixed_packages_sabberworm_css_parsing_parserstate_php() {
}
