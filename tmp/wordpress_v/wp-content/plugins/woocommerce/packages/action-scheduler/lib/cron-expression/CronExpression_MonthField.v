...
fn (mut this Class_CronExpression_MonthField) issatisfiedby(mut var_date Class_DateTime, var_value rt.PhpVal) rt.PhpVal {
	...
	return this.issatisfied(var_date.format(rt.new_string('m')), var_value_mutated.dup())
}
...
fn (mut this Class_CronExpression_MonthField) validate(var_value rt.PhpVal) rt.PhpVal {
	mut var_value_mutated := var_value
	return
}
...
fn create_cronexpression_monthfield() &Class_CronExpression_MonthField {
...
pub fn init_wp_content_plugins_woocommerce_packages_action_scheduler_lib_cron_expression_cronexpression_monthfield_php() {
}
