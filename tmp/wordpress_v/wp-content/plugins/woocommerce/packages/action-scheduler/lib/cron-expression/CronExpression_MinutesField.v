...
fn (mut this Class_CronExpression_MinutesField) issatisfiedby(mut var_date Class_DateTime, var_value rt.PhpVal) rt.PhpVal {
	return this.issatisfied(var_date.format(rt.new_string('i')), var_value.dup())
}
...
fn (mut this Class_CronExpression_MinutesField) validate(var_value rt.PhpVal) rt.PhpVal {
	return
}
...
fn create_cronexpression_minutesfield() &Class_CronExpression_MinutesField {
...
pub fn init_wp_content_plugins_woocommerce_packages_action_scheduler_lib_cron_expression_cronexpression_minutesfield_php() {
}
