...
fn (mut this Class_ActionScheduler_FatalErrorMonitor) handle_unexpected_shutdown() {
	...
	if rt.is_true(var_error) {
		if rt.is_true(rt.call_function('in_array', [var_error.array_get('type'),
...
pub fn init_wp_content_plugins_woocommerce_packages_action_scheduler_classes_actionscheduler_fatalerrormonitor_php() {
}
