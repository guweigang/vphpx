...
fn (mut this Class_ActionScheduler_CanceledAction) construct(var_hook rt.PhpVal, mut var_args Class_array, mut var_schedule Class_?ActionScheduler_Schedule, group string)  {
	this.Class_ActionScheduler_FinishedAction.construct(var_hook.dup(), rt.new_object('array', []string{}, var_args), rt.new_object('?ActionScheduler_Schedule', []string{}, var_schedule), rt.new_string(group))
...
fn create_actionscheduler_finishedaction() &Class_ActionScheduler_FinishedAction {
...
pub fn init_wp_content_plugins_woocommerce_packages_action_scheduler_classes_actions_actionscheduler_canceledaction_php() {
}
