...
fn (mut this Class_ActionScheduler_RecurringActionScheduler) init() {
	rt.call_function('add_action', [
		Class_ActionScheduler_RecurringActionScheduler.run_scheduled_recurring_actions_hook(),
		rt.create_array([
	...
	if rt.is_true(rt.new_bool(rt.is_true(rt.call_function('is_admin', []rt.PhpVal{}))
		&& rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(!(rt.is_true(rt.call_function('defined', [rt.new_string('DOING_AJAX')])))))
...
pub fn init_wp_content_plugins_woocommerce_packages_action_scheduler_classes_actionscheduler_recurringactionscheduler_php() {
}
