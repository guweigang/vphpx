...
fn (mut this Class_Automattic_WooCommerce_Blueprint_BuiltInStepProcessors) create_install_plugins_processor() rt.PhpVal {
	...
	return create_automattic_woocommerce_blueprint_importers_importinstallplugin(var_storages.dup())
}
...
fn (mut this Class_Automattic_WooCommerce_Blueprint_BuiltInStepProcessors) create_install_themes_processor() rt.PhpVal {
	...
	return create_automattic_woocommerce_blueprint_importers_importinstalltheme(var_storage.dup())
}
...
fn create_automattic_woocommerce_blueprint_importers_importactivatetheme() &Class_Automattic_WooCommerce_Blueprint_Importers_ImportActivateTheme {
...
fn create_automattic_woocommerce_blueprint_resourcestorages() &Class_Automattic_WooCommerce_Blueprint_ResourceStorages {
...
fn create_automattic_woocommerce_blueprint_importers_importinstallplugin() &Class_Automattic_WooCommerce_Blueprint_Importers_ImportInstallPlugin {
...
fn create_automattic_woocommerce_blueprint_importers_importinstalltheme() &Class_Automattic_WooCommerce_Blueprint_Importers_ImportInstallTheme {
...
pub fn init_wp_content_plugins_woocommerce_packages_blueprint_src_builtinstepprocessors_php() {
}
