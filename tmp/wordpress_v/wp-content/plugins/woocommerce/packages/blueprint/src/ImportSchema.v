...
fn Class_Automattic_WooCommerce_Blueprint_ImportSchema.create_from_file(var_file rt.PhpVal) rt.PhpVal {
	return Class_Automattic_WooCommerce_Blueprint_ImportSchema.create_from_json(var_file.dup())
}

fn Class_Automattic_WooCommerce_Blueprint_ImportSchema.create_from_json(var_json_path rt.PhpVal) rt.PhpVal {
	return create_automattic_woocommerce_blueprint_self(create_automattic_woocommerce_blueprint_schemas_jsonschema(var_json_path.dup()))
}

fn (mut this Class_Automattic_WooCommerce_Blueprint_ImportSchema) import() rt.PhpVal {
	mut var_results := rt.new_array()
	mut var_result := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_Automattic_WooCommerce_Blueprint_StepProcessorResult{}; return temp.success(arg_0) }(rt.new_string('ImportSchema'))
	var_results.array_push(var_result.dup())
	{
		...
		for {
			...
			mut var_step_importer := create_automattic_woocommerce_blueprint_importstep(var_step_schema.dup(), this.validator)
...
fn create_automattic_woocommerce_blueprint_self() &Class_Automattic_WooCommerce_Blueprint_self {
...
fn create_automattic_woocommerce_blueprint_schemas_jsonschema() &Class_Automattic_WooCommerce_Blueprint_Schemas_JsonSchema {
...
pub fn init_wp_content_plugins_woocommerce_packages_blueprint_src_importschema_php() {
}
