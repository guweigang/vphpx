...
fn (mut this Class_Automattic_WooCommerce_Blueprint_Steps_InstallPlugin) construct(var_slug rt.PhpVal, var_resource rt.PhpVal, mut var_options Class_Automattic_WooCommerce_Blueprint_Steps_array) {
	this.slug = var_slug.dup()
	this.resource = var_resource.dup()
	this.options = var_options.dup()
}

fn (mut this Class_Automattic_WooCommerce_Blueprint_Steps_InstallPlugin) prepare_json_array() rt.PhpVal {
	return rt.create_array([
		rt.ArrayItem{
			key: 'step'
			val: Class_Automattic_WooCommerce_Blueprint_Steps_InstallPlugin.get_step_name()
		},
		rt.ArrayItem{ key: 'pluginData', val: rt.create_array([
...
fn Class_Automattic_WooCommerce_Blueprint_Steps_InstallPlugin.get_schema(version i64) rt.PhpVal {
	return rt.create_array([rt.ArrayItem{ key: 'type', val: 'object' },
		rt.ArrayItem{ key: 'properties', val: rt.create_array([
			...
			rt.ArrayItem{ key: none, val: 'pluginData' },
		]) }])
}

fn Class_Automattic_WooCommerce_Blueprint_Steps_InstallPlugin.get_step_name() string {
...
fn create_automattic_woocommerce_blueprint_steps_installplugin(arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) &Class_Automattic_WooCommerce_Blueprint_Steps_InstallPlugin {
...
fn (mut this Class_Automattic_WooCommerce_Blueprint_Steps_InstallPlugin) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		...
		'get_schema' {
			...
			return Class_Automattic_WooCommerce_Blueprint_Steps_InstallPlugin.get_schema(dispatch_arg_0)
		}
		'get_step_name' {
			return rt.new_string(Class_Automattic_WooCommerce_Blueprint_Steps_InstallPlugin.get_step_name())
		}
		else {
			return none
		}
...
pub fn init_wp_content_plugins_woocommerce_packages_blueprint_src_steps_installplugin_php() {
}
