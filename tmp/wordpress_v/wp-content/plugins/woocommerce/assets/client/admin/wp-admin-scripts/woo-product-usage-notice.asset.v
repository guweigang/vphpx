...
pub fn init_wp_content_plugins_woocommerce_assets_client_admin_wp_admin_scripts_woo_product_usage_notice_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: '44dec6e33204dfe949d3' },
	])
}
