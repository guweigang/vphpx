...
pub fn init_wp_content_plugins_woocommerce_assets_client_admin_wp_admin_scripts_product_category_metabox_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'b3da88fa18a90b9fe1c8' },
	])
}
