...
pub fn init_wp_content_plugins_woocommerce_assets_client_admin_wp_admin_scripts_email_editor_integration_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'a124b8ed137475a5af8f' },
	])
}
