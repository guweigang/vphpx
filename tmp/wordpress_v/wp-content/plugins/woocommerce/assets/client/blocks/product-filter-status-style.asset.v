...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_product_filter_status_style_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'f794382521d4c33dec1d' },
	])
}
