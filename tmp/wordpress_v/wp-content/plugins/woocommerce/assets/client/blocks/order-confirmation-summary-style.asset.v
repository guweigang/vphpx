...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_order_confirmation_summary_style_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: '0e6ae4b73ed4f1b426fd' },
	])
}
