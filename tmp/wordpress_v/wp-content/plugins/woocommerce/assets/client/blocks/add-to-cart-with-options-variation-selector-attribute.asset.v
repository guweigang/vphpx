...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_add_to_cart_with_options_variation_selector_attribute_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'cc121c3e771c7955db62' },
	])
}
