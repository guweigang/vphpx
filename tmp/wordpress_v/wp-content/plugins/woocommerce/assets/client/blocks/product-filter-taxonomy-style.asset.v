...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_product_filter_taxonomy_style_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: '76832d4e4e99fc90cd05' },
	])
}
