...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_add_to_cart_with_options_grouped_product_item_style_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'fe919330bcd21be8ce68' },
	])
}
