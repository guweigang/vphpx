...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_order_confirmation_totals_wrapper_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'c9b8d5d6bdbefe98d0a5' },
	])
}
