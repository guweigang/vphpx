...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_product_filter_removable_chips_style_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: '12f13385b1511685bf66' },
	])
}
