...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_product_filter_attribute_style_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: '752903a34fd7b9a5fed6' },
	])
}
