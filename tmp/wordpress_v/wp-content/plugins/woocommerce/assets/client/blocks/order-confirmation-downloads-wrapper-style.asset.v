...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_order_confirmation_downloads_wrapper_style_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'dfda7d3cbe031526bd4e' },
	])
}
