...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_order_confirmation_billing_wrapper_style_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'f3d0ca8b10f2bb44ce9f' },
	])
}
