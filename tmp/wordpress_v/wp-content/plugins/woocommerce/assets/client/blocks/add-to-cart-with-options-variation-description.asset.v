...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_add_to_cart_with_options_variation_description_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'f87bd4253a4bbdc4e350' },
	])
}
