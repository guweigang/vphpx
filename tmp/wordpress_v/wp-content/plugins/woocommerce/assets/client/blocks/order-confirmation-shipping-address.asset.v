...
pub fn init_wp_content_plugins_woocommerce_assets_client_blocks_order_confirmation_shipping_address_asset_php() {
	return rt.create_array([
		...
		rt.ArrayItem{ key: 'version', val: 'abab17f70b5fbfcf920e' },
	])
}
