...
pub fn init_wp_content_plugins_woocommerce_patterns_footer_large_php() {
	// unsupported statement: Stmt_Nop
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('esc_html_e', [rt.new_string('Join the community'),
		rt.new_string('woocommerce')])
	// unsupported statement: Stmt_InlineHTML
	rt.call_function('esc_html_e', [
		rt.new_string('Learn about new products and discounts'),
		rt.new_string('woocommerce'),
	])
	// unsupported statement: Stmt_InlineHTML
