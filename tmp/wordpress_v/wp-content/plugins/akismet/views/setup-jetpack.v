...
pub fn init_wp_content_plugins_akismet_views_setup_jetpack_php() {
	...
	// unsupported statement: Stmt_InlineHTML
	if rt.is_true(rt.call_function('in_array', [var_user_status.dup(),
		rt.create_array([
		...
		])]))
	{
		...
		rt.echo_val(rt.call_function('esc_attr', [
			rt.call_function('str_replace', [rt.new_string('-'),
				rt.new_string('_'), var_user_status.dup()]),
		]))
		// unsupported statement: Stmt_InlineHTML
