...
pub fn init_wp_content_themes_twentytwentyfive_patterns_hero_full_width_image_php() {
	...
	rt.echo_val(rt.call_function('esc_attr_x', [rt.new_string('Picture of a flower'),
		rt.new_string('Alt text for cover image.'), rt.new_string('twentytwentyfive')]))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_url', [
		rt.call_function('get_template_directory_uri', []rt.PhpVal{}),
	]))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_html_x', [rt.new_string('Tell your story'),
		rt.new_string('Sample hero heading'), rt.new_string('twentytwentyfive')]))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.call_function('esc_html_x', [
		...
		rt.new_string('Sample hero paragraph'),
