...
fn Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_decrypt(message string, ad string, nonce string, key string) rt.PhpVal {
	...
	mut var_len := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.strlen(arg_0) }(rt.new_string(message))
	mut var_clen := rt.sub(var_len, Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_abytes())
	mut var_adlen := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.strlen(arg_0) }(rt.new_string(ad))
	mut var_mac := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(message), var_clen.dup(), rt.new_int(Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_abytes()))
	mut var_ciphertext := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(message), rt.new_int(0), var_clen.dup())
	mut var_block0 := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20{}; return temp.stream(arg_0, arg_1, arg_2) }(rt.new_int(32), rt.new_string(nonce_mutated), rt.new_string(key))
	mut var_state := create_paragonie_sodium_core32_poly1305_state(var_block0.dup())
...
end_label_1:
	...
	rt.call_method(var_state, 'update', [fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.store64_le(arg_0) }(var_adlen.dup())])
	rt.call_method(var_state, 'update', [var_ciphertext.dup()])
	rt.call_method(var_state, 'update', [fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.store64_le(arg_0) }(var_clen.dup())])
	mut var_computed_mac := rt.call_method(var_state, 'finish', []rt.PhpVal{})
	if rt.is_true(rt.new_bool(!(rt.is_true(fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.verify_16(arg_0, arg_1) }(var_computed_mac.dup(), var_mac.dup()))))) {
		rt.throw_exception(rt.new_object('SodiumException', []string{}, create_sodiumexception(rt.new_string('Invalid MAC'))))
	}
	return fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal, arg_3 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20{}; return temp.streamxoric(arg_0, arg_1, arg_2, arg_3) }(var_ciphertext.dup(), rt.new_string(nonce_mutated), rt.new_string(key), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.store64_le(arg_0) }(rt.new_int(1)))
}
...
end_label_2:
	mut var_ciphertext := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal, arg_3 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20{}; return temp.streamxoric(arg_0, arg_1, arg_2, arg_3) }(rt.new_string(message), rt.new_string(nonce_mutated), rt.new_string(key), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.store64_le(arg_0) }(rt.new_int(1)))
	rt.call_method(var_state, 'update', [rt.new_string(ad)])
	rt.call_method(var_state, 'update', [fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.store64_le(arg_0) }(var_adlen.dup())])
	rt.call_method(var_state, 'update', [var_ciphertext.dup()])
	rt.call_method(var_state, 'update', [fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.store64_le(arg_0) }(var_len.dup())])
...
fn Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_ietf_decrypt(message string, ad string, nonce string, key string) rt.PhpVal {
	...
	mut var_adlen := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.strlen(arg_0) }(rt.new_string(ad))
	mut var_len := fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.strlen(arg_0) }(rt.new_string(message))
	mut var_clen := rt.sub(var_len, Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_ietf_abytes())
	mut var_block0 := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20{}; return temp.ietfstream(arg_0, arg_1, arg_2) }(rt.new_int(32), rt.new_string(nonce_mutated), rt.new_string(key))
	mut var_mac := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(message), rt.sub(var_len, Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_ietf_abytes()), rt.new_int(Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_ietf_abytes()))
	mut var_ciphertext := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(message), rt.new_int(0), rt.sub(var_len, Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_ietf_abytes()))
	mut var_state := create_paragonie_sodium_core32_poly1305_state(var_block0.dup())
	fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Compat{}; return temp.memzero(arg_0) }(var_block0.dup())
...
end_label_3:
	...
	return fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal, arg_3 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20{}; return temp.ietfstreamxoric(arg_0, arg_1, arg_2, arg_3) }(var_ciphertext.dup(), rt.new_string(nonce_mutated), rt.new_string(key), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.store64_le(arg_0) }(rt.new_int(1)))
}
...
end_label_4:
	mut var_ciphertext := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal, arg_3 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20{}; return temp.ietfstreamxoric(arg_0, arg_1, arg_2, arg_3) }(rt.new_string(message), rt.new_string(nonce_mutated), rt.new_string(key), fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.store64_le(arg_0) }(rt.new_int(1)))
	rt.call_method(var_state, 'update', [rt.new_string(ad)])
	rt.call_method(var_state, 'update', [rt.call_function('str_repeat', [rt.new_string(''), rt.bitwise_and(rt.sub(rt.new_int(16), var_adlen), rt.new_int(15))])])
	rt.call_method(var_state, 'update', [var_ciphertext.dup()])
...
fn Class_ParagonIE_Sodium_Crypto32.aead_xchacha20poly1305_ietf_decrypt(message string, ad string, nonce string, key string) rt.PhpVal {
	mut nonce_mutated := nonce
	mut var_subkey := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_HChaCha20{}; return temp.hchacha20(arg_0, arg_1) }(fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(nonce_mutated), rt.new_int(0), rt.new_int(16)), rt.new_string(key))
	mut var_nonceLast := rt.new_string('' + (fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(nonce_mutated), rt.new_int(16), rt.new_int(8))).str())
	return Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_ietf_decrypt(message, ad, (var_nonceLast).str(), (var_subkey).str())
}
...
fn Class_ParagonIE_Sodium_Crypto32.aead_xchacha20poly1305_ietf_encrypt(message string, ad string, nonce string, key string) rt.PhpVal {
	...
	mut var_subkey := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_HChaCha20{}; return temp.hchacha20(arg_0, arg_1) }(fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(nonce_mutated), rt.new_int(0), rt.new_int(16)), rt.new_string(key))
	mut var_nonceLast := rt.new_string('' + (fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(nonce_mutated), rt.new_int(16), rt.new_int(8))).str())
	return Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_ietf_encrypt(message, ad, (var_nonceLast).str(), (var_subkey).str())
}

fn Class_ParagonIE_Sodium_Crypto32.auth(var_message rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	return fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.call_function('hash_hmac', [rt.new_string('sha512'), var_message.dup(), var_key.dup(), rt.new_bool(true)]), rt.new_int(0), rt.new_int(32))
}
...
fn Class_ParagonIE_Sodium_Crypto32.auth_verify(var_mac rt.PhpVal, var_message rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	...
	return fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.hashequals(arg_0, arg_1) }(var_mac_mutated.dup(), Class_ParagonIE_Sodium_Crypto32.auth(var_message.dup(), var_key.dup()))
}
...
fn Class_ParagonIE_Sodium_Crypto32.box(var_plaintext rt.PhpVal, var_nonce rt.PhpVal, var_keypair rt.PhpVal) rt.PhpVal {
	...
	return Class_ParagonIE_Sodium_Crypto32.secretbox(var_plaintext.dup(), var_nonce_mutated.dup(), Class_ParagonIE_Sodium_Crypto32.box_beforenm(Class_ParagonIE_Sodium_Crypto32.box_secretkey(var_keypair_mutated.dup()), Class_ParagonIE_Sodium_Crypto32.box_publickey(var_keypair_mutated.dup())))
}
...
fn Class_ParagonIE_Sodium_Crypto32.box_seal(var_message rt.PhpVal, var_publicKey rt.PhpVal) string {
	...
	mut var_ephemeralSK := Class_ParagonIE_Sodium_Crypto32.box_secretkey(var_ephemeralKeypair.dup())
	mut var_ephemeralPK := Class_ParagonIE_Sodium_Crypto32.box_publickey(var_ephemeralKeypair.dup())
	mut var_nonce := Class_ParagonIE_Sodium_Crypto32.generichash((var_ephemeralPK).str() + (var_publicKey_mutated).str(), '', rt.new_int(24))
	mut var_keypair := Class_ParagonIE_Sodium_Crypto32.box_keypair_from_secretkey_and_publickey(var_ephemeralSK.dup(), var_publicKey_mutated.dup())
	mut var_ciphertext := Class_ParagonIE_Sodium_Crypto32.box(var_message.dup(), var_nonce.dup(), var_keypair.dup())
...
fn Class_ParagonIE_Sodium_Crypto32.box_seal_open(var_message rt.PhpVal, var_keypair rt.PhpVal) rt.PhpVal {
	mut var_keypair_mutated := var_keypair
	mut var_ephemeralPK := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1, arg_2) }(var_message.dup(), rt.new_int(0), rt.new_int(32))
	mut var_ciphertext := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Util{}; return temp.substr(arg_0, arg_1) }(var_message.dup(), rt.new_int(32))
	mut var_secretKey := Class_ParagonIE_Sodium_Crypto32.box_secretkey(var_keypair_mutated.dup())
	mut var_publicKey := Class_ParagonIE_Sodium_Crypto32.box_publickey(var_keypair_mutated.dup())
	mut var_nonce := Class_ParagonIE_Sodium_Crypto32.generichash((var_ephemeralPK).str() + (var_publicKey).str(), '', rt.new_int(24))
	var_keypair_mutated = Class_ParagonIE_Sodium_Crypto32.box_keypair_from_secretkey_and_publickey(var_secretKey.dup(), var_ephemeralPK.dup())
	mut var_m := Class_ParagonIE_Sodium_Crypto32.box_open(var_ciphertext.dup(), var_nonce.dup(), var_keypair_mutated.dup())
	fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Compat{}; return temp.memzero(arg_0) }(var_secretKey.dup())
...
fn create_paragonie_sodium_crypto32() &Class_ParagonIE_Sodium_Crypto32 {
...
fn (mut this Class_ParagonIE_Sodium_Crypto32) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'aead_chacha20poly1305_decrypt' {
			...
			return Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_decrypt(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'aead_chacha20poly1305_encrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return rt.new_string(Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_encrypt(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3))
		}
		'aead_chacha20poly1305_ietf_decrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_ietf_decrypt(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'aead_chacha20poly1305_ietf_encrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return rt.new_string(Class_ParagonIE_Sodium_Crypto32.aead_chacha20poly1305_ietf_encrypt(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3))
		}
		'aead_xchacha20poly1305_ietf_decrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto32.aead_xchacha20poly1305_ietf_decrypt(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'aead_xchacha20poly1305_ietf_encrypt' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto32.aead_xchacha20poly1305_ietf_encrypt(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'auth' {
		...
		'auth_verify' {
			...
			return Class_ParagonIE_Sodium_Crypto32.auth_verify(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'box' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto32.box(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'box_seal' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			return rt.new_string(Class_ParagonIE_Sodium_Crypto32.box_seal(dispatch_arg_0, dispatch_arg_1))
		}
		'box_seal_open' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
		...
		'box_keypair_from_secretkey_and_publickey' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			return rt.new_string(Class_ParagonIE_Sodium_Crypto32.box_keypair_from_secretkey_and_publickey(dispatch_arg_0, dispatch_arg_1))
		}
		'box_secretkey' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
		...
		'box_open' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto32.box_open(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'generichash' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := (if args.len > 1 { args[1] } else { rt.new_null() }).str()
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).to_i64()
			return Class_ParagonIE_Sodium_Crypto32.generichash(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'generichash_final' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
		...
		'generichash_init_salt_personal' {
			...
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			dispatch_arg_3 := (if args.len > 3 { args[3] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto32.generichash_init_salt_personal(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'generichash_update' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto32.generichash_update(dispatch_arg_0, dispatch_arg_1)
		}
		'keyExchange' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			...
			return Class_ParagonIE_Sodium_Crypto32.keyexchange(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'scalarmult' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
		...
		'secretbox' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto32.secretbox(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'secretbox_open' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto32.secretbox_open(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'secretbox_xchacha20poly1305' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto32.secretbox_xchacha20poly1305(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		'secretbox_xchacha20poly1305_open' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto32.secretbox_xchacha20poly1305_open(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		...
		'secretstream_xchacha20poly1305_init_pull' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto32.secretstream_xchacha20poly1305_init_pull(dispatch_arg_0, dispatch_arg_1)
		}
		'secretstream_xchacha20poly1305_push' {
			...
			return Class_ParagonIE_Sodium_Crypto32.secretstream_xchacha20poly1305_push(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2, dispatch_arg_3)
		}
		'secretstream_xchacha20poly1305_pull' {
			dispatch_arg_0 := if args.len > 0 { args[0] } else { rt.new_null() }
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := (if args.len > 2 { args[2] } else { rt.new_null() }).str()
			return Class_ParagonIE_Sodium_Crypto32.secretstream_xchacha20poly1305_pull(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		...
		'sign_verify_detached' {
			...
			dispatch_arg_1 := if args.len > 1 { args[1] } else { rt.new_null() }
			dispatch_arg_2 := if args.len > 2 { args[2] } else { rt.new_null() }
			return Class_ParagonIE_Sodium_Crypto32.sign_verify_detached(dispatch_arg_0, dispatch_arg_1, dispatch_arg_2)
		}
		else { return none }
	}
}
...
pub fn init_wp_includes_sodium_compat_src_crypto32_php() {
	if rt.is_true(rt.call_function('class_exists', [rt.new_string('ParagonIE_Sodium_Crypto32'), rt.new_bool(false)])) {
		return rt.new_null()
	}
}
