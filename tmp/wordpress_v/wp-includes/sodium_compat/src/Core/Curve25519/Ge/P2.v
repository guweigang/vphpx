...
fn (mut this Class_ParagonIE_Sodium_Core_Curve25519_Ge_P2) construct(var_x rt.PhpVal, var_y rt.PhpVal, var_z rt.PhpVal) {
...
fn create_paragonie_sodium_core_curve25519_ge_p2(arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) &Class_ParagonIE_Sodium_Core_Curve25519_Ge_P2 {
...
pub fn init_wp_includes_sodium_compat_src_core_curve25519_ge_p2_php() {
	if rt.is_true(rt.call_function('class_exists', [
		rt.new_string('ParagonIE_Sodium_Core_Curve25519_Ge_P2'),
		rt.new_bool(false),
	]))
	{
		return rt.new_null()
