...
fn Class_ParagonIE_Sodium_Core32_XSalsa20.xsalsa20(var_len rt.PhpVal, var_nonce rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	mut var_ret := fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal {
		mut temp := Class_ParagonIE_Sodium_Core32_XSalsa20{}
...
fn Class_ParagonIE_Sodium_Core32_XSalsa20.xsalsa20_xor(var_message rt.PhpVal, var_nonce rt.PhpVal, var_key rt.PhpVal) rt.PhpVal {
	...
	}(var_message.dup(), Class_ParagonIE_Sodium_Core32_XSalsa20.xsalsa20(fn (arg_0 rt.PhpVal) rt.PhpVal {
		mut temp := Class_ParagonIE_Sodium_Core32_XSalsa20{}
...
fn create_paragonie_sodium_core32_xsalsa20() &Class_ParagonIE_Sodium_Core32_XSalsa20 {
...
pub fn init_wp_includes_sodium_compat_src_core32_xsalsa20_php() {
