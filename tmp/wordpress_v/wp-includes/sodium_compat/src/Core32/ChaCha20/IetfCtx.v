...
fn (mut this Class_ParagonIE_Sodium_Core32_ChaCha20_IetfCtx) construct(key string, iv string, counter string)  {
	...
	this.Class_ParagonIE_Sodium_Core32_ChaCha20_Ctx.construct(rt.new_string(key), fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20_IetfCtx{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(iv), rt.new_int(0), rt.new_int(8)), rt.new_string(counter))
	if !(counter == '') {
		rt.get_property(rt.new_object('ParagonIE_Sodium_Core32_ChaCha20_IetfCtx', ['ParagonIE_Sodium_Core32_ChaCha20_Ctx'], &this), 'container').array_set(12, fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Int32{}; return temp.fromreversestring(arg_0) }(fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20_IetfCtx{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(counter), rt.new_int(0), rt.new_int(4))))
	}
	rt.get_property(rt.new_object('ParagonIE_Sodium_Core32_ChaCha20_IetfCtx', ['ParagonIE_Sodium_Core32_ChaCha20_Ctx'], &this), 'container').array_set(13, fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Int32{}; return temp.fromreversestring(arg_0) }(fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20_IetfCtx{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(iv), rt.new_int(0), rt.new_int(4))))
	rt.get_property(rt.new_object('ParagonIE_Sodium_Core32_ChaCha20_IetfCtx', ['ParagonIE_Sodium_Core32_ChaCha20_Ctx'], &this), 'container').array_set(14, fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Int32{}; return temp.fromreversestring(arg_0) }(fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20_IetfCtx{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(iv), rt.new_int(4), rt.new_int(4))))
	rt.get_property(rt.new_object('ParagonIE_Sodium_Core32_ChaCha20_IetfCtx', ['ParagonIE_Sodium_Core32_ChaCha20_Ctx'], &this), 'container').array_set(15, fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_Int32{}; return temp.fromreversestring(arg_0) }(fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal, arg_2 rt.PhpVal) rt.PhpVal { mut temp := Class_ParagonIE_Sodium_Core32_ChaCha20_IetfCtx{}; return temp.substr(arg_0, arg_1, arg_2) }(rt.new_string(iv), rt.new_int(8), rt.new_int(4))))
}
...
pub fn init_wp_includes_sodium_compat_src_core32_chacha20_ietfctx_php() {
