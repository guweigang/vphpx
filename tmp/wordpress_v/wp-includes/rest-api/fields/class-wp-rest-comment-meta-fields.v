...
fn (mut this Class_WP_REST_Comment_Meta_Fields) get_meta_type() string {
	return 'comment'
}

fn (mut this Class_WP_REST_Comment_Meta_Fields) get_meta_subtype() string {
	return 'comment'
}

fn (mut this Class_WP_REST_Comment_Meta_Fields) get_rest_field_type() string {
	return 'comment'
}
...
pub fn init_wp_includes_rest_api_fields_class_wp_rest_comment_meta_fields_php() {
}
