...
fn (mut this Class_WP_REST_Abilities_V1_Categories_Controller) register_routes()  {
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str(), rt.create_array([rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WP_REST_Abilities_V1_Categories_Controller', ['WP_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WP_REST_Abilities_V1_Categories_Controller', ['WP_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_items_permissions_check' }]) }, rt.ArrayItem{ key: 'args', val: this.get_collection_params() }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WP_REST_Abilities_V1_Categories_Controller', ['WP_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
	rt.call_function('register_rest_route', [this.namespace, '/' + (this.rest_base).str() + '/(?P<slug>[a-z0-9]+(?:-[a-z0-9]+)*)', rt.create_array([rt.ArrayItem{ key: 'args', val: rt.create_array([rt.ArrayItem{ key: 'slug', val: rt.create_array([rt.ArrayItem{ key: 'description', val: rt.call_function('__', [rt.new_string('Unique identifier for the ability category.')]) }, rt.ArrayItem{ key: 'type', val: 'string' }, rt.ArrayItem{ key: 'pattern', val: '^[a-z0-9]+(?:-[a-z0-9]+)*$' }]) }]) }, rt.ArrayItem{ key: none, val: rt.create_array([rt.ArrayItem{ key: 'methods', val: Class_WP_REST_Server.readable() }, rt.ArrayItem{ key: 'callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WP_REST_Abilities_V1_Categories_Controller', ['WP_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_item' }]) }, rt.ArrayItem{ key: 'permission_callback', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WP_REST_Abilities_V1_Categories_Controller', ['WP_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_item_permissions_check' }]) }]) }, rt.ArrayItem{ key: 'schema', val: rt.create_array([rt.ArrayItem{ key: none, val: rt.new_object('WP_REST_Abilities_V1_Categories_Controller', ['WP_REST_Controller'], &this) }, rt.ArrayItem{ key: none, val: 'get_public_item_schema' }]) }])])
}
...
fn (mut this Class_WP_REST_Abilities_V1_Categories_Controller) get_items(var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_total_categories := rt.new_int(rt.new_int(var_categories.dup().array_count()))
	...
	if rt.is_true(rt.identical(rt.call_method(var_request, 'get_method', []rt.PhpVal{}), rt.new_string('HEAD'))) {
		...
		var_categories = rt.call_function('array_slice', [var_categories.dup(), var_offset.dup(), var_per_page.dup()])
		mut var_data := rt.new_array()
		{
			...
			for {
				...
				mut var_item := this.prepare_item_for_response(var_category.dup(), var_request.dup())
...
fn (mut this Class_WP_REST_Abilities_V1_Categories_Controller) get_item(var_request rt.PhpVal) rt.PhpVal {
	mut var_category := rt.call_function('wp_get_ability_category', [var_request.array_get('slug')])
	if rt.is_true(rt.new_bool(!(rt.is_true(var_category)))) {
		return create_wp_error(rt.new_string('rest_ability_category_not_found'), rt.call_function('__', [rt.new_string('Ability category not found.')]), rt.create_array([rt.ArrayItem{ key: 'status', val: 404 }]))
	}
	mut var_data := this.prepare_item_for_response(var_category.dup(), var_request.dup())
...
fn (mut this Class_WP_REST_Abilities_V1_Categories_Controller) prepare_item_for_response(var_category rt.PhpVal, var_request rt.PhpVal) rt.PhpVal {
	...
	mut var_data := rt.create_array([rt.ArrayItem{ key: 'slug', val: rt.call_method(var_category_mutated, 'get_slug', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'label', val: rt.call_method(var_category_mutated, 'get_label', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'description', val: rt.call_method(var_category_mutated, 'get_description', []rt.PhpVal{}) }, rt.ArrayItem{ key: 'meta', val: rt.call_method(var_category_mutated, 'get_meta', []rt.PhpVal{}) }])
	...
	if rt.is_true(rt.new_bool(rt.is_true(rt.call_function('rest_is_field_included', [rt.new_string('_links'), var_fields.dup()])) || rt.is_true(rt.call_function('rest_is_field_included', [rt.new_string('_embedded'), var_fields.dup()])))) {
		mut var_links := { 'self': { 'href': rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('%s/%s/%s'), this.namespace, this.rest_base, rt.call_method(var_category_mutated, 'get_slug', []rt.PhpVal{})])]) }, 'collection': { 'href': rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('%s/%s'), this.namespace, this.rest_base])]) }, 'abilities': { 'href': rt.call_function('rest_url', [rt.call_function('sprintf', [rt.new_string('%s/abilities?category=%s'), this.namespace, rt.call_method(var_category_mutated, 'get_slug', []rt.PhpVal{})])]) } }
...
fn (mut this Class_WP_REST_Abilities_V1_Categories_Controller) get_item_schema() rt.PhpVal {
	mut var_schema := { '$schema': rt.new_string('http://json-schema.org/draft-04/schema#'), 'title': rt.new_string('ability-category'), 'type': rt.new_string('object'), 'properties': { 'slug': { 'description': rt.call_function('__', [rt.new_string('Unique identifier for the ability category.')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'label': { 'description': rt.call_function('__', [rt.new_string('Display label for the category.')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'description': { 'description': rt.call_function('__', [rt.new_string('Description of the category.')]), 'type': rt.new_string('string'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) }, 'meta': { 'description': rt.call_function('__', [rt.new_string('Meta information about the category.')]), 'type': rt.new_string('object'), 'context': map[string]rt.PhpVal{}, 'readonly': rt.new_bool(true) } } }
...
fn create_wp_rest_abilities_v1_categories_controller() &Class_WP_REST_Abilities_V1_Categories_Controller {
...
pub fn init_wp_includes_rest_api_endpoints_class_wp_rest_abilities_v1_categories_controller_php() {
