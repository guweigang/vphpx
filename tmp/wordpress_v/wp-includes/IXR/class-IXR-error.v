...
fn (mut this Class_IXR_Error) construct(var_code rt.PhpVal, var_message rt.PhpVal) {
	...
	this.message = rt.call_function('htmlspecialchars', [var_message.dup()])
}
...
fn (mut this Class_IXR_Error) ixr_error(var_code rt.PhpVal, var_message rt.PhpVal) {
	fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
		mut temp := Class_IXR_Error{}
		temp.construct(arg_0, arg_1)
		return rt.new_null()
	}(var_code.dup(), var_message.dup())
}
...
pub fn init_wp_includes_ixr_class_ixr_error_php() {
}
