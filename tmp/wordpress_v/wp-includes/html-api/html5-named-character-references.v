...
pub fn init_wp_includes_html_api_html5_named_character_references_php() {
	// unsupported statement: Stmt_Global
	mut var_html5_named_character_references := fn (arg_0 rt.PhpVal) rt.PhpVal {
		mut temp := Class_WP_Token_Map{}
		return temp.from_precomputed_table(arg_0)
	}(rt.create_array([rt.ArrayItem{ key: 'storage_version', val: '6.6.0-trunk' },
		rt.ArrayItem{ key: 'key_length', val: 2 }, rt.ArrayItem{ key: 'groups', val: 'AE' },
		...
		]) }, rt.ArrayItem{ key: 'small_words', val: 'GT' }, rt.ArrayItem{ key: 'small_mappings', val: rt.create_array([
			rt.ArrayItem{ key: none, val: '>' },
			rt.ArrayItem{ key: none, val: '<' },
			rt.ArrayItem{ key: none, val: '>' },
			rt.ArrayItem{ key: none, val: '<' },
