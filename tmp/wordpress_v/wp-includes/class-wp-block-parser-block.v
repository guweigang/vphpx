...
fn (mut this Class_WP_Block_Parser_Block) construct(var_name rt.PhpVal, var_attrs rt.PhpVal, var_inner_blocks rt.PhpVal, var_inner_html rt.PhpVal, var_inner_content rt.PhpVal) {
	this.blockName = var_name.dup()
	this.attrs = var_attrs.dup()
	this.innerBlocks = var_inner_blocks.dup()
	this.innerHTML = var_inner_html.dup()
	this.innerContent = var_inner_content.dup()
...
pub fn init_wp_includes_class_wp_block_parser_block_php() {
}
