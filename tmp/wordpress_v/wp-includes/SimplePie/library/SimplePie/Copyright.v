...
fn create_simplepie_copyright() &Class_SimplePie_Copyright {
...
pub fn init_wp_includes_simplepie_library_simplepie_copyright_php() {
	// unsupported statement: Stmt_Declare
	rt.call_function('class_exists', [rt.new_string('SimplePie\\Copyright')])
	if false {
	}
}
