...
fn create_simplepie_item() &Class_SimplePie_Item {
...
pub fn init_wp_includes_simplepie_library_simplepie_item_php() {
	// unsupported statement: Stmt_Declare
	rt.call_function('class_exists', [rt.new_string('SimplePie\\Item')])
	if false {
	}
}
