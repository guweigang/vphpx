...
fn create_simplepie_rating() &Class_SimplePie_Rating {
...
pub fn init_wp_includes_simplepie_library_simplepie_rating_php() {
	// unsupported statement: Stmt_Declare
	rt.call_function('class_exists', [rt.new_string('SimplePie\\Rating')])
	if false {
	}
}
