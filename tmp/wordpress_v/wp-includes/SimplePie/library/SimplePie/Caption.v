...
fn create_simplepie_caption() &Class_SimplePie_Caption {
...
pub fn init_wp_includes_simplepie_library_simplepie_caption_php() {
	// unsupported statement: Stmt_Declare
	rt.call_function('class_exists', [rt.new_string('SimplePie\\Caption')])
	if false {
	}
}
