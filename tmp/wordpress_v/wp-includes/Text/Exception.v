...
fn (mut this Class_Text_Exception) construct(var_message rt.PhpVal) {
	this.message = var_message.to_string()
}

fn (mut this Class_Text_Exception) getmessage() string {
	return this.message
}
...
fn create_text_exception(arg_0 rt.PhpVal) &Class_Text_Exception {
...
pub fn init_wp_includes_text_exception_php() {
}
