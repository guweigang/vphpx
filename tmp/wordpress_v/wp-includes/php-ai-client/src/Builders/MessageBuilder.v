...
fn (mut this Class_WordPress_AiClient_Builders_MessageBuilder) construct(var_input rt.PhpVal, mut var_role Class_WordPress_AiClient_Builders_?MessageRoleEnum)  {
	...
	if rt.is_true(rt.new_bool(rt.instance_of(var_input, 'WordPress_AiClient_Messages_DTO_MessagePart'))) {
		this.parts.array_push(var_input.dup())
	} else if rt.is_true(rt.new_bool(var_input.dup().is_string())) {
		this.withtext((var_input).str())
	} else if rt.is_true(rt.new_bool(rt.instance_of(var_input, 'WordPress_AiClient_Files_DTO_File'))) {
		this.withfile(var_input.dup(), rt.new_null())
	...
	} else if rt.is_true(rt.new_bool(rt.is_true(rt.new_bool(var_input.dup().is_array())) && rt.is_true(fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_WordPress_AiClient_Messages_DTO_MessagePart{}; return temp.isarrayshape(arg_0) }(var_input.dup())))) {
		this.parts.array_push(fn (arg_0 rt.PhpVal) rt.PhpVal { mut temp := Class_WordPress_AiClient_Messages_DTO_MessagePart{}; return temp.fromarray(arg_0) }(var_input.dup()))
	} else {
...
fn (mut this Class_WordPress_AiClient_Builders_MessageBuilder) usinguserrole() rt.PhpVal {
	return this.usingrole(mut rt.cast_object_ptr[Class_WordPress_AiClient_Messages_Enums_MessageRoleEnum](fn () rt.PhpVal { mut temp := Class_WordPress_AiClient_Messages_Enums_MessageRoleEnum{}; return temp.user() }()))
}

fn (mut this Class_WordPress_AiClient_Builders_MessageBuilder) usingmodelrole() rt.PhpVal {
	return this.usingrole(mut rt.cast_object_ptr[Class_WordPress_AiClient_Messages_Enums_MessageRoleEnum](fn () rt.PhpVal { mut temp := Class_WordPress_AiClient_Messages_Enums_MessageRoleEnum{}; return temp.model() }()))
}
...
fn (mut this Class_WordPress_AiClient_Builders_MessageBuilder) withtext(text string) rt.PhpVal {
	...
	this.parts.array_push(create_wordpress_aiclient_messages_dto_messagepart(rt.new_string(text).dup()))
	return rt.new_object('WordPress_AiClient_Builders_MessageBuilder', []string{}, this)
}
...
fn (mut this Class_WordPress_AiClient_Builders_MessageBuilder) withfile(var_file rt.PhpVal, mut var_mimeType Class_WordPress_AiClient_Builders_?string) rt.PhpVal {
	...
	this.parts.array_push(create_wordpress_aiclient_messages_dto_messagepart(var_file_mutated.dup()))
	return rt.new_object('WordPress_AiClient_Builders_MessageBuilder', []string{}, this)
}
...
fn (mut this Class_WordPress_AiClient_Builders_MessageBuilder) withfunctioncall(mut var_functionCall Class_WordPress_AiClient_Tools_DTO_FunctionCall) rt.PhpVal {
	this.parts.array_push(create_wordpress_aiclient_messages_dto_messagepart(var_functionCall.dup()))
	return rt.new_object('WordPress_AiClient_Builders_MessageBuilder', []string{}, this)
}
...
fn (mut this Class_WordPress_AiClient_Builders_MessageBuilder) withfunctionresponse(mut var_functionResponse Class_WordPress_AiClient_Tools_DTO_FunctionResponse) rt.PhpVal {
	this.parts.array_push(create_wordpress_aiclient_messages_dto_messagepart(var_functionResponse.dup()))
	return rt.new_object('WordPress_AiClient_Builders_MessageBuilder', []string{}, this)
}
...
fn (mut this Class_WordPress_AiClient_Builders_MessageBuilder) withmessageparts(mut var_parts Class_WordPress_AiClient_Messages_DTO_MessagePart) rt.PhpVal {
	{
		...
		for {
			item_1 := iter_1.next() or { break }
			mut var_part := item_1.val
			this.parts.array_push(var_part.dup())
		}
	}
	return rt.new_object('WordPress_AiClient_Builders_MessageBuilder', []string{}, this)
}
...
fn (mut this Class_WordPress_AiClient_Builders_MessageBuilder) get() rt.PhpVal {
	...
	return create_wordpress_aiclient_messages_dto_message(var_role.dup(), this.parts)
}
...
pub fn init_wp_includes_php_ai_client_src_builders_messagebuilder_php() {
