...
pub fn Class_WordPress_AiClient_Files_Enums_FileTypeEnum.inline() string {
	return 'inline'
}

pub fn Class_WordPress_AiClient_Files_Enums_FileTypeEnum.remote() string {
	return 'remote'
}
...
pub fn init_wp_includes_php_ai_client_src_files_enums_filetypeenum_php() {
