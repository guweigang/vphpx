...
fn Class_WordPress_AiClient_Providers_Http_DTO_ApiKeyRequestAuthentication.fromarray(mut var_array Class_WordPress_AiClient_Providers_Http_DTO_array) rt.PhpVal {
	fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
		mut temp := Class_WordPress_AiClient_Providers_Http_DTO_ApiKeyRequestAuthentication{}
	...
	return create_wordpress_aiclient_providers_http_dto_self(var_array.array_get(Class_WordPress_AiClient_Providers_Http_DTO_WordPress_AiClient_Providers_Http_DTO_ApiKeyRequestAuthentication.key_api_key()))
}
...
pub fn init_wp_includes_php_ai_client_src_providers_http_dto_apikeyrequestauthentication_php() {
