...
struct Class_WordPress_AiClient_Providers_AbstractProvider {
	rt.PhpObjectBase
pub mut:
		metadataCache rt.PhpVal = rt.new_array()
		availabilityCache rt.PhpVal = rt.new_array()
		modelMetadataDirectoryCache rt.PhpVal = rt.new_array()
}
...
fn Class_WordPress_AiClient_Providers_AbstractProvider.metadata() rt.PhpVal {
	...
	if !(// unsupported expression: Expr_StaticPropertyFetch.array_isset(var_className)) {
		// unsupported expression: Expr_StaticPropertyFetch.array_set(var_className, Class_WordPress_AiClient_Providers_AbstractProvider.createprovidermetadata())
	}
...
fn Class_WordPress_AiClient_Providers_AbstractProvider.model(modelId string, mut var_modelConfig Class_WordPress_AiClient_Providers_?ModelConfig) rt.PhpVal {
	...
	return var_model.dup()
}

fn Class_WordPress_AiClient_Providers_AbstractProvider.availability() rt.PhpVal {
	mut var_className := Class_WordPress_AiClient_Providers_static.class()
	if !(// unsupported expression: Expr_StaticPropertyFetch.array_isset(var_className)) {
		// unsupported expression: Expr_StaticPropertyFetch.array_set(var_className, Class_WordPress_AiClient_Providers_AbstractProvider.createprovideravailability())
	}
	return // unsupported expression: Expr_StaticPropertyFetch.array_get(var_className)
}
...
fn Class_WordPress_AiClient_Providers_AbstractProvider.modelmetadatadirectory() rt.PhpVal {
	mut var_className := Class_WordPress_AiClient_Providers_static.class()
	if !(// unsupported expression: Expr_StaticPropertyFetch.array_isset(var_className)) {
		// unsupported expression: Expr_StaticPropertyFetch.array_set(var_className, Class_WordPress_AiClient_Providers_AbstractProvider.createmodelmetadatadirectory())
	}
	return // unsupported expression: Expr_StaticPropertyFetch.array_get(var_className)
}
...
fn create_wordpress_aiclient_providers_abstractprovider() &Class_WordPress_AiClient_Providers_AbstractProvider {
	mut obj := &Class_WordPress_AiClient_Providers_AbstractProvider{
		...
		metadataCache: rt.new_array()
		availabilityCache: rt.new_array()
		modelMetadataDirectoryCache: rt.new_array()
	}
	return obj
}
...
fn (this &Class_WordPress_AiClient_Providers_AbstractProvider) dispatch_get_prop(prop_name string) ?rt.PhpVal {
	match prop_name {
		'metadataCache' { return this.metadataCache }
		'availabilityCache' { return this.availabilityCache }
		'modelMetadataDirectoryCache' { return this.modelMetadataDirectoryCache }
...
fn (mut this Class_WordPress_AiClient_Providers_AbstractProvider) dispatch_set_prop(prop_name string, val rt.PhpVal) bool {
	match prop_name {
		'metadataCache' { this.metadataCache = val; return true }
		'availabilityCache' { this.availabilityCache = val; return true }
		'modelMetadataDirectoryCache' { this.modelMetadataDirectoryCache = val; return true }
...
pub fn init_wp_includes_php_ai_client_src_providers_abstractprovider_php() {
