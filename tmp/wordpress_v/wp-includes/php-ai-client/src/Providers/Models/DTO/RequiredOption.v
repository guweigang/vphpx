		...
		rt.ArrayItem{ key: 'properties', val: rt.create_array([
			rt.ArrayItem{
				...
				val: rt.create_array([rt.ArrayItem{ key: 'type', val: 'string' },
					rt.ArrayItem{ key: 'enum', val: fn () rt.PhpVal {
						mut temp := Class_WordPress_AiClient_Providers_Models_Enums_OptionEnum{}
...
fn Class_WordPress_AiClient_Providers_Models_DTO_RequiredOption.fromarray(mut var_array Class_WordPress_AiClient_Providers_Models_DTO_array) rt.PhpVal {
	fn (arg_0 rt.PhpVal, arg_1 rt.PhpVal) rt.PhpVal {
		mut temp := Class_WordPress_AiClient_Providers_Models_DTO_RequiredOption{}
		return temp.validatefromarraydata(arg_0, arg_1)
	}(rt.new_object('WordPress_AiClient_Providers_Models_DTO_array', []string{}, var_array), rt.create_array([
		rt.ArrayItem{
			key: none
			val: Class_WordPress_AiClient_Providers_Models_DTO_WordPress_AiClient_Providers_Models_DTO_RequiredOption.key_name()
		},
	...
	return create_wordpress_aiclient_providers_models_dto_self(fn (arg_0 rt.PhpVal) rt.PhpVal {
		mut temp := Class_WordPress_AiClient_Providers_Models_Enums_OptionEnum{}
		return temp.from(arg_0)
	}(var_array.array_get(Class_WordPress_AiClient_Providers_Models_DTO_WordPress_AiClient_Providers_Models_DTO_RequiredOption.key_name())),
...
pub fn init_wp_includes_php_ai_client_src_providers_models_dto_requiredoption_php() {
