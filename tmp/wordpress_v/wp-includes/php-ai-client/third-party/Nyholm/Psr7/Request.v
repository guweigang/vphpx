...
fn (mut this Class_WordPress_AiClientDependencies_Nyholm_Psr7_Request) dispatch_method(method_name string, args []rt.PhpVal) ?rt.PhpVal {
	match method_name {
		'__construct' {
			...
			this.construct(dispatch_arg_0, dispatch_arg_1, mut dispatch_arg_2, dispatch_arg_3, dispatch_arg_4)
			return rt.new_null()
		}
		else { return none }
	}
...
pub fn init_wp_includes_php_ai_client_third_party_nyholm_psr7_request_php() {
