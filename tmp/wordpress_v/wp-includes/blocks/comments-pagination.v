...
fn render_block_core_comments_pagination(var_attributes rt.PhpVal, var_content rt.PhpVal) string {
...
fn register_block_core_comments_pagination() {
	rt.call_function('register_block_type_from_metadata', [
		@DIR + '/comments-pagination',
		rt.create_array([
			rt.ArrayItem{ key: 'render_callback', val: 'render_block_core_comments_pagination' },
		]),
	])
}

pub fn init_wp_includes_blocks_comments_pagination_php() {
	rt.call_function('add_action', [rt.new_string('init'),
		rt.new_string('register_block_core_comments_pagination')])
}
