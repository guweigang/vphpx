...
fn register_block_core_heading() {
	rt.call_function('register_block_type_from_metadata', [@DIR + '/heading',
		rt.create_array([
...
pub fn init_wp_includes_blocks_heading_php() {
