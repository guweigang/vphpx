...
fn render_block_core_post_author_biography(var_attributes rt.PhpVal, var_content rt.PhpVal, var_block rt.PhpVal) string {
	...
	mut var_author_biography := rt.call_function('get_the_author_meta', [
	...
	return
		(rt.call_function('sprintf', [rt.new_string('<div %1$s>'), var_wrapper_attributes.dup()])).str() +
		var_author_biography.str() + '</div>'
}

fn register_block_core_post_author_biography() {
	rt.call_function('register_block_type_from_metadata', [
		@DIR + '/post-author-biography',
		rt.create_array([
...
pub fn init_wp_includes_blocks_post_author_biography_php() {
