...
fn (mut this Class_WP_Customize_Site_Icon_Control) construct(var_manager rt.PhpVal, var_id rt.PhpVal, var_args rt.PhpVal) {
	this.Class_WP_Customize_Cropped_Image_Control.construct(var_manager.dup(), var_id.dup(),
		var_args.dup())
...
fn (mut this Class_WP_Customize_Site_Icon_Control) content_template() {
	...
	], &this), 'button_labels').array_get('remove'))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.get_property(rt.new_object('WP_Customize_Site_Icon_Control', [
		'WP_Customize_Cropped_Image_Control',
	], &this), 'button_labels').array_get('change'))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.get_property(rt.new_object('WP_Customize_Site_Icon_Control', [
		'WP_Customize_Cropped_Image_Control',
	], &this), 'button_labels').array_get('site_icon'))
	// unsupported statement: Stmt_InlineHTML
	rt.echo_val(rt.get_property(rt.new_object('WP_Customize_Site_Icon_Control', [
		'WP_Customize_Cropped_Image_Control',
	], &this), 'button_labels').array_get('default'))
	// unsupported statement: Stmt_InlineHTML
}
...
fn create_wp_customize_cropped_image_control() &Class_WP_Customize_Cropped_Image_Control {
...
pub fn init_wp_includes_customize_class_wp_customize_site_icon_control_php() {
}
