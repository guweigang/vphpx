...
fn (mut this Class_WP_Customize_Nav_Menu_Section) json() rt.PhpVal {
	...
	var_exported.array_set('menu_id', // unsupported expression: Expr_Cast_Int)
...
fn create_wp_customize_nav_menu_section() &Class_WP_Customize_Nav_Menu_Section {
...
pub fn init_wp_includes_customize_class_wp_customize_nav_menu_section_php() {
}
