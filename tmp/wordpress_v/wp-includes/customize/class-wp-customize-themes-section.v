...
fn (mut this Class_WP_Customize_Themes_Section) filter_drawer_content_template() {
	...
	// unsupported statement: Stmt_InlineHTML
	{
		...
		for {
			...
			// unsupported statement: Stmt_InlineHTML
			rt.echo_val(rt.call_function('esc_html', [var_feature_name.dup()]))
			// unsupported statement: Stmt_InlineHTML
			{
...
fn create_wp_customize_themes_section() &Class_WP_Customize_Themes_Section {
...
pub fn init_wp_includes_customize_class_wp_customize_themes_section_php() {
}
