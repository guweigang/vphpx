	...
	for var_group in var_options {
		// unsupported statement: Stmt_InlineHTML
		{
			...
			for {
				...
				// unsupported statement: Stmt_InlineHTML
				rt.echo_val(rt.call_function('esc_attr', [var_input.array_get('icon')]))
				// unsupported statement: Stmt_InlineHTML
				rt.echo_val(var_input.array_get('label'))
				// unsupported statement: Stmt_InlineHTML
			}
		}
		// unsupported statement: Stmt_InlineHTML
...
fn create_wp_customize_background_position_control() &Class_WP_Customize_Background_Position_Control {
...
pub fn init_wp_includes_customize_class_wp_customize_background_position_control_php() {
}
