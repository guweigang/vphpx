...
fn (mut this Class_WP_Customize_Themes_Panel) content_template() {
	...
	rt.call_function('printf', [
		...
		'<strong class="panel-title">' + (rt.call_function('__', [rt.new_string('Themes')])).str() +
			'</strong>',
	])
...
fn create_wp_customize_themes_panel() &Class_WP_Customize_Themes_Panel {
...
pub fn init_wp_includes_customize_class_wp_customize_themes_panel_php() {
}
