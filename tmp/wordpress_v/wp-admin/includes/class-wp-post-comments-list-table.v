...
fn (mut this Class_WP_Post_Comments_List_Table) display(output_empty bool) {
	...
	rt.call_function('wp_nonce_field', [
		'fetch-list-' +(rt.call_function('get_class', [rt.new_object('WP_Post_Comments_List_Table', ['WP_Comments_List_Table'], &this)])).str(),
...
fn create_wp_post_comments_list_table() &Class_WP_Post_Comments_List_Table {
...
fn create_wp_comments_list_table() &Class_WP_Comments_List_Table {
...
pub fn init_wp_admin_includes_class_wp_post_comments_list_table_php() {
}
