...
fn (mut this Class_Bulk_Plugin_Upgrader_Skin) before(title string) {
	this.Class_Bulk_Upgrader_Skin.before(this.plugin_info.array_get('Title'))
}

fn (mut this Class_Bulk_Plugin_Upgrader_Skin) after(title string) {
	this.Class_Bulk_Upgrader_Skin.after(this.plugin_info.array_get('Title'))
...
pub fn init_wp_admin_includes_class_bulk_plugin_upgrader_skin_php() {
}
