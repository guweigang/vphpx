...
fn main() {
	...
	if rt.is_true(rt.new_bool(rt.get_superglobal('_GET').array_isset(rt.new_string('action'))
		&& rt.is_true(rt.call_function('in_array', [rt.get_superglobal('_GET').array_get('action'), rt.create_array([rt.ArrayItem{
		key: none
		val: 'update-selected'
