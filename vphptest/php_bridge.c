...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_php_class_ref_api, 0, 0, 0)
ZEND_ARG_VARIADIC_TYPE_INFO(0, args, IS_MIXED, 0)
ZEND_END_ARG_INFO()
extern void vphp_wrap_v_php_class_ref_api(vphp_context_internal ctx);
PHP_FUNCTION(v_php_class_ref_api) {
    vphp_context_internal ctx = vphp_context_from_execute(execute_data, return_value);
    vphp_wrap_v_php_class_ref_api(ctx);
}
...
static const zend_function_entry vphptest_functions[] = {
    ...
    PHP_FE(v_php_class_ref_api, arginfo_v_php_class_ref_api)
