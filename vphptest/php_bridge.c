...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_add, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_float_id, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_pure_map_test, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_bind_class_interface, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_call_php_closure_helper, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_invoke_callable, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_invoke_with_arg, 0, 0, 2)
ZEND_ARG_CALLABLE_INFO(0, callback, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_lifecycle_hook_state, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_find_after, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v_try_divide, 0, 0, 2)
ZEND_ARG_TYPE_INFO(0, a, IS_LONG, 0)
ZEND_ARG_TYPE_INFO(0, b, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEND_ARG_INFO(0, ctx)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_finder_find, 0, 0, 1)
ZEND_ARG_TYPE_INFO(0, keyword, IS_STRING, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_finder_index_of, 0, 0, 1)
ZEND_ARG_TYPE_INFO(0, keyword, IS_STRING, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_finder_has_match, 0, 0, 1)
ZEND_ARG_TYPE_INFO(0, keyword, IS_STRING, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_finder_try_parse_int, 0, 0, 1)
...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_traitpost_trait_only, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_traitpost_internal_trait, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_vphp__task_spawn, 0, 1, IS_VOID, 0)
ZEND_ARG_INFO(0, ctx)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_vphp__task_wait, 0, 1, IS_VOID, 0)
ZEND_ARG_INFO(0, ctx)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_vphp__task_list, 0, 1, IS_VOID, 0)
ZEND_ARG_INFO(0, ctx)
ZEND_END_ARG_INFO()
...
PHP_MINIT_FUNCTION(vphptest) {
    ...
    {   zend_class_entry ce;
        ...
        zend_class_entry *iface_0_ce = zend_hash_str_find_ptr(CG(class_table), "demo\\contracts\\namedcontract", sizeof("demo\\contracts\\namedcontract")-1);
        if (!iface_0_ce) {
    ...
    {   zend_class_entry ce;
        ...
        runtimedemo__baseexception_ce->create_object = parent_ce->create_object;
    }
    {   zend_class_entry ce;
        INIT_CLASS_ENTRY(ce, "RuntimeDemo\\ChildException", runtimedemo__childexception_methods);
        zend_class_entry *parent_ce = zend_hash_str_find_ptr(CG(class_table), "runtimedemo\\baseexception", sizeof("runtimedemo\\baseexception")-1);
        if (!parent_ce) {
        ...
        runtimedemo__childexception_ce->create_object = parent_ce->create_object;
    }
    {   zend_class_entry ce;
