...
final class ProfileController {
    public function show(ServerRequestInterface $req): string { return 'show'; }
    ...
    public function edit(ServerRequestInterface $req): string { return 'edit'; }
    public function update(ServerRequestInterface $req): string { return 'update'; }
    public function destroy(ServerRequestInterface $req): string { return 'destroy'; }
}
