--TEST--
VSlim dispatch_request keeps controller layout rendering stable across authenticated middleware requests
--SKIPIF--
...
namespace {
    ...
    final class LayoutProbeController extends VSlim\Controller
    {
...
TOML);
    ...
    $app->container()->set(LayoutProbeController::class, new LayoutProbeController($app));
    $app->get('/console', [LayoutProbeController::class, 'console']);
    $app->get('/console/knowledge/documents', [LayoutProbeController::class, 'documents']);
