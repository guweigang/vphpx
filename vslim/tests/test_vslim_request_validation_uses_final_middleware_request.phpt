--TEST--
VSlim request validation error responses receive final request state from middleware
--SKIPIF--
...
?>
--EXPECT--
400|err|400|Bad Request: invalid JSON body|global>group|group-trace|trace_id=group-query
413|err|413|Payload too large|global>group|group-trace|trace_id=group-query
