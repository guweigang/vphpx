...
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VSlim/App/Feishu/BotAdapter.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/JsonShape.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Event.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Command.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Command/AbstractCommand.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Command/Factory.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Command/SendCommand.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Command/UpdateCommand.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Content/InteractiveCard.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Content/PostContent.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Content/CardActionValue.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Content/CardButton.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Content/CardMarkdown.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Content/CardActionBlock.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Content/PlainText.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Content/CardHeader.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Event/AbstractEvent.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Event/Factory.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Event/CardActionEvent.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message/AbstractMessage.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message/Factory.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message/TextMessage.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message/ImageMessage.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message/PostMessage.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message/FileMessage.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message/AudioMessage.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message/MediaMessage.php';
require_once (getenv('VHTTPD_ROOT') ?: dirname(__DIR__, 3) . '/vhttpd') . '/php/package/src/VHttpd/Upstream/WebSocket/Feishu/Message/StickerMessage.php';
