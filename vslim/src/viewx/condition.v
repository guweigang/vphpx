...
fn (view &VSlimView) eval_template_condition_node(node TemplateConditionNode, scalars map[string]string, lists map[string][]string, objects map[string]vphp.PhpValue, template_path string) bool {
	match node.kind {
		.expr {
