...
fn new_psr20_system_clock_ref() vphp.PhpObject {
...
fn psr20_clock_now_unix_or_throw(clock vphp.PhpObject) !i64 {
...
fn psr20_clock_now_unix_milli_string_or_throw(clock vphp.PhpObject) !string {
	mut now := psr20_clock_now_datetime_or_throw(clock)!
	defer {
		now.release()
	}
